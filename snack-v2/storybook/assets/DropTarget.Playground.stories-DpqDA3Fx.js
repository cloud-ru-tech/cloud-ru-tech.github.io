import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{n,t as r}from"./classnames-iuquYaxc.js";import{d as i,f as a,g as o,p as s,t as c,u as l}from"./iframe-qs8RgOhH.js";import{n as u,p as d,t as f}from"./src-CMn_Zd_H.js";import{n as p,t as m}from"./stories.module-8jYz_uRV.js";import{t as h}from"./testIds-DH4zQpic.js";var g,_,v,y,b,x,S;t((()=>{f(),g=e(r(),1),c(),m(),h(),_=n(),{expect:v,within:y}=__STORYBOOK_MODULE_TEST__,b={title:`Snack/Foundation & utilities/DragAndDrop/DropTarget`,id:`components-draganddrop-droptarget`,component:u,parameters:{layout:`fullscreen`},args:{active:!0,"data-test-id":d.dropTarget}},x={tags:[`dev`,`test`],render:e=>(0,_.jsx)(a,{children:(0,_.jsxs)(s,{children:[(0,_.jsx)(o,{children:`Playground`}),(0,_.jsx)(i,{children:"Зона приёма: подсветка включается, когда перетаскиваемая сущность над зоной (`active`). Живой перенос между зонами — в story `DropTarget/Examples/CrossZone`."}),(0,_.jsx)(l,{align:`center`,children:(0,_.jsx)(`div`,{className:p.canvas,children:(0,_.jsxs)(u,{...e,className:(0,g.default)(p.entity,e.className),children:[(0,_.jsx)(`div`,{className:p.row,children:`ListItemGroup 1`}),(0,_.jsx)(`div`,{className:p.row,children:`ListItem 1`}),(0,_.jsx)(`div`,{className:p.row,children:`ListItem 2`})]})})})]})}),play:async({canvasElement:e})=>{await v(y(e).getByTestId(d.dropTarget)).toBeVisible()}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=DropTarget.Playground.stories-DpqDA3Fx.js.map