import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{d as i,f as a,g as o,p as s,t as c,u as l}from"./iframe-qs8RgOhH.js";import{U as u,t as d}from"./system-BjOKAueR.js";import{a as f,s as p,t as m,u as h}from"./src-CHNzQsqP.js";import{i as g,n as _,t as v}from"./src-D7HLogX5.js";import{n as y,t as b}from"./testIds-BxSFzDir.js";var x,S,C,w,T,E,D,O,k;t((()=>{m(),d(),v(),x=e(n(),1),c(),y(),S=r(),{expect:C,fn:w,userEvent:T,within:E}=__STORYBOOK_MODULE_TEST__,D={title:`Snack/Inputs & Forms/Search/Examples/WithAfterContent`,id:`components-search-examples-withaftercontent`,component:_,parameters:{layout:`fullscreen`},args:{size:g.M,placeholder:`Поиск`,outline:!0,onSubmit:w(),"data-test-id":b.root}},O={tags:[`dev`,`test`],render:function(e){let[t,n]=(0,x.useState)(``);return(0,S.jsx)(a,{children:(0,S.jsxs)(s,{children:[(0,S.jsx)(o,{children:`WithAfterContent`}),(0,S.jsx)(i,{children:`Кнопка «Найти» в слоте afterContent — внутри поля, справа от кнопки очистки.`}),(0,S.jsx)(l,{block:!0,children:(0,S.jsx)(_,{...e,value:t,onChange:n,afterContent:(0,S.jsx)(f,{"data-test-id":b.afterContentButton,size:e.size,view:h.Function,appearance:p.Neutral,icon:(0,S.jsx)(u,{}),minWidth:!1,onClick:()=>e.onSubmit?.(t)})})})]})})},play:async({args:e,canvasElement:t,step:n})=>{let r=E(t),i=r.getByTestId(b.input),a=r.getByTestId(b.afterContentButton);await n(`type into search input (setup for next step)`,async()=>{await T.click(i),await T.type(i,`query`)}),await n(`click afterContent button: onSubmit fired with current value`,async()=>{await T.click(a),C(e.onSubmit).toHaveBeenCalledTimes(1),C(e.onSubmit).toHaveBeenLastCalledWith(`query`)}),await n(`Enter in input: onSubmit fired again`,async()=>{await T.click(i),await T.keyboard(`{Enter}`),C(e.onSubmit).toHaveBeenCalledTimes(2)})}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Search.WithAfterContent.stories-BnuyJ72Y.js.map