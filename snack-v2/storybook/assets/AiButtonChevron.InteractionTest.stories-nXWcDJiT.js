import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{c as i,d as a,l as o,m as s,t as c,u as l}from"./iframe-CSZ3Qkp5.js";import{n as u,t as d}from"./src-B_UC9S1t2.js";import{n as f,t as p}from"./testIds-kVQxXJIp.js";var m,h,g,_,v,y,b,x,S,C;t((()=>{d(),m=e(n(),1),c(),f(),h=r(),{expect:g,fn:_,userEvent:v,within:y}=__STORYBOOK_MODULE_TEST__,b=_(),x={title:`AI/Primitives/ButtonChevron/Tests/Interaction`,id:`ai-buttonchevron-tests-interaction`,component:u,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{open:!1,onClick:_(),"data-test-id":p.root}},S={tags:[`test`,`dev`],render:function(e){let[t,n]=(0,m.useState)(e.open??!1);return(0,h.jsx)(l,{children:(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{children:`Interaction`}),(0,h.jsx)(o,{children:`Enabled-кнопка переключает шеврон кликом / Enter; disabled-кнопка не реагирует.`}),(0,h.jsxs)(i,{align:`center`,children:[(0,h.jsx)(u,{...e,open:t,onClick:t=>{n(e=>!e),e.onClick?.(t)},"data-test-id":p.root}),(0,h.jsx)(u,{...e,disabled:!0,onClick:b,"data-test-id":p.disabled})]})]})})},play:async({args:e,canvasElement:t,step:n})=>{b.mockClear();let r=y(t),i=r.getByTestId(p.root),a=r.getByTestId(p.disabled);await n(`click: toggles open → true`,async()=>{await v.click(i),g(e.onClick).toHaveBeenCalledTimes(1),await g(i).toHaveAttribute(`data-open`,`true`),await g(i).toHaveAttribute(`aria-expanded`,`true`)}),await n(`click: toggles open → false`,async()=>{await v.click(i),g(e.onClick).toHaveBeenCalledTimes(2),await g(i).toHaveAttribute(`aria-expanded`,`false`)}),await n(`keyboard: Tab focuses root`,async()=>{i.focus(),await g(i).toHaveFocus()}),await n(`keyboard: Enter triggers toggle`,async()=>{await v.keyboard(`{Enter}`),g(e.onClick).toHaveBeenCalledTimes(3),await g(i).toHaveAttribute(`data-open`,`true`)}),await n(`disabled: native disabled attribute is set`,async()=>{await g(a).toBeDisabled()}),await n(`disabled: click does not fire onClick`,async()=>{await v.click(a,{pointerEventsCheck:0}),g(b).not.toHaveBeenCalled()})}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
    ...
    return <DemoPage>
        <DemoPanel>
          ...
          <DemoActions align='center'>
            <AiButtonChevron {...args} open={open} onClick={event => {
            setOpen(prev => !prev);
            args.onClick?.(event);
...
//# sourceMappingURL=AiButtonChevron.InteractionTest.stories-nXWcDJiT.js.map