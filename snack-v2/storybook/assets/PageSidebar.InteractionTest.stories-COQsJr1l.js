import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{t as c,x as l}from"./src-Cl0HJWYS.js";import{n as u,r as d,t as f,u as p}from"./testIds-BYUpXbkv.js";import{n as m,t as h}from"./styles.module-BLI8_pKO.js";import{f as g,p as _,u as v,v as y}from"./demoData-CHiwTFmp.js";var b,x,S,C,w,T,E,D,O,k;e((()=>{c(),d(),o(),y(),h(),u(),b=t(),{expect:x,fn:S,userEvent:C,waitFor:w,within:T}=__STORYBOOK_MODULE_TEST__,E={title:`Uikit Product/Layout & containers/PageLayout/PageSidebar/Tests/Interaction`,id:`uikit-product-pagelayout-pagesidebar-tests-interaction`,component:p,parameters:{layout:`fullscreen`,controls:{disable:!0}}},D=S(),O={tags:[`test`,`dev`],render:()=>(0,b.jsx)(r,{children:(0,b.jsxs)(a,{children:[(0,b.jsx)(i,{children:`InteractionTest`}),(0,b.jsx)(n,{children:`Выбор пункта сайдбара вызывает onSelect с его id.`}),(0,b.jsx)(s,{align:`center`,children:(0,b.jsx)(`div`,{className:m.sidebarFrame,children:(0,b.jsx)(p,{items:_,footerItems:v,header:g,selected:`overview`,onSelect:D,defaultOpen:!0,"data-test-id":f.pageSidebar.root})})})]})}),play:async({canvasElement:e,step:t})=>{D.mockClear();let n=T(e),r=n.getByTestId(f.pageSidebar.root);await t(`select item triggers onSelect`,async()=>{let e=T(r).getByTestId(`${l.baseItem}_overview`);await C.click(e),await w(()=>x(D).toHaveBeenCalledWith(`overview`))}),await t(`root remains visible`,async()=>{await x(n.getByTestId(f.pageSidebar.root)).toBeVisible()})}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  render: () => <DemoPage>
      <DemoPanel>
...
//# sourceMappingURL=PageSidebar.InteractionTest.stories-COQsJr1l.js.map