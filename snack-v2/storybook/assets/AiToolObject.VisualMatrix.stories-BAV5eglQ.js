import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-Coxm4alt.js";import{c as i,k as a,o,t as s}from"./src-DLmIrK-q.js";import{n as c,t as l}from"./testIds-7t_1p-OA.js";var u,d,f,p=e((()=>{u=`_cell_fqkus_1`,d=`_grid_fqkus_5`,f={cell:u,grid:d}})),m,h,g,_,v,y,b;e((()=>{s(),r(),c(),p(),m=t(),h={title:`AI/Primitives/AiTool/Content/AiToolObject`,id:`ai-aitool-content-aitoolobject`,component:o,parameters:{layout:`padded`}},g=[{label:`complex-closed`,node:(0,m.jsx)(o,{name:`Key[ObjectName]`,variant:a.Complex,open:!1,"data-test-id":`${l.object}-complex-closed`})},{label:`complex-open`,node:(0,m.jsxs)(o,{name:`Key[ObjectName]`,variant:a.Complex,open:!0,"data-test-id":`${l.object}-complex-open`,children:[(0,m.jsx)(i,{label:`region`,value:`ru-central1`}),(0,m.jsx)(i,{label:`status`,value:`ok`})]})},{label:`string`,node:(0,m.jsx)(o,{name:`Key`,value:`Value`,variant:a.String,"data-test-id":`${l.object}-string`})}],_=[!1,!0],v=[!1,!0],y={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,m.jsxs)(`div`,{className:f.grid,children:[(0,m.jsx)(n,{sectionTitle:`Variant × Open`,firstColumnHeader:`—`,columnHeaders:g.map(e=>e.label.toUpperCase()),rows:[{variantLabel:`object`,cells:g.map(e=>(0,m.jsx)(`div`,{className:f.cell,children:e.node},e.label))}]}),(0,m.jsx)(n,{sectionTitle:`Error × Mono`,firstColumnHeader:`Error`,columnHeaders:_.map(e=>e?`MONO`:`LABEL`),rows:v.map(e=>({variantLabel:e?`error`:`default`,cells:_.map(t=>(0,m.jsx)(`div`,{className:f.cell,children:(0,m.jsx)(o,{name:`Key`,value:`Value`,variant:a.String,error:e,mono:t,"data-test-id":`${l.object}-${e?`error`:`default`}-${t?`mono`:`label`}`})},`${e}-${t}`))}))})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=AiToolObject.VisualMatrix.stories-BAV5eglQ.js.map