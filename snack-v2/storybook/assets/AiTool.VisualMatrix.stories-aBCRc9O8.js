import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-Bl-uTAel.js";import{A as i,D as a,m as o,t as s}from"./src-BIyn0abJ.js";import{n as c,t as l}from"./testIds-XU3ftBCu.js";import{a as u,i as d,n as f,r as p,t as m}from"./presets-DZQG3D9o.js";import{n as h,t as g}from"./styles.module-C7JKx5QE.js";var _,v,y,b,x,S;e((()=>{s(),r(),g(),c(),d(),_=t(),v={title:`AI/Primitives/AiTool/AiTool`,id:`ai-aitool-aitool`,component:o,parameters:{layout:`padded`}},y=[i.Pending,i.Loading,i.Success,i.Error],b=[{label:`call + result`,suffix:`both`,state:i.Success,call:p,result:u},{label:`только call`,suffix:`call`,state:i.Success,call:p},{label:`только result`,suffix:`result`,state:i.Success,result:u},{label:`без деталей`,suffix:`none`,state:i.Success},{label:`error: красный result`,suffix:`error`,state:i.Error,call:p,result:u}],x={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:h.grid,children:[(0,_.jsx)(n,{sectionTitle:`State (closed)`,firstColumnHeader:`State`,columnHeaders:[`—`],rows:y.map(e=>({variantLabel:e,cells:[(0,_.jsx)(`div`,{className:h.cell,children:(0,_.jsx)(o,{name:f,icon:a.Search,state:e,duration:m,call:p,result:u,"data-test-id":`${l.tool}-${e}-closed`})},e)]}))}),(0,_.jsx)(n,{sectionTitle:`Slots (open)`,firstColumnHeader:`Slots`,columnHeaders:[`—`],rows:b.map(({label:e,suffix:t,state:n,call:r,result:i})=>({variantLabel:e,cells:[(0,_.jsx)(`div`,{className:h.cell,children:(0,_.jsx)(o,{name:`create_instance`,icon:a.Act,state:n,open:!0,call:r,result:i,"data-test-id":`${l.tool}-slots-${t}`})},t)]}))}),(0,_.jsx)(n,{sectionTitle:`Timeline (connector)`,firstColumnHeader:`—`,columnHeaders:[`—`],rows:[{variantLabel:`timeline`,cells:[(0,_.jsxs)(`div`,{className:h.timeline,children:[(0,_.jsx)(o,{name:`search_documents`,icon:a.Search,state:i.Success,duration:3,connector:!0,"data-test-id":`${l.tool}-timeline-1`}),(0,_.jsx)(o,{name:`read_document`,icon:a.Read,state:i.Success,duration:12,connector:!0,"data-test-id":`${l.tool}-timeline-2`}),(0,_.jsx)(o,{name:f,icon:a.Act,state:i.Loading,duration:9,"data-test-id":`${l.tool}-timeline-3`})]},`timeline`)]}]})]})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=AiTool.VisualMatrix.stories-aBCRc9O8.js.map