import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{c as n,d as r,ot as i,t as a,wn as o}from"./iframe-qs8RgOhH.js";import{R as s,V as c,b as l,t as u}from"./src-CkdaAHPN.js";import{n as d,t as f}from"./TableStorySurfaceSync-rcSQdvyl.js";import{a as p,c as m,l as h}from"./fixtures-CohIGhuC.js";import{n as g,r as _}from"./testIds-Bvm4v2KG.js";import{n as v,t as y}from"./styles.module-nXmJ-1ev.js";import{n as b,t as x}from"./styles.module-s2CWiWjM.js";var S,C,w,T,E,D,O,k,A,j,M;e((()=>{i(),u(),a(),f(),m(),_(),y(),x(),S=t(),{expect:C,within:w}=__STORYBOOK_MODULE_TEST__,T={title:`Snack/Data display/Table/Table/Examples/StickyControlsOffset`,id:`components-table-table-examples-stickycontrolsoffset`,component:l,parameters:{layout:`fullscreen`}},E=p({withStatusColumn:!0}),D=h(40),O=20,k=56,A=48,j={tags:[`dev`,`test`],render:()=>(0,S.jsx)(n,{layoutType:o.Mobile,children:(0,S.jsx)(d,{children:(0,S.jsxs)(`div`,{className:b.pageScrollDemo,children:[(0,S.jsxs)(`div`,{className:b.mockAppHeader,style:{height:k},"data-test-id":`mock-app-header`,children:[`Mock app header (`,k,`px)`]}),(0,S.jsx)(r,{children:"`layoutPresets.mobile.stickyControls`: toolbar и pagination липнут ниже mock app header и выше mock tab bar. Прокрутите страницу — chrome таблицы не перекрывает внешний UI."}),(0,S.jsx)(`div`,{className:v.mobileCell,children:(0,S.jsx)(l,{"data-test-id":g.table.root,data:D,pageSize:O,columnDefinitions:E,layoutPresets:{mobile:{defaultView:c.Table,stickyControls:{enabled:!0,offsetTop:k,offsetBottom:A}}},sorting:{},outline:!0})}),(0,S.jsxs)(`div`,{className:b.mockTabBar,style:{height:A},"data-test-id":`mock-tab-bar`,children:[`Mock tab bar (`,A,`px)`]})]})})}),play:async({canvasElement:e})=>{let t=w(e).getByTestId(g.table.root);await C(t).toHaveAttribute(`data-sticky-controls`,`true`),await C(t).toHaveStyle({[s.stickyControlsOffsetTop]:`${k}px`,[s.stickyControlsOffsetBottom]:`${A}px`})}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Table.StickyControlsOffset.stories-KCNnNHMF.js.map