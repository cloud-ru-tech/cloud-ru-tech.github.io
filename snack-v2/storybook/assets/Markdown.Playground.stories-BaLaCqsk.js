import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{i as c,t as l}from"./src-BDbiIL0R.js";import{n as u,t as d}from"./testIds-sG43GgyN.js";var f,p,m,h,g,_,v;e((()=>{l(),o(),u(),f=t(),{expect:p,fn:m,within:h}=__STORYBOOK_MODULE_TEST__,g={title:`Snack/Inputs & Forms/Markdown/Markdown`,id:`components-markdown-markdown`,component:c,parameters:{layout:`fullscreen`},args:{value:`# Markdown viewer
...
`,skipHtml:!0,onCodeCopyClick:m(),"data-test-id":d.viewer},argTypes:{remarkPlugins:{table:{disable:!0}},rehypePlugins:{table:{disable:!0}},components:{table:{disable:!0}},className:{table:{disable:!0}},"data-test-id":{table:{disable:!0}}},render:e=>(0,f.jsx)(r,{children:(0,f.jsxs)(a,{width:`wide`,children:[(0,f.jsx)(i,{children:`Markdown`}),(0,f.jsx)(n,{children:`Рендер markdown-строки в безопасный HTML (GFM + подсветка кода).`}),(0,f.jsx)(s,{align:`start`,children:(0,f.jsx)(c,{...e})})]})})},_={tags:[`dev`,`test`],play:async({canvasElement:e,step:t})=>{let n=h(e).getByTestId(d.viewer);await p(n).toBeVisible(),await t(`renders headings, table, code block`,async()=>{await p(n.querySelector(`h1`)).toBeTruthy(),await p(n.querySelector(`table`)).toBeTruthy(),await p(n.querySelector(`pre code`)).toBeTruthy()})}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  play: async ({
    canvasElement,
    step
...
//# sourceMappingURL=Markdown.Playground.stories-BaLaCqsk.js.map