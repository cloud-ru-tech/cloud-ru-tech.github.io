import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{K as i,W as a,d as o,f as s,g as c,p as l,t as u,u as d}from"./iframe-qs8RgOhH.js";import{a as f,s as p,t as m,u as h}from"./src-CHNzQsqP.js";import{b as g}from"./src-DItGAddj.js";import{n as _,t as v}from"./src-uydiE72u.js";import{n as y,t as b}from"./testIds-Dt9cgXKV.js";function x(e){let[t,n]=(0,S.useState)(!1),r=i();return(0,C.jsxs)(s,{children:[(0,C.jsxs)(l,{children:[(0,C.jsx)(c,{children:`Controlled`}),(0,C.jsxs)(o,{children:[`Backdrop-click вызывает `,(0,C.jsx)(`code`,{children:`onClose`}),`, но parent не закрывает sheet — проверяем, что закрытие в controlled-режиме под полным контролем потребителя.`]}),(0,C.jsx)(d,{align:`center`,children:(0,C.jsx)(f,{"data-test-id":b.triggerOpen,label:`Open`,view:h.Outline,appearance:p.Neutral,onClick:()=>n(!0)})})]}),(0,C.jsx)(_,{open:t,onClose:()=>{e.onClose()},container:r.current||void 0,title:`Controlled mode`,content:(0,C.jsx)(`p`,{children:`Sheet остаётся открытым после backdrop-click.`})})]})}var S,C,w,T,E,D,O,k,A,j;t((()=>{v(),m(),a(),S=e(n(),1),u(),y(),C=r(),{expect:w,fn:T,userEvent:E,waitFor:D,within:O}=__STORYBOOK_MODULE_TEST__,k={title:`Snack/Overlays/BottomSheet/Tests/Controlled`,id:`components-bottomsheet-tests-controlled`,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{onClose:T()}},A={tags:[`test`,`dev`],render:e=>(0,C.jsx)(x,{...e}),play:async({args:e,canvasElement:t,step:n})=>{let r=O(t),i=O(document.body);await n(`opens via trigger`,async()=>{let e=r.getByTestId(b.triggerOpen);await E.click(e),await D(()=>w(i.getByTestId(g.title)).toBeVisible())}),await n(`backdrop click calls onClose but does not close the sheet (controlled)`,async()=>{let t=i.getByTestId(g.backdrop);await E.click(t),w(e.onClose).toHaveBeenCalledTimes(1),await D(()=>w(i.getByTestId(g.title)).toBeVisible())})}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
...
//# sourceMappingURL=BottomSheet.Controlled.stories-Ck9iU4R2.js.map