import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{c as n,i as r,ot as i,t as a,wn as o}from"./iframe-qs8RgOhH.js";import{A as s,E as c,M as l,O as u,V as d,b as f,t as p,z as m}from"./src-CkdaAHPN.js";import{a as h,c as g,t as _}from"./fixtures-CohIGhuC.js";import{n as v,r as y}from"./testIds-Bvm4v2KG.js";import{n as b,t as x}from"./styles.module-nXmJ-1ev.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{i(),p(),a(),g(),y(),x(),S=t(),C={title:`Snack/Data display/Table/Table`,id:`components-table-table`,component:f},w=_.slice(0,4),T=_.slice(2,6),E=h({withStatusColumn:!0}),D=h(),O=()=>{},k=e=>e.id,A={noData:{title:`Нет данных`,description:`Список пуст`},noResults:{title:`Ничего не найдено`,description:`Измените запрос или фильтры`},error:{title:`Ошибка загрузки`,description:`Не удалось получить данные`}},j=Object.values(u).map((e,t)=>({id:`status-${e}`,name:`Сервис ${t+1}`,status:e})),M=[c({accessorKey:`status`,mapStatusToAppearance:e=>e,renderDescription:e=>String(e),header:`Статус`,size:160}),{accessorKey:`name`,header:`Имя`,size:200}],N=Object.values(m),P=_.slice(0,N.length),F=new Map(P.map((e,t)=>[e.id,N[t]])),I=e=>F.get(e.id),L=[...h({withStatusColumn:!0}),s({pinned:!0,actionsGenerator:()=>[{content:{label:`Открыть`},onClick:O}]})],R={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,S.jsxs)(`div`,{className:b.grid,children:[(0,S.jsx)(r,{sectionTitle:`View`,firstColumnHeader:`View`,columnHeaders:[`Default`],rows:[{variantLabel:`table`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Table,suppressPagination:!0,outline:!0})},`view-table`)]},{variantLabel:`cards`,cells:[(0,S.jsx)(`div`,{className:b.cardCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Cards,headlineId:`name`,suppressPagination:!0,outline:!0})},`view-cards`)]},{variantLabel:`cards selected`,cells:[(0,S.jsx)(`div`,{className:b.cardCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Cards,headlineId:`name`,getRowId:k,rowSelection:{enable:!0,multiRow:!0,initialState:{"u-1":!0}},suppressPagination:!0,outline:!0})},`view-cards-selected`)]},{variantLabel:`cards single (radio)`,cells:[(0,S.jsx)(`div`,{className:b.cardCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Cards,headlineId:`name`,getRowId:k,rowSelection:{enable:!0,multiRow:!1,initialState:{"u-2":!0}},suppressPagination:!0,outline:!0})},`view-cards-single`)]}]}),(0,S.jsx)(r,{sectionTitle:`Status appearance`,firstColumnHeader:`Axis`,columnHeaders:[`Все значения STATUS_APPEARANCE`],rows:[{variantLabel:`status`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:j,columnDefinitions:M,getRowId:e=>e.id,suppressToolbar:!0,suppressPagination:!0,outline:!0})},`status-appearance`)]}]}),(0,S.jsx)(r,{sectionTitle:`Row color`,firstColumnHeader:`Axis`,columnHeaders:[`Все значения TABLE_ROW_COLOR`],rows:[{variantLabel:`row colors`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:P,columnDefinitions:D,getRowId:k,getRowBackgroundColor:I,suppressToolbar:!0,suppressPagination:!0,outline:!0})},`row-colors`)]}]}),(0,S.jsx)(r,{sectionTitle:`Selection & Sorting`,firstColumnHeader:`State`,columnHeaders:[`Table`],rows:[{variantLabel:`multi (checkbox)`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,getRowId:k,rowSelection:{enable:!0,multiRow:!0,initialState:{"u-1":!0}},suppressPagination:!0,outline:!0})},`selection-multi`)]},{variantLabel:`single (radio)`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,getRowId:k,rowSelection:{enable:!0,multiRow:!1,initialState:{"u-2":!0}},suppressPagination:!0,outline:!0})},`selection-single`)]},{variantLabel:`appearance: disabled`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:T,columnDefinitions:E,getRowId:k,rowSelection:{enable:e=>e.original.status!==`blocked`,multiRow:!0,appearance:l.Disabled},suppressPagination:!0,outline:!0})},`selection-disabled`)]},{variantLabel:`appearance: hide-toggler`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:T,columnDefinitions:E,getRowId:k,rowSelection:{enable:e=>e.original.status!==`blocked`,multiRow:!0,appearance:l.HideToggler},suppressPagination:!0,outline:!0})},`selection-hide-toggler`)]},{variantLabel:`sorted`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,sorting:{initialState:[{id:`name`,desc:!1}]},suppressPagination:!0,outline:!0})},`sorted`)]}]}),(0,S.jsx)(r,{sectionTitle:`Pinned columns`,firstColumnHeader:`State`,columnHeaders:[`Narrow container (overflow)`],rows:[{variantLabel:`left + right pinned`,cells:[(0,S.jsx)(`div`,{className:b.narrowCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:L,getRowId:k,suppressToolbar:!0,suppressPagination:!0,outline:!0})},`pinned-columns`)]}]}),(0,S.jsx)(r,{sectionTitle:`Pinned rows`,firstColumnHeader:`State`,columnHeaders:[`Table`],rows:[{variantLabel:`top pinned`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:_.slice(0,6),columnDefinitions:E,getRowId:k,rowPinning:{top:[`u-3`,`u-5`]},keepPinnedRows:!0,suppressToolbar:!0,suppressPagination:!0,outline:!0})},`pinned-rows`)]}]}),(0,S.jsx)(r,{sectionTitle:`Toolbar & chrome`,firstColumnHeader:`State`,columnHeaders:[`Table`],rows:[{variantLabel:`full toolbar (bulk bar)`,cells:[(0,S.jsx)(`div`,{className:b.wideCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,getRowId:k,rowSelection:{enable:!0,multiRow:!0,initialState:{"u-1":!0,"u-2":!0}},onRefresh:O,onExport:O,moreActions:[{content:{label:`Ещё`},onClick:O}],suppressPagination:!0,outline:!0})},`toolbar-full`)]},{variantLabel:`data view toggle`,cells:[(0,S.jsx)(`div`,{className:b.wideCell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,getRowId:k,showDataView:!0,suppressPagination:!0,outline:!0})},`toolbar-data-view`)]},{variantLabel:`suppress search`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,getRowId:k,rowSelection:{enable:!0,multiRow:!0},suppressSearch:!0,suppressPagination:!0,outline:!0})},`toolbar-no-search`)]},{variantLabel:`suppress toolbar`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,suppressToolbar:!0,suppressPagination:!0,outline:!0})},`toolbar-suppressed`)]},{variantLabel:`suppress header`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,suppressHeader:!0,suppressPagination:!0,outline:!0})},`header-suppressed`)]},{variantLabel:`no outline`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,suppressPagination:!0})},`no-outline`)]},{variantLabel:`rows-per-page options`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:_,columnDefinitions:E,pageSize:5,pagination:{options:[5,10]},outline:!0})},`pagination-options`)]}]}),(0,S.jsx)(r,{sectionTitle:`Layout type`,firstColumnHeader:`layoutType`,columnHeaders:[`table view`,`cards view`],rows:[{variantLabel:`mobile`,cells:[(0,S.jsx)(`div`,{className:b.mobileCell,children:(0,S.jsx)(n,{layoutType:o.Mobile,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Table,getRowId:k,rowSelection:{enable:!0,multiRow:!0},columnsSettings:{enableSettingsMenu:!0},sorting:{},suppressPagination:!0,outline:!0})})},`layout-mobile-table`),(0,S.jsx)(`div`,{className:b.mobileCell,children:(0,S.jsx)(n,{layoutType:o.Mobile,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,view:d.Cards,headlineId:`name`,getRowId:k,rowSelection:{enable:!0,multiRow:!0},columnsSettings:{enableSettingsMenu:!0},sorting:{},suppressPagination:!0,outline:!0})})},`layout-mobile-cards`)]}]}),(0,S.jsx)(r,{sectionTitle:`Loading & Empty states`,firstColumnHeader:`State`,columnHeaders:[`Table`],rows:[{variantLabel:`loading`,cells:[(0,S.jsx)(`div`,{className:b.cell,"data-test-id":v.visualMatrix.loadingSection,children:(0,S.jsx)(f,{data:[],columnDefinitions:E,loading:!0,suppressPagination:!0,outline:!0})},`loading`)]},{variantLabel:`infinite loading`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:w,columnDefinitions:E,infiniteLoading:!0,loading:!0,outline:!0})},`infinite-loading`)]},{variantLabel:`no data`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:[],columnDefinitions:E,noDataState:A.noData,suppressPagination:!0,outline:!0})},`no-data`)]},{variantLabel:`no results`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:[],columnDefinitions:E,dataFiltered:!0,noResultsState:A.noResults,suppressPagination:!0,outline:!0})},`no-results`)]},{variantLabel:`error`,cells:[(0,S.jsx)(`div`,{className:b.cell,children:(0,S.jsx)(f,{data:[],columnDefinitions:E,dataError:!0,errorDataState:A.error,suppressPagination:!0,outline:!0})},`error`)]}]})]})},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=Table.VisualMatrix.stories-BPd3731U.js.map