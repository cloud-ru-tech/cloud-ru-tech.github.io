import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{fn as n,gn as r,l as i,nt as a,t as o}from"./iframe-DMWsC78w.js";import{t as s,v as c}from"./src-DFSCavZ3.js";import{n as l,t as u}from"./TableStorySurfaceSync-UlIjcwsJ.js";import{a as d,c as f,t as p}from"./fixtures-Dvr84QN0.js";import{n as m,r as h}from"./testIds-CRkqsqn12.js";import{n as g,t as _}from"./styles.module-nXmJ-1ev.js";import{n as v,t as y}from"./styles.module-s2CWiWjM.js";var b,x,S,C,w,T,E;e((()=>{a(),s(),o(),u(),f(),h(),_(),y(),b=t(),{expect:x,within:S}=__STORYBOOK_MODULE_TEST__,C={title:`Snack/Data display/Table/Table/Examples/MobileLayout`,id:`components-table-table-examples-mobilelayout`,component:c,parameters:{layout:`fullscreen`}},w=d({withStatusColumn:!0}),T={tags:[`dev`,`test`],render:()=>(0,b.jsx)(n,{layoutType:r.Mobile,children:(0,b.jsxs)(l,{children:[(0,b.jsx)(i,{children:'`layoutType="mobile"` (из `AdaptiveProvider`) + `defaultView="cards"` — вертикальный список карточек; сортировка и настройки колонок — иконки в строке тулбара (BottomSheet). Переключите на table-вид сегментом в тулбаре — появится сетка со строками. По умолчанию `stickyControls=true`: тулбар, header (в table-view) и пагинация — sticky при скролле страницы; контент растёт по высоте. `stickyControls=false` — сплошной поток без sticky.'}),(0,b.jsx)(`div`,{className:v.pageScrollDemo,children:(0,b.jsx)(`div`,{className:g.mobileCell,children:(0,b.jsx)(c,{"data-test-id":m.table.root,data:p,columnDefinitions:w,showDataView:!0,headlineId:`name`,rowSelection:{enable:!0,multiRow:!0},columnsSettings:{enableSettingsMenu:!0},sorting:{},outline:!0})})})]})}),play:async({canvasElement:e})=>{let t=S(e).getByTestId(m.table.root);await x(t).toHaveAttribute(`data-layout-type`,`mobile`),await x(t).toHaveAttribute(`data-sticky-controls`,`true`),await x(t).toHaveAttribute(`data-view`,`cards`),await x(S(t).getAllByTestId(m.component.card)).toHaveLength(10),await x(S(t).queryByTestId(m.component.headerRow)).toBeNull()}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Table.MobileLayout.stories-lC3W8BHu.js.map