import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{On as n,d as r,f as i,g as a,kn as o,p as s,t as c,u as l}from"./iframe-qs8RgOhH.js";import{a as u,t as d}from"./src-CHNzQsqP.js";import{ct as f,lt as p}from"./helperComponents-DlhcWLAW.js";import{n as m,t as h}from"./src-Cw_GfiZY.js";import{o as g}from"./testIds-DQO6y4hn.js";var _,v,y,b,x,S,C;e((()=>{d(),c(),o(),h(),g(),_=t(),{expect:v,within:y}=__STORYBOOK_MODULE_TEST__,b={title:`Snack/Inputs & Forms/Calendar/Time Picker Dropdown`,id:`components-calendar-time-picker-dropdown`,component:m,parameters:{readme:{content:n},layout:`fullscreen`,design:{type:`figma`,url:`https://www.figma.com/design/aNPU3MHwRJiEwbk5F82zux/Snack-Ui-Kit-variables?node-id=23720-29347&m=dev`}}},x=e=>(0,_.jsx)(i,{children:(0,_.jsxs)(s,{children:[(0,_.jsx)(a,{children:`Playground`}),(0,_.jsx)(r,{children:`Кнопка-триггер с выпадающим выбором времени.`}),(0,_.jsx)(l,{align:`center`,children:(0,_.jsx)(m,{...e,children:(0,_.jsx)(u,{"data-test-id":p.timePickerDropdownTrigger,label:`Открыть TimePickerDropdown`})})})]})}),S={tags:[`dev`,`test`],args:{size:f.S,showSeconds:!0,trigger:`click`,closeOnApply:!0,placement:`bottom-start`,"data-test-id":p.timePickerDropdown},argTypes:{onChangeValue:{table:{disable:!0}},onFocusLeave:{table:{disable:!0}},navigationStartRef:{table:{disable:!0}},className:{table:{disable:!0}},children:{table:{disable:!0}},today:{table:{disable:!0}},fitToContainer:{table:{disable:!0}},size:{control:`radio`,options:Object.values(f)},trigger:{control:`radio`,options:[`click`,`hover`,`focus`]},placement:{control:`select`,options:[`top-start`,`top`,`top-end`,`bottom-start`,`bottom`,`bottom-end`,`left`,`right`]},closeOnApply:{control:`boolean`}},render:x,play:async({canvasElement:e})=>{await v(y(e).getByTestId(`time-picker-dropdown-trigger`)).toBeVisible()}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  args: {
    size: SIZE.S,
    showSeconds: true,
...
//# sourceMappingURL=TimePickerDropdown.Playground.stories-WOfZa9Rl.js.map