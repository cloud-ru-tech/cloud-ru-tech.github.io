import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{f as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{a as c,c as l,i as u,n as d,o as f,r as p,t as m}from"./testIds-yL7r_Fy9.js";function h(){let[e,t]=(0,_.useState)(!1);return(0,v.jsx)(f,{className:u.root,title:`Удалить виртуальную машину?`,content:C,open:e,onOpenChange:t,primaryAction:{label:`Подтвердить`},secondaryAction:{label:`Отмена`},"data-test-id":m.root})}function g(){let[e,t]=(0,_.useState)(!0);return(0,v.jsx)(`div`,{className:u.constrainedParent,"data-test-id":m.constrainedParent,children:(0,v.jsx)(f,{className:u.constrainedRoot,title:`Удалить виртуальную машину?`,content:C,hint:`Подсказка под панелью`,appearance:l.Primary,primaryAction:{label:`Подтвердить`},secondaryAction:{label:`Отмена`},open:e,onOpenChange:t,"data-test-id":m.root})})}var _,v,y,b,x,S,C,w,T,E,D,O,k,A;t((()=>{c(),_=e(n(),1),o(),p(),d(),v=r(),{expect:y,fn:b,userEvent:x,within:S}=__STORYBOOK_MODULE_TEST__,C=`Виртуальная машина будет остановлена и удалена вместе с дисками. Дополнительное описание действия занимает несколько строк и используется для проверки раскрытия длинного текста в свёрнутом и развёрнутом состояниях. Ещё один абзац с нейтральным содержимым без привязки к предметной области. Третий абзац нужен, чтобы содержимое переполняло предел по высоте и на широком экране: тогда кнопка «Показать» появляется в любой ширине карточки, а не только в узкой.`,w={title:`AI/Surfaces/AiFieldRequest/Tests/Interaction`,id:`ai-aifieldrequest-tests-interaction`,component:f,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{primaryAction:{label:`Подтвердить`,onClick:b()},secondaryAction:{label:`Отмена`,onClick:b()}}},T={tags:[`test`,`dev`],render:e=>(0,v.jsx)(i,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{align:`start`,children:(0,v.jsx)(f,{...e,className:u.root,title:`Удалить виртуальную машину?`,content:C,hint:`Подсказка под панелью`,appearance:l.Primary,"data-test-id":m.root})})})}),play:async({args:e,canvasElement:t})=>{let n=S(t),r=n.getByTestId(m.root);await y(r).toBeVisible();let i=await n.findByTestId(m.expand);await x.click(i),await y(r).toHaveAttribute(`data-open`,`true`),await x.click(i),await y(r).not.toHaveAttribute(`data-open`),await y(i).toHaveFocus(),await x.click(n.getByTestId(m.primaryAction)),y(e.primaryAction.onClick).toHaveBeenCalledTimes(1),await x.click(n.getByTestId(m.secondaryAction)),y(e.secondaryAction.onClick).toHaveBeenCalledTimes(1)}},E={tags:[`test`,`dev`],render:()=>(0,v.jsx)(i,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{align:`start`,children:(0,v.jsx)(h,{})})})}),play:async({canvasElement:e})=>{let t=S(e),n=t.getByTestId(m.root);await x.click(await t.findByTestId(m.expand)),await y(n).toHaveAttribute(`data-open`,`true`)}},D={tags:[`test`,`dev`],render:()=>(0,v.jsx)(i,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{align:`start`,children:(0,v.jsx)(f,{className:u.root,title:`Удалить виртуальную машину?`,content:`Диски будут удалены вместе с машиной.`,primaryAction:{label:`Подтвердить`},secondaryAction:{label:`Отмена`},"data-test-id":m.root})})})}),play:async({canvasElement:e})=>{let t=S(e);await y(t.getByTestId(m.root)).toBeVisible(),await y(t.getByTestId(m.expand)).toHaveAttribute(`aria-hidden`,`true`)}},O={tags:[`test`,`dev`],args:{title:`Удалить виртуальную машину?`,content:C,hint:`Подсказка под панелью`,primaryAction:{label:`Подтвердить`,loading:!0},secondaryAction:{label:`Отмена`}},render:e=>(0,v.jsx)(i,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{align:`start`,children:(0,v.jsx)(f,{...e,className:u.root,"data-test-id":m.root})})})})},k={tags:[`test`,`dev`],render:()=>(0,v.jsx)(i,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{align:`start`,children:(0,v.jsx)(g,{})})})})},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
...
//# sourceMappingURL=AiFieldRequest.InteractionTest.stories-D_LvTcep.js.map