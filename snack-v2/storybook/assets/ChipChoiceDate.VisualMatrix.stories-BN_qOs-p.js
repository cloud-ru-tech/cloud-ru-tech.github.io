import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-BA2s2ydY.js";import{o as i,t as a}from"./src-BK0M3zjM.js";import{d as o,i as s,l as c,n as l,r as u,s as d,t as f}from"./visualMatrix.helpers-7FRoVpvQ.js";import{n as p,t as m}from"./styles.module-B5TQqo6I.js";var h,g,_,v;e((()=>{a(),r(),o(),m(),h=t(),g={title:`Snack/Inputs & Forms/Chips/ChipChoice/Date`,id:`components-chips-chipchoice-date`,component:i.Date,parameters:{layout:`padded`}},_={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:p.matrix,children:[(0,h.jsx)(n,{sectionTitle:`Value × Size`,firstColumnHeader:`Value`,columnHeaders:s,rows:[{variantLabel:`no value`,cells:c.map(e=>(0,h.jsx)(i.Date,{label:`Date`,size:e},e))},{variantLabel:`no value + icon`,cells:c.map(e=>(0,h.jsx)(i.Date,{label:`Date`,size:e,icon:f},e))},{variantLabel:`value set + icon + clear`,cells:c.map(e=>(0,h.jsx)(i.Date,{label:`Date`,size:e,defaultValue:d,icon:f,...u},e))}]}),(0,h.jsx)(n,{sectionTitle:`State × Size`,firstColumnHeader:`State`,columnHeaders:s,rows:l.map(({key:e,extra:t})=>({variantLabel:e,cells:c.map(e=>(0,h.jsx)(i.Date,{label:`Date`,size:e,...t},e))}))})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=ChipChoiceDate.VisualMatrix.stories-BN_qOs-p.js.map