import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{f as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{O as c,i as l,t as u}from"./src-Wlx-Lh91.js";function d(){let[e,t]=(0,f.useState)(``);return(0,p.jsx)(i,{children:(0,p.jsx)(a,{width:`narrow`,children:(0,p.jsxs)(s,{align:`center`,children:[(0,p.jsx)(l,{"data-test-id":c.fieldTextArea,label:`Comment`,value:e,onChange:e=>{w(e),t(e??``)},maxLength:80,showClearButton:!0}),(0,p.jsx)(l,{"data-test-id":b,label:`Uncontrolled`,defaultValue:`preset value`}),(0,p.jsx)(l,{"data-test-id":y,label:`Readonly`,readonly:!0,value:`copy me
second line`,showCopyButton:!0,onCopyButtonClick:T}),(0,p.jsx)(l,{"data-test-id":S,label:`Copy in edit mode`,defaultValue:`copy me while typing`,showCopyButtonInEditMode:!0}),(0,p.jsx)(l,{"data-test-id":x,label:`Hard cap`,defaultValue:``,maxLength:C,allowMoreThanMaxLength:!1})]})})})}var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;t((()=>{u(),f=e(n(),1),o(),p=r(),{expect:m,fn:h,userEvent:g,within:_}=__STORYBOOK_MODULE_TEST__,v=`button-clear-value`,y=`field-textarea-readonly`,b=`field-textarea-uncontrolled`,x=`field-textarea-hard-cap`,S=`field-textarea-edit-copy`,C=8,w=h(),T=h(),E={title:`Snack/Inputs & Forms/Fields/FieldTextArea/Tests/Interaction`,id:`components-fields-fieldtextarea-tests-interaction`,component:l,parameters:{layout:`fullscreen`,controls:{disable:!0}},render:()=>(0,p.jsx)(d,{})},D={tags:[`test`,`dev`],play:async({canvasElement:e,step:t})=>{w.mockClear(),T.mockClear();let n=_(e),r=n.getByTestId(c.fieldTextArea),i=n.getByTestId(b),a=n.getByTestId(y),o=n.getByTestId(x),s=n.getByTestId(S),l=_(r).getByTestId(c.fieldTextAreaInput);await t(`renders root, textarea and counter (maxLength → fieldDecoratorCounter)`,async()=>{await m(r).toBeVisible(),await m(l).toBeVisible(),await m(a).toBeVisible();let e=_(r).getByTestId(c.fieldDecoratorCounter);await m(e).toBeVisible(),await m(e).toHaveTextContent(`0/80`)}),await t(`uncontrolled field keeps and edits its own defaultValue without value/onChange`,async()=>{let e=_(i).getByTestId(c.fieldTextAreaInput);await m(e).toHaveValue(`preset value`),await g.click(e),await g.type(e,`!`),await m(e).toHaveValue(`preset value!`)}),await t(`typing into the controlled textarea fires onChange, updates value and counter`,async()=>{await g.click(l),await g.type(l,`comment text`),m(w).toHaveBeenCalled(),await m(l).toHaveValue(`comment text`),await m(_(r).getByTestId(c.fieldDecoratorCounter)).toHaveTextContent(`12/80`)}),await t(`keyboard: ArrowRight at end of editable textarea roves focus to the clear button`,async()=>{l.focus(),l.setSelectionRange(l.value.length,l.value.length),await g.keyboard(`{ArrowRight}`);let e=_(r).getByTestId(v);await m(e).toHaveFocus()}),await t(`editable field with value shows clear, but no copy by default`,async()=>{let e=_(r).getByTestId(v);await m(e).toBeVisible(),await m(_(r).queryByTestId(c.fieldTextCopyButton)).not.toBeInTheDocument(),await m(e).toHaveFocus()}),await t(`showCopyButtonInEditMode shows both clear and copy in the editable field`,async()=>{await m(_(s).getByTestId(v)).toBeVisible(),await m(_(s).getByTestId(c.fieldTextCopyButton)).toBeVisible()}),await t(`clear button empties the value, fires onChange("") and refocuses the textarea`,async()=>{let e=_(r).getByTestId(v);await g.click(e),m(w).toHaveBeenLastCalledWith(``),await m(l).toHaveValue(``),await m(l).toHaveFocus()}),await t(`readonly field: ArrowRight roves focus from textarea to the copy button`,async()=>{let e=_(a).getByTestId(c.fieldTextAreaInput);e.focus(),e.setSelectionRange(e.value.length,e.value.length),await g.keyboard(`{ArrowRight}`);let t=_(a).getByTestId(c.fieldTextCopyButton);await m(t).toHaveFocus()}),await t(`readonly field exposes a clickable copy button firing onCopyButtonClick`,async()=>{let e=_(a).getByTestId(c.fieldTextCopyButton);await m(e).toBeVisible(),await g.click(e),await m(e).toBeVisible()}),await t(`hard cap: allowMoreThanMaxLength=false caps the native textarea at maxLength`,async()=>{let e=_(o).getByTestId(c.fieldTextAreaInput);await m(e).toHaveAttribute(`maxlength`,String(C)),await g.click(e),await g.type(e,`0123456789ABCDEF`),await m(e).toHaveValue(`01234567`)})}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  play: async ({
    canvasElement,
    step
...
//# sourceMappingURL=FieldTextArea.InteractionTest.stories-fKa3stu0.js.map