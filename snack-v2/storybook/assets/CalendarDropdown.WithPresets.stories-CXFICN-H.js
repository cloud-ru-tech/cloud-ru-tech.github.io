import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{a as c,t as l}from"./src-CHNzQsqP.js";import{ct as u,lt as d,ot as f}from"./helperComponents-DlhcWLAW.js";import{o as p,t as m}from"./src-Cw_GfiZY.js";import{o as h}from"./testIds-DQO6y4hn.js";var g,_,v,y,b,x;e((()=>{l(),o(),m(),h(),g=t(),{expect:_,within:v}=__STORYBOOK_MODULE_TEST__,y={title:`Snack/Inputs & Forms/Calendar/Calendar Dropdown/Examples/WithPresets`,id:`components-calendar-calendar-dropdown-examples-withpresets`,component:p,parameters:{layout:`fullscreen`}},b={tags:[`dev`,`test`],args:{mode:f.DateRange,size:u.S,presets:{enabled:!0},"data-test-id":d.calendarDropdown},render:e=>(0,g.jsx)(r,{children:(0,g.jsxs)(a,{width:`wide`,children:[(0,g.jsx)(i,{children:`WithPresets`}),(0,g.jsx)(n,{children:`Режим date-range с пресетами периода (последняя неделя / месяц / квартал / …).`}),(0,g.jsx)(s,{align:`center`,children:(0,g.jsx)(p,{...e,children:(0,g.jsx)(c,{"data-test-id":d.calendarDropdownTrigger,label:`Выбрать период`})})})]})}),play:async({canvasElement:e})=>{await _(v(e).getByTestId(d.calendarDropdownTrigger)).toBeVisible()}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  args: {
...
//# sourceMappingURL=CalendarDropdown.WithPresets.stories-CXFICN-H.js.map