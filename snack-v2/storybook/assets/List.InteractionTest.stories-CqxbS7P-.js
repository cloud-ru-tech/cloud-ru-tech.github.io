import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{c as i,d as a,t as o,u as s}from"./iframe-Du0zU9lI.js";import{D as c,kt as l,st as u,t as d}from"./system-B3b9qWhT.js";import{I as f,a as p,t as m}from"./src-BB54vc1d.js";import{n as h,t as g}from"./testIds-zOjMf_tk.js";import{n as _,t as v}from"./stories.module-Cv0zmHWk.js";function y({content:e}){let t=e&&typeof e==`object`&&`label`in e?e.label:``;return(0,C.jsxs)(`span`,{"data-test-id":P,children:[`Custom · `,t]})}function b(e,t){let n=`content`in e?e.content:void 0;return typeof n==`object`&&n&&`label`in n?String(n.label).toLowerCase().includes(t.toLowerCase()):!0}function x(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)([]),o=j.filter(t=>b(t,e));return(0,C.jsx)(s,{children:(0,C.jsx)(a,{width:`narrow`,children:(0,C.jsxs)(i,{align:`center`,children:[(0,C.jsx)(`div`,{className:_.listFrame,children:(0,C.jsx)(p,{"data-test-id":g.list.root,items:o,pinTop:M,size:`m`,marker:!0,selection:{mode:`multiple`,value:n,onChange:r},search:{placeholder:`Search`,value:e,onChange:t}})}),(0,C.jsx)(`div`,{className:_.listFrame,children:(0,C.jsx)(p,{"data-test-id":N,items:F,size:`m`,contentRender:y})})]})})})}var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;t((()=>{d(),m(),S=e(n(),1),o(),h(),v(),C=r(),{expect:w,fn:T,userEvent:E,within:D}=__STORYBOOK_MODULE_TEST__,O={title:`Snack/Data display/List/List/Tests/Interaction`,id:`components-list-list-tests-interaction`,component:p,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{"data-test-id":g.list.root}},k=T(),A=T(),j=[{id:`a`,beforeContent:(0,C.jsx)(u,{}),content:{label:`Overview`},onClick:k},{id:`b`,beforeContent:(0,C.jsx)(c,{}),content:{label:`Analytics`},onClick:A},{id:`c`,content:{label:`Billing`}},{id:`notify`,switch:!0,content:{label:`Notifications`}},{id:`dim`,inactive:!0,content:{label:`Inactive row`}},{id:`ghost`,hidden:!0,content:{label:`Hidden row`}}],M=[{id:`pinned`,beforeContent:(0,C.jsx)(l,{}),content:{label:`Pinned`}}],N=`list-content-render`,P=`list-content-render__custom`,F=[{id:`cr`,content:{label:`Original option`}}],I=e=>`${f.baseItem}_${e}`,L=`search__field-input`,R={tags:[`test`,`dev`],render:()=>(0,C.jsx)(x,{}),play:async({canvasElement:e,step:t})=>{k.mockClear(),A.mockClear();let n=D(e),r=n.getByTestId(g.list.root);await t(`renders root`,async()=>{await w(r).toBeVisible()}),await t(`click: item with onClick fires its callback and selects it (multiple mode)`,async()=>{let e=n.getByTestId(I(`a`));await E.click(e),w(k).toHaveBeenCalledTimes(1),await w(e).toHaveAttribute(`data-checked`,`true`)}),await t(`click: second item toggles independently and keeps the first checked`,async()=>{let e=n.getByTestId(I(`b`));await E.click(e),w(A).toHaveBeenCalledTimes(1),await w(e).toHaveAttribute(`data-checked`,`true`),await w(n.getByTestId(I(`a`))).toHaveAttribute(`data-checked`,`true`)}),await t(`click: clicking a selected item deselects it`,async()=>{let e=n.getByTestId(I(`a`));await E.click(e),await w(e).not.toHaveAttribute(`data-checked`,`true`)}),await t(`inactive item is non-interactive (data-non-pointer on the row, never checked)`,async()=>{let e=n.getByTestId(I(`dim`));await w(e).toHaveAttribute(`data-non-pointer`,`true`),await w(e).not.toHaveAttribute(`data-checked`,`true`)}),await t(`hidden item is absent from the DOM`,async()=>{await w(n.queryByTestId(I(`ghost`))).toBeNull()}),await t(`switch item toggles selection via its Switch input`,async()=>{let e=n.getByTestId(I(`notify`)),t=n.getByTestId(`${f.baseItemSwitch}-native-input`);await w(t).not.toBeChecked(),await E.click(e),await w(t).toBeChecked()}),await t(`contentRender replaces the default ItemContent`,async()=>{let e=n.getByTestId(N);await w(D(e).getByTestId(P)).toBeVisible(),await w(D(e).queryByTestId(f.baseItemLabel)).toBeNull()}),await t(`search: typing filters items by content option`,async()=>{let e=n.getByTestId(L);await E.click(e),await E.type(e,`Analyt`),await w(n.getByTestId(I(`b`))).toBeVisible(),await w(n.queryByTestId(I(`a`))).toBeNull(),await E.clear(e),await w(n.getByTestId(I(`a`))).toBeVisible()}),await t(`keyboard: root is focusable, ArrowDown moves focus off the root into the list`,async()=>{r.focus(),await w(r).toHaveFocus(),await E.keyboard(`{ArrowDown}`),await w(r).not.toHaveFocus()})}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
...
//# sourceMappingURL=List.InteractionTest.stories-CqxbS7P-.js.map