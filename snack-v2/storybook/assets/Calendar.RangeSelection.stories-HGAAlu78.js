import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{d as i,f as a,g as o,p as s,t as c,u as l}from"./iframe-qs8RgOhH.js";import{ct as u,ot as d}from"./helperComponents-DlhcWLAW.js";import{d as f,t as p}from"./src-Cw_GfiZY.js";import{o as m,t as h}from"./testIds-DQO6y4hn.js";var g,_,v,y,b,x,S,C,w;t((()=>{g=e(n(),1),c(),p(),m(),_=r(),{expect:v,fn:y,within:b}=__STORYBOOK_MODULE_TEST__,x=new Date(2026,3,15),S={title:`Snack/Inputs & Forms/Calendar/Calendar/Examples/RangeSelection`,id:`components-calendar-calendar-examples-rangeselection`,component:f,parameters:{layout:`fullscreen`,controls:{disable:!0}}},C={tags:[`dev`],render:function(){let[e,t]=(0,g.useState)(void 0),n=y(e=>t(e));return(0,_.jsx)(a,{children:(0,_.jsxs)(s,{width:`wide`,children:[(0,_.jsx)(o,{children:`RangeSelection`}),(0,_.jsx)(i,{children:`Выбор диапазона дат двумя кликами по календарю.`}),(0,_.jsx)(l,{align:`center`,children:(0,_.jsxs)(`div`,{"data-test-id":h.rangeRoot,children:[(0,_.jsx)(f,{"data-test-id":h.range,mode:d.DateRange,size:u.M,today:x,value:e,onChangeValue:n}),(0,_.jsx)(`div`,{"data-test-id":h.rangeValue,children:e?`${e[0].toISOString()}|${e[1].toISOString()}`:`empty`})]})})]})})},play:async({canvasElement:e,step:t})=>{let n=b(e);await t(`selecting range start (day 10)`,async()=>{let e=n.getByTestId(`calendar-range`);b(e).getAllByText(`10`)[0].click()}),await t(`range start applies data-range-position`,async()=>{let t=e.querySelectorAll(`[data-range-position="start"], [data-range-position="start-end"]`);await v(t.length).toBeGreaterThan(0)})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  tags: ['dev'],
...
//# sourceMappingURL=Calendar.RangeSelection.stories-HGAAlu78.js.map