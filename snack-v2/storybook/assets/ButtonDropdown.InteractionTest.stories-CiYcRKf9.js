import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{c as n,f as r,ot as i,p as a,t as o,u as s,wn as c}from"./iframe-qs8RgOhH.js";import{a as l,i as u,n as d,t as f}from"./src-CP5bD3pi.js";import{n as p,t as m}from"./styles.module-DFYLdCyG.js";var h,g,_,v,y,b,x,S,C,w;e((()=>{i(),f(),o(),l(),m(),h=t(),{expect:g,fn:_,userEvent:v,waitFor:y,within:b}=__STORYBOOK_MODULE_TEST__,x={title:`Uikit Product/Actions/ButtonPredefined/ButtonDropdown/Tests/Interaction`,id:`uikit-product-buttonpredefined-buttondropdown-tests-interaction`,component:d,parameters:{layout:`fullscreen`,controls:{disable:!0}}},S={tags:[`test`,`dev`],render:()=>(0,h.jsx)(n,{layoutType:c.Desktop,children:(0,h.jsx)(r,{children:(0,h.jsx)(a,{children:(0,h.jsx)(s,{align:`center`,children:(0,h.jsx)(`div`,{className:p.panel,children:(0,h.jsx)(d,{label:`Period`,size:`s`,closeDroplistOnItemClick:!0,"data-test-id":u.buttonDropdown,items:[{id:`y`,content:{label:`Year`},onClick:_(),"data-test-id":u.itemYear},{id:`m`,content:{label:`Month`},onClick:_(),"data-test-id":u.itemMonth}]})})})})})}),play:async({canvasElement:e,step:t})=>{let n=b(e),r=b(document.body);await t(`opens droplist on click`,async()=>{await v.click(n.getByTestId(u.buttonDropdown)),await y(()=>g(r.getByTestId(u.droplist)).toBeVisible())}),await t(`selects item`,async()=>{await v.click(r.getByTestId(u.itemYear)),await y(()=>g(r.queryByTestId(u.itemYear)).toBeNull())})}},C={tags:[`test`,`dev`],render:()=>(0,h.jsx)(n,{layoutType:c.Mobile,children:(0,h.jsx)(r,{children:(0,h.jsx)(a,{children:(0,h.jsx)(s,{align:`center`,children:(0,h.jsx)(`div`,{className:p.panel,children:(0,h.jsx)(d,{label:`Period`,size:`s`,closeDroplistOnItemClick:!0,"data-test-id":u.buttonDropdown,items:[{id:`y`,content:{label:`Year`},onClick:_(),"data-test-id":u.itemYear},{id:`m`,content:{label:`Month`},onClick:_(),"data-test-id":u.itemMonth}]})})})})})}),play:async({canvasElement:e,step:t})=>{let n=b(e),r=b(document.body);await t(`mobile: opens bottom sheet on trigger click`,async()=>{await v.click(n.getByTestId(u.buttonDropdown)),await y(()=>g(r.getByTestId(u.itemMonth)).toBeVisible())}),await t(`mobile: selects item and closes bottom sheet`,async()=>{await v.click(r.getByTestId(u.itemMonth)),await y(()=>g(r.queryByTestId(u.itemMonth)).toBeNull())})}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  render: () => <LayoutScope layoutType={LAYOUT_TYPE.Desktop}>
      <DemoPage>
        <DemoPanel>
  ...
  tags: ['test', 'dev'],
  render: () => <LayoutScope layoutType={LAYOUT_TYPE.Mobile}>
      <DemoPage>
        <DemoPanel>
          <DemoActions align='center'>
            <div className={styles.panel}>
...
//# sourceMappingURL=ButtonDropdown.InteractionTest.stories-CiYcRKf9.js.map