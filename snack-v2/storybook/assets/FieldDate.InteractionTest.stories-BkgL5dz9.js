import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-Bg-8jzDh.js";import{n as r}from"./classnames-iuquYaxc.js";import{d as i,f as a,g as o,p as s,t as c,u as l}from"./iframe-qs8RgOhH.js";import{O as u,b as d,t as f,v as p}from"./src-Wlx-Lh91.js";var m,h=t((()=>{m={fieldDate:{singleRoot:`field-date-single`,rangeRoot:`field-date-range`,readonlyRoot:`field-date-readonly`}}}));function g(){let[e,t]=(0,_.useState)(void 0),[n,r]=(0,_.useState)([void 0,void 0]);return(0,v.jsx)(a,{children:(0,v.jsxs)(s,{width:`narrow`,children:[(0,v.jsx)(o,{children:`Single (date)`}),(0,v.jsx)(i,{children:`Сегментный движок: авто-переход, откат невалидного дня, маска при фокусе.`}),(0,v.jsx)(l,{align:`center`,children:(0,v.jsx)(p,{"data-test-id":m.fieldDate.singleRoot,label:`Дата`,value:e,onChange:t})}),(0,v.jsx)(o,{children:`Range (date-range)`}),(0,v.jsx)(i,{children:`Движок formatMask: авто-ноль и clamp; onChange только когда обе даты валидны.`}),(0,v.jsx)(l,{align:`center`,children:(0,v.jsx)(p,{"data-test-id":m.fieldDate.rangeRoot,label:`Период`,mode:d.DateRange,value:n,onChange:e=>{w(e),r(e)}})}),(0,v.jsx)(o,{children:`Readonly + copy`}),(0,v.jsx)(i,{children:`readonly показывает кнопку копирования и скрывает очистку.`}),(0,v.jsx)(l,{align:`center`,children:(0,v.jsx)(p,{"data-test-id":m.fieldDate.readonlyRoot,label:`Только чтение`,readonly:!0,defaultValue:new Date(2026,4,17)})})]})})}var _,v,y,b,x,S,C,w,T,E,D,O;t((()=>{f(),_=e(n(),1),c(),h(),v=r(),{expect:y,fn:b,userEvent:x,waitFor:S,within:C}=__STORYBOOK_MODULE_TEST__,w=b(),T={title:`Snack/Inputs & Forms/Fields/FieldDate/Tests/Interaction`,id:`components-fields-fielddate-tests-interaction`,component:p,parameters:{layout:`fullscreen`,controls:{disable:!0}},render:()=>(0,v.jsx)(g,{})},E={tags:[`test`,`dev`],play:async({canvasElement:e,step:t})=>{w.mockClear();let n=C(e),r=n.getByTestId(m.fieldDate.singleRoot),i=C(r).getByTestId(u.fieldDateInput);await t(`renders root and masked input`,async()=>{await y(r).toBeVisible(),await y(i).toBeVisible()}),await t(`input advertises the RU segment mask as its placeholder`,async()=>{await y(i).toHaveAttribute(`placeholder`,`ДД.ММ.ГГГГ`)}),await t(`range renders two masked inputs (from / to) with RU placeholders`,async()=>{let e=n.getByTestId(m.fieldDate.rangeRoot),t=C(e).getByTestId(u.fieldDateInputFrom),r=C(e).getByTestId(u.fieldDateInputTo);await y(t).toBeVisible(),await y(r).toBeVisible(),await y(t).toHaveAttribute(`placeholder`,`ДД.ММ.ГГГГ`),await y(r).toHaveAttribute(`placeholder`,`ДД.ММ.ГГГГ`)}),await t(`range formatMask auto-prefixes a single high digit (5 → 05) on the from-input`,async()=>{let e=n.getByTestId(m.fieldDate.rangeRoot),t=C(e).getByTestId(u.fieldDateInputFrom);w.mockClear(),await x.click(t),await x.type(t,`5`),await S(()=>y(t.value).toBe(`05`)),y(w).not.toHaveBeenCalled()}),await t(`range formatMask restarts a full segment over its max from the last digit (day 35 → 05)`,async()=>{let e=n.getByTestId(m.fieldDate.rangeRoot),t=C(e).getByTestId(u.fieldDateInputFrom);await x.clear(t),await x.click(t),await x.type(t,`35`),await S(()=>y(t.value).toBe(`05`))}),await t(`readonly shows the copy button and hides clear`,async()=>{let e=n.getByTestId(m.fieldDate.readonlyRoot),t=C(e).getByTestId(u.fieldDateCopy);await y(t).toBeVisible(),await y(C(e).queryByTestId(u.fieldDateClear)).toBeNull()}),await t(`cleanup: close calendar portal and blur`,async()=>{await x.keyboard(`{Escape}`),document.activeElement?.blur?.()})}},D={tags:[`test`,`dev`],render:()=>(0,v.jsx)(a,{style:{placeItems:`end center`},children:(0,v.jsxs)(s,{width:`wide`,children:[(0,v.jsx)(o,{children:`Outside click (wide field)`}),(0,v.jsx)(i,{children:`Широкое поле воспроизводит свободную область справа от календаря.`}),(0,v.jsx)(l,{block:!0,children:(0,v.jsx)(p,{"data-test-id":u.fieldDate,label:`Дата`})})]})}),play:async({canvasElement:e})=>{await y(C(e).getByTestId(u.fieldDate)).toBeVisible()}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  play: async ({
    canvasElement,
    step
...
}`,...D.parameters?.docs?.source}}},O=[`InteractionTest`,`OutsideClickWide`]}))();export{E as InteractionTest,D as OutsideClickWide,O as __namedExportsOrder,T as default};
//# sourceMappingURL=FieldDate.InteractionTest.stories-BkgL5dz9.js.map