import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{V as n,b as r,t as i}from"./src-RbwpdxGx.js";import{a,c as o,t as s}from"./fixtures-C3acPEZs.js";import{n as c,r as l}from"./testIds-uj6NvpMo.js";import{n as u,t as d}from"./sharedMeta-DZxsH53w.js";var f,p,m,h,g,_,v,y,b,x,S;e((()=>{i(),o(),l(),d(),f=t(),{expect:p,userEvent:m,waitFor:h,within:g}=__STORYBOOK_MODULE_TEST__,_={title:`Snack/Data display/Table/Table/Examples/CardView`,id:`components-table-table-examples-cardview`,...u},v=c.component,y=`section-list`,b=a({withStatusColumn:!0}),x={tags:[`dev`,`test`],render:()=>(0,f.jsx)(r,{"data-test-id":c.table.root,data:s,columnDefinitions:b,defaultView:n.Cards,showDataView:!0,headlineId:`name`,rowSelection:{enable:!0,multiRow:!0},sorting:{},outline:!0}),play:async({canvasElement:e,step:t})=>{let n=g(e),r=g(document.body),i=n.getByTestId(c.table.root);await t(`cards: рендерится страница карточек`,async()=>{let e=g(i).getAllByTestId(v.card);p(e).toHaveLength(10)}),await t(`sort: droplist сортировки меняет порядок карточек`,async()=>{let e=g(i).getAllByTestId(v.card)[0].textContent;await m.click(g(i).getByTestId(v.viewSort.droplistTrigger)),await h(()=>p(r.getByTestId(v.viewSort.droplist)).toBeVisible());let t=r.getAllByTestId(v.viewSort.option);await m.click(t[t.length-1]),await h(()=>{let t=g(i).getAllByTestId(v.card)[0];p(t.textContent).not.toBe(e)}),await m.keyboard(`{Escape}`),await h(()=>p(r.queryByTestId(v.viewSort.droplist)).toBeNull())}),await t(`view: сегмент-контрол переключает в table-вид и обратно`,async()=>{let e=n.getByTestId(c.toolbar.dataView);await m.click(g(e).getByTestId(y)),await h(()=>p(g(i).getByTestId(v.headerRow)).toBeVisible()),await m.click(g(e).getByTestId(c.toolbar.dataViewCardsSegment)),await h(()=>p(g(i).getAllByTestId(v.card).length).toBeGreaterThan(0))})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Table.CardView.stories-DLUhM3h5.js.map