import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{O as c,t as l}from"./src-Wlx-Lh91.js";import{M as u,_ as d,h as f,j as p,t as m}from"./src-7Go8s995.js";var h,g,_,v,y,b,x,S;e((()=>{l(),m(),o(),u(),h=t(),{expect:g,fn:_,userEvent:v,within:y}=__STORYBOOK_MODULE_TEST__,b={title:`Uikit Product/Inputs & Forms/FieldsPredefined/FieldMask/Tests/Interaction`,id:`uikit-product-fieldspredefined-fieldmask-tests-interaction`,component:f,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{label:`СНИЛС`,mask:d.Snils,onChange:_(),"data-test-id":p.fieldMask}},x={tags:[`test`,`dev`],render:e=>(0,h.jsx)(r,{children:(0,h.jsxs)(a,{width:`narrow`,children:[(0,h.jsx)(i,{children:`InteractionTest`}),(0,h.jsx)(n,{children:`Ввод цифр форматируется маской СНИЛС, onChange получает значение с разделителями.`}),(0,h.jsx)(s,{block:!0,children:(0,h.jsx)(f,{...e})})]})}),play:async({args:e,canvasElement:t,step:n})=>{let r=y(t).getByTestId(c.fieldComboInput);await n(`typing digits applies the mask separators`,async()=>{await v.click(r),await v.type(r,`12345678901`),g(r).toHaveValue(`123456-789 01`)}),await n(`onChange is fired with the formatted value`,async()=>{g(e.onChange).toHaveBeenCalled(),g(e.onChange).toHaveBeenCalledWith(`123456-789 01`,g.anything(),g.anything())})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
...
//# sourceMappingURL=FieldMask.InteractionTest.stories-CWdu2Do2.js.map