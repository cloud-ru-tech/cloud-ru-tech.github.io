import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{a as n,c as r,i,l as a,n as o,o as s,r as c,t as l}from"./testIds-BckWMora.js";var u,d,f,p,m,h,g;e((()=>{n(),c(),o(),u=t(),{expect:d,fn:f,within:p}=__STORYBOOK_MODULE_TEST__,m={title:`Uikit Product/Feedback/ErrorPages`,id:`uikit-product-errorpages`,component:s,parameters:{layout:`fullscreen`},args:{errorType:r.FrontendError,logoVariant:a.Cloud,mainPageUrl:`/`,showMainButton:!0,showSupport:!0,"data-test-id":l.root},argTypes:{errorType:{control:`select`,options:Object.values(r)},logoVariant:{control:`radio`,options:[a.Cloud,a.None]},showSupport:{name:`[Stories]: showSupport`,control:`boolean`}}},h={tags:[`dev`,`test`],render:({errorType:e,logoVariant:t,showSupport:n,...a})=>{let o=n?f():void 0;return(0,u.jsx)(`div`,{className:i.playground,children:e===r.Custom?(0,u.jsx)(s,{...a,logoVariant:t,errorType:r.Custom,custom:{title:`Custom title`,description:`Custom text`,statusCode:418},onSupportCenterClick:o}):(0,u.jsx)(s,{...a,logoVariant:t,errorType:e,onSupportCenterClick:o})})},play:async({canvasElement:e})=>{await d(p(e).getByTestId(l.root)).toBeVisible()}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  render: ({
    errorType,
    logoVariant,
...
//# sourceMappingURL=ErrorPage.Playground.stories-D9kQIvqI.js.map