import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{c as n,d as r,l as i,m as a,t as o,u as s}from"./iframe-Du0zU9lI.js";import{D as c,Nt as l,j as u,kt as d,st as f,t as p}from"./system-B3b9qWhT.js";import{I as m,a as h,t as g}from"./src-BB54vc1d.js";import{n as _,t as v}from"./testIds-zOjMf_tk.js";import{n as y,t as b}from"./stories.module-Cv0zmHWk.js";var x,S,C,w,T,E,D;e((()=>{p(),g(),o(),_(),b(),x=t(),{userEvent:S,within:C}=__STORYBOOK_MODULE_TEST__,w={title:`Snack/Data display/List/List/Examples/Submenu`,id:`components-list-list-examples-submenu`,component:h,parameters:{layout:`fullscreen`,design:{type:`figma`,url:`https://www.figma.com/design/wKxqVGm5YH01EgQMBK4a3G/list?node-id=27832-59174`}}},T=[{id:`home`,beforeContent:(0,x.jsx)(f,{}),content:{label:`Home`}},{id:`workspace`,type:`next-list`,beforeContent:(0,x.jsx)(d,{}),content:{label:`Workspace`},items:[{id:`w-overview`,content:{label:`Overview`}},{id:`w-analytics`,content:{label:`Analytics`}},{id:`w-projects`,type:`next-list`,beforeContent:(0,x.jsx)(l,{}),content:{label:`Projects`},items:[{id:`p-frontend`,content:{label:`Frontend`}},{id:`p-backend`,content:{label:`Backend`}}]}]},{id:`reports`,type:`next-list`,beforeContent:(0,x.jsx)(l,{}),content:{label:`Reports (loading)`},loading:!0,items:[{id:`r-pending`,content:{label:`Pending…`}}]},{id:`favourites`,beforeContent:(0,x.jsx)(c,{}),content:{label:`Favourites`}},{id:`settings`,beforeContent:(0,x.jsx)(u,{}),content:{label:`Settings`}}],E={tags:[`dev`,`test`],render:()=>(0,x.jsx)(s,{children:(0,x.jsxs)(r,{width:`narrow`,children:[(0,x.jsx)(a,{children:`Submenu (next-list)`}),(0,x.jsx)(i,{children:`Hover «Workspace» — открывается вложенный список (NextListItem → Dropdown).`}),(0,x.jsx)(n,{align:`center`,children:(0,x.jsx)(`div`,{className:y.listFrame,children:(0,x.jsx)(h,{"data-test-id":v.list.submenuScenario,items:T,size:`m`})})})]})}),play:async({canvasElement:e,step:t})=>{let n=C(e).getByTestId(v.list.submenuScenario);await t(`hover root item with submenu (opens NextListItem)`,async()=>{let e=n.querySelectorAll(`[data-test-id^="${m.baseItem}"]`);e[1]&&await S.hover(e[1])})}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  render: () => <DemoPage>
...
//# sourceMappingURL=List.Submenu.stories-C2XkJsNt.js.map