import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{t as n,v as r}from"./src-BFnLcVPc.js";import{a as i,c as a,l as o}from"./fixtures-dP01vc5l.js";import{n as s,r as c}from"./testIds-zndDgWg-2.js";import{n as l,t as u}from"./sharedMeta-4vzySTV2.js";import{n as d,t as f}from"./styles.module-s2CWiWjM.js";function p(){let e=i({withStatusColumn:!0});return(0,g.jsx)(`div`,{className:d.scrollArea,children:(0,g.jsx)(r,{"data-test-id":s.table.root,data:b,columnDefinitions:e,enableRowVirtualization:!0,suppressPagination:!0,pageSize:b.length,outline:!0})})}function m(){return(0,g.jsx)(`div`,{className:d.scrollArea,children:(0,g.jsx)(r,{"data-test-id":s.table.root,data:b.slice(0,20),columnDefinitions:x,enableColumnVirtualization:!0,suppressPagination:!0,pageSize:20,outline:!0})})}function h(){return(0,g.jsx)(`div`,{className:d.scrollArea,children:(0,g.jsx)(r,{"data-test-id":s.table.root,data:b,columnDefinitions:x,enableRowVirtualization:!0,enableColumnVirtualization:!0,suppressPagination:!0,pageSize:b.length,outline:!0})})}var g,_,v,y,b,x,S,C,w,T;e((()=>{n(),a(),c(),u(),f(),g=t(),{expect:_,within:v}=__STORYBOOK_MODULE_TEST__,y={title:`Snack/Data display/Table/Table/Examples/Virtualization`,id:`components-table-table-examples-virtualization`,...l},b=o(500),x=i({wide:!0,withStatusColumn:!0,withDates:!0}),S={tags:[`dev`,`test`],render:()=>(0,g.jsx)(p,{}),play:async({canvasElement:e})=>{let t=v(e).getByTestId(s.table.root);await _(t).toBeVisible();let n=v(t).getAllByTestId(s.component.bodyRow);_(n.length).toBeGreaterThan(0),_(n.length).toBeLessThan(500)}},C={tags:[`dev`,`test`],render:()=>(0,g.jsx)(m,{}),play:async({canvasElement:e})=>{let t=v(e).getByTestId(s.table.root);await _(t).toBeVisible()}},w={tags:[`dev`,`test`],render:()=>(0,g.jsx)(h,{}),play:async({canvasElement:e})=>{let t=v(e).getByTestId(s.table.root);await _(t).toBeVisible();let n=v(t).getAllByTestId(s.component.bodyRow);_(n.length).toBeGreaterThan(0),_(n.length).toBeLessThan(500)}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Table.Virtualization.stories-C5r_oVNr.js.map