import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{bn as n,gn as r,i,nt as a,t as o}from"./iframe-BRJzdrhE.js";import{r as s,t as c}from"./product-CtYgDwhT.js";import{c as l,t as u}from"./src-DABHgXCj.js";import{i as d,n as f,o as p}from"./demoData-B-Ba4Z-l.js";import{n as m,t as h}from"./styles.module-DX2_Oqo2.js";var g,_,v,y,b,x;e((()=>{a(),c(),u(),o(),p(),h(),g=t(),_={title:`Uikit Product/Layout/Header/MainMenu`,id:`uikit-product-header-mainmenu`,component:l,parameters:{layout:`fullscreen`}},v=[{id:`allServices`,label:`Все сервисы`,icon:(0,g.jsx)(s,{size:24}),items:d}],y=[{layoutType:n.Desktop,label:`desktop`},{layoutType:n.Mobile,label:`mobile`}],b={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,g.jsx)(i,{sectionTitle:`Trigger`,firstColumnHeader:`layoutType`,columnHeaders:[`default`,`disabled`],rows:y.map(({layoutType:e,label:t})=>({variantLabel:t,cells:[!1,!0].map(n=>(0,g.jsx)(r,{layoutType:e,children:(0,g.jsx)(`div`,{className:m.cell,children:(0,g.jsx)(l,{open:!1,disabled:n,segments:v,settingItems:f})})},`${t}-${n}`))}))})},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=MainMenu.VisualMatrix.stories-JtaJLReb.js.map