import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{dn as c,t as l}from"./system-BjOKAueR.js";import{n as u,s as d,t as f}from"./src-B0U4maK7.js";import{i as p,o as m,t as h}from"./src-CiSoRuzB.js";import{c as g,i as _,l as v,n as y,t as b}from"./src-CCKhzsXR.js";import{t as x}from"./testIds-3HEuIpsg.js";var S,C=e((()=>{S=``+new URL(`portrait-8-XXbEES5w.jpg`,import.meta.url).href})),w,T=e((()=>{w=``+new URL(`portrait-12-CvZQ3V8T.jpg`,import.meta.url).href})),E,D=e((()=>{E=``+new URL(`portrait-20-BhYjfOF6.jpg`,import.meta.url).href})),O,k=e((()=>{O=``+new URL(`portrait-47-FHnNpdmB.jpg`,import.meta.url).href})),A,j,M=e((()=>{A=`_verified_o8snz_4`,j={verified:A}})),N,P,F,I,L;e((()=>{b(),f(),l(),h(),o(),x(),C(),T(),D(),k(),M(),N=t(),P=[w,O,S,E].map(e=>e),F={title:`Snack/Data display/Avatar/Examples/CustomBadge`,id:`components-avatar-examples-custombadge`,component:y,parameters:{layout:`fullscreen`,controls:{disable:!0}}},I={tags:[`dev`,`test`],render:()=>(0,N.jsx)(r,{children:(0,N.jsxs)(a,{width:`wide`,children:[(0,N.jsx)(i,{children:`Custom badge slot`}),(0,N.jsx)(n,{children:"В слот `badge` можно положить любой компонент: счётчик уведомлений, иконку верификации, собственный микро-компонент. Bbox бейджа упирается в правый-нижний угол аватара."}),(0,N.jsxs)(s,{align:`center`,children:[(0,N.jsx)(y,{"data-test-id":v.root,name:`John Doe`,size:g[`6Xl`],src:P[0],badge:(0,N.jsx)(u,{value:5,size:d.S})}),(0,N.jsx)(y,{name:`Jane Roe`,size:g[`6Xl`],src:P[1],badge:(0,N.jsx)(`span`,{className:j.verified,children:(0,N.jsx)(c,{size:16})})}),(0,N.jsx)(y,{name:`Alex Roe`,size:g[`6Xl`],src:P[2],status:m.Green}),(0,N.jsx)(y,{name:`Mia Roe`,size:g[`6Xl`],src:P[3],badge:(0,N.jsx)(p,{size:_[g[`6Xl`]],appearance:m.Red})})]})]})})},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  render: () => <DemoPage>
...
//# sourceMappingURL=Avatar.CustomBadge.stories-CtcTJVgj.js.map