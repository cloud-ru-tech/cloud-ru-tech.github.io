import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{c,i as l,t as u}from"./src-ry4xi_BO.js";import{n as d,t as f}from"./testIds-wyan2m2i.js";var p,m,h,g,_,v;e((()=>{u(),o(),d(),p=t(),{expect:m,within:h}=__STORYBOOK_MODULE_TEST__,g={title:`Snack/Inputs & Forms/FieldDecorator/Label`,id:`components-fielddecorator-label`,component:l,parameters:{layout:`fullscreen`},args:{size:c.M,label:`Заголовок поля`,caption:`Подпись`,required:!0,labelTooltip:{tip:`Пояснение к заголовку`},"data-test-id":f.label.root}},_={tags:[`dev`,`test`],render:e=>(0,p.jsx)(r,{children:(0,p.jsxs)(a,{children:[(0,p.jsx)(i,{children:`Playground`}),(0,p.jsx)(n,{children:`Строка заголовка поля: label, знак обязательности, question-tooltip и подпись.`}),(0,p.jsx)(s,{align:`start`,children:(0,p.jsx)(l,{...e})})]})}),play:async({canvasElement:e})=>{await m(h(e).getByTestId(f.label.root)).toBeVisible()}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=Label.Playground.stories-bLmNjwvQ.js.map