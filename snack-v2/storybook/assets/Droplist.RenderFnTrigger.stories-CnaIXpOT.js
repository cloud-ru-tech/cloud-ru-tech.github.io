import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{a as c,t as l}from"./src-CHNzQsqP.js";import{n as u,t as d}from"./src-Cl0HJWYS.js";import{n as f,t as p}from"./testIds-1v137Tcu.js";var m,h,g,_,v,y,b;e((()=>{l(),d(),o(),f(),m=t(),{expect:h,within:g}=__STORYBOOK_MODULE_TEST__,_=[{id:`overview`,content:{label:`Overview`}},{id:`analytics`,content:{label:`Analytics`}},{id:`billing`,content:{label:`Billing`}}],v={title:`Snack/Data display/List/Droplist/Examples/RenderFnTrigger`,id:`components-list-droplist-examples-renderfntrigger`,component:u,parameters:{layout:`fullscreen`}},y={tags:[`dev`,`test`],render:()=>(0,m.jsx)(r,{children:(0,m.jsxs)(a,{children:[(0,m.jsx)(i,{children:`Render-function trigger`}),(0,m.jsx)(n,{children:`children — функция; onKeyDown прокинут в кастомный триггер для клавиатурного открытия.`}),(0,m.jsx)(s,{align:`center`,children:(0,m.jsx)(u,{items:_,size:`m`,placement:`bottom-start`,trigger:`click`,children:({onKeyDown:e})=>(0,m.jsx)(c,{"data-test-id":p.droplist.renderFnTrigger,label:`Custom trigger`,view:`outline`,appearance:`neutral`,size:`m`,onKeyDown:e})})})]})}),play:async({canvasElement:e})=>{await h(g(e).getByTestId(p.droplist.renderFnTrigger)).toBeVisible()}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  render: () => <DemoPage>
      <DemoPanel>
...
//# sourceMappingURL=Droplist.RenderFnTrigger.stories-CnaIXpOT.js.map