import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{a as c,c as l,i as u,o as d,t as f,u as p}from"./src-Bo1rmC5T.js";import{n as m,r as h,t as g}from"./testIds-CS-eequk.js";var _,v,y,b,x,S;e((()=>{f(),o(),m(),g(),_=t(),{expect:v,within:y}=__STORYBOOK_MODULE_TEST__,b={title:`Snack/Feedback/Skeleton/SkeletonText`,id:`components-skeleton-skeletontext`,component:l,parameters:{layout:`fullscreen`},args:{loading:!0,variant:d.Body,size:c.M,align:u.Left,lines:3,"data-test-id":p.skeletonText.root},argTypes:{loading:{control:`boolean`,description:`Флаг состояния загрузки`},lines:{control:{type:`number`,min:1,max:10},description:`Количество строк`},variant:{options:Object.values(d),control:`select`,description:`Роль типографики`},size:{options:Object.values(c),control:`radio`,description:`Масштаб: s / m / l`},align:{options:Object.values(u),control:`radio`,description:`Выравнивание`},width:{control:{type:`number`},description:`Ширина контейнера`}}},x={tags:[`dev`,`test`],render:e=>(0,_.jsx)(r,{children:(0,_.jsxs)(a,{children:[(0,_.jsx)(i,{children:`Playground`}),(0,_.jsx)(n,{children:`Многострочный текстовый скелетон с настройкой типографики и количества строк.`}),(0,_.jsx)(s,{block:!0,children:(0,_.jsx)(`div`,{className:h.wrapper,children:(0,_.jsx)(l,{...e,children:(0,_.jsx)(`span`,{children:`Контент после загрузки.`})})})})]})}),play:async({canvasElement:e})=>{await v(y(e).getByTestId(p.skeletonText.root)).toBeVisible()}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
...
//# sourceMappingURL=SkeletonText.Playground.stories-DKk04c--.js.map