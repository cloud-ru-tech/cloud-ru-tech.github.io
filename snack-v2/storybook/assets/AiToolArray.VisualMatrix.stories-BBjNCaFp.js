import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-C2bZDhP2.js";import{c as i,i as a,t as o}from"./src-5N5EnYa1.js";import{n as s,t as c}from"./testIds-D1rBkYOW.js";var l,u,d,f=e((()=>{l=`_cell_fqkus_1`,u=`_grid_fqkus_5`,d={cell:l,grid:u}})),p,m,h,g,_,v,y;e((()=>{o(),r(),s(),f(),p=t(),m={title:`AI/Primitives/AiTool/Content/AiToolArray`,id:`ai-aitool-content-aitoolarray`,component:a,parameters:{layout:`padded`}},h=[!1,!0],g=[!1,!0],_=[!1,!0],v={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,p.jsxs)(`div`,{className:d.grid,children:[(0,p.jsx)(n,{sectionTitle:`State × Open`,firstColumnHeader:`—`,columnHeaders:h.map(e=>e?`OPEN`:`CLOSED`),rows:[{variantLabel:`array`,cells:h.map(e=>(0,p.jsx)(`div`,{className:d.cell,children:(0,p.jsxs)(a,{name:`Key[ArrayName]`,count:2,unit:`шт.`,open:e,"data-test-id":`${c.array}-${e?`open`:`closed`}`,children:[(0,p.jsx)(i,{label:`0`,value:`alpha`}),(0,p.jsx)(i,{label:`1`,value:`beta`})]})},String(e)))}]}),(0,p.jsx)(n,{sectionTitle:`Error × Mono`,firstColumnHeader:`Error`,columnHeaders:g.map(e=>e?`MONO`:`LABEL`),rows:_.map(e=>({variantLabel:e?`error`:`default`,cells:g.map(t=>(0,p.jsx)(`div`,{className:d.cell,children:(0,p.jsx)(a,{name:`Key[ArrayName]`,count:2,unit:`шт.`,error:e,mono:t,"data-test-id":`${c.array}-${e?`error`:`default`}-${t?`mono`:`label`}`})},`${e}-${t}`))}))})]})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <div className={styles.grid}>
      <StoryTable sectionTitle='State × Open' firstColumnHeader='—' columnHeaders={openStates.map(o => o ? 'OPEN' : 'CLOSED')} rows={[{
      variantLabel: 'array',
      cells: openStates.map(open => <div key={String(open)} className={styles.cell}>
                <AiToolArray name='Key[ArrayName]' count={2} unit='шт.' open={open} data-test-id={\`\${TEST_IDS.array}-\${open ? 'open' : 'closed'}\`}>
...
//# sourceMappingURL=AiToolArray.VisualMatrix.stories-BBjNCaFp.js.map