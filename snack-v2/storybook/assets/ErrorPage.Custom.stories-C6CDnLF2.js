import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{a as c,c as l,i as u,l as d,n as f,o as p,r as m,t as h}from"./testIds-LOwfBV6o.js";var g,_,v,y,b,x;e((()=>{c(),o(),m(),f(),g=t(),{expect:_,within:v}=__STORYBOOK_MODULE_TEST__,y={title:`Uikit Product/Feedback/ErrorPages/Examples/Custom`,id:`uikit-product-errorpages-examples-custom`,component:p,parameters:{layout:`fullscreen`}},b={tags:[`dev`,`test`],render:()=>(0,g.jsx)(r,{children:(0,g.jsxs)(a,{width:`wide`,children:[(0,g.jsx)(i,{children:`Custom`}),(0,g.jsx)(n,{children:`Полностью кастомный контент: свой заголовок, код статуса, кнопка и логотип.`}),(0,g.jsx)(s,{block:!0,children:(0,g.jsx)(`div`,{className:u.frame,children:(0,g.jsx)(p,{"data-test-id":h.root,errorType:l.Custom,logoVariant:d.Custom,logo:(0,g.jsx)(`span`,{children:`ACME`}),mainPageUrl:`/dashboard`,custom:{title:`Quota exceeded`,description:`Your project reached its resource limit. Upgrade the plan to continue.`,statusCode:429,mainButton:{label:`Upgrade plan`,href:`/billing`},showMainPageLink:!0,showBackLink:!0}})})})]})}),play:async({canvasElement:e})=>{let t=v(e);await _(t.getByTestId(h.root)).toBeVisible(),await _(t.getByTestId(h.statusCode)).toHaveTextContent(`429`),await _(t.getByTestId(h.mainButton)).toBeVisible()}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  render: () => <DemoPage>
...
//# sourceMappingURL=ErrorPage.Custom.stories-C6CDnLF2.js.map