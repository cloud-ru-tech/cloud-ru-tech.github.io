import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{bn as n,gn as r,i,nt as a,t as o}from"./iframe-DCnmYW19.js";import{U as s,t as c}from"./system-RRIeUQJT.js";import{r as l,t as u}from"./src-DFgQXuB7.js";import{i as d,t as f}from"./src-DzZnxWSg.js";var p,m,h,g,_=e((()=>{p=`_grid_846sy_2`,m=`_cellDesktop_846sy_8`,h=`_cellMobile_846sy_12`,g={grid:p,cellDesktop:m,cellMobile:h}})),v,y,b,x,S,C;e((()=>{a(),u(),c(),o(),f(),_(),v=t(),y={title:`Uikit Product/Layout/Layout/EmptyBlock`,id:`uikit-product-layout-emptyblock`,component:d,parameters:{layout:`fullscreen`}},b=(0,v.jsx)(l,{primaryAction:{label:`Label text`},secondaryAction:{label:`Label text`}}),x=[{layoutType:n.Desktop,label:`desktop (horizontal)`,cellClass:g.cellDesktop},{layoutType:n.Mobile,label:`mobile (vertical)`,cellClass:g.cellMobile}],S={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,v.jsx)(`div`,{className:g.grid,children:(0,v.jsx)(i,{sectionTitle:`Layout × Footer`,firstColumnHeader:`layoutType`,columnHeaders:[`without footer`,`with footer`],rows:x.map(({layoutType:e,label:t,cellClass:n})=>({variantLabel:t,cells:[!1,!0].map(i=>(0,v.jsx)(r,{layoutType:e,children:(0,v.jsx)(`div`,{className:n,children:(0,v.jsx)(d,{title:`Title text`,content:`Body text`,icon:{icon:s},footer:i?b:void 0})})},`${t}-${i}`))}))})})},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=EmptyBlock.VisualMatrix.stories-D7SXSjx_.js.map