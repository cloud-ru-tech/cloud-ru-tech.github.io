import{i as e}from"./preload-helper-CCSz8wUY.js";import{o as t,t as n,u as r}from"./src-CFwAjJxo.js";import{c as i,i as a}from"./mockData-DkqJwWhB.js";import{n as o}from"./testIds-O_uF4frA.js";import{n as s,t as c}from"./decorators-pHzjIPtL.js";var l,u,d,f,p,m;e((()=>{n(),i(),o(),c(),{expect:l,userEvent:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Uikit Product/Data display/Quota/QuotaWidgetCard`,id:`uikit-product-quota-quotawidgetcard`,component:t,parameters:{layout:`padded`}},p={tags:[`test`],decorators:[s],args:{quota:a,"data-test-id":r.quotaWidgetCard.root},play:async({canvasElement:e})=>{let t=d(e),n=d(document.body);await u.hover(t.getByTestId(r.quotaWidgetCard.root)),await l(await n.findByTestId(r.quotaWidgetCard.tooltip)).toBeVisible()}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  tags: ['test'],
...
//# sourceMappingURL=QuotaWidgetCard.InteractionTest.stories-TMPmIV_N.js.map