import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{d as n,f as r,g as i,p as a,t as o,u as s}from"./iframe-qs8RgOhH.js";import{i as c,l,n as u,t as d,u as f}from"./src-DpI57Dvv.js";var p,m,h,g,_,v,y;e((()=>{d(),o(),f(),p=t(),{expect:m,userEvent:h,within:g}=__STORYBOOK_MODULE_TEST__,_={title:`Uikit Product/Inputs & Forms/TogglesPredefined/ToggleCard/Tests/Interaction`,id:`uikit-product-togglespredefined-togglecard-tests-interaction`,component:c,parameters:{layout:`fullscreen`,controls:{disable:!0}},args:{title:`Тариф Pro`,description:`100 ГБ хранилища`,value:`pro`,"data-test-id":l.card}},v={tags:[`test`,`dev`],render:e=>(0,p.jsx)(r,{children:(0,p.jsxs)(a,{children:[(0,p.jsx)(i,{children:`InteractionTest`}),(0,p.jsx)(n,{children:`Клик / Enter по карточке выбирает её значение в ToggleGroup.`}),(0,p.jsx)(s,{align:`center`,children:(0,p.jsx)(u,{children:(0,p.jsx)(c,{...e})})})]})}),play:async({canvasElement:e,step:t})=>{let n=g(e).getByTestId(l.card);await t(`initial: card is not checked`,async()=>{await m(n).toHaveAttribute(`aria-checked`,`false`)}),await t(`click: selects the card`,async()=>{await h.click(n),await m(n).toHaveAttribute(`aria-checked`,`true`)}),await t(`keyboard: Enter toggles selection off`,async()=>{n.focus(),await h.keyboard(`{Enter}`),await m(n).toHaveAttribute(`aria-checked`,`false`)})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
...
//# sourceMappingURL=ToggleCard.InteractionTest.stories-rEJUBQz3.js.map