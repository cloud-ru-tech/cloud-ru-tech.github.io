import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{n,t as r}from"./classnames-iuquYaxc.js";import{On as i,d as a,f as o,g as s,kn as c,p as l,t as u,u as d}from"./iframe-qs8RgOhH.js";import{ct as f,lt as p}from"./helperComponents-DlhcWLAW.js";import{i as m,t as h}from"./src-Cw_GfiZY.js";import{o as g}from"./testIds-DQO6y4hn.js";function _(e,t,n){if(![e,t,n].every(e=>e===void 0))return{hours:e,minutes:t,seconds:n}}var v=t((()=>{})),y,b,x,S,C,w,T,E=t((()=>{y=`_story_1jouy_4`,b=`_storyWrapper_1jouy_15`,x=`_valueHolder_1jouy_21`,S=`_scrollS_1jouy_25`,C=`_scrollM_1jouy_29`,w=`_scrollL_1jouy_33`,T={story:y,storyWrapper:b,valueHolder:x,scrollS:S,scrollM:C,scrollL:w}})),D,O,k,A,j,M,N,P,F,I,L;t((()=>{D=e(r(),1),u(),c(),h(),g(),v(),E(),O=n(),{useArgs:k,useMemo:A}=__STORYBOOK_MODULE_PREVIEW_API__,{expect:j,within:M}=__STORYBOOK_MODULE_TEST__,N={title:`Snack/Inputs & Forms/Calendar/Time Picker`,id:`components-calendar-time-picker`,component:m,parameters:{layout:`fullscreen`,readme:{content:i},design:{type:`figma`,url:`https://www.figma.com/design/aNPU3MHwRJiEwbk5F82zux/Snack-Ui-Kit-variables?node-id=3553-18435&m=dev`}}},P={[f.S]:T.scrollS,[f.M]:T.scrollM,[f.L]:T.scrollL},F=({size:e,showSeconds:t,fitToContainer:n,withFixedSizes:r,withBackground:i,valueHours:c,valueMinutes:u,valueSeconds:h,defaultValueHours:g,defaultValueMinutes:v,defaultValueSeconds:y})=>{let[,b]=k(),x=A(()=>_(c,u,h),[c,u,h]),S=A(()=>_(g,v,y),[g,v,y]),C=e=>{b({valueHours:e.hours??void 0,valueMinutes:e.minutes??void 0,valueSeconds:e.seconds??void 0})},w=String(c).padStart(2,`0`),E=String(u).padStart(2,`0`),j=String(h).padStart(2,`0`);return(0,O.jsx)(o,{children:(0,O.jsxs)(l,{children:[(0,O.jsx)(s,{children:`Playground`}),(0,O.jsx)(a,{children:`Барабан выбора времени: часы, минуты и опционально секунды.`}),(0,O.jsx)(d,{align:`center`,children:(0,O.jsxs)(`div`,{className:(0,D.default)(T.story,r&&P[e||f.S]),"data-with-background":i||void 0,children:[(0,O.jsx)(m,{size:e,showSeconds:t,fitToContainer:n,defaultValue:S,value:x,onChangeValue:C,"data-test-id":p.timePickerPlayground}),(0,O.jsx)(`div`,{className:T.valueHolder,"data-test-id":p.timePickerValueHolder,children:x?`${w}:${E}:${j}`:``})]})})]})})},I={tags:[`dev`,`test`],args:{showSeconds:!0,size:f.S,withFixedSizes:!0,fitToContainer:!0,withBackground:!0,valueHours:void 0,valueMinutes:void 0,valueSeconds:void 0,defaultValueHours:void 0,defaultValueMinutes:void 0,defaultValueSeconds:void 0},argTypes:{size:{control:`radio`,options:Object.values(f)},valueHours:{name:`[value] hours`,control:{type:`number`}},valueMinutes:{name:`[value] minutes`,control:{type:`number`}},valueSeconds:{name:`[value] seconds`,control:{type:`number`}},defaultValueHours:{name:`[defaultValue] hours`,control:{type:`number`}},defaultValueMinutes:{name:`[defaultValue] minutes`,control:{type:`number`}},defaultValueSeconds:{name:`[defaultValue] seconds`,control:{type:`number`}},withFixedSizes:{name:`[Stories]: Fixed sizes of story`},withBackground:{name:`[Stories]: Enable white background for story wrapper`,control:{type:`boolean`}}},render:F,play:async({canvasElement:e})=>{await j(M(e).getByTestId(`timepicker-playground`)).toBeVisible()}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  tags: ['dev', 'test'],
  args: {
    showSeconds: true,
    size: SIZE.S,
...
//# sourceMappingURL=TimePicker.Playground.stories-BaM9VFcg.js.map