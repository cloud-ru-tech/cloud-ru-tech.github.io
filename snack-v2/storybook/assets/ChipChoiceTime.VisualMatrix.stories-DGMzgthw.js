import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-CtVh-JlF.js";import{o as i,t as a}from"./src-Btydntad.js";import{d as o,i as s,l as c,n as l,r as u,t as d,u as f}from"./visualMatrix.helpers-BCs_M4Xr.js";import{n as p,t as m}from"./styles.module-B5TQqo6I.js";var h,g,_,v;e((()=>{a(),r(),o(),m(),h=t(),g={title:`Snack/Inputs & Forms/Chips/ChipChoice/Time`,id:`components-chips-chipchoice-time`,component:i.Time,parameters:{layout:`padded`}},_={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:p.matrix,children:[(0,h.jsx)(n,{sectionTitle:`Value × Size`,firstColumnHeader:`Value`,columnHeaders:s,rows:[{variantLabel:`no value`,cells:c.map(e=>(0,h.jsx)(i.Time,{label:`Time`,size:e},e))},{variantLabel:`no value + icon`,cells:c.map(e=>(0,h.jsx)(i.Time,{label:`Time`,size:e,icon:d},e))},{variantLabel:`value set + icon + clear`,cells:c.map(e=>(0,h.jsx)(i.Time,{label:`Time`,size:e,defaultValue:f,icon:d,...u},e))}]}),(0,h.jsx)(n,{sectionTitle:`State × Size`,firstColumnHeader:`State`,columnHeaders:s,rows:l.map(({key:e,extra:t})=>({variantLabel:e,cells:c.map(e=>(0,h.jsx)(i.Time,{label:`Time`,size:e,...t},e))}))})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=ChipChoiceTime.VisualMatrix.stories-DGMzgthw.js.map