import{i as e}from"./preload-helper-CCSz8wUY.js";import{n as t}from"./classnames-iuquYaxc.js";import{i as n,t as r}from"./iframe-qs8RgOhH.js";import{a as i,d as a,f as o,l as s,s as c,t as l}from"./src-DrWypOgt.js";import{a as u,i as d,n as f,r as p,t as m}from"./uploadFixtures-7Nm7XGwM.js";var h,g,_,v,y,b,x,S,C,w=e((()=>{h=`_matrix_w2vlc_7`,g=`_progressCell_w2vlc_14`,_=`_fileLineCell_w2vlc_18`,v=`_fileLineDarkBg_w2vlc_22`,y=`_playgroundPage_w2vlc_28`,b=`_playgroundPanel_w2vlc_35`,x=`_playgroundTitle_w2vlc_48`,S=`_playgroundHint_w2vlc_58`,C={matrix:h,progressCell:g,fileLineCell:_,fileLineDarkBg:v,playgroundPage:y,playgroundPanel:b,playgroundTitle:x,playgroundHint:S}})),T,E,D,O,k,A,j,M,N,P,F;e((()=>{l(),r(),u(),w(),T=t(),E={title:`Snack/Overlays/Toaster/ToastUpload`,id:`components-toaster-toastupload`,component:i,parameters:{layout:`padded`}},D=Object.values(o),O=Object.values(a),k={title:`Загрузка файлов`,progress:{current:2,total:4},generalActions:{}},A={loading:f,pause:p,error:m,uploaded:d,errorUploaded:m},j={loading:f,pause:p,error:m,uploaded:d},M=[`neutral`,`green`,`red`],N=[0,25,50,75,100],P={tags:[`test`,`dev`],parameters:{controls:{disable:!0}},render:()=>(0,T.jsxs)(`div`,{className:C.matrix,children:[(0,T.jsx)(n,{sectionTitle:`Status × Collapsed`,firstColumnHeader:`Status`,columnHeaders:[`expanded`,`collapsed`],rows:D.map(e=>({variantLabel:e,cells:[!1,!0].map(t=>(0,T.jsx)(`div`,{className:C.fileLineCell,children:(0,T.jsx)(i,{...k,status:e,description:`Состояние: ${e}`,files:[A[e]],collapsed:t,closable:!0})},`${e}-${String(t)}`))}))}),(0,T.jsx)(n,{sectionTitle:`onCancelAll slot`,firstColumnHeader:`onCancelAll`,columnHeaders:[`expanded`,`collapsed`],rows:[{variantLabel:`present`,value:()=>void 0},{variantLabel:`absent`,value:void 0}].map(({variantLabel:e,value:t})=>({variantLabel:e,cells:[!1,!0].map(n=>(0,T.jsx)(`div`,{className:C.fileLineCell,children:(0,T.jsx)(i,{...k,status:o.Loading,description:`Состояние: loading`,files:[f],collapsed:n,closable:!0,onCancelAll:t})},`${e}-${String(n)}`))}))}),(0,T.jsx)(n,{sectionTitle:`File-line item status`,firstColumnHeader:`Item status`,columnHeaders:[`ToastUploadFileLine`],rows:O.map(e=>({variantLabel:e,cells:[(0,T.jsx)(`div`,{className:`${C.fileLineCell} ${C.fileLineDarkBg}`,children:(0,T.jsx)(c,{item:j[e]})},e)]}))}),(0,T.jsx)(n,{sectionTitle:`Progress appearance × percent`,firstColumnHeader:`Appearance`,columnHeaders:N.map(e=>`${e}%`),rows:M.map(e=>({variantLabel:e,cells:N.map(t=>(0,T.jsx)(`div`,{className:`${C.progressCell} ${C.fileLineDarkBg}`,children:(0,T.jsx)(s,{appearance:e,progress:t})},`${e}-${t}`))}))})]})},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  tags: ['test', 'dev'],
  parameters: {
    controls: {
      disable: true
...
//# sourceMappingURL=ToastUpload.VisualMatrix.stories-8kOoFziz.js.map