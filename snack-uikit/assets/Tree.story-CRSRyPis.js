import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{r as o}from"./index-CJ_LmFaV.js";import{P as Ve}from"./index-CU6E9CWM.js";import{c as ge}from"./index-CXM-PPQz.js";import{u as He}from"./index-JZGyZbA2.js";import{C as ze}from"./index-CQc5r4_Q.js";import{K as qe}from"./index-B4f8p1mq.js";import{D as Je}from"./DropList-vdFsay0b.js";import{B as Pe}from"./ButtonFunction-CsJIzq2t.js";import{F as $e}from"./index-9wvJTAiE.js";import{F as We,a as Xe}from"./index-DnTCD4Me.js";import{C as Ye}from"./Checkbox-Dm2bIKAT.js";import{R as Ze}from"./Radio-BDmxsDzr.js";import{T as et}from"./Typography-BRWvDK8D.js";import{T as tt}from"./TruncateString-Chrk-fjN.js";import{e as xe}from"./componentPropsProcessors-UJEZy8aQ.js";import{E as nt,a as st}from"./index-nGp8qeK-.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-B7wZyJkK.js";import"./hooks-lImjenbH.js";import"./useValueControl-CNLw7ht-.js";import"./Switch-CJ0-IE_Z.js";import"./constants-BObEONKm.js";import"./TogglePrivate-D_Ey2AsU.js";import"./index-CAYnss5D.js";import"./index-CF-13Pl-.js";import"./index-DHfXeKe7.js";import"./Dropdown-BIBNsN_z.js";import"./PopoverPrivate-Dbj5k6oN.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./isBrowser-C2N6XvuH.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./index-CV7xtGUY.js";import"./LocaleProvider-7fZm_0X9.js";import"./lodash-DyrGR4_s.js";import"./index-BRkGOJ1S.js";import"./IconPredefined-BRbxZfzQ.js";import"./Tooltip-CeCihl4C.js";import"./ButtonTonal-Dbo7t3Uw.js";import"./utils-nE8vb_Mt.js";import"./Counter-CVeRO6SA.js";import"./Sun-Czt8-gDg.js";import"./constants-BAH7I9kc.js";import"./ButtonFilled-CQj7dEdz.js";import"./Divider-BbKtI3tl.js";import"./Scroll-Dm8myf0Z.js";import"./Spinner-BcyWg2qj.js";import"./useButtonNavigation-DVt-5Flo.js";import"./useClearButton-X6xACxcY.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-DSbAEC5z.js";import"./index-C0OXG0Ut.js";const it=`# Change Log
...
- Initial version
`,ct="@snack-uikit/tree",at="0.12.5",ye={name:ct,version:at},ut=`# Tree
...
`,x={Single:"single",Multi:"multi"},ot={accordionFolding:200},f={node:"tree__node",line:"tree__node__line",item:"tree__node__item",chevron:"tree__node__chevron",checkbox:"tree__node__checkbox",radio:"tree__node__radio",icon:"tree__node__icon",title:"tree__node__title",droplistTrigger:"tree__node__droplist-trigger",droplistAction:"tree__node__droplist-action",expandable:"tree__node__expandable",expandableContent:"tree__node__expandable-content",link:"tree__node__link"},ie="/snack/?path=/story/welcome--welcome";function Te(e){var c;const t=[...e],s=[];let i;for(;i=t.pop();)i.disabled||(s.push(i.id),(c=i.nested)!=null&&c.length&&t.push(...i.nested));return s}function ce(e,t){const s=Te(e),i=s.filter(p=>t.includes(p)),c=i.length>0,a=c&&s.length===i.length;return{someSelected:!a&&c,allSelected:a}}function dt(e,t){var a;const s=[...e],i=[];let c;for(;c=s.shift();)i.push(c.id),(a=c.nested)!=null&&a.length&&t.includes(c.id)&&s.unshift(...c.nested);return i}function rt({node:e,selectedNodes:t,parentNode:s}){var h;const{nested:i}=e,c=i!=null&&i.length?ce(i,t):void 0,a=c?c.someSelected||c.allSelected:t.includes(e.id);let p=[];const d=[e.id];if(i!=null&&i.length&&d.push(...Te(i)),a?p=t.filter(g=>!d.includes(g)):p=t.concat(d),s){let g=s;for(;g;){if((h=g.nested)!=null&&h.length){const u=ce(g.nested,p),l=g.id;if(a){if(!u.allSelected){const k=p.indexOf(l);k>-1&&p.splice(k,1)}}else u.allSelected&&p.push(l)}g=g.parentNode}}return p}const De=o.createContext({data:[],selected:void 0,onSelect(){},expandedNodes:[],onExpand(){return new Promise(e=>e)},onNodeClick(){},setFocusPosition(){},setFocusIndex(){},resetFocusPosition(){},focusableNodeIds:[],isMultiSelect:!1,isSingleSelect:!1,isSelectable:!1});function ae({children:e,value:t}){const{onNodeClick:s,onExpand:i,onSelect:c,selectionMode:a,data:p,...d}=t,h=a===x.Multi,g=a===x.Single,u=!!a,[l,k]=He(t.expandedNodes,t.expandedNodes||[],i),G=o.useCallback(r=>{const y=l.includes(r.id)?l.filter(U=>U!==r.id):l.concat(r.id);k(y,r)},[l,k]),[b,E]=He(t.selected,[],c),B=o.useCallback((r,N)=>{if(!(!u||r.disabled)){if(g){E(r.id===b?void 0:r.id,r);return}if(Array.isArray(b)){const y=rt({node:r,parentNode:N,selectedNodes:b});E(y,r)}}},[g,E,b,u]),C=o.useMemo(()=>l!=null&&l.length?p.reduce((r,N)=>{var U;return r.push(N.id),l.includes(N.id)&&((U=N.nested)!=null&&U.length)&&r.push(...dt(N.nested,l)),r},[]):p.map(r=>r.id),[p,l]),[H,L]=o.useState(),O=H!==void 0?C[H]:void 0,A=o.useCallback(r=>{const N=C.indexOf(r);L(N>=0?N:void 0)},[C]),F=o.useCallback(()=>L(void 0),[]),P=o.useCallback((r,N)=>{var y;r.disabled||(g&&B(r),(y=r.onClick)!=null&&y.call(r,N)||(s==null||s(r,N)))},[g,B,s]);return n.jsx(De.Provider,{value:{...d,data:p,selected:b,isSingleSelect:g,isMultiSelect:h,isSelectable:u,expandedNodes:l,onExpand:G,onSelect:B,onNodeClick:P,focusedNodeId:O,setFocusPosition:A,resetFocusPosition:F,setFocusIndex:L,focusableNodeIds:C},children:e})}const Ue=()=>o.useContext(De);try{ae.displayName="TreeContextProvider",ae.__docgenInfo={description:"",displayName:"TreeContextProvider",props:{value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"TreeContextBaseProps"}}}}}catch{}const ue=0,oe=1,$=2,W=3,X=4,lt=5,Qe=6,kt=["preEnter","entering","entered","preExit","exiting","exited","unmounted"],Ie=e=>({_s:e,status:kt[e],isEnter:e<W,isMounted:e!==Qe,isResolved:e===$||e>X}),de=e=>e?Qe:lt,gt=(e,t)=>{switch(e){case oe:case ue:return $;case X:case W:return de(t)}},pt=e=>typeof e=="object"?[e.enter,e.exit]:[e,e],mt=(e,t)=>setTimeout(()=>{isNaN(document.body.offsetTop)||e(t+1)},0),Be=(e,t,s,i,c)=>{clearTimeout(i.current);const a=Ie(e);t(a),s.current=a,c&&c({current:a})},ht=({enter:e=!0,exit:t=!0,preEnter:s,preExit:i,timeout:c,initialEntered:a,mountOnEnter:p,unmountOnExit:d,onStateChange:h}={})=>{const[g,u]=o.useState(()=>Ie(a?$:de(p))),l=o.useRef(g),k=o.useRef(),[G,b]=pt(c),E=o.useCallback(()=>{const C=gt(l.current._s,d);C&&Be(C,u,l,k,h)},[h,d]),B=o.useCallback(C=>{const H=O=>{switch(Be(O,u,l,k,h),O){case oe:G>=0&&(k.current=setTimeout(E,G));break;case X:b>=0&&(k.current=setTimeout(E,b));break;case ue:case W:k.current=mt(H,O);break}},L=l.current.isEnter;typeof C!="boolean"&&(C=!L),C?!L&&H(e?s?ue:oe:$):L&&H(t?i?W:X:de(d))},[E,h,e,t,s,i,G,b,d]);return o.useEffect(()=>()=>clearTimeout(k.current),[]),[g,B,E]},bt="_treeLine_14ukc_1",At={treeLine:bt};function Q({className:e,halfWidth:t,horizontal:s,visible:i,height:c,width:a}){return n.jsx("div",{className:ge(At.treeLine,e),style:{height:c,width:a},"data-horizontal":s||void 0,"data-half-width":t||void 0,"data-visible":i||void 0,"data-test-id":f.line})}try{Q.displayName="TreeLine",Q.__docgenInfo={description:"",displayName:"TreeLine",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},halfWidth:{defaultValue:null,description:"",name:"halfWidth",required:!1,type:{name:"boolean"}},visible:{defaultValue:null,description:"",name:"visible",required:!1,type:{name:"boolean"}},horizontal:{defaultValue:null,description:"",name:"horizontal",required:!1,type:{name:"boolean"}}}}}catch{}const Gt="_treeNode_pjs1v_1",Et="_treeNodeIcon_pjs1v_8",Ct="_treeNodeTitle_pjs1v_21",Nt="_treeNodeActions_pjs1v_31",Ot="_treeNodeContent_pjs1v_39",ft="_treeNodeCheckboxWrap_pjs1v_100",Lt="_treeNodeExpandButton_pjs1v_110",Ht="_treeNodeExpandButtonWrapper_pjs1v_121",yt="_treeNodeLink_pjs1v_129",_={treeNode:Gt,treeNodeIcon:Et,treeNodeTitle:Ct,treeNodeActions:Nt,treeNodeContent:Ot,treeNodeCheckboxWrap:ft,treeNodeExpandButton:Lt,treeNodeExpandButtonWrapper:Ht,treeNodeLink:yt};function Ke(e){e.stopPropagation()}function Bt(e){e.stopPropagation()}function re({getNodeActions:e,isDroplistTriggerFocused:t,focusNode:s,isDroplistOpen:i,setDroplistOpen:c,onBlurActions:a,node:p}){const d=e(p),h=o.useRef(null);o.useEffect(()=>{h.current&&t&&h.current.focus()},[t,h]);const g=u=>{var l;switch(u.key){case"Tab":{s(),c(!1),u.preventDefault(),u.stopPropagation();return}case"ArrowLeft":{t&&(s(),c(!1),u.stopPropagation());return}case" ":case"Enter":{u.stopPropagation();return}case"ArrowDown":{t&&c(!0),u.stopPropagation();return}case"ArrowUp":{c(!1),(l=h.current)==null||l.focus(),u.stopPropagation();return}default:return}};return d.length?n.jsx("div",{role:"presentation",className:_.treeNodeActions,"data-focused":t||void 0,onClick:Ke,onKeyDown:g,onFocus:Bt,children:n.jsx(Je,{open:i,onOpenChange:c,items:d,closeDroplistOnItemClick:!0,placement:"bottom-end",triggerElemRef:h,size:"m",children:n.jsx(Pe,{size:"xs",icon:n.jsx(qe,{}),onBlur:a,tabIndex:-1,"data-test-id":f.droplistTrigger})})}):null}try{re.displayName="TreeNodeActions",re.__docgenInfo={description:"",displayName:"TreeNodeActions",props:{isDroplistOpen:{defaultValue:null,description:"",name:"isDroplistOpen",required:!0,type:{name:"boolean"}},setDroplistOpen:{defaultValue:null,description:"",name:"setDroplistOpen",required:!0,type:{name:"Dispatch<SetStateAction<boolean>>"}},getNodeActions:{defaultValue:null,description:"",name:"getNodeActions",required:!0,type:{name:'(node: Omit<TreeNodeProps, "href">) => Item[]'}},node:{defaultValue:null,description:"",name:"node",required:!0,type:{name:'Omit<TreeNodeProps, "href">'}},isDroplistTriggerFocused:{defaultValue:null,description:"",name:"isDroplistTriggerFocused",required:!0,type:{name:"boolean"}},focusNode:{defaultValue:null,description:"",name:"focusNode",required:!0,type:{name:"() => void"}},onBlurActions:{defaultValue:null,description:"",name:"onBlurActions",required:!0,type:{name:"() => void"}}}}}catch{}const Y=o.forwardRef(({href:e,children:t,onClick:s},i)=>e?n.jsx("a",{href:e,className:_.treeNodeLink,onClick:s,"data-test-id":f.link,tabIndex:-2,ref:i,children:t}):t);Y.displayName="TreeNodeHref";try{Y.displayName="TreeNodeHref",Y.__docgenInfo={description:"",displayName:"TreeNodeHref",props:{href:{defaultValue:null,description:"",name:"href",required:!1,type:{name:"string"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLAnchorElement>"}}}}}catch{}const Z=o.forwardRef(({id:e,title:t,icon:s=n.jsx($e,{size:24}),expandedIcon:i=n.jsx(We,{size:24}),collapsedIcon:c=n.jsx(Xe,{size:24}),disabled:a,onClick:p,nested:d,className:h,onChevronClick:g,onKeyDown:u,isLoading:l,parentNode:k,tabIndexAvailable:G,href:b,...E},B)=>{const{isMultiSelect:C,isSelectable:H,onNodeClick:L,selected:O,expandedNodes:A,onSelect:F,nodeActions:P,parentActions:r,setFocusPosition:N,resetFocusPosition:y,focusedNodeId:U,setFocusIndex:pe,focusableNodeIds:Se,showToggle:me,showLines:he,showIcons:be}=Ue(),[ne,we]=o.useState(!1),[M,V]=o.useState(!1),T=o.useRef(null),se=o.useRef(null),K=Array.isArray(d),D=K?A==null?void 0:A.includes(e):void 0,v=o.useMemo(()=>{if(!(!d||!O))return ce(d,Array.isArray(O)?O:[O])},[d,O]),z=(Array.isArray(O)?O.includes(e)||(v==null?void 0:v.allSelected):O===e)||!1,Ae=U===e;o.useEffect(()=>{T.current&&Ae&&T.current.focus()},[Ae]);const Ge=o.useMemo(()=>{if(be)return K?D?i:c:s},[be,K,s,D,i,c]),Ee=m=>{L({id:e,title:t,disabled:a,nested:d,onClick:p,href:b},m)},Re=m=>{m.stopPropagation(),!(m!=null&&m.metaKey||m!=null&&m.ctrlKey||(m==null?void 0:m.button)===1)&&p&&(m.preventDefault(),Ee(m))},Ce=()=>{F({id:e,disabled:a,nested:d},k)},Ne=m=>{var S;N(e),m||(V(!1),(S=T.current)==null||S.focus())},je=()=>{var m;M&&!ne&&(V(!1),(m=T.current)==null||m.blur())},Me=m=>{var fe,Le;u==null||u(m);const S=Se.length;switch(m.key){case"ArrowDown":{m.preventDefault(),pe((w=0)=>w>=S-1?S-1:w+1);return}case"ArrowUp":{m.preventDefault(),pe((w=0)=>w?w-1:0);return}case"ArrowRight":{m.preventDefault(),(D||!K||a)&&V(!0);return}case"ArrowLeft":{m.preventDefault(),M&&(V(!1),(fe=T.current)==null||fe.focus());return}case"Escape":{(Le=T.current)==null||Le.blur();return}case" ":case"Enter":{m.preventDefault(),Ce(),b&&se.current&&se.current.click();return}default:return}},Oe=d?r:P;return n.jsxs("div",{role:"presentation",className:ge(_.treeNode,h),...xe(E),"data-node-id":e,ref:B,children:[k&&n.jsx(Q,{halfWidth:!!d,horizontal:!0,visible:he,"data-test-id":f.line}),!k&&!d&&n.jsx(Q,{visible:!1}),K&&n.jsxs("div",{className:_.treeNodeExpandButtonWrapper,children:[n.jsx(Pe,{size:"xs",icon:n.jsx(ze,{}),loading:l,onClick:g,"data-expanded":D||void 0,className:_.treeNodeExpandButton,tabIndex:-1,"data-test-id":f.chevron}),n.jsx(Q,{visible:D&&he,height:"100%"})]}),n.jsxs("div",{role:"treeitem","aria-expanded":D,"aria-selected":H?z||(v==null?void 0:v.someSelected)&&!D&&!C:void 0,"aria-disabled":a,"data-multiselect":C||void 0,"data-droplist-active":ne||M||void 0,onClick:Ee,onKeyDown:Me,onFocus:Ne,onBlur:y,tabIndex:G?0:-1,className:_.treeNodeContent,"data-test-id":f.item,ref:T,children:[(C||me)&&n.jsxs("div",{className:_.treeNodeCheckboxWrap,children:[C&&n.jsx(Ye,{size:"s",disabled:a,checked:z,indeterminate:!z&&(v==null?void 0:v.someSelected),onChange:Ce,onClick:Ke,"data-test-id":f.checkbox,tabIndex:-1}),me&&n.jsx(Ze,{size:"s",checked:z,disabled:a,"data-test-id":f.radio,tabIndex:-1})]}),Ge&&n.jsx("div",{className:_.treeNodeIcon,"data-test-id":f.icon,children:Ge}),n.jsx(et.SansBodyM,{tag:"div",className:_.treeNodeTitle,children:n.jsxs(Y,{href:b,onClick:Re,ref:se,children:[typeof t=="string"&&n.jsx(tt,{text:t,"data-test-id":f.title}),typeof t!="string"&&t({id:e,disabled:a,nested:d})]})}),Oe&&n.jsx(re,{getNodeActions:Oe,node:{id:e,title:t,disabled:a,nested:d},focusNode:Ne,onBlurActions:je,isDroplistTriggerFocused:M,isDroplistOpen:ne,setDroplistOpen:we})]})]})});try{Z.displayName="TreeNode",Z.__docgenInfo={description:"",displayName:"TreeNode",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"Идентификатор элемента",name:"id",required:!0,type:{name:"string"}},title:{defaultValue:null,description:"Имя элемента",name:"title",required:!0,type:{name:'((value: Pick<BaseTreeNode, "id" | "disabled">) => ReactNode) | ((string | ((value: Pick<BaseTreeNode, "id" | "disabled">) => ReactNode)) & (string | ((value: Pick<...>) => ReactNode)))'}},disabled:{defaultValue:null,description:"Является ли элемент деактивированным",name:"disabled",required:!1,type:{name:"boolean"}},onClick:{defaultValue:null,description:"Обработчик клика по элементу",name:"onClick",required:!1,type:{name:"MouseEventHandler"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},href:{defaultValue:null,description:"Ссылка на элемент",name:"href",required:!1,type:{name:"string"}},icon:{defaultValue:{value:"<FileSVG size={24} />"},description:"Иконка дочернего элемента",name:"icon",required:!1,type:{name:"ReactNode"}},nested:{defaultValue:null,description:"Вложенные элементы дерева",name:"nested",required:!1,type:{name:"(ChildTreeNode | ParentTreeNode)[]"}},expandedIcon:{defaultValue:{value:"<FolderOpenSVG size={24} />"},description:"Иконка элемента-родителя в открытом состоянии",name:"expandedIcon",required:!1,type:{name:"ReactNode"}},collapsedIcon:{defaultValue:{value:"<FolderSVG size={24} />"},description:"Иконка элемента-родителя в закрытом состоянии",name:"collapsedIcon",required:!1,type:{name:"ReactNode"}},onChevronClick:{defaultValue:null,description:"",name:"onChevronClick",required:!1,type:{name:"MouseEventHandler<HTMLElement>"}},onKeyDown:{defaultValue:null,description:"",name:"onKeyDown",required:!1,type:{name:"KeyboardEventHandler<HTMLElement>"}},isLoading:{defaultValue:null,description:"",name:"isLoading",required:!1,type:{name:"boolean"}},parentNode:{defaultValue:null,description:"",name:"parentNode",required:!1,type:{name:"ParentNode"}},tabIndexAvailable:{defaultValue:null,description:"",name:"tabIndexAvailable",required:!1,type:{name:"boolean"}}}}}catch{}const ee=o.forwardRef(({node:e,tabIndexAvailable:t,parentNode:s},i)=>{const c=e["data-test-id"]||f.node,a={...e,"data-test-id":c};return e.nested?n.jsx(le,{node:a,tabIndexAvailable:t,parentNode:s,ref:i}):n.jsx(Z,{...a,tabIndexAvailable:t,parentNode:s,ref:i})});try{ee.displayName="TreeItem",ee.__docgenInfo={description:"",displayName:"TreeItem",props:{node:{defaultValue:null,description:"",name:"node",required:!0,type:{name:"TreeNodeProps"}},parentNode:{defaultValue:null,description:"",name:"parentNode",required:!1,type:{name:"ParentNode"}},tabIndexAvailable:{defaultValue:null,description:"",name:"tabIndexAvailable",required:!1,type:{name:"boolean"}}}}}catch{}const vt="_expandableTreeNode_1l3up_1",_t="_expandableContent_1l3up_6",Ft="_expandableWrap_1l3up_15",Pt="_expandableNested_1l3up_31",xt="_treeLine_1l3up_36",R={expandableTreeNode:vt,expandableContent:_t,expandableWrap:Ft,expandableNested:Pt,treeLine:xt},le=o.forwardRef(({node:{"data-test-id":e,...t},parentNode:s,tabIndexAvailable:i},c)=>{const{expandedNodes:a,onExpand:p,onDataLoad:d,showLines:h}=Ue(),g=!!t.nested,u=(a==null?void 0:a.includes(t.id))||!1,[l,k]=o.useState(!1),[G,b]=ht({timeout:ot.accordionFolding,initialEntered:u||void 0,enter:u}),E=t.nested&&t.nested.length>0&&G.status!=="exited",B=o.useRef([]),[C,H]=o.useState(0);o.useEffect(()=>{var F;const A=(F=B.current)==null?void 0:F.at(-1);if(A){const P=new ResizeObserver(r=>r.forEach(N=>{if(N.target===A){const[{blockSize:y}]=N.contentBoxSize;H(y)}}));return P.observe(A),H(A.scrollHeight??0),()=>P.disconnect()}},[G.status]),o.useEffect(()=>{var A;(A=t.nested)!=null&&A.length&&u&&G.status==="exited"&&b(!0)},[u,t.nested,G.status]);const L=async()=>{t.nested&&!t.nested.length&&!u&&d&&(k(!0),await d(t).finally(()=>{k(!1)})),p(t),b()},O=A=>{if(g)switch(A.key){case"ArrowRight":{u||L();return}case"ArrowLeft":{u&&L();return}default:return}};return n.jsxs("div",{className:R.expandableTreeNode,"data-test-id":e,"data-expandable":!!t.nested||void 0,"data-disabled":t.disabled||void 0,ref:c,children:[n.jsx(Z,{...t,isLoading:l,parentNode:s,onChevronClick:L,onKeyDown:O,tabIndexAvailable:i}),t.nested&&n.jsx("div",{className:R.expandableWrap,"data-expanded":u||void 0,"data-test-id":f.expandable,children:E&&n.jsxs("div",{className:R.expandableContent,"data-test-id":f.expandableContent,children:[n.jsx(Q,{visible:h,"data-test-id":f.line,height:`calc(100% - ${C}px)`,className:R.treeLine}),n.jsx("div",{className:R.expandableNested,children:t.nested.map((A,F)=>{const P={id:t.id,nested:t.nested,parentNode:s};return n.jsx(ee,{ref:r=>B.current[F]=r,node:{...A,disabled:t.disabled||A.disabled},parentNode:P},A.id)})})]})})]})});try{le.displayName="ExpandableTreeNode",le.__docgenInfo={description:"",displayName:"ExpandableTreeNode",props:{node:{defaultValue:null,description:"",name:"node",required:!0,type:{name:"TreeNodeProps"}},parentNode:{defaultValue:null,description:"",name:"parentNode",required:!1,type:{name:'(Pick<TreeNodeProps, "id" | "nested"> & { parentNode?: ParentNode; } & { parentNode?: ParentNode; }) | undefined'}},tabIndexAvailable:{defaultValue:null,description:"",name:"tabIndexAvailable",required:!1,type:{name:"boolean"}}}}}catch{}const Tt="_tree_16mi5_1",Dt={tree:Tt};function Ut({selectionMode:e,selected:t,onSelect:s}){switch(e){case x.Single:return{selectionMode:e,selected:t,onSelect:s};case x.Multi:return{selectionMode:e,selected:t,onSelect:s};case void 0:default:return{}}}function I({data:e,onNodeClick:t,onExpand:s,expandedNodes:i,nodeActions:c,parentActions:a,onDataLoad:p,showLines:d=!0,showIcons:h=!0,className:g,...u}){return n.jsx("div",{className:ge(Dt.tree,g),role:"tree",...xe(u),children:n.jsx(ae,{value:{showToggle:u.selectionMode==="single"&&u.showToggle,data:e,expandedNodes:i,onNodeClick:t,onExpand:s,nodeActions:c,parentActions:a,onDataLoad:p,showLines:d,showIcons:h,...Ut(u)},children:e.map((l,k)=>n.jsx(ee,{node:l,tabIndexAvailable:k===0||k===e.length-1},l.id))})})}try{I.displayName="Tree",I.__docgenInfo={description:"",displayName:"Tree",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},data:{defaultValue:null,description:"Данные для отрисовки",name:"data",required:!0,type:{name:"TreeNodeProps[]"}},showLines:{defaultValue:{value:"true"},description:"Флаг отвечающий за отображение линий вложенности",name:"showLines",required:!1,type:{name:"boolean"}},onNodeClick:{defaultValue:null,description:"Обработчик клика по элементу дерева",name:"onNodeClick",required:!1,type:{name:"OnNodeClick"}},expandedNodes:{defaultValue:null,description:"Состояние для раскрытых элементов",name:"expandedNodes",required:!1,type:{name:"string[]"}},onExpand:{defaultValue:null,description:"Колбэк при раскрытии/закрытии элементов",name:"onExpand",required:!1,type:{name:"((expandedKeys: string[], node: TreeNodeProps) => void)"}},onDataLoad:{defaultValue:null,description:"Колбэк для асинхронной загрузки данных при раскрытии дерева",name:"onDataLoad",required:!1,type:{name:"((node: TreeNodeProps) => Promise<unknown>)"}},parentActions:{defaultValue:null,description:"Дополнительные действия для элемента-родителя",name:"parentActions",required:!1,type:{name:"((node: TreeNodeProps) => Item[])"}},nodeActions:{defaultValue:null,description:"Дополнительные действия для элемента-потомка",name:"nodeActions",required:!1,type:{name:"((node: TreeNodeProps) => Item[])"}},showIcons:{defaultValue:{value:"true"},description:"Флаг отвечающий за отображение иконок у элементов дерева",name:"showIcons",required:!1,type:{name:"boolean"}},selectionMode:{defaultValue:null,description:"Режим выбора элементов:\n<br> - `Single` - одиночный выбор\n<br> - `Multi` - множественный выбор\n<br> - `undefined` - без выбора",name:"selectionMode",required:!1,type:{name:"enum",value:[{value:'"single"'},{value:'"multi"'}]}},selected:{defaultValue:null,description:"Состояние для выбраных элементов:\n<br> - При <strong>selectionMode</strong>=`Multi` - принимает массив строк\n<br> - При <strong>selectionMode</strong>=`Single` - принимает строку",name:"selected",required:!1,type:{name:"string | string[]"}},onSelect:{defaultValue:null,description:"Колбэк при изменении выбраных элементов:\n<br> - При <strong>selectionMode</strong>=`Multi` - возвращает массив строк\n<br> - При <strong>selectionMode</strong>=`Single` - возвращает строку",name:"onSelect",required:!1,type:{name:"((selectedKeys: string[], node: TreeNodeProps) => void) | ((selectedKey: string, node: TreeNodeProps) => void)"}},showToggle:{defaultValue:null,description:"",name:"showToggle",required:!1,type:{name:"boolean"}}}}}catch{}function ke(e){return[{id:`${e}/2.1`,title:"item 3",nested:[{id:`${e}/2.1-1`,title:"item 4",nested:[{id:`${e}/2.1-1.1`,title:"item 5",nested:[{id:`${e}/2.1-1.1-1`,title:"item 6"}]},{id:`${e}/2.1-1.2`,title:"item 7",nested:[{id:`${e}/2.1-1.2-1`,title:"item 6"}]}]}]},{id:`${e}/2.2`,title:"item 8",nested:[{id:`${e}/2.2-1.1`,title:"item 4",icon:n.jsx(Ve,{})},{id:`${e}/2.2-1.2`,title:"first-second"}]}]}function te(e=!1){return t=>{const s=e?"parent":"node";return[{content:`${s} action 1 for node ${t.id}`,"data-test-id":f.droplistAction},{content:`${s} action 2 for node ${t.id}`,"data-test-id":f.droplistAction}]}}try{ke.displayName="getNested",ke.__docgenInfo={description:"",displayName:"getNested",props:{}}}catch{}try{te.displayName="getNodeActions",te.__docgenInfo={description:"",displayName:"getNodeActions",props:{}}}catch{}const q="data:image/jpeg;base64,",Qt="_storyWrap_1q7ef_1",It="_image_1q7ef_13",j={storyWrap:Qt,image:It},Rn={title:"Components/Tree",component:I},Kt=[{id:"1",title:"item with custom icon",nested:[],expandedIcon:n.jsx(st,{}),collapsedIcon:n.jsx(nt,{})},{id:"2",title:"item 2",nested:[]},{id:"syncOpen",title:"main 3",className:"test",nested:[{id:"3.1",title:()=>n.jsx("img",{src:q,alt:"custom-content",className:j.image}),nested:[{id:"3.1-1",title:()=>n.jsx("img",{src:q,alt:"custom-content",className:j.image})},{id:"3.1-2",title:"first-second"}]},{id:"3.2",title:"3.2",nested:[{id:"3.2-1.1",title:"first-first"},{id:"3.2-1.2",title:"first-second"}]},{id:"3-disabled",title:"item disabled",disabled:!0},{id:"3.3",title:()=>n.jsx("img",{src:q,alt:"custom-content",className:j.image})}]},{id:"empty",title:"empty after load",nested:[]},{id:"0-disabled",title:"folder disabled",disabled:!0,nested:[]},{id:"link",title:"link to url",href:ie},{id:"nestedLink",title:"nested link to url",nested:[{id:"nested-link-1",title:"link to url",href:ie}],href:ie},{id:"linkOnClick",title:"link with onClick prevent redirect",onClick:()=>console.warn("onClick"),href:"/test"},{id:"justItem",title:"file"},{id:"custom-content",title:"item with custom content",nested:[{id:"custom-content-1",title:()=>n.jsx("img",{src:q,alt:"custom-content",className:j.image})}]}],St=({selectionMode:e,enableNodeActions:t,...s})=>{const[i,c]=o.useState(),[a,p]=o.useState(Kt);o.useEffect(()=>{c(void 0)},[e]);const d=(k,G,b)=>G==="empty"?k:k.map(E=>(E.id===G&&(E.nested=b),E)),h=k=>new Promise(G=>{var b;if((b=k.nested)!=null&&b.length){G(!0);return}setTimeout(()=>{p(E=>d(E,k.id,ke(k.id))),G(!0)},1e3)}),g={...s,onSelect:void 0,selected:void 0,data:a,...t?{nodeActions:te(),parentActions:te(!0)}:{},onDataLoad:h},u={...g,selected:i,onSelect:c},l=()=>{switch(e){case x.Single:return n.jsx(I,{...u,selectionMode:e,selected:i});case x.Multi:return n.jsx(I,{...u,selectionMode:e,selected:i});case void 0:default:return n.jsx(I,{...g})}};return n.jsx("div",{className:j.storyWrap,children:l()})},J={render:St,args:{enableNodeActions:!0,selectionMode:x.Single},argTypes:{selectionMode:{options:[void 0,...Object.values(x)],control:{type:"select"}},enableNodeActions:{name:"[Stories]: Enable node actions"}},parameters:{readme:{sidebar:[`Latest version: ${ye.version}`,ut,it]},packageName:ye.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A34043&mode=design"}}};var ve,_e,Fe;J.parameters={...J.parameters,docs:{...(ve=J.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  render: Template,
  args: {
...
}`,...(Fe=(_e=J.parameters)==null?void 0:_e.docs)==null?void 0:Fe.source}}};export{Rn as default,J as tree};
