import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as f}from"./index-CXM-PPQz.js";import{r as F}from"./index-CJ_LmFaV.js";import{D as C,V as u,S as o,A as p,C as d}from"./Counter-CVeRO6SA.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";const v=`# Change Log
...
- Initial version
`,O="@snack-uikit/counter",N="0.8.12",m={name:O,version:N},A=`# Counter
...
`,G="_wrapper_1c6kb_1",E="_table_1c6kb_15",y="_cell_1c6kb_22",L="_headerCell_1c6kb_30",c={wrapper:G,table:E,cell:y,headerCell:L},P={title:"Components/Counter",component:d},x=({...l})=>{const k=Object.values(o),g=Object.values(p),i=Object.values(u),a=f(c.cell,c.headerCell);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:c.wrapper,children:["Controlled:",n.jsx(d,{...l})]}),n.jsxs("div",{className:c.table,children:[n.jsx("div",{className:a,style:{gridRow:"1 / 3"}}),k.map((e,t)=>n.jsx("div",{className:a,style:{gridColumnStart:t*3+2,gridColumnEnd:t*3+5},children:e},e)),i.map(e=>n.jsx("div",{className:a,children:e},e)),i.map(e=>n.jsx("div",{className:a,children:e},e)),g.map(e=>n.jsxs(F.Fragment,{children:[n.jsx("div",{className:a,children:e}),i.map(t=>n.jsx("div",{className:c.cell,children:n.jsx(d,{value:t===u.Count?9:9e3,size:o.S,variant:t,appearance:e,color:l.color})},t)),i.map(t=>n.jsx("div",{className:c.cell,children:n.jsx(d,{value:t===u.Count?9:9e3,size:o.M,variant:t,appearance:e,color:l.color})},t))]},e))]})]})},s={render:x,args:{value:9,appearance:p.Primary,size:o.S,variant:u.Count,plusLimit:C,color:"accent"},argTypes:{value:{type:"number"},appearance:{control:{type:"radio"}},size:{control:{type:"radio"}},variant:{control:{type:"radio"}}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,A,v]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=7%3A4148&mode=design"}}};var r,h,b;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: Template,
  args: {
    value: 9,
