import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as A}from"./index-DUmpqB7p.js";import{r as L}from"./index-CJ_LmFaV.js";import{L as u,A as G,P as N,S as O,T as f,a as C}from"./Link-BSVaCUhC.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./TruncateString-D54BiV_x.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DzAF_V2U.js";import"./PopoverPrivate-CnKgsFAm.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-JZGyZbA2.js";const v=`# Change Log
...
- Initial version
`,F="@snack-uikit/link",y="0.17.15",m={name:F,version:y},H=`# Link
...
`,x="_wrapper_1ev7a_1",T="_table_1ev7a_104",_="_cell_1ev7a_112",S="_headerCell_1ev7a_210",a={wrapper:x,table:T,cell:_,headerCell:S},nn={title:"Components/Link",component:u},s="Link text",E=O.S,j=N.Body,o=f.Default,k=G.Primary,w=Object.values(G),P=Object.values(O),D=Object.values(f);function r({header:d,options:t}){const e=A(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:e}),n.jsx("div",{className:e,children:d}),t.map(c=>{var h,b;return n.jsxs(L.Fragment,{children:[n.jsx("div",{className:e,children:c.header}),n.jsx("div",{className:a.cell,"data-appearance":(h=c.props)==null?void 0:h.appearance,"data-text-mode":(b=c.props)==null?void 0:b.textMode,children:n.jsx(u,{...c.props})})]},c.header)})]})}const R=({insideText:d,...t})=>n.jsxs(n.Fragment,{children:[n.jsx("div",{className:a.wrapper,"data-appearance":t.appearance,"data-text-mode":t.textMode,children:d?n.jsxs("span",{children:["Some text some text ",n.jsx(u,{...t,insideText:!0})," some text some text"]}):n.jsx(u,{...t})}),n.jsxs("div",{children:[n.jsx(r,{header:"Appearance",options:w.map(e=>({header:e,props:{appearance:e,text:s,textMode:o,size:E}}))}),n.jsx(r,{header:"Text Mode",options:D.map(e=>({header:e,props:{appearance:k,text:s,textMode:e}}))}),n.jsx(r,{header:"Size",options:P.map(e=>({header:e,props:{appearance:k,text:s,size:e,textMode:o}}))})]})]}),i={render:R,args:{textMode:o,href:"#",text:s,size:E,purpose:j,target:"_blank",appearance:k,insideText:!1,truncateVariant:"end"},argTypes:{size:{control:{type:"radio"}},target:{control:{type:"select",options:Object.values(C)}},download:{type:"string"}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,H,v]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=2%3A9&mode=design"}}};var l,p,g;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: Template,
  args: {
