import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as F}from"./index-DUmpqB7p.js";import{r as L}from"./index-CJ_LmFaV.js";import{A as w}from"./StatusIndicator-3Vfyu6S9.js";import{S as o,a as e,A as m,b as l}from"./Avatar-BnyePUFR.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";const I=`# Change Log
...
- Initial version
`,y="@snack-uikit/avatar",j="0.8.9",p={name:y,version:j},U='# Avatar\n\n## Installation\n`npm i @snack-uikit/avatar`\n\n[Changelog](./CHANGELOG.md)\n\n## Example\n\n```typescript jsx\nimport { Avatar } from "@snack-uikit/avatar";\n\n<Avatar\n  name="Name Surname"\n  src="path-to-avatar/image.jpg"\n  size=\'xl\'\n/>\n\n<Avatar \n  name="Name Surname"\n  appearance=\'pink\'\n  indicator=\'violet\'\n  shape=\'square\'\n  showTwoSymbols={true}\n/>\n```\n\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## Avatar\nКомпонент отображения аватара пользователя.\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| name* | `string` | - | Имя |\n| src | `string` | - | src аттрибут изображеня |\n| appearance | enum Appearance: `"red"`, `"orange"`, `"yellow"`, `"green"`, `"blue"`, `"violet"`, `"pink"`, `"neutral"` | red | Внешний вид |\n| size | enum Size: `"xxs"`, `"xs"`, `"s"`, `"m"`, `"l"`, `"xl"`, `"xxl"` | s | Размер |\n| shape | enum Shape: `"round"`, `"square"` | round | Форма: круглая или квадратная |\n| indicator | enum Appearance: `"red"`, `"orange"`, `"yellow"`, `"green"`, `"blue"`, `"violet"`, `"pink"`, `"neutral"`, `"primary"` | - | Индикатор |\n| showTwoSymbols | `boolean` | - | Отображение двух заглавных символов имени |\n| className | `string` | - | CSS-класс |\n\n\n[//]: DOCUMENTATION_SECTION_END\n',x=""+new URL("ImageCorp01-CgvwRRCD.jpg",import.meta.url).href,H=""+new URL("ImageCorp02-B-I_owas.jpg",import.meta.url).href,S=""+new URL("ImageCorp03-nTQ3Xaon.jpg",import.meta.url).href,_=""+new URL("ImageCorp04-DfsBLJwB.jpg",import.meta.url).href,R=""+new URL("ImageCorp05-DRRx2G3P.jpg",import.meta.url).href,T=""+new URL("ImageCorp06-BIiaLpUM.jpg",import.meta.url).href,P=""+new URL("ImageCorp07-pUPh_07Z.jpg",import.meta.url).href,D=""+new URL("ImageCorp08-B0QpUwph.jpg",import.meta.url).href,B=""+new URL("ImageUser01-Clej7SsF.jpg",import.meta.url).href,z=""+new URL("ImageUser02-CxtugQ_j.jpg",import.meta.url).href,M=""+new URL("ImageUser03-Da4kh21e.jpg",import.meta.url).href,V=""+new URL("ImageUser04-Bp9pxQow.jpg",import.meta.url).href,K=""+new URL("ImageUser05-CJOeERMP.jpg",import.meta.url).href,Q=""+new URL("ImageUser06-DUAyf60s.jpg",import.meta.url).href,W=""+new URL("ImageUser07-B4cxRweM.jpg",import.meta.url).href,Z=""+new URL("ImageUser08-q1bAz7dA.jpg",import.meta.url).href,h={[o.Round]:{[e.Red]:B,[e.Orange]:z,[e.Yellow]:M,[e.Green]:V,[e.Blue]:K,[e.Violet]:Q,[e.Pink]:W,[e.Neutral]:Z},[o.Square]:{[e.Red]:x,[e.Orange]:H,[e.Yellow]:S,[e.Green]:_,[e.Blue]:R,[e.Violet]:T,[e.Pink]:P,[e.Neutral]:D}},q="_pageWrapper_1ey0r_1",J="_wrapper_1ey0r_7",Y="_tableHorizontalGroup_1ey0r_20",$="_tableVerticalGroup_1ey0r_26",X="_table_1ey0r_20",ee="_cell_1ey0r_40",ne="_headerCell_1ey0r_48",a={pageWrapper:q,wrapper:J,tableHorizontalGroup:Y,tableVerticalGroup:$,table:X,cell:ee,headerCell:ne},le={title:"Components/Avatar",component:m},f="Will Willow",te=l.S,A=o.Round,G=e.Red;function i({header:r,options:d}){const s=F(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:s}),n.jsx("div",{className:s,children:r}),d.map(c=>n.jsxs(L.Fragment,{children:[n.jsx("div",{className:s,children:c.header}),n.jsx("div",{className:a.cell,children:n.jsx(m,{name:f,...c.props})})]},c.header))]})}const ae=({showImage:r,customSrc:d,shape:s=A,appearance:c=G,...C})=>{const E=Object.values(o),O=Object.values(l),N=Object.values(e),v=Object.values(w);return n.jsxs("div",{className:a.pageWrapper,children:[n.jsxs("div",{className:a.wrapper,children:["Controlled:",n.jsx(m,{...C,shape:s,appearance:c,src:r?d||h[s][c]:void 0})]}),n.jsxs("div",{className:a.tableHorizontalGroup,children:[n.jsxs("div",{className:a.tableVerticalGroup,children:[n.jsx(i,{header:"Image",options:[{header:"Yes",props:{src:h[o.Round][e.Red]}},{header:"No"}]}),n.jsx(i,{header:"Shape",options:E.map(t=>({header:t,props:{shape:t}}))}),n.jsx(i,{header:"Symbols",options:[{header:"One",props:{showTwoSymbols:!1}},{header:"Two",props:{showTwoSymbols:!0}}]})]}),n.jsx(i,{header:"Appearance",options:N.map(t=>({header:t,props:{appearance:t}}))}),n.jsx(i,{header:"Indicator",options:[{header:"None"},...v.map(t=>({header:t,props:{indicator:t}}))]}),n.jsx(i,{header:"Size",options:O.map(t=>({header:t,props:{size:t}}))})]})]})},u={render:ae,args:{showImage:!1,customSrc:"",name:f,size:te,appearance:G,shape:A,indicator:void 0,showTwoSymbols:!1},argTypes:{showImage:{type:"boolean"},customSrc:{type:"string",if:{arg:"showImage"}},src:{table:{disable:!0}},size:{options:Object.values(l),control:{type:"select"}}},parameters:{readme:{sidebar:[`Latest version: ${p.version}`,U,I]},packageName:p.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A21136&mode=design"}}};var b,k,g;u.parameters={...u.parameters,docs:{...(b=u.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: Template,
  args: {
    showImage: false,
    customSrc: '',
...
}`,...(g=(k=u.parameters)==null?void 0:k.docs)==null?void 0:g.source}}};export{u as avatar,le as default};
