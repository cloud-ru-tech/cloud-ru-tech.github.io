...
- Initial version
`,o="@snack-uikit/divider",m="3.2.7",t={name:o,version:m},h=`# Divider
...
`,l="_container_1qa84_1",r={container:l},v={title:"Components/Divider",component:s},b=({...u})=>e.jsx("div",{className:r.container,children:e.jsx(s,{...u})}),n={render:b,args:{},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${t.version}`,h,d]},packageName:t.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=11%3A7167&mode=design"}}};var c,i,a;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: Template,
  args: {},
  argTypes: {},
  parameters: {
