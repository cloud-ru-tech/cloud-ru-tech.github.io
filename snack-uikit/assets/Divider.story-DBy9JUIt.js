...
- Initial version
`,o="@snack-uikit/divider",m="3.2.12",t={name:o,version:m},l=`# Divider
...
`,r="_container_1qa84_1",h={container:r},O={title:"Components/Divider",component:s},b=({...d})=>e.jsx("div",{className:h.container,children:e.jsx(s,{...d})}),n={render:b,args:{},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${t.version}`,l,u]},packageName:t.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=11%3A7167&mode=design"}}};var i,c,a;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: Template,
  args: {},
  argTypes: {},
  parameters: {
