...
- Initial version
`,o="@snack-uikit/divider",m="3.2.6",t={name:o,version:m},r=`# Divider
...
`,h="_container_1qa84_1",l={container:h},v={title:"Components/Divider",component:s},b=({...d})=>e.jsx("div",{className:l.container,children:e.jsx(s,{...d})}),n={render:b,args:{},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${t.version}`,r,u]},packageName:t.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=11%3A7167&mode=design"}}};var c,i,a;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: Template,
  args: {},
  argTypes: {},
  parameters: {
