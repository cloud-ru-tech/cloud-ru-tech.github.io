import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as A}from"./index-CXM-PPQz.js";import{r as L}from"./index-CJ_LmFaV.js";import{L as u,A as G,P as C,S as O,T as f,a as N}from"./Link-C4t_crgO.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./TruncateString-Cw8qBX1n.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-ChnZZ3jk.js";import"./PopoverPrivate-BQgi56s-.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";const v=`# Change Log
...
- Initial version
`,F="@snack-uikit/link",y="0.17.20",b={name:F,version:y},H=`# Link
...
`,x="_wrapper_1ev7a_1",T="_table_1ev7a_104",_="_cell_1ev7a_112",P="_headerCell_1ev7a_210",a={wrapper:x,table:T,cell:_,headerCell:P},nn={title:"Components/Link",component:u},s="Link text",E=O.S,w=C.Body,o=f.Default,k=G.Primary,S=Object.values(G),j=Object.values(O),R=Object.values(f);function r({header:d,options:t}){const e=A(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:e}),n.jsx("div",{className:e,children:d}),t.map(c=>{var h,m;return n.jsxs(L.Fragment,{children:[n.jsx("div",{className:e,children:c.header}),n.jsx("div",{className:a.cell,"data-appearance":(h=c.props)==null?void 0:h.appearance,"data-text-mode":(m=c.props)==null?void 0:m.textMode,children:n.jsx(u,{...c.props})})]},c.header)})]})}const U=({insideText:d,...t})=>n.jsxs(n.Fragment,{children:[n.jsx("div",{className:a.wrapper,"data-appearance":t.appearance,"data-text-mode":t.textMode,children:d?n.jsxs("span",{children:["Some text some text ",n.jsx(u,{...t,insideText:!0})," some text some text"]}):n.jsx(u,{...t})}),n.jsxs("div",{children:[n.jsx(r,{header:"Appearance",options:S.map(e=>({header:e,props:{appearance:e,text:s,textMode:o,size:E}}))}),n.jsx(r,{header:"Text Mode",options:R.map(e=>({header:e,props:{appearance:k,text:s,textMode:e}}))}),n.jsx(r,{header:"Size",options:j.map(e=>({header:e,props:{appearance:k,text:s,size:e,textMode:o}}))})]})]}),i={render:U,args:{textMode:o,href:"#",text:s,size:E,purpose:w,target:"_blank",appearance:k,insideText:!1,truncateVariant:"end",truncateMaxLines:1},argTypes:{size:{control:{type:"radio"}},target:{control:{type:"select",options:Object.values(N)}},download:{type:"string"},truncateMaxLines:{if:{arg:"truncateVariant",eq:"end"}}},parameters:{readme:{sidebar:[`Latest version: ${b.version}`,H,v]},packageName:b.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=2%3A9&mode=design"}}};var l,g,p;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: Template,
  args: {
