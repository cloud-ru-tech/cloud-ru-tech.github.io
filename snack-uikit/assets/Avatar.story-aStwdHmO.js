import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as v}from"./index-CXM-PPQz.js";import{r as F}from"./index-CJ_LmFaV.js";import{A as y}from"./StatusIndicator-BFjfxMzR.js";import{S as u,a as e,b as m,A as l}from"./Avatar-CkEZb7nh.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";const I=`# Change Log
...
- Initial version
`,H="@snack-uikit/avatar",w="0.8.27",h={name:H,version:w},U=`# Avatar
...
`,_=""+new URL("ImageCorp01-CgvwRRCD.jpg",import.meta.url).href,R=""+new URL("ImageCorp02-B-I_owas.jpg",import.meta.url).href,j=""+new URL("ImageCorp03-nTQ3Xaon.jpg",import.meta.url).href,x=""+new URL("ImageCorp04-DfsBLJwB.jpg",import.meta.url).href,S=""+new URL("ImageCorp05-DRRx2G3P.jpg",import.meta.url).href,T=""+new URL("ImageCorp06-BIiaLpUM.jpg",import.meta.url).href,P=""+new URL("ImageCorp07-pUPh_07Z.jpg",import.meta.url).href,B=""+new URL("ImageCorp08-B0QpUwph.jpg",import.meta.url).href,D=""+new URL("ImageUser01-Clej7SsF.jpg",import.meta.url).href,J=""+new URL("ImageUser02-CxtugQ_j.jpg",import.meta.url).href,z=""+new URL("ImageUser03-Da4kh21e.jpg",import.meta.url).href,M=""+new URL("ImageUser04-Bp9pxQow.jpg",import.meta.url).href,$=""+new URL("ImageUser05-CJOeERMP.jpg",import.meta.url).href,V=""+new URL("ImageUser06-DUAyf60s.jpg",import.meta.url).href,K=""+new URL("ImageUser07-B4cxRweM.jpg",import.meta.url).href,Q=""+new URL("ImageUser08-q1bAz7dA.jpg",import.meta.url).href,p={[u.Round]:{[e.Red]:D,[e.Orange]:J,[e.Yellow]:z,[e.Green]:M,[e.Blue]:$,[e.Violet]:V,[e.Pink]:K,[e.Neutral]:Q},[u.Square]:{[e.Red]:_,[e.Orange]:R,[e.Yellow]:j,[e.Green]:x,[e.Blue]:S,[e.Violet]:T,[e.Pink]:P,[e.Neutral]:B}},W="_pageWrapper_1ey0r_1",Z="_wrapper_1ey0r_7",q="_tableHorizontalGroup_1ey0r_20",Y="_tableVerticalGroup_1ey0r_26",X="_table_1ey0r_20",ee="_cell_1ey0r_40",ne="_headerCell_1ey0r_48",a={pageWrapper:W,wrapper:Z,tableHorizontalGroup:q,tableVerticalGroup:Y,table:X,cell:ee,headerCell:ne},le={title:"Components/Avatar",component:l},G="Will Willow",te=m.S,f=u.Round,O=e.Red;function i({header:d,options:r}){const s=v(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:s}),n.jsx("div",{className:s,children:d}),r.map(c=>n.jsxs(F.Fragment,{children:[n.jsx("div",{className:s,children:c.header}),n.jsx("div",{className:a.cell,children:n.jsx(l,{name:G,...c.props})})]},c.header))]})}const ae=({showImage:d,customSrc:r,shape:s=f,appearance:c=O,...C})=>{const A=Object.values(u),E=Object.values(m),L=Object.values(e),N=Object.values(y);return n.jsxs("div",{className:a.pageWrapper,children:[n.jsxs("div",{className:a.wrapper,children:["Controlled:",n.jsx(l,{...C,shape:s,appearance:c,src:d?r||p[s][c]:void 0})]}),n.jsxs("div",{className:a.tableHorizontalGroup,children:[n.jsxs("div",{className:a.tableVerticalGroup,children:[n.jsx(i,{header:"Image",options:[{header:"Yes",props:{src:p[u.Round][e.Red]}},{header:"No"}]}),n.jsx(i,{header:"Shape",options:A.map(t=>({header:t,props:{shape:t}}))}),n.jsx(i,{header:"Symbols",options:[{header:"One",props:{showTwoSymbols:!1}},{header:"Two",props:{showTwoSymbols:!0}}]})]}),n.jsx(i,{header:"Appearance",options:L.map(t=>({header:t,props:{appearance:t}}))}),n.jsx(i,{header:"Indicator",options:[{header:"None"},...N.map(t=>({header:t,props:{indicator:t}}))]}),n.jsx(i,{header:"Size",options:E.map(t=>({header:t,props:{size:t}}))})]})]})},o={render:ae,args:{showImage:!1,customSrc:"",name:G,size:te,appearance:O,shape:f,indicator:void 0,showTwoSymbols:!1},argTypes:{showImage:{type:"boolean"},customSrc:{type:"string",if:{arg:"showImage"}},src:{table:{disable:!0}},size:{options:Object.values(m),control:{type:"select"}}},parameters:{readme:{sidebar:[`Latest version: ${h.version}`,U,I]},packageName:h.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A21136&mode=design"}}};var k,b,g;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: Template,
  args: {
    showImage: false,
    customSrc: '',
...
}`,...(g=(b=o.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};export{o as avatar,le as default};
