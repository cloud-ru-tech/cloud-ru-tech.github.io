import{j as l}from"./jsx-runtime-BTJTZTIL.js";import{a as oe}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import{r as h}from"./index-CJ_LmFaV.js";import{d as de}from"./index-D3kvmOHM.js";import{i as re}from"./isBrowser-C2N6XvuH.js";import{c as se}from"./index-DUmpqB7p.js";import{e as ae}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as he}from"./Typography-DmSN6cv6.js";import{D as pe}from"./DropList-8p36hK6-.js";import{H as me}from"./index-B_69vUNX.js";import"./index-ChsGqxH_.js";import"./v4-CtRu48qb.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-B7wZyJkK.js";import"./hooks-CAebMJU9.js";import"./useValueControl-C51frgGe.js";import"./index-JZGyZbA2.js";import"./Checkbox-qiHN918A.js";import"./constants-BObEONKm.js";import"./TogglePrivate-BTSew7b5.js";import"./index-w0WAZL2A.js";import"./index-Y3TRpJ-L.js";import"./TruncateString-D12I7bk8.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./Tooltip-BNp3usZT.js";import"./PopoverPrivate-CnKgsFAm.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./Switch-DZam4yEg.js";import"./index-DHAmGKAZ.js";import"./index-CGBRtoFy.js";import"./index-DrT0s6v0.js";import"./Dropdown-uG1Hplv7.js";import"./index-C3mvkShn.js";import"./index-CXJdfWGn.js";import"./LocaleProvider-CyhbxqE1.js";import"./index-B3VroJpC.js";import"./IconPredefined-FEPQkyLi.js";import"./ButtonTonal-DYtlQSFl.js";import"./utils-Cl9LJVwK.js";import"./Counter-CRGhF3Kb.js";import"./Sun-CLMO8Tpr.js";import"./constants-BAH7I9kc.js";import"./ButtonFilled-CqpH2yJb.js";import"./Divider-C1X9zrkx.js";import"./Spinner-DZPrD8kc.js";import"./Scroll-B3e6J9cA.js";import"./ButtonFunction-DXeIONHl.js";import"./useButtonNavigation-CVCsehRW.js";import"./useClearButton-xwxQpdbg.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-B9JOWh00.js";const be=`# Change Log
...
- Initial version
`,ke="@snack-uikit/breadcrumbs",ge="0.11.20",Z={name:ke,version:ge},ye=`# Breadcrumbs
...
\`\`\`
Компоненты Breadcrumbs мемоизирован, старайтесь передавать \`items\` одной и той же ссылкой.`,ie="›",o={Full:"full",ShortLabel:"shortLabel",Ellipsis:"ellipsis",Collapsed:"collapsed"},k={Separator:"separator",Collapse:"collapse",Item:"item"},f={Xs:"xs",S:"s"},Ee={[o.Full]:0,[o.ShortLabel]:1,[o.Ellipsis]:100,[o.Collapsed]:1e4},Ge=[o.Full,o.ShortLabel,o.Ellipsis],x=e=>(n,u)=>[{...n,renderMode:e},...u],R=x(o.Full),V=x(o.ShortLabel),T=x(o.Ellipsis),q=x(o.Collapsed);function F([e,...n],{useCollapse:u=!0,useEllipse:t=!0}){const a=[];return e?n.length?(F(n,{useCollapse:!1,useEllipse:!1}).forEach(s=>{a.push(R(e,s)),e.shortLabel&&a.push(V(e,s))}),t&&F(n,{useCollapse:!1,useEllipse:!0}).forEach(s=>{a.push(T(e,s))}),u&&F(n,{useCollapse:!0,useEllipse:!1}).forEach(s=>{a.push(q(e,s))}),a):(a.push(R(e,[])),e.shortLabel&&a.push(V(e,[])),a):a}const L=(e,n)=>n.map((u,t,a)=>{const s=t===a.length-1;return{...u,renderMode:s?e:o.Collapsed}});function Oe(e,n,u){if(!e.length)return[];const t=[],[a,...s]=e.map(c=>({...c,renderMode:o.Full}));return F(s,{useCollapse:!0,useEllipse:!0}).forEach(c=>{t.push(R(a,c)),a.shortLabel&&t.push(V(a,c))}),t.push(T(a,L(o.Full,s))),t.push(T(a,L(o.Ellipsis,s))),t.push(q(a,L(o.Full,s))),t.push(q(a,L(o.Ellipsis,s))),t.map(c=>c.reduce((i,d,p,m)=>{const{renderMode:r}=d;p&&Ge.includes(r)&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),!i.hasCollapsed&&r===o.Collapsed&&(p&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i.hasCollapsed=!0,i.width+=n.collapse,i.chain.push({element:k.Collapse,width:n.collapse}));const g=n.items[d.id][r];return i.weight+=Ee[d.renderMode],i.width+=g,i.chain.push({element:k.Item,item:d,width:g}),p===m.length-1&&u&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i},{chain:[],weight:0,width:0,hasCollapsed:!1}))}const fe=()=>({[o.ShortLabel]:0,[o.Collapsed]:0,[o.Ellipsis]:0,[o.Full]:0}),j=e=>e.getBoundingClientRect().width;function Ce(e){if(!e)return;const n=e.children,[u,t,...a]=Array.from(n);return{separator:j(u),collapse:j(t),items:a.reduce((s,c)=>{const i=c.getAttribute("data-id"),d=c.getAttribute("data-render-mode");return s[i]=s[i]||fe(),s[i][d]=j(c),s},{})}}const J=e=>{if(!e)return 0;if(re()){const n=document.createElement("div");n.style.width="10000px",e.append(n);const u=e.getBoundingClientRect().width;return e.removeChild(n),u}return 0},P=(e,n)=>n?`${e}-element-${n}`:"",Q=(e,n)=>{if(!n.length)return;let[u]=n;for(const t of n)t.width<=e?(u.width>e||u.weight>t.weight)&&(u=t):t.width<u.width&&(u=t);if(u)return{chain:u.chain,containerWidth:e,chainWidth:u.width}};function W(e){const[n,u]=h.useState(void 0),[t,a]=h.useState([]),s=h.useCallback(c=>Q(c,t),[t]);return h.useEffect(()=>{var i;const c=(i=e.current)==null?void 0:i.parentElement;c&&u(Q(J(c),t))},[t,e]),h.useEffect(()=>{var p;const c=(p=e.current)==null?void 0:p.parentElement;if(!c)return;const i=de(()=>{const m=J(c);u(r=>(r==null?void 0:r.containerWidth)===m?r:s(m)||r&&{...r,containerWidth:m})},100),d=new ResizeObserver(i);return d.observe(c),d.observe(document.body),()=>d.disconnect()},[e,s]),{setConfigs:a,currentConfig:n}}try{W.displayName="useBreadcrumbsLayout",W.__docgenInfo={description:`Расчет способа отображения breadcrumbs работает следующим образом:
