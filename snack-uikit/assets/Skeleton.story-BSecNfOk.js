import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{a as d,S as N}from"./Skeleton-Cf0sBfNU.js";import{T as O,P as _,S as E}from"./Typography-DmSN6cv6.js";import{T as m}from"./TruncateString-P8oWpQXG.js";import{S}from"./SkeletonText-DP-re6Ou.js";import{W as G}from"./WithSkeleton-BvFnKWIX.js";import"./index-ChsGqxH_.js";import"./index-DUmpqB7p.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-CJ_LmFaV.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-BF_Vu_8t.js";import"./PopoverPrivate-BRtB5jhm.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-JZGyZbA2.js";const T=`# Change Log
...
- Initial version
`,A="@snack-uikit/skeleton",F="0.6.5",f={name:A,version:F},L=`# Skeleton
...
`,j="_textContainer_1ausg_1",P="_storyCard_1ausg_12",H="_storyCard_header_1ausg_19",R="_storyCard_avatar_1ausg_26",I="_storyCard_title_1ausg_36",i={textContainer:j,storyCard:P,storyCard_header:H,storyCard_avatar:R,storyCard_title:I},ae={title:"Components/Skeleton",component:d},l={readme:{sidebar:[`Latest version: ${f.version}`,L,T]}},u=f.name;function w({...n}){return e.jsx(d,{...n,children:e.jsx("div",{"data-test-id":"children"})})}const a={render:w,args:{loading:!0},argTypes:{width:{type:"string"},height:{type:"string"},borderRadius:{type:"string"}},parameters:{...l,packageName:u,controls:{exclude:["className"]}}},D=Object.values(_).reduce((n,t)=>(Object.values(E).forEach(s=>{n.push([t,s].join("-"))}),n),[]),o={render:({text:n,typography:t,textOpacity:s,...c})=>e.jsx(O,{family:"sans",size:(t==null?void 0:t.split("-")[1])||"m",purpose:(t==null?void 0:t.split("-")[0])||"body",children:e.jsxs("div",{className:i.textContainer,style:{position:"relative"},children:[e.jsx("div",{style:{opacity:s/100},children:e.jsx(m,{text:n,maxLines:c.lines})}),e.jsx("div",{style:{position:"absolute",left:0,top:0},children:e.jsx(S,{...c,typography:t,children:e.jsx("div",{"data-test-id":"children",children:e.jsx(m,{text:n,maxLines:c.lines})})})})]})}),args:{text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis nesciunt consequuntur veniam libero aliquid perspiciatis earum quasi natus unde saepe provident, aliquam maiores dolor. Illum possimus modi saepe architecto voluptatibus!",textOpacity:50,typography:"body-m",lines:3,loading:!0},parameters:{...l,packageName:u,controls:{exclude:["width","height","className"]}},argTypes:{lines:{type:"number"},text:{name:"[Stories]: demo text",type:"string"},typography:{options:D,control:{type:"select"}},textOpacity:{name:"[Stories]: demo text opacity",control:{type:"range",min:0,max:100,step:1}}}};function W({children:n}){return e.jsx("div",{"data-test-id":"children",className:i.storyCard,children:e.jsxs("div",{className:i.storyCard_header,children:[e.jsx("div",{className:i.storyCard_avatar}),e.jsx("div",{className:i.storyCard_title,children:n})]})})}const r={render:({...n})=>{const t=e.jsx("div",{"data-test-id":n["data-test-id"],className:i.storyCard,children:e.jsxs("div",{className:i.storyCard_header,children:[e.jsx(d,{width:100,height:100,borderRadius:50}),e.jsx("div",{className:i.storyCard_title,children:e.jsx(S,{lines:3})})]})});return e.jsx(N,{loading:n.loading,children:["Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, laboriosam iure!","Lorem ipsum dolor sit, amet consectetur adipisicing elit. Commodi cupiditate qui amet.","Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, provident."].map(s=>e.jsx(G,{skeleton:t,children:e.jsx(W,{children:s})},s))})},args:{loading:!0},parameters:{...l,packageName:u,controls:{exclude:["width","height","borderRadius","className"]}}};var p,h,b;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: Template,
  args: {
    loading: true
  },
...
}`,...(b=(h=a.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var g,k,y;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: ({
    text,
    typography,
    textOpacity,
...
}`,...(y=(k=o.parameters)==null?void 0:k.docs)==null?void 0:y.source}}};var x,C,v;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: ({
    ...args
  }) => {
...
}`,...(v=(C=r.parameters)==null?void 0:C.docs)==null?void 0:v.source}}};export{ae as default,a as skeleton,o as skeletonText,r as withSkeleton};
