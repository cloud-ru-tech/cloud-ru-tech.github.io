import{j as a}from"./jsx-runtime-BTJTZTIL.js";import{r as i}from"./index-CJ_LmFaV.js";import{c as X}from"./index-CXM-PPQz.js";import{u as Q}from"./index-JZGyZbA2.js";import{d as Y}from"./index-D3kvmOHM.js";import{m as Z}from"./index-B7wZyJkK.js";import{u as nn}from"./useSwipeable-DMbEt_5P.js";import{C as en}from"./index-Ca89sW9R.js";import{e as K}from"./componentPropsProcessors-UJEZy8aQ.js";import{P as tn}from"./PaginationSlider-B1gi-f4V.js";import{t as an}from"./helpers-BognYlfV.js";import{P as un}from"./index-CTTgWa-s.js";import{C as S}from"./index-CGhEVF2_.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./getRange-CHNeUywO.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-Chjiymov.js";import"./index-DreyRvUE.js";import"./index-DHAmGKAZ.js";import"./ProgressBar-CNltTGkY.js";import"./index-Dn6vuaYJ.js";import"./index-CAfvFIBF.js";import"./index-DbF-M2Rm.js";import"./TruncateString-D87T9sdI.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-YPDKlKP_.js";import"./PopoverPrivate-Dbj5k6oN.js";import"./Link-ChxRw2xB.js";import"./LocaleProvider-DoPVyUfh.js";import"./Scroll-Dm8myf0Z.js";import"./Sun-BMXO82GS.js";import"./constants-BAH7I9kc.js";import"./Typography-B_4XbOMz.js";import"./ButtonFilled-3I0Fv0_B.js";import"./utils-Bd0G2N0B.js";import"./Counter-B1ZrBHB5.js";import"./ButtonTonal-BtUAW-dk.js";import"./PromoTag-Bg7ePu1o.js";import"./index-Y3TRpJ-L.js";import"./IconPredefined-BFl5DzK0.js";import"./index-B80hK4m0.js";import"./DropList-D8Oqj-Ov.js";import"./hooks-DYquVy_d.js";import"./useValueControl-CNLw7ht-.js";import"./Checkbox-CVD4Q-tk.js";import"./constants-BObEONKm.js";import"./TogglePrivate-aVh1Iudt.js";import"./index-w0WAZL2A.js";import"./Switch-DOcaPScE.js";import"./Dropdown-K9UII4sk.js";import"./index-C3mvkShn.js";import"./index-CXJdfWGn.js";import"./index-DyujHG43.js";import"./Divider-Damo9_Fl.js";import"./Spinner-kGs9Wy83.js";import"./ButtonFunction-DXSJzP7S.js";import"./useButtonNavigation-DVt-5Flo.js";import"./useClearButton-sF1AxKoI.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-DPuiSAz2.js";import"./Tag-BdY3Nip0.js";import"./constants-BaREPXw5.js";const cn=`# Change Log
...
- Initial version
`,sn="@snack-uikit/carousel",on="0.6.13",M={name:sn,version:on},rn=`# Carousel
...
`,y={arrowNext:"carousel__arrow-next",arrowPrev:"carousel__arrow-prev",pagination:"carousel__pagination",trackLine:"carousel__track-line",trackItem:"carousel__track-item"},dn="_control_1yam4_1",ln="_icon_1yam4_43",U={control:dn,icon:ln},P=i.forwardRef(({onClick:n,variant:e,className:o,...d},p)=>a.jsx("button",{ref:p,className:X(U.control,o),onClick:n,type:"button","data-variant":e,...K(d),children:a.jsx(en,{size:24,className:U.icon})}));try{P.displayName="Control",P.__docgenInfo={description:"",displayName:"Control",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"(() => void)"}},variant:{defaultValue:null,description:"",name:"variant",required:!0,type:{name:"enum",value:[{value:'"prev"'},{value:'"next"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const mn="_itemProvider_19mzj_1",pn="_itemContainer_19mzj_20",hn="_itemTracker_19mzj_25",gn="_hiddenItem_19mzj_32",H={itemProvider:mn,itemContainer:pn,itemTracker:hn,hiddenItem:gn};function j({items:n,showItems:e,scrollBy:o,slideCallback:d,transition:p,swipe:O,swipeActivateLength:E,page:h,gap:v}){const r=i.useRef(null),[c,D]=i.useState({itemWidth:0,gap:0}),g=i.useCallback(()=>{const t=r.current;if(!t)return;const u=getComputedStyle(t),m=Number.parseFloat(u.getPropertyValue("--gap")),L=Number.parseFloat(u.getPropertyValue("padding-left")),G=Number.parseFloat(u.getPropertyValue("padding-right")),_=(t.getBoundingClientRect().width-(Math.trunc(e)-1)*m-L-G)/e;D({itemWidth:_,gap:m})},[e]);i.useEffect(()=>{const t=r.current;if(!t)return;g();const u=new ResizeObserver(Y(g,100));return u.observe(t),()=>u.disconnect()},[g]);const N=i.useRef(null),I=()=>{var t;(t=N.current)==null||t.querySelectorAll(`[data-test-id=${y.trackItem}]`).forEach(u=>{u.setAttribute("aria-hidden","0"),u.querySelectorAll('a, button, select, input, textarea, [tabindex="0"]').forEach(m=>{m.setAttribute("tabindex","-5"),m.classList.add(H.hiddenItem)})})},x=(t,u,m)=>{var L;(L=N.current)==null||L.querySelectorAll(`[data-test-id=${y.trackItem}]`).forEach((G,_)=>{_>=u*t&&_<u*t+Math.trunc(m)&&(G.removeAttribute("aria-hidden"),G.querySelectorAll('a, button, select, input, textarea, [tabindex="-5"]').forEach(F=>{F.setAttribute("tabindex","0"),F.classList.remove(H.hiddenItem)}))})},A=i.useMemo(()=>Number(-(h*o*c.itemWidth+c.gap*h*o)),[c.gap,c.itemWidth,h,o]);i.useEffect(()=>{I(),x(o,h,e)},[h,o,e]);const k=i.useCallback(t=>{var F;if(e===1)return;const u=t.currentTarget.getBoundingClientRect(),m=(F=r.current)==null?void 0:F.getBoundingClientRect(),G=((m==null?void 0:m.right)??0)-u.right;Math.min(G,u.x)<0&&d(G)},[e,d]),b=i.useMemo(()=>c.itemWidth>0?c.itemWidth:`${Math.floor(100/e)}%`,[c.itemWidth,e]),[l,f]=i.useState({drag:0,pointers:!0}),C=t=>{f({drag:t.deltaX,pointers:Math.abs(t.deltaX)<Number.MIN_SAFE_INTEGER})},T=t=>{if(Math.abs(l.drag)<E)return f({drag:0,pointers:!0});d(t.dir==="Left"?-1:1),f({drag:0,pointers:!0})},{ref:s,...R}=nn({onSwiping:C,onSwiped:T,trackMouse:!0,enabled:O,availableDirections:["Left","Right"]});return a.jsx("div",{ref:r,className:H.itemProvider,"data-pointers":!l.pointers||void 0,"data-swipe":O||void 0,"data-gap":v,style:{...v?{"--gap":v}:{}},children:a.jsx("div",{...R,className:H.itemTracker,"data-test-id":y.trackLine,style:{transform:`translateX(${A+l.drag}px)`,transition:`transform ${p}s ease 0s`},ref:Z(s,N),children:n.map((t,u)=>a.jsx("div",{style:{width:b},className:H.itemContainer,role:"group","data-test-id":y.trackItem,onClick:k,children:t},u))})})}try{j.displayName="ItemProvider",j.__docgenInfo={description:"",displayName:"ItemProvider",props:{items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>[]"}},showItems:{defaultValue:null,description:"",name:"showItems",required:!0,type:{name:"number"}},scrollBy:{defaultValue:null,description:"",name:"scrollBy",required:!0,type:{name:"number"}},slideCallback:{defaultValue:null,description:"",name:"slideCallback",required:!0,type:{name:"(direction: number) => void"}},transition:{defaultValue:null,description:"",name:"transition",required:!0,type:{name:"number"}},swipe:{defaultValue:null,description:"",name:"swipe",required:!0,type:{name:"boolean"}},swipeActivateLength:{defaultValue:null,description:"",name:"swipeActivateLength",required:!0,type:{name:"number"}},page:{defaultValue:null,description:"",name:"page",required:!0,type:{name:"number"}},gap:{defaultValue:null,description:"",name:"gap",required:!1,type:{name:"string"}}}}}catch{}const kn="_carouselBase_17gga_1",bn="_control_17gga_9",fn="_carousel_17gga_1",Cn="_pagination_17gga_26",w={carouselBase:kn,control:bn,carousel:fn,pagination:Cn};function V({children:n,showItems:e=1,scrollBy:o,transition:d=.4,swipe:p=!0,arrows:O=!0,pagination:E=!0,className:h,gap:v,state:r,infiniteScroll:c=!1,swipeActivateLength:D=48,autoSwipe:g,controlsVisibility:N="hover",...I}){const x=i.useRef(),A=i.useMemo(()=>o??Math.trunc(e),[e,o]),[k,b]=Q(r==null?void 0:r.page,(r==null?void 0:r.page)??0,s=>{const R=typeof s=="function"?s(k):s;r==null||r.onChange(R)}),l=i.useMemo(()=>n.length<=e?1:1+Math.ceil((n.length-e)/A),[n.length,A,e]),f=i.useCallback(()=>{b(s=>c?(l+s-1)%l:Math.max(0,s-1))},[c,b,l]),C=i.useCallback(()=>{b(s=>c?(s+1)%l:Math.min(l-1,s+1))},[c,b,l]),T=i.useCallback(s=>{if(s<0){C();return}f()},[f,C]);return i.useEffect(()=>{if(!(!g||!c))return x.current=setTimeout(()=>C(),g*1e3),()=>clearTimeout(x.current)},[g,c,C]),a.jsxs("div",{className:X(w.carousel,h),"data-controls-visibility":N,...K(I),children:[a.jsxs("div",{className:w.carouselBase,children:[a.jsx(j,{showItems:e,scrollBy:A,swipe:p,transition:d,items:n,slideCallback:T,page:k,gap:v,swipeActivateLength:D}),O&&a.jsxs(a.Fragment,{children:[(c||k>0)&&a.jsx(P,{onClick:f,variant:"prev","data-test-id":y.arrowPrev,className:w.control}),(c||k+1<l)&&a.jsx(P,{onClick:C,variant:"next","data-test-id":y.arrowNext,className:w.control})]})]}),E&&a.jsx("div",{className:w.pagination,children:a.jsx(tn,{"data-test-id":y.pagination,page:k+1,onChange:s=>{b(s-1)},total:l})})]})}try{V.displayName="Carousel",V.__docgenInfo={description:"",displayName:"Carousel",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"CSS - класснейм",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"Массив айтемов",name:"children",required:!0,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>[]"}},showItems:{defaultValue:{value:"1"},description:"Кол-во отображаемых единовременно айтемов",name:"showItems",required:!1,type:{name:"number"}},scrollBy:{defaultValue:{value:"Math.trunc(show)"},description:"Сдвиг айтемов при смене 1 страницы",name:"scrollBy",required:!1,type:{name:"number"}},transition:{defaultValue:{value:"0.4"},description:"Время переключения 1 страницы (в s)",name:"transition",required:!1,type:{name:"number"}},swipe:{defaultValue:{value:"true"},description:"Переключение страниц свайпом",name:"swipe",required:!1,type:{name:"boolean"}},autoSwipe:{defaultValue:null,description:"Автоматическое переключение слайдов в секундах",name:"autoSwipe",required:!1,type:{name:"number"}},swipeActivateLength:{defaultValue:{value:"48"},description:"Минимальная длина в px для активации свайпа",name:"swipeActivateLength",required:!1,type:{name:"number"}},arrows:{defaultValue:{value:"true"},description:"Использовать стрелки для переключения страниц",name:"arrows",required:!1,type:{name:"boolean"}},pagination:{defaultValue:{value:"true"},description:"Использовать пагинацию для переключения страниц",name:"pagination",required:!1,type:{name:"boolean"}},gap:{defaultValue:{value:"var(--dimension-2m)"},description:"Расстояние между айтемами",name:"gap",required:!1,type:{name:"string"}},state:{defaultValue:null,description:"Управление состоянием извне",name:"state",required:!1,type:{name:"{ page: number; onChange(page: number): void; }"}},infiniteScroll:{defaultValue:{value:"false"},description:"Цикличная прокрутка",name:"infiniteScroll",required:!1,type:{name:"boolean"}},controlsVisibility:{defaultValue:{value:"hover"},description:"Управление видимостью стрелок: 'hover' — по ховеру, 'always' — всегда",name:"controlsVisibility",required:!1,type:{name:"enum",value:[{value:'"hover"'},{value:'"always"'}]}}}}}catch{}const Gn={HiddenPageCounter:"carousel__hidden-page-counter"},yn=""+new URL("ImageProdContentBackground-C3l1NiPg.jpg",import.meta.url).href,En=n=>{n.stopPropagation(),an.userAction.neutral({label:"Button clicked"})},On={button:{label:"Label text",onClick:En},volume:{currentValue:"999 999,00",oldValue:"1 000 000,00",dimension:"₽"}},vn={metadata:"Metadata truncate 1 line",description:"Description truncate 2 lines",body:"Body text written in several lines",icon:un};function q({title:n}){const{body:e,description:o,metadata:d,icon:p}=vn;return a.jsx(S,{image:a.jsx(S.Image,{mode:"background",alt:"alt",src:yn}),header:a.jsx(S.Header,{title:n,description:o,metadata:d,emblem:{icon:p}}),footer:a.jsx(S.Footer.Promo,{...On}),outline:!0,children:e})}try{q.displayName="StoryCard",q.__docgenInfo={description:"",displayName:"StoryCard",props:{title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}}}}}catch{}const Nn="_wrapper_1f41p_1",An="_hiddenPageCounter_1f41p_6",$={wrapper:Nn,hiddenPageCounter:An},Te={title:"Components/Carousel",component:V},Ln=({page:n,itemsCount:e,...o})=>{const[d,p]=i.useState(n?n-1:0);return i.useEffect(()=>{p(n?n-1:0)},[n]),a.jsxs("div",{className:$.wrapper,children:[a.jsx(V,{...o,state:{page:d,onChange:p},children:Array.from({length:e||12}).map((O,E)=>a.jsx(q,{title:`Item ${E+1}`},E))}),a.jsx("span",{"data-test-id":Gn.HiddenPageCounter,className:$.hiddenPageCounter,children:d+1})]})},B={render:Ln,args:{showItems:2.5,scrollBy:2,transition:.4,swipe:!0,arrows:!0,pagination:!0,infiniteScroll:!0,autoSwipe:5,itemsCount:12,page:1,controlsVisibility:"hover"},argTypes:{page:{name:"[Story]: pagination page as controlled state"},itemsCount:{name:"[Story]: count demo cards"}},parameters:{readme:{sidebar:[`Latest version: ${M.version}`,rn,cn]},packageName:M.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=44%3A7537&mode=design"}}};var J,W,z;B.parameters={...B.parameters,docs:{...(J=B.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: Template,
  args: {
    showItems: 2.5,
    scrollBy: 2,
...
}`,...(z=(W=B.parameters)==null?void 0:W.docs)==null?void 0:z.source}}};export{B as carousel,Te as default};
