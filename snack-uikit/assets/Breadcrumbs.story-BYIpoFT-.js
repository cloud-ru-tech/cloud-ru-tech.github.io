import{j as c}from"./jsx-runtime-BTJTZTIL.js";import{a as le}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import{r as h}from"./index-CJ_LmFaV.js";import{d as oe}from"./index-D3kvmOHM.js";import{i as de}from"./isBrowser-C2N6XvuH.js";import{c as ue}from"./index-CXM-PPQz.js";import{e as se}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as re}from"./Typography-B_4XbOMz.js";import{D as he}from"./DropList-D8Oqj-Ov.js";import{H as pe}from"./index-B_69vUNX.js";import"./index-ChsGqxH_.js";import"./v4-CtRu48qb.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-B7wZyJkK.js";import"./hooks-DYquVy_d.js";import"./useValueControl-CNLw7ht-.js";import"./index-JZGyZbA2.js";import"./Checkbox-CVD4Q-tk.js";import"./constants-BObEONKm.js";import"./TogglePrivate-aVh1Iudt.js";import"./index-w0WAZL2A.js";import"./index-Y3TRpJ-L.js";import"./TruncateString-D87T9sdI.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./Tooltip-YPDKlKP_.js";import"./PopoverPrivate-Dbj5k6oN.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./Switch-DOcaPScE.js";import"./index-DHAmGKAZ.js";import"./index-DreyRvUE.js";import"./Dropdown-K9UII4sk.js";import"./index-C3mvkShn.js";import"./index-CXJdfWGn.js";import"./LocaleProvider-DoPVyUfh.js";import"./index-DyujHG43.js";import"./IconPredefined-BFl5DzK0.js";import"./ButtonTonal-BtUAW-dk.js";import"./utils-Bd0G2N0B.js";import"./Counter-B1ZrBHB5.js";import"./Sun-BMXO82GS.js";import"./constants-BAH7I9kc.js";import"./ButtonFilled-3I0Fv0_B.js";import"./Divider-Damo9_Fl.js";import"./Scroll-Dm8myf0Z.js";import"./Spinner-kGs9Wy83.js";import"./ButtonFunction-DXSJzP7S.js";import"./useButtonNavigation-DVt-5Flo.js";import"./useClearButton-sF1AxKoI.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-DPuiSAz2.js";const me=`# Change Log
...
- Initial version
`,be="@snack-uikit/breadcrumbs",ke="0.11.41",K={name:be,version:ke},ge=`# Breadcrumbs
...
\`\`\`
Компоненты Breadcrumbs мемоизирован, старайтесь передавать \`items\` одной и той же ссылкой.`,ae="›",o={Full:"full",ShortLabel:"shortLabel",Ellipsis:"ellipsis",Collapsed:"collapsed"},k={Separator:"separator",Collapse:"collapse",Item:"item"},E={Xs:"xs",S:"s"},ye={[o.Full]:0,[o.ShortLabel]:1,[o.Ellipsis]:100,[o.Collapsed]:1e4},Oe=[o.Full,o.ShortLabel,o.Ellipsis],D=e=>(n,u)=>[{...n,renderMode:e},...u],T=D(o.Full),j=D(o.ShortLabel),P=D(o.Ellipsis),V=D(o.Collapsed);function F([e,...n],{useCollapse:u=!0,useEllipse:t=!0}){const s=[];return e?n.length?(F(n,{useCollapse:!1,useEllipse:!1}).forEach(a=>{s.push(T(e,a)),e.shortLabel&&s.push(j(e,a))}),t&&F(n,{useCollapse:!1,useEllipse:!0}).forEach(a=>{s.push(P(e,a))}),u&&F(n,{useCollapse:!0,useEllipse:!1}).forEach(a=>{s.push(V(e,a))}),s):(s.push(T(e,[])),e.shortLabel&&s.push(j(e,[])),s):s}const A=(e,n)=>n.map((u,t,s)=>{const a=t===s.length-1;return{...u,renderMode:a?e:o.Collapsed}});function Ge(e,n,u){if(!e.length)return[];const t=[],[s,...a]=e.map(l=>({...l,renderMode:o.Full}));return F(a,{useCollapse:!0,useEllipse:!0}).forEach(l=>{t.push(T(s,l)),s.shortLabel&&t.push(j(s,l))}),t.push(P(s,A(o.Full,a))),t.push(P(s,A(o.Ellipsis,a))),t.push(V(s,A(o.Full,a))),t.push(V(s,A(o.Ellipsis,a))),t.map(l=>l.reduce((i,d,r,b)=>{const{renderMode:p}=d;r&&Oe.includes(p)&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),!i.hasCollapsed&&p===o.Collapsed&&(r&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i.hasCollapsed=!0,i.width+=n.collapse,i.chain.push({element:k.Collapse,width:n.collapse}));const g=n.items[d.id][p];return i.weight+=ye[d.renderMode],i.width+=g,i.chain.push({element:k.Item,item:d,width:g}),r===b.length-1&&u&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i},{chain:[],weight:0,width:0,hasCollapsed:!1}))}const Ce=()=>({[o.ShortLabel]:0,[o.Collapsed]:0,[o.Ellipsis]:0,[o.Full]:0}),R=e=>e.getBoundingClientRect().width;function Ee(e){if(!e)return;const n=e.children,[u,t,...s]=Array.from(n);return{separator:R(u),collapse:R(t),items:s.reduce((a,l)=>{const i=l.getAttribute("data-id"),d=l.getAttribute("data-render-mode");return a[i]=a[i]||Ce(),a[i][d]=R(l),a},{})}}const Q=e=>{if(!e)return 0;if(de()){const n=document.createElement("div");n.style.width="10000px",e.append(n);const u=e.getBoundingClientRect().width;return e.removeChild(n),u}return 0},M=(e,n)=>n?`${e}-element-${n}`:"",fe=(e,n)=>{if(!n.length)return;let[u]=n;for(const t of n)t.width<=e?(u.width>e||u.weight>t.weight)&&(u=t):t.width<u.width&&(u=t);if(u)return{chain:u.chain,containerWidth:e,chainWidth:u.width}};function U(e){const[n,u]=h.useState([]),[t,s]=h.useState(0);h.useEffect(()=>{var r;const l=(r=e.current)==null?void 0:r.parentElement;if(!l)return;s(Q(l));const i=oe(()=>{s(Q(l))},100),d=new ResizeObserver(i);return d.observe(l),d.observe(document.body),()=>d.disconnect()},[e]);const a=h.useMemo(()=>fe(t,n),[t,n]);return{setConfigs:u,currentConfig:a}}try{U.displayName="useBreadcrumbsLayout",U.__docgenInfo={description:`Расчет способа отображения breadcrumbs работает следующим образом:
Каждый item может быть отображен в одном из режимов:
 ...
 Для того чтоб отобразить breadcrumbs, нужно подобрать конфиг, максимальный по ширине, влезающий в контейнер, но с минимальным весом (наименьшим количеством сокращений).`,displayName:"useBreadcrumbsLayout",props:{}}}catch{}const f=h.createContext({hidden:!1,size:E.S,separator:ae});function v({size:e,children:n,className:u}){return c.jsx(re,{className:u,size:e===E.S?"m":"s",tag:"div",family:"sans",purpose:"body",children:n})}try{v.displayName="CrumbsTypography",v.__docgenInfo={description:"",displayName:"CrumbsTypography",props:{size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const ve="_collapse_28pvy_1",Le="_a_28pvy_20",Z={collapse:ve,a:Le};function _({currentConfig:e,className:n}){const u=h.useContext(f),{hidden:t,size:s,testId:a}=u,l=h.useRef(null),i=e.filter(d=>d.element===k.Item&&d.item.renderMode===o.Collapsed).map(d=>({content:{option:d.item.label},...d.item.href?{itemWrapRender:r=>c.jsx("a",{href:d.item.href,onClick:d.item.onClick,className:Z.a,children:r})}:{onClick:d.item.onClick}}));return c.jsx("div",{className:n,"data-test-id":M("collapse",a),"data-element-type":k.Collapse,children:c.jsx(f.Provider,{value:{...u,testId:`${a}-collapsed`},children:c.jsx(he,{trigger:"hoverAndFocusVisible",size:"s",scroll:!0,triggerElemRef:l,items:i,children:c.jsx("button",{type:"button",ref:l,className:Z.collapse,tabIndex:t?-1:0,children:c.jsx(v,{size:s,children:"..."})})})})})}try{_.displayName="Collapse",_.__docgenInfo={description:"",displayName:"Collapse",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},currentConfig:{defaultValue:null,description:"",name:"currentConfig",required:!0,type:{name:"BreadcrumbsConfigChain"}}}}}catch{}const Ne="_wrapper_1sszs_1",Ae="_crumb_1sszs_9",He="_label_1sszs_43",Fe="_icon_1sszs_49",G={wrapper:Ne,crumb:Ae,label:He,icon:Fe},_e=8,B=h.memo(function({minWidth:n=0,current:u=!1,renderMode:t,className:s,item:{label:a,shortLabel:l,icon:i,id:d,onClick:r,href:b},useIconOnly:p,...g}){const{hidden:m,size:y,testId:w}=h.useContext(f),O=m&&a.length>_e&&t===o.Ellipsis?`${a.substring(0,4)}...`:a,C=!!(i&&p),ce=n&&t===o.Ellipsis?n:"auto",L={"data-render-mode":t,"data-current":u,"data-hidden":m,"data-size":y,"data-id":d},S=c.jsxs(c.Fragment,{children:[i&&c.jsx("div",{className:G.icon,children:c.jsx(i,{size:16})}),!C&&c.jsx(v,{size:y,className:G.label,children:t===o.ShortLabel?l:O})]}),W=m?{tabIndex:-1}:{},J=t===o.Ellipsis?O:"";let N=null;return b?N=c.jsx("a",{className:G.crumb,onClick:r,href:b,"aria-label":C?O:void 0,"data-clickable":!0,...L,...W,children:S}):r?N=c.jsx("button",{type:"button",title:J,onClick:r,className:G.crumb,"aria-label":C?O:void 0,"data-clickable":!0,...L,...W,children:S}):N=c.jsx("div",{className:G.crumb,...L,children:S}),c.jsx("li",{...se(g),...L,"data-test-id":M("crumb",w),className:ue(G.wrapper,s),"data-element-type":k.Item,style:{minWidth:ce},title:J,children:N})});try{B.displayName="Crumb",B.__docgenInfo={description:"",displayName:"Crumb",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},renderMode:{defaultValue:null,description:"",name:"renderMode",required:!0,type:{name:"enum",value:[{value:'"full"'},{value:'"collapsed"'},{value:'"shortLabel"'},{value:'"ellipsis"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},minWidth:{defaultValue:null,description:"",name:"minWidth",required:!1,type:{name:"number"}},current:{defaultValue:null,description:"",name:"current",required:!1,type:{name:"boolean"}},item:{defaultValue:null,description:"",name:"item",required:!0,type:{name:"Item"}},useIconOnly:{defaultValue:null,description:"",name:"useIconOnly",required:!1,type:{name:"boolean"}}}}}catch{}const Be="_separator_sbabc_1",Ie={separator:Be};function ie(){const{size:e,separator:n,testId:u}=h.useContext(f);return c.jsx("div",{"aria-hidden":!0,"data-size":e,className:Ie.separator,"data-test-id":M("separator",u),"data-element-type":k.Separator,children:c.jsx(v,{size:e,children:n})})}const xe="_wrapper_1v8x9_1",De="_row_1v8x9_12",Y={wrapper:xe,row:De},I=h.forwardRef(function({children:n,className:u,size:t,hidden:s,separator:a,"data-test-id":l,...i},d){return c.jsx("nav",{...se(i),className:ue(Y.wrapper,u),"data-test-id":l,"data-hidden":s,"aria-hidden":s,children:c.jsx(f.Provider,{value:{hidden:s,size:t,separator:a,testId:l},children:c.jsx("ul",{className:Y.row,ref:d,"data-hidden":s,"data-size":t,children:n})})})});try{I.displayName="Wrapper",I.__docgenInfo={description:"",displayName:"Wrapper",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},hidden:{defaultValue:null,description:"",name:"hidden",required:!0,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},separator:{defaultValue:null,description:"",name:"separator",required:!0,type:{name:"string"}}}}}catch{}const we=[[o.ShortLabel,"shortLabel"],[o.Ellipsis,"label"],[o.Full,"label"]],Se=[[o.Full,"label"]],Re=e=>(n,u)=>{const t=!u&&e;return(t?Se:we).map(([a,l])=>!n[l]&&a!==o.Full?null:c.jsx(B,{useIconOnly:t,renderMode:a,item:n},n.id+a))},q=({firstItemIconOnly:e})=>h.useMemo(()=>Re(e),[e]);try{q.displayName="useItemModesRender",q.__docgenInfo={description:"",displayName:"useItemModesRender",props:{firstItemIconOnly:{defaultValue:null,description:"",name:"firstItemIconOnly",required:!0,type:{name:"boolean"}}}}}catch{}const z=h.memo(function({size:n,separator:u,items:t,onConfigsBuilt:s,firstItemIconOnly:a=!1,lastEmpty:l=!1}){const i=h.useRef(null),d=h.useRef(t);d.current=t,h.useEffect(()=>{const b=i.current;if(b){const p=new ResizeObserver(([{target:g}])=>{const m=Ee(g);m&&s(Ge(d.current,m,l))});return p.observe(b),()=>{p.disconnect()}}},[t,l,s]);const r=q({firstItemIconOnly:a});return c.jsxs(I,{size:n,hidden:!0,ref:i,separator:u,"data-test-id":"hidden-wrapper",children:[c.jsx(ie,{}),c.jsx(_,{currentConfig:[]}),t.map(r)]})});try{z.displayName="HiddenChain",z.__docgenInfo={description:"",displayName:"HiddenChain",props:{separator:{defaultValue:null,description:"",name:"separator",required:!0,type:{name:"string"}},items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"Item[]"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},onConfigsBuilt:{defaultValue:null,description:"",name:"onConfigsBuilt",required:!0,type:{name:"(config: BreadcrumbsConfig[]) => void"}},firstItemIconOnly:{defaultValue:null,description:"",name:"firstItemIconOnly",required:!1,type:{name:"boolean"}},lastEmpty:{defaultValue:null,description:"",name:"lastEmpty",required:!1,type:{name:"boolean"}}}}}catch{}const x=h.memo(function({items:n,size:u=E.S,separator:t=ae,className:s,firstItemIconOnly:a=!1,inactiveLastItem:l=!1,lastEmpty:i=!1,...d}){const r=h.useRef(null),{setConfigs:b,currentConfig:p}=U(r),g=h.useMemo(()=>l?n.map((m,y)=>y===n.length-1?{...m,onClick:void 0,href:void 0}:m):n,[l,n]);return c.jsxs(c.Fragment,{children:[c.jsx(z,{items:g,size:u,separator:t,onConfigsBuilt:b,firstItemIconOnly:a,lastEmpty:i}),c.jsx(I,{...d,ref:r,hidden:!1,size:u,separator:t,className:s,children:p==null?void 0:p.chain.map((m,y,w)=>{const $=y===w.length-1;switch(m.element){case k.Separator:return c.jsx(ie,{},y);case k.Collapse:return c.jsx(_,{currentConfig:p.chain},y);case k.Item:{const{renderMode:O,id:C}=m.item;if(O!==o.Collapsed)return c.jsx(B,{useIconOnly:!y&&a,current:$,renderMode:O,minWidth:m.width,item:m.item},C);break}default:return null}})})]})});try{x.displayName="Breadcrumbs",x.__docgenInfo={description:"Компонент хлебных крошек",displayName:"Breadcrumbs",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},items:{defaultValue:null,description:"Массив айтемов",name:"items",required:!0,type:{name:"Item[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},separator:{defaultValue:{value:'"›"'},description:"Разделитель",name:"separator",required:!1,type:{name:"string"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},firstItemIconOnly:{defaultValue:{value:"false"},description:"Использовать иконку без лейбла в первом айтеме",name:"firstItemIconOnly",required:!1,type:{name:"boolean"}},inactiveLastItem:{defaultValue:{value:"false"},description:"Делает некликабельным последний элемент, даже если для него переданы `href` или `onClick`",name:"inactiveLastItem",required:!1,type:{name:"boolean"}},lastEmpty:{defaultValue:null,description:"",name:"lastEmpty",required:!1,type:{name:"boolean"}}}}}catch{}const Te="_container_15w2x_1",je="_crumbClickHolder_15w2x_13",X={container:Te,crumbClickHolder:je},jn={title:"Components/Breadcrumbs",component:x},Pe=({storyIcon:e,storyBreadcrumbs:n,storyUrl:u,storyOnClick:t,storyContainerWidth:s,...a})=>{const l=le("onClick"),[i,d]=h.useState(""),r=n.map((b,p)=>({...b,id:`id${p}`,href:u?`https://yandex.ru/search?text=${encodeURIComponent(b.label)}`:void 0,onClick:t?(...g)=>{d(b.label),l(...g)}:void 0}));return e&&(r[0].icon=pe),c.jsxs("div",{children:[c.jsx("div",{className:X.container,style:{width:s},children:c.jsx(x,{...a,items:r})}),c.jsx("div",{className:X.crumbClickHolder,"data-test-id":"last-clicked-crumb",children:i})]})},H={render:Pe,args:{storyBreadcrumbs:[{label:"Литература"},{label:"Стихи"},{label:"Золотой век русской поэзии",shortLabel:"Золотой век"},{label:"Михаил Лермонтов",shortLabel:"Лермонтов"},{label:'Тема "Одиночество"',shortLabel:"Одиночество"},{label:"Парус"}],storyUrl:!1,storyIcon:!1,storyOnClick:!1,lastEmpty:!1,storyContainerWidth:"100%",size:E.S},argTypes:{items:{table:{disable:!0}},storyBreadcrumbs:{name:"[story] Items"},storyUrl:{name:"[story] url",description:"Передать урлы для айтемов"},storyOnClick:{name:"[story] onClick",description:"Передать обработчики кликов для айтемов"},storyIcon:{name:"[story] icon",description:"Передать иконку в первый айтем"},storyContainerWidth:{name:"[story] container width"},size:{options:Object.values(E),control:{type:"radio"}}},parameters:{readme:{sidebar:[`Latest version: ${K.version}`,ge,me]},packageName:K.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A30976&mode=design"}}};var ee,ne,te;H.parameters={...H.parameters,docs:{...(ee=H.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: Template,
  args: {
    storyBreadcrumbs: [{
      label: 'Литература'
...
}`,...(te=(ne=H.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};export{H as breadcrumbs,jn as default};
