import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as H}from"./index-CXM-PPQz.js";import{r}from"./index-CJ_LmFaV.js";import{C as Q}from"./index-DHAmGKAZ.js";import{C as W}from"./index-Y3TRpJ-L.js";import{T as N}from"./Typography-B_4XbOMz.js";import{S as X}from"./Sun-BMXO82GS.js";import{T}from"./TruncateString-C1JUVyIC.js";import{e as V}from"./componentPropsProcessors-UJEZy8aQ.js";import{B as y}from"./ButtonOutline-fV8NNWQG.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./constants-BAH7I9kc.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-CwDzTnvM.js";import"./PopoverPrivate-B3hkMTjr.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";import"./utils-BUH8iG2Y.js";import"./Counter-B1ZrBHB5.js";const Y=`# Change Log
...
- Initial version
`,Z="@snack-uikit/stepper",tt="0.8.43",I={name:Z,version:tt},nt="# Stepper\n\n## Installation\n`npm i @snack-uikit/stepper`\n\n[Changelog](./CHANGELOG.md)\n\n## Description\n\n- Пакет `@snack-uikit/stepper` предоставляет компонент `Stepper` для отображения состояния пошагового процесса и управления навигацией между шагами.\n- Компонент использует паттерн render prop: принимает функцию-колбек в пропе `children`, которая получает JSX-элемент степпера, методы управления навигацией (`goNext`, `goPrev`) и состояние процесса (`isCompleted`, `currentStepIndex`, `stepCount`).\n- Поддерживает валидацию шагов через асинхронную функцию-валидатор (`validator`), которая вызывается при переходе на следующий шаг и должна вернуть `Promise<boolean>`: при успешной валидации происходит переход, при ошибке шаг остаётся в состоянии отклонения (`rejected`).\n- Каждый шаг может находиться в одном из состояний: `completed` (завершён), `current` (текущий), `loading` (идёт валидация), `waiting` (ожидает выполнения) или `rejected` (отклонён).\n- Позволяет навигироваться между шагами программно через методы API или кликом по шагам: можно перейти на следующий шаг, вернуться на предыдущий, а также кликнуть на завершённый шаг для возврата к нему.\n- Поддерживает отслеживание завершённости всего процесса, сброс состояния валидации для текущего шага и динамическое переопределение валидатора через `setValidator`.\n- Каждый шаг может содержать заголовок (`title`) и описание (`description`), которые отображаются в визуальном представлении степпера.\n- Figma: [`Stepper`](https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A33355&mode=design).\n\n## Example\n\n```tsx\nimport { Stepper } from '@snack-uikit/stepper';\n\nfunction Example() {\n  const steps = [\n    { title: 'First step', description: 'First step long description two lines truncated' },\n    { title: 'Second step', description: 'Second step long description two lines truncated' },\n    { title: 'Third step', description: 'Third step long description two lines truncated' },\n    { title: 'Fourth step', description: 'Fourth step long description two lines truncated' },\n  ];\n\n  const validator = (currentStepIndex: number, newStepIndex: number) => {\n    // Асинхронная валидация текущего шага\n    return new Promise<boolean>(resolve => {\n      setTimeout(() => {\n        resolve(true); // или false при ошибке валидации\n      }, 1000);\n    });\n  };\n\n  return (\n    <Stepper steps={steps} validator={validator}>\n      {({ stepper, isCompleted, goNext, goPrev, resetValidation, currentStepIndex }) => (\n        <>\n          {stepper}\n          <div>\n            <button onClick={() => goPrev()}>Назад</button>\n            <button onClick={() => goNext()}>Далее</button>\n            <button onClick={resetValidation}>Сбросить валидацию</button>\n          </div>\n          <div>Текущий шаг: {currentStepIndex + 1}</div>\n          <div>Процесс завершён: {isCompleted ? 'да' : 'нет'}</div>\n        </>\n      )}\n    </Stepper>\n  );\n}\n```\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## Stepper\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| children* | `({stepper, ...api}) => ReactElement` | - | Render function. Принимает аргументы: `stepper` - JSX-элемент степпера, `goNext(stepIndex?: number)` - перейти на след. шаг, `goPrev(stepIndex?: number)` - перейти на пред. шаг, `resetValidation` - сбросить состояние валидации для текущего шага, `setValidator` переопределяет функцию-валидатор, которая принимает в параметры индекс текущего шага и индекс нового, `isCompleted` - окончен ли процесс, `currentStepIndex` - индекс текущего шага, `stepCount` - кол-во шагов. |\n| steps* | `StepData[]` | - | Массив шагов |\n| defaultCurrentStepIndex | `number` | - | Индекс текущего шага по-дефолту |\n| validator | `StepsValidator` | - | Валидатор шагов. Выполняется при смене шага. Принимает первым аргументом индекс текущего, вторым - индекс нового шага. |\n| className | `string` | - | CSS-класс |\n| onChangeCurrentStep | `(newValue: number, prevValue: number) => void` | - | Колбек смены текущего степа |\n| onCompleteChange | `(isCompleted: boolean) => void` | - | Колбек изменения завершенности |\n\n\n[//]: DOCUMENTATION_SECTION_END\n",s={Completed:"completed",Current:"current",Loading:"loading",Waiting:"waiting",Rejected:"rejected"},w=n=>e=>n&&e?`${e}${n}`:void 0,et="_icon_1dzeq_1",ct={icon:et};function at(n,e){switch(n){case s.Completed:return t.jsx(W,{});case s.Rejected:return t.jsx(Q,{});case s.Loading:return t.jsx(X,{size:"s"});default:return e}}function A({state:n,number:e,className:d}){const u=r.useMemo(()=>at(n,e),[e,n]);return t.jsx("div",{"data-state":n,className:H(ct.icon,d),children:typeof u=="number"?t.jsx(N.SansLabelL,{children:u}):u})}try{A.displayName="Icon",A.__docgenInfo={description:"",displayName:"Icon",props:{state:{defaultValue:null,description:"",name:"state",required:!0,type:{name:"enum",value:[{value:'"loading"'},{value:'"current"'},{value:'"completed"'},{value:'"waiting"'},{value:'"rejected"'}]}},number:{defaultValue:null,description:"",name:"number",required:!0,type:{name:"number"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const st="_tailLine_1c26u_1",it="_tail_1c26u_1",ut="_title_1c26u_19",rt="_description_1c26u_24",ot="_step_1c26u_29",dt="_track_1c26u_40",kt="_statusContainer_1c26u_46",lt="_content_1c26u_75",pt="_icon_1c26u_81",l={tailLine:st,tail:it,title:ut,description:rt,step:ot,track:dt,statusContainer:kt,content:lt,icon:pt},ht=w("_element-tail"),mt=w("_element-step");function L({step:n,className:e,"data-test-id":d,hideTailLine:u,...o}){return t.jsxs("div",{className:H(l.step,e),"data-state":n.state,...V(o),children:[t.jsxs("div",{className:l.track,children:[t.jsx("button",{type:"button",className:l.statusContainer,onClick:n.onClick,disabled:!n.onClick,"data-test-id":mt(d),"data-state":n.state,children:t.jsx(A,{...n,className:l.icon})}),!u&&t.jsx("div",{className:l.tail,"data-completed":n.state===s.Completed||void 0,"data-test-id":ht(d),children:t.jsx("div",{className:l.tailLine})})]}),t.jsxs("div",{className:l.content,children:[t.jsx(N.SansBodyM,{className:l.title,tag:"div",children:t.jsx(T,{text:n.title})}),n.description&&t.jsx(N.SansBodyS,{className:l.description,tag:"div",children:t.jsx(T,{text:n.description,maxLines:2})})]})]})}try{L.displayName="Step",L.__docgenInfo={description:"",displayName:"Step",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},hideTailLine:{defaultValue:null,description:"",name:"hideTailLine",required:!1,type:{name:"boolean"}},step:{defaultValue:null,description:"",name:"step",required:!0,type:{name:"StepViewData"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const P=r.createContext({stepper:t.jsx(t.Fragment,{}),stepCount:0,isCompleted:!1,currentStepIndex:0,goNext(){},goPrev(){},resetValidation(){},setValidator(){}}),gt=()=>r.useContext(P),bt="_stepper_y1r4g_1",Gt={stepper:bt},Ot=async()=>!0;function C({children:n,steps:e,className:d,onChangeCurrentStep:u,onCompleteChange:o,defaultCurrentStepIndex:v=0,validator:f=Ot,...F}){const _=v===e.length-1,[g,p]=r.useState(_?s.Completed:s.Current),[a,U]=r.useState(v),[k,S]=r.useState(_),[h,q]=r.useState();r.useEffect(()=>{o==null||o(k)},[k,o]);const b=r.useCallback(c=>{U(i=>(i!==c&&(u==null||u(c,i)),c))},[u]),E=r.useCallback((c=a+1)=>{if(a>=e.length||k||c<=a)return;const i=Math.min(e.length-1,c);p(s.Loading),((h==null?void 0:h.value)||f)(a,i).catch(()=>!1).then(z=>{if(!z){p(s.Rejected);return}a===e.length-1?(p(s.Completed),S(!0)):(b(i),p(s.Current))})},[a,k,b,e.length,h==null?void 0:h.value,f]),G=r.useCallback((c=a-1)=>{a===0||c<0||c>a||c===a&&!k||(k&&S(!1),b(c),p(s.Current))},[a,k,b]),$=r.useMemo(()=>e.map((c,i)=>{const m=i+1;return i<a?{...c,number:m,state:s.Completed,onClick:()=>G(i)}:i===a?{...c,number:m,state:g,onClick:k?()=>G(i):void 0}:i-1===a?{...c,number:m,state:s.Waiting,onClick:()=>E()}:{...c,number:m,state:s.Waiting}}),[e,a,G,g,k,E]),J=r.useCallback(()=>{g===s.Rejected&&p(s.Current)},[g]),M=r.useCallback(c=>{q({value:c})},[]),K=t.jsx("div",{className:H(Gt.stepper,d),...V(F),children:$.map((c,i)=>t.jsx(L,{step:c,"data-test-id":F["data-test-id"],hideTailLine:i===e.length-1},c.title+i))}),x={goNext:E,goPrev:G,currentStepIndex:a,isCompleted:k,resetValidation:J,stepCount:e.length,stepper:K,setValidator:M};return t.jsx(P.Provider,{value:x,children:n(x)})}try{C.displayName="Stepper",C.__docgenInfo={description:"",displayName:"Stepper",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},steps:{defaultValue:null,description:"Массив шагов",name:"steps",required:!0,type:{name:"StepData[]"}},defaultCurrentStepIndex:{defaultValue:{value:"0"},description:"Индекс текущего шага по-дефолту",name:"defaultCurrentStepIndex",required:!1,type:{name:"number"}},validator:{defaultValue:null,description:"Валидатор шагов. Выполняется при смене шага. Принимает первым аргументом индекс текущего, вторым - индекс нового шага.",name:"validator",required:!1,type:{name:"StepsValidator"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"Render function. Принимает аргументы: `stepper` - JSX-элемент степпера,\n`goNext(stepIndex?: number)` - перейти на след. шаг, `goPrev(stepIndex?: number)` - перейти на пред. шаг, `resetValidation` - сбросить состояние валидации для текущего шага, `setValidator` переопределяет функцию-валидатор, которая принимает в параметры индекс текущего шага и индекс нового, `isCompleted` - окончен ли процесс, `currentStepIndex` - индекс текущего шага, `stepCount` - кол-во шагов.",name:"children",required:!0,type:{name:"({stepper, ...api}) => ReactElement"}},onChangeCurrentStep:{defaultValue:null,description:"Колбек смены текущего степа",name:"onChangeCurrentStep",required:!1,type:{name:"((newValue: number, prevValue: number) => void)"}},onCompleteChange:{defaultValue:null,description:"Колбек изменения завершенности",name:"onCompleteChange",required:!1,type:{name:"((isCompleted: boolean) => void)"}}}}}catch{}const Ct="_story_142nc_1",Et="_panel_142nc_9",R={story:Ct,panel:Et},Mt={title:"Components/Stepper",component:C};function yt(){const{goPrev:n,goNext:e,isCompleted:d,currentStepIndex:u,resetValidation:o}=gt();return t.jsxs(t.Fragment,{children:[t.jsxs("div",{children:[t.jsxs("div",{"data-test-id":"is-completed",children:["isCompleted: ",d?"yes":"no"]}),t.jsxs("div",{"data-test-id":"current-index",children:["current step index: ",u]})]}),t.jsxs("div",{className:R.panel,children:[t.jsx(y,{"data-test-id":"prev",size:"s",label:"go prev",onClick:()=>n()}),t.jsx(y,{"data-test-id":"reset-validation",size:"s",label:"reset validation",onClick:o}),t.jsx(y,{"data-test-id":"next",size:"s",label:"go next",onClick:()=>e()})]})]})}const Nt=({validationTimeout:n,isValid:e,...d})=>{const u=()=>new Promise(o=>setTimeout(()=>o(e),n));return t.jsx(C,{...d,validator:u,children:({stepper:o})=>t.jsxs(t.Fragment,{children:[t.jsx("div",{className:R.story,children:o}),t.jsx(yt,{})]})})},O={render:Nt,args:{steps:[{title:"First step",description:"First step long description two lines truncated"},{title:"Second step",description:"Second step long description two lines truncated"},{title:"Third step",description:"Third step long description two lines truncated"},{title:"Fourth step",description:"Fourth step long description two lines truncated"},{title:"Fifth step",description:"Fifth step long description two lines truncated"}],isValid:!0,validationTimeout:1e3},argTypes:{isValid:{name:"[stories] is current step valid",control:{type:"boolean"}},validationTimeout:{name:"[stories] validation timeout",control:{min:0,type:"number"}}},parameters:{readme:{sidebar:[`Latest version: ${I.version}`,nt,Y]},packageName:I.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A33355&mode=design"}}};var j,D,B;O.parameters={...O.parameters,docs:{...(j=O.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: Template,
  args: {
    steps: [{
      title: 'First step',
...
}`,...(B=(D=O.parameters)==null?void 0:D.docs)==null?void 0:B.source}}};export{Mt as default,O as stepper};
