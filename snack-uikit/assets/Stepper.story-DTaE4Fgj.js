import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as F}from"./index-CXM-PPQz.js";import{r as u}from"./index-CJ_LmFaV.js";import{C as Z}from"./index-DHAmGKAZ.js";import{C as tt}from"./index-Y3TRpJ-L.js";import{T as H}from"./Typography-B-8nXnBH.js";import{S as nt}from"./Sun-BMXO82GS.js";import{T as D}from"./TruncateString-BO9DNutf.js";import{e as $}from"./componentPropsProcessors-UJEZy8aQ.js";import{B as L}from"./ButtonOutline-brZN20Dc.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./constants-BAH7I9kc.js";import"./lodash-DyrGR4_s.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-YPDKlKP_.js";import"./PopoverPrivate-Dbj5k6oN.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";import"./utils-C17C2Jkd.js";import"./Counter-BqPtvVBi.js";const et=`# Change Log
...
- Initial version
`,ct="@snack-uikit/stepper",at="0.9.3",R={name:ct,version:at},ut="# Stepper\n\n## Installation\n`npm i @snack-uikit/stepper`\n\n[Changelog](./CHANGELOG.md)\n\n## Description\n\n- Пакет `@snack-uikit/stepper` предоставляет компонент `Stepper` для отображения состояния пошагового процесса и управления навигацией между шагами.\n- Компонент использует паттерн render prop: принимает функцию-колбек в пропе `children`, которая получает JSX-элемент степпера, методы управления навигацией (`goNext`, `goPrev`) и состояние процесса (`isCompleted`, `currentStepIndex`, `stepCount`).\n- Поддерживает валидацию шагов через асинхронную функцию-валидатор (`validator`), которая вызывается при переходе на следующий шаг и должна вернуть `Promise<boolean>`: при успешной валидации происходит переход, при ошибке шаг остаётся в состоянии отклонения (`rejected`).\n- Каждый шаг может находиться в одном из состояний: `completed` (завершён), `current` (текущий), `loading` (идёт валидация), `waiting` (ожидает выполнения) или `rejected` (отклонён).\n- Позволяет навигироваться между шагами программно через методы API или кликом по шагам: можно перейти на следующий шаг, вернуться на предыдущий, а также кликнуть на завершённый шаг для возврата к нему.\n- Поддерживает отслеживание завершённости всего процесса, сброс состояния валидации для текущего шага и динамическое переопределение валидатора через `setValidator`.\n- Каждый шаг может содержать заголовок (`title`) и описание (`description`), которые отображаются в визуальном представлении степпера.\n- Figma: [`Stepper`](https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A33355&mode=design).\n\n## Example\n\n```tsx\nimport { Stepper } from '@snack-uikit/stepper';\n\nfunction Example() {\n  const steps = [\n    { title: 'First step', description: 'First step long description two lines truncated' },\n    { title: 'Second step', description: 'Second step long description two lines truncated' },\n    { title: 'Third step', description: 'Third step long description two lines truncated' },\n    { title: 'Fourth step', description: 'Fourth step long description two lines truncated' },\n  ];\n\n  const validator = (currentStepIndex: number, newStepIndex: number) => {\n    // Асинхронная валидация текущего шага\n    return new Promise<boolean>(resolve => {\n      setTimeout(() => {\n        resolve(true); // или false при ошибке валидации\n      }, 1000);\n    });\n  };\n\n  return (\n    <Stepper steps={steps} validator={validator}>\n      {({ stepper, isCompleted, goNext, goPrev, resetValidation, currentStepIndex }) => (\n        <>\n          {stepper}\n          <div>\n            <button onClick={() => goPrev()}>Назад</button>\n            <button onClick={() => goNext()}>Далее</button>\n            <button onClick={resetValidation}>Сбросить валидацию</button>\n          </div>\n          <div>Текущий шаг: {currentStepIndex + 1}</div>\n          <div>Процесс завершён: {isCompleted ? 'да' : 'нет'}</div>\n        </>\n      )}\n    </Stepper>\n  );\n}\n```\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## Stepper\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| children* | `({stepper, ...api}) => ReactElement` | - | Render function. Принимает аргументы: `stepper` - JSX-элемент степпера, `goNext(stepIndex?: number)` - перейти на след. шаг, `goPrev(stepIndex?: number)` - перейти на пред. шаг, `resetValidation` - сбросить состояние валидации для текущего шага, `setValidator` переопределяет функцию-валидатор, которая принимает в параметры индекс текущего шага и индекс нового, `isCompleted` - окончен ли процесс, `currentStepIndex` - индекс текущего шага, `stepCount` - кол-во шагов. |\n| steps* | `StepData[]` | - | Массив шагов |\n| defaultCurrentStepIndex | `number` | - | Индекс текущего шага по-дефолту |\n| validator | `StepsValidator` | - | Валидатор шагов. Выполняется при смене шага. Принимает первым аргументом индекс текущего, вторым - индекс нового шага. |\n| className | `string` | - | CSS-класс |\n| onChangeCurrentStep | `(newValue: number, prevValue: number) => void` | - | Колбек смены текущего степа |\n| onCompleteChange | `(isCompleted: boolean) => void` | - | Колбек изменения завершенности |\n| allowFreeNavigation | `boolean` | - | Позволяет свободно переключаться между разными шагами без валидации |\n\n\n[//]: DOCUMENTATION_SECTION_END\n",s={Completed:"completed",Current:"current",Loading:"loading",Waiting:"waiting",Rejected:"rejected"},J=e=>c=>e&&c?`${c}${e}`:void 0,st="_icon_1dzeq_1",it={icon:st};function rt(e,c){switch(e){case s.Completed:return t.jsx(tt,{});case s.Rejected:return t.jsx(Z,{});case s.Loading:return t.jsx(nt,{size:"s"});default:return c}}function v({state:e,number:c,className:k}){const i=u.useMemo(()=>rt(e,c),[c,e]);return t.jsx("div",{"data-state":e,className:F(it.icon,k),children:typeof i=="number"?t.jsx(H.SansLabelL,{children:i}):i})}try{v.displayName="Icon",v.__docgenInfo={description:"",displayName:"Icon",props:{state:{defaultValue:null,description:"",name:"state",required:!0,type:{name:"enum",value:[{value:'"loading"'},{value:'"current"'},{value:'"completed"'},{value:'"waiting"'},{value:'"rejected"'}]}},number:{defaultValue:null,description:"",name:"number",required:!0,type:{name:"number"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const ot="_tailLine_1c26u_1",dt="_tail_1c26u_1",kt="_title_1c26u_19",lt="_description_1c26u_24",pt="_step_1c26u_29",ht="_track_1c26u_40",mt="_statusContainer_1c26u_46",gt="_content_1c26u_75",bt="_icon_1c26u_81",l={tailLine:ot,tail:dt,title:kt,description:lt,step:pt,track:ht,statusContainer:mt,content:gt,icon:bt},Gt=J("_element-tail"),Ct=J("_element-step");function f({step:e,className:c,"data-test-id":k,hideTailLine:i,...o}){return t.jsxs("div",{className:F(l.step,c),"data-state":e.state,...$(o),children:[t.jsxs("div",{className:l.track,children:[t.jsx("button",{type:"button",className:l.statusContainer,onClick:e.onClick,disabled:!e.onClick,"data-test-id":Ct(k),"data-state":e.state,children:t.jsx(v,{...e,className:l.icon})}),!i&&t.jsx("div",{className:l.tail,"data-completed":e.state===s.Completed||void 0,"data-test-id":Gt(k),children:t.jsx("div",{className:l.tailLine})})]}),t.jsxs("div",{className:l.content,children:[t.jsx(H.SansBodyM,{className:l.title,tag:"div",children:t.jsx(D,{text:e.title})}),e.description&&t.jsx(H.SansBodyS,{className:l.description,tag:"div",children:t.jsx(D,{text:e.description,maxLines:2})})]})]})}try{f.displayName="Step",f.__docgenInfo={description:"",displayName:"Step",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},hideTailLine:{defaultValue:null,description:"",name:"hideTailLine",required:!1,type:{name:"boolean"}},step:{defaultValue:null,description:"",name:"step",required:!0,type:{name:"StepViewData"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const q=u.createContext({stepper:t.jsx(t.Fragment,{}),stepCount:0,isCompleted:!1,currentStepIndex:0,goToStep(){},goNext(){},goPrev(){},resetValidation(){},setValidator(){}}),Ot=()=>u.useContext(q),Et="_stepper_y1r4g_1",yt={stepper:Et},Nt=async()=>!0;function O({children:e,steps:c,className:k,onChangeCurrentStep:i,onCompleteChange:o,defaultCurrentStepIndex:_=0,validator:S=Nt,allowFreeNavigation:E=!1,...x}){const T=_===c.length-1,[g,p]=u.useState(T?s.Completed:s.Current),[a,K]=u.useState(_),[d,B]=u.useState(T),[h,z]=u.useState();u.useEffect(()=>{o==null||o(d)},[d,o]);const b=u.useCallback(n=>{K(r=>(r!==n&&(i==null||i(n,r)),n))},[i]),y=u.useCallback((n=a+1)=>{if(a>=c.length||d||n<=a)return;const r=Math.min(c.length-1,n);p(s.Loading),((h==null?void 0:h.value)||S)(a,r).catch(()=>!1).then(m=>{if(!m){p(s.Rejected);return}a===c.length-1?(p(s.Completed),B(!0)):(b(r),p(s.Current))})},[a,d,b,c.length,h==null?void 0:h.value,S]),G=u.useCallback(n=>{d&&B(!1),b(n),p(s.Current)},[d,b]),N=u.useCallback(n=>{n<0||n>=c.length||n!==a&&G(n)},[a,c,G]),A=u.useCallback((n=a-1)=>{a===0||n<0||n>a||n===a&&!d||G(n)},[a,d,G]),P=u.useCallback(n=>{if(E)return()=>N(n);if(n<a||n===a&&d)return()=>A(n);if(n===a+1)return()=>y()},[E,a,y,A,N,d]),Q=u.useMemo(()=>c.map((n,r)=>{const j=r+1;let m=s.Waiting;return r<a?m=s.Completed:r===a&&(m=g),{...n,number:j,state:m,onClick:P(r)}}),[c,a,g,P]),X=u.useCallback(()=>{g===s.Rejected&&p(s.Current)},[g]),W=u.useCallback(n=>{z({value:n})},[]),Y=t.jsx("div",{className:F(yt.stepper,k),...$(x),children:Q.map((n,r)=>t.jsx(f,{step:n,"data-test-id":x["data-test-id"],hideTailLine:r===c.length-1},n.title+r))}),I={goNext:y,goPrev:A,currentStepIndex:a,isCompleted:d,resetValidation:X,stepCount:c.length,stepper:Y,setValidator:W,goToStep:E?N:void 0};return t.jsx(q.Provider,{value:I,children:e(I)})}try{O.displayName="Stepper",O.__docgenInfo={description:"",displayName:"Stepper",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},steps:{defaultValue:null,description:"Массив шагов",name:"steps",required:!0,type:{name:"StepData[]"}},defaultCurrentStepIndex:{defaultValue:{value:"0"},description:"Индекс текущего шага по-дефолту",name:"defaultCurrentStepIndex",required:!1,type:{name:"number"}},validator:{defaultValue:null,description:"Валидатор шагов. Выполняется при смене шага. Принимает первым аргументом индекс текущего, вторым - индекс нового шага.",name:"validator",required:!1,type:{name:"StepsValidator"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"Render function. Принимает аргументы: `stepper` - JSX-элемент степпера,\n`goNext(stepIndex?: number)` - перейти на след. шаг, `goPrev(stepIndex?: number)` - перейти на пред. шаг, `resetValidation` - сбросить состояние валидации для текущего шага, `setValidator` переопределяет функцию-валидатор, которая принимает в параметры индекс текущего шага и индекс нового, `isCompleted` - окончен ли процесс, `currentStepIndex` - индекс текущего шага, `stepCount` - кол-во шагов.",name:"children",required:!0,type:{name:"({stepper, ...api}) => ReactElement"}},onChangeCurrentStep:{defaultValue:null,description:"Колбек смены текущего степа",name:"onChangeCurrentStep",required:!1,type:{name:"((newValue: number, prevValue: number) => void)"}},onCompleteChange:{defaultValue:null,description:"Колбек изменения завершенности",name:"onCompleteChange",required:!1,type:{name:"((isCompleted: boolean) => void)"}},allowFreeNavigation:{defaultValue:{value:"false"},description:"Позволяет свободно переключаться между разными шагами без валидации",name:"allowFreeNavigation",required:!1,type:{name:"boolean"}}}}}catch{}const At="_story_142nc_1",Lt="_panel_142nc_9",M={story:At,panel:Lt},Wt={title:"Components/Stepper",component:O};function Ht(){const{goPrev:e,goNext:c,isCompleted:k,currentStepIndex:i,resetValidation:o}=Ot();return t.jsxs(t.Fragment,{children:[t.jsxs("div",{children:[t.jsxs("div",{"data-test-id":"is-completed",children:["isCompleted: ",k?"yes":"no"]}),t.jsxs("div",{"data-test-id":"current-index",children:["current step index: ",i]})]}),t.jsxs("div",{className:M.panel,children:[t.jsx(L,{"data-test-id":"prev",size:"s",label:"go prev",onClick:()=>e()}),t.jsx(L,{"data-test-id":"reset-validation",size:"s",label:"reset validation",onClick:o}),t.jsx(L,{"data-test-id":"next",size:"s",label:"go next",onClick:()=>c()})]})]})}const vt=({validationTimeout:e,isValid:c,...k})=>{const i=()=>new Promise(o=>setTimeout(()=>o(c),e));return t.jsx(O,{...k,validator:i,children:({stepper:o})=>t.jsxs(t.Fragment,{children:[t.jsx("div",{className:M.story,children:o}),t.jsx(Ht,{})]})})},C={render:vt,args:{steps:[{title:"First step",description:"First step long description two lines truncated"},{title:"Second step",description:"Second step long description two lines truncated"},{title:"Third step",description:"Third step long description two lines truncated"},{title:"Fourth step",description:"Fourth step long description two lines truncated"},{title:"Fifth step",description:"Fifth step long description two lines truncated"}],isValid:!0,validationTimeout:1e3},argTypes:{isValid:{name:"[stories] is current step valid",control:{type:"boolean"}},validationTimeout:{name:"[stories] validation timeout",control:{min:0,type:"number"}}},parameters:{readme:{sidebar:[`Latest version: ${R.version}`,ut,et]},packageName:R.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A33355&mode=design"}}};var V,w,U;C.parameters={...C.parameters,docs:{...(V=C.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: Template,
  args: {
    steps: [{
      title: 'First step',
...
}`,...(U=(w=C.parameters)==null?void 0:w.docs)==null?void 0:U.source}}};export{Wt as default,C as stepper};
