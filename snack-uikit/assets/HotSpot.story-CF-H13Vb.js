import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c}from"./index-CXM-PPQz.js";import{e as l}from"./componentPropsProcessors-UJEZy8aQ.js";import{P as F}from"./index-CTTgWa-s.js";import{B as O}from"./ButtonFilled-3I0Fv0_B.js";import{T as _}from"./Tooltip-DSIXDjBr.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-CJ_LmFaV.js";import"./utils-Bd0G2N0B.js";import"./Counter-B1ZrBHB5.js";import"./Sun-BMXO82GS.js";import"./constants-BAH7I9kc.js";import"./PopoverPrivate-BoGrpd0w.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";import"./isBrowser-C2N6XvuH.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";const G=`# Change Log
...
- Initial version
`,H="@snack-uikit/hot-spot",A="0.4.11",d={name:H,version:A},T=`# Hotspot
...
`,x="_dotPlacementContainer_1489t_1",R="_hotSpotDot_1489t_32",w="_hotSpotDotContainer_1489t_84",P="_wrapper_1489t_111",u={dotPlacementContainer:x,hotSpotDot:R,hotSpotDotContainer:w,wrapper:P},p="hot-spot",m={dot:`${p}__dot`,dotContainer:`${p}__dot-container`};function h(e=0){return typeof e!="number"?e:e>=0?`${e}px`:`calc(0px - ${Math.abs(e)}px)`}function i({dotRender:e,children:t,offsetX:r=0,offsetY:k=0,placement:v="right-top",duration:C="2s",pulse:y=!0,enabled:E=!0,appearance:S="primary",className:N,wrapperClassName:D,...s}){if(!E)return n.jsx(n.Fragment,{children:t});const a=n.jsx("div",{className:c(u.hotSpotDot,N),"data-appearance":S,"data-pulse":y||void 0,"data-test-id":m.dot});return t?n.jsxs("div",{...l(s),className:c(u.wrapper,D),style:{"--offset-x":h(r),"--offset-y":h(k),"--duration":C},children:[t,n.jsx("span",{className:u.dotPlacementContainer,"data-placement":v,"data-test-id":m.dotContainer,children:n.jsx("span",{className:u.hotSpotDotContainer,children:e?e(a):a})})]}):n.jsx("span",{...l(s),className:u.hotSpotDotContainer,children:e?e(a):a})}try{i.displayName="HotSpot",i.__docgenInfo={description:"",displayName:"HotSpot",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},appearance:{defaultValue:{value:"primary"},description:"Внешний вид",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"neutral"'},{value:'"red"'},{value:'"orange"'},{value:'"yellow"'},{value:'"green"'},{value:'"blue"'},{value:'"violet"'},{value:'"pink"'}]}},pulse:{defaultValue:{value:"true"},description:"Анимация пульсации",name:"pulse",required:!1,type:{name:"boolean"}},duration:{defaultValue:{value:"2s"},description:"Время анимации пульсации",name:"duration",required:!1,type:{name:"string"}},placement:{defaultValue:{value:"right-top"},description:"Положение относительно children.",name:"placement",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"right"'},{value:'"center"'},{value:'"left-top"'},{value:'"left-bottom"'},{value:'"right-top"'},{value:'"right-bottom"'},{value:'"center-top"'},{value:'"center-bottom"'}]}},dotRender:{defaultValue:null,description:"Рендер функция для dot",name:"dotRender",required:!1,type:{name:"((dot: ReactNode) => ReactNode)"}},children:{defaultValue:null,description:"Вложенный контент",name:"children",required:!1,type:{name:"ReactNode"}},offsetX:{defaultValue:{value:"0"},description:"Смещение dot по оси X (ось направлена вправо)",name:"offsetX",required:!1,type:{name:"string | number"}},offsetY:{defaultValue:{value:"0"},description:"Смещение dot по оси Y (ось направлена вниз)",name:"offsetY",required:!1,type:{name:"string | number"}},enabled:{defaultValue:{value:"true"},description:"Управление состоянием отрисовки",name:"enabled",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},wrapperClassName:{defaultValue:null,description:"",name:"wrapperClassName",required:!1,type:{name:"string"}}}}}catch{}const ue={title:"Components/HotSpot",component:i},L=({showDotRender:e,...t})=>n.jsx(i,{...t,dotRender:e?r=>n.jsx(_,{placement:"bottom",tip:"HotSpot dotRender",trigger:"click",children:r}):void 0,children:n.jsx(O,{appearance:"neutral",label:"Send Message",icon:n.jsx(F,{})})}),o={render:L,args:{appearance:"primary",placement:"right-top",pulse:!0,offsetX:8,offsetY:-8,showDotRender:!0,enabled:!0,duration:"2s"},argTypes:{offsetX:{type:"number"},offsetY:{type:"number"},duration:{if:{eq:!0,arg:"pulse"}},dotRender:{table:{disable:!0}}},parameters:{readme:{sidebar:[`Latest version: ${d.version}`,T,G]},packageName:d.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-5.0.0?node-id=4799-2805"}}};var g,f,b;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: Template,
  args: {
    appearance: 'primary',
    placement: 'right-top',
