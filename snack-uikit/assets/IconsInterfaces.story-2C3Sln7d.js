...
- Initial version
`,p0="@snack-uikit/icons",k0="0.27.2",a={name:p0,version:k0},g0=`<?xml version="1.0" encoding="utf-8"?>
...
</svg>`,F0="_wrapper_1yar5_1",w0="_iconCard_1yar5_7",i={wrapper:F0,iconCard:w0},c1={title:"Components/Icons/Interfaces"},v0=({size:r,applySprite:l})=>n.jsxs("div",{className:i.wrapper,children:[l&&n.jsx(f0,{content:g0}),Object.keys(t).map(e=>{const u=t[e];return n.jsxs("div",{className:i.iconCard,children:[n.jsx(u,{size:r}),e]},e)})]}),c={render:v0,args:{size:24,applySprite:!1},argTypes:{applySprite:{name:"[Story]: Apply custom sprite",type:"boolean"},size:{type:"number"}},parameters:{readme:{sidebar:[`Latest version: ${a.version}`,m,h0]},packageName:a.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/Ur8wo5KsEZzwsTWIHo29WG/Base-Icon?node-id=3%3A102&t=qCKiZ5yyQ2Eq95OX-0"}}};var o,s,d;c.parameters={...c.parameters,docs:{...(o=c.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: Template,
  args: {
    size: 24,
    applySprite: false
