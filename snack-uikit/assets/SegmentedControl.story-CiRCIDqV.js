import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{r as s}from"./index-CJ_LmFaV.js";import{P as c}from"./index-CTTgWa-s.js";import{S as m}from"./SegmentedControl-DxV4c4xv.js";import{T as i}from"./Tooltip-BDL6mZ5Y.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-CXM-PPQz.js";import"./index-JZGyZbA2.js";import"./TruncateString-BOaVbHNH.js";import"./lodash-DyrGR4_s.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./Counter-B1ZrBHB5.js";import"./PopoverPrivate-DNtkV98k.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";const p=`# Change Log
...
- Initial version
`,G="@snack-uikit/segmented-control",O="0.6.23",u={name:G,version:O},C=`# Segmented Control
...
`,v="_story_1sldx_1",L="_invisible_1sldx_8",r={story:v,invisible:L},J={title:"Components/Segmented Control",component:m};var g=(n=>(n.Labels="labels",n.Icons="icons",n.LabelsAndIcons="labels and icons",n.LabelsAndCounters="labels and counters",n.LabelsAndCountersAndIcons="labels and counters and icons",n))(g||{});const E=({...n})=>{const k=s.useMemo(()=>n.items.map(e=>{switch(n.storyType){case"labels":return{...e,icon:void 0,counter:void 0};case"icons":return{...e,label:void 0,counter:void 0};case"labels and icons":return{...e,counter:void 0};case"labels and counters":return{...e,icon:void 0};default:return e}}).filter(e=>e.label||e.icon||e.counter),[n.items,n.storyType]),[h,b]=s.useState(n.defaultValue);return t.jsxs("div",{className:r.story,children:[t.jsx(m,{...n,items:k,onChange:b}),t.jsx("div",{className:r.invisible,"data-test-id":"selected-segment",children:h})]})},a={render:E,args:{items:[{label:"Chip",value:"1",icon:t.jsx(c,{})},{label:"Gadget Hackwrench",value:"2",icon:t.jsx(c,{})},{label:"Dale",value:"3",counter:{value:9,appearance:"neutral"}},{label:"Zipper",value:"4",icon:t.jsx(c,{}),disabled:!0,renderWrapSegment:n=>t.jsx(i,{tip:"Not a rodent",placement:"bottom",children:n})},{label:"Monterey Jack",value:"5",counter:{value:10}},{label:"Peter Parker",value:"6",counter:{value:1994,appearance:"red"},disabled:!0,renderWrapSegment:n=>t.jsx(i,{tip:"Spider-Man",placement:"bottom",children:n})}],defaultValue:"1",size:"m",outline:!1,storyType:"labels and counters and icons",width:"auto"},argTypes:{className:{table:{disable:!0}},storyType:{name:"[Story]: story type",options:Object.values(g),control:{type:"radio"},if:{arg:"size",neq:"xs"}},defaultValue:{type:"string"}},parameters:{readme:{sidebar:[`Latest version: ${u.version}`,C,p]},packageName:u.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/branch/5GN8XXj3rBfLTWvJA7kliW/Snack-UI-Kit-3.1.0?node-id=3025-1827&t=z817Qjsi8DfuRDiK-0"}}};var o,l,d;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: Template,
  args: {
    items: [{
      label: 'Chip',
      ...
      icon: <PlaceholderSVG />,
      disabled: true,
      renderWrapSegment: segment => <Tooltip tip='Not a rodent' placement='bottom'>
            {segment}
          </Tooltip>
    }, {
      label: 'Monterey Jack',
      ...
      disabled: true,
      renderWrapSegment: segment => <Tooltip tip='Spider-Man' placement='bottom'>
            {segment}
          </Tooltip>
    }],
    defaultValue: '1',
...
}`,...(d=(l=a.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};export{J as default,a as segmentedControl};
