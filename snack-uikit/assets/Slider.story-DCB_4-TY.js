import{j as s}from"./jsx-runtime-BTJTZTIL.js";import{r as a}from"./index-CJ_LmFaV.js";import{S as b}from"./Slider-7lH2T0Zc.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-CXM-PPQz.js";import"./KeyCode-CHzoJbuw.js";import"./objectWithoutProperties-3ReGGzEA.js";import"./objectWithoutPropertiesLoose-Dsqj8S3w.js";import"./extends-CF3RwP-h.js";import"./useSwipeable-DMbEt_5P.js";import"./Tooltip-B8F47jJX.js";import"./PopoverPrivate-BgnwkLUT.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";import"./isBrowser-C2N6XvuH.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./componentPropsProcessors-UJEZy8aQ.js";const v=`# Change Log
...
- Initial version
`,E="@snack-uikit/slider",C="0.3.33",u={name:E,version:C},y=`# Slider
...
`,N="_wrapper_1r7by_1",f={wrapper:N},Y={title:"Components/Slider",component:b},l={1:"512mb",4:"2gb",8:"4gb",16:"8gb"},A={1:"1",4:"4",8:"8",12:"12",16:"16"},d={none:"none",linear:"linear","not-linear":"not-linear"},r=[4,8],L=({storyMarks:n,moveByMarks:h,step:g,...t})=>{const[c,o]=a.useState(r);a.useEffect(()=>{o(r)},[t.range]);const O=a.useMemo(()=>{switch(n){case"not-linear":return l;case"linear":return A;case"none":default:return}},[n]),G=a.useCallback(e=>{switch(n){case"not-linear":return l[Number(e)];case"linear":case"none":default:return e}},[n]);return s.jsx("div",{className:f.wrapper,children:s.jsx(b,{...t,value:t.range?c:c[0],onChange:e=>{t.range?o(e):o([e])},step:h&&n!=="none"?null:g,marks:O,tipFormatter:G})})},i={render:L,args:{className:"osThemeSnack",min:1,max:16,storyMarks:"not-linear",step:1,moveByMarks:!0,handleTip:!0,range:!1,reverse:!1},argTypes:{storyMarks:{name:"[Story]: example marks",options:Object.keys(d),mapping:d,control:{type:"radio"}},moveByMarks:{name:"[Story]: change value only by marks",type:"boolean"},step:{if:{arg:"moveByMarks",eq:!1}}},parameters:{readme:{sidebar:[`Latest version: ${u.version}`,y,v]},packageName:u.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-5.0.0?node-id=1755-108937&m=dev"}}};var m,p,k;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: Template,
  args: {
...
}`,...(k=(p=i.parameters)==null?void 0:p.docs)==null?void 0:k.source}}};export{Y as default,i as slider};
