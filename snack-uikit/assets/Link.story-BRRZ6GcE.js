import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as A}from"./index-DUmpqB7p.js";import{r as N}from"./index-CJ_LmFaV.js";import{L as u,A as G,P as L,S as O,T as f,a as C}from"./Link-D99a5Mz9.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./TruncateString-D54BiV_x.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DzAF_V2U.js";import"./PopoverPrivate-CnKgsFAm.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-JZGyZbA2.js";const v=`# Change Log
...
- Initial version
`,F="@snack-uikit/link",y="0.17.13",m={name:F,version:y},H=`# Link
...
`,x="_wrapper_1ev7a_1",T="_table_1ev7a_104",_="_cell_1ev7a_112",S="_headerCell_1ev7a_210",a={wrapper:x,table:T,cell:_,headerCell:S},nn={title:"Components/Link",component:u},s="Link text",E=O.S,j=L.Body,o=f.Default,k=G.Primary,P=Object.values(G),w=Object.values(O),D=Object.values(f);function r({header:d,options:e}){const t=A(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:t}),n.jsx("div",{className:t,children:d}),e.map(c=>{var h,b;return n.jsxs(N.Fragment,{children:[n.jsx("div",{className:t,children:c.header}),n.jsx("div",{className:a.cell,"data-appearance":(h=c.props)==null?void 0:h.appearance,"data-text-mode":(b=c.props)==null?void 0:b.textMode,children:n.jsx(u,{...c.props})})]},c.header)})]})}const R=({insideText:d,...e})=>n.jsxs(n.Fragment,{children:[n.jsx("div",{className:a.wrapper,"data-appearance":e.appearance,"data-text-mode":e.textMode,children:d?n.jsxs("span",{children:["Some text some text ",n.jsx(u,{...e,insideText:!0})," some text some text"]}):n.jsx(u,{...e})}),n.jsxs("div",{children:[n.jsx(r,{header:"Appearance",options:P.map(t=>({header:t,props:{appearance:t,text:s,textMode:o,size:E}}))}),n.jsx(r,{header:"Text Mode",options:D.map(t=>({header:t,props:{appearance:k,text:s,textMode:t}}))}),n.jsx(r,{header:"Size",options:w.map(t=>({header:t,props:{appearance:k,text:s,size:t,textMode:o}}))})]})]}),i={render:R,args:{textMode:o,href:"#",text:s,size:E,purpose:j,target:"_blank",appearance:k,insideText:!1,truncateVariant:"end"},argTypes:{size:{control:{type:"radio"}},target:{control:{type:"select",options:Object.values(C)}},download:{type:"string"}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,H,v]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=2%3A9&mode=design"}}};var l,p,g;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: Template,
  args: {
