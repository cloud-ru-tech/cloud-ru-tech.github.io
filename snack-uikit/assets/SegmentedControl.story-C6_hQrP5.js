import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{r as s}from"./index-CJ_LmFaV.js";import{P as t}from"./index-C1BBUjNh.js";import{S as l}from"./SegmentedControl-hAkA0_fX.js";import{T as b}from"./Tooltip-DMNQxdBh.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-DUmpqB7p.js";import"./index-JZGyZbA2.js";import"./TruncateString-C-ApBzyA.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./PopoverPrivate-TrV_4kB1.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";const p=`# Change Log
...
- Initial version
`,G="@snack-uikit/segmented-control",O="0.6.1",i={name:G,version:O},y='# Segmented Control\n\n## Installation\n`npm i @snack-uikit/segmented-control`\n\n[Changelog](./CHANGELOG.md)\n\n\n\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## SegmentedControl\nSegmentedControl\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| items* | `Segment<Value>[]` | - | Набор сегментов. |\n| value | `IdType` | - | Value выбранного сегмента. |\n| defaultValue | `IdType` | - | ID выбранного по умолчанию сегмента. (в uncontrolled режиме) |\n| onChange | `(value: Value) => void` | - | Колбек смены выбранного сегмента. |\n| className | `string` | - | CSS-класс контейнера. |\n| size | enum Size: `"xs"`, `"s"`, `"m"`, `"l"` | m | Размер компонента. |\n| outline | `boolean` | - | Обводка |\n| width | enum Width: `"auto"`, `"full"` | auto | Управление шириной компонента. |\n| name | `string` | - | Имя поля |\n\n\n[//]: DOCUMENTATION_SECTION_END\n',v="_story_1sldx_1",f="_invisible_1sldx_8",u={story:v,invisible:f},z={title:"Components/Segmented Control",component:l};var m=(n=>(n.Labels="labels",n.Icons="icons",n.LabelsAndIcons="labels and icons",n))(m||{});const C=({...n})=>{const g=s.useMemo(()=>n.items.map(c=>n.storyType==="labels"?{...c,icon:void 0}:n.storyType==="icons"?{...c,label:void 0}:c),[n.items,n.storyType]),[h,k]=s.useState(n.defaultValue);return e.jsxs("div",{className:u.story,children:[e.jsx(l,{...n,items:g,onChange:k}),e.jsx("div",{className:u.invisible,"data-test-id":"selected-segment",children:h})]})},a={render:C,args:{items:[{label:"Chip",value:"1",icon:e.jsx(t,{})},{label:"Gadget Hackwrench",value:"2",icon:e.jsx(t,{})},{label:"Dale",value:"3",icon:e.jsx(t,{})},{label:"Zipper",value:"4",icon:e.jsx(t,{}),disabled:!0,renderWrapSegment:n=>e.jsx(b,{tip:"Not a rodent",placement:"bottom",children:n})},{label:"Monterey Jack",value:"5",icon:e.jsx(t,{})}],defaultValue:"1",size:"m",outline:!1,storyType:"labels and icons",width:"auto"},argTypes:{className:{table:{disable:!0}},storyType:{name:"[Story]: story type",options:Object.values(m),control:{type:"radio"},if:{arg:"size",neq:"xs"}},defaultValue:{type:"string"}},parameters:{readme:{sidebar:[`Latest version: ${i.version}`,y,p]},packageName:i.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/branch/5GN8XXj3rBfLTWvJA7kliW/Snack-UI-Kit-3.1.0?node-id=3025-1827&t=z817Qjsi8DfuRDiK-0"}}};var o,r,d;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: Template,
  args: {
    items: [{
      label: 'Chip',
...
}`,...(d=(r=a.parameters)==null?void 0:r.docs)==null?void 0:d.source}}};export{z as default,a as segmentedControl};
