import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{S as d}from"./Sun-BMXO82GS.js";import{I as h,A as b,a as m,C as g}from"./index-CAfvFIBF.js";const f=`# Change Log
...
- Initial version
`,p="@snack-uikit/alert",G="0.16.30",y={name:p,version:G},v=`# Alert
...
`,n={Neutral:"neutral",Primary:"primary",Error:"error",Warning:"warning",Success:"success",Info:"info"},F={[n.Neutral]:"neutral",[n.Primary]:"primary",[n.Error]:"red",[n.Warning]:"yellow",[n.Success]:"green",[n.Info]:"blue"},_={[n.Neutral]:"primary",[n.Primary]:"primary",[n.Error]:"red",[n.Warning]:"yellow",[n.Success]:"green",[n.Info]:"blue"},O="_alertButton_12zor_1",C="_text_12zor_13",A="_icon_12zor_29",i={alertButton:O,text:C,icon:A};function k({appearance:c,text:t,icon:a,onClick:r,variant:o="simple",dataTestId:l,loading:s=!1,size:u="s"}){return e.jsxs("button",{type:"button",onClick:r,className:i.alertButton,"data-variant":o,"data-appearance":c,"data-test-id":l||"alert__action-button","data-icon-only":!t||void 0,"data-loading":s,"data-size":u,children:[t&&e.jsx("span",{className:i.text,"data-size":u,children:t}),a&&(s?e.jsx(d,{size:"s"}):e.jsx("span",{className:i.icon,children:a}))]})}try{k.displayName="AlertButton",k.__docgenInfo={description:"",displayName:"AlertButton",props:{appearance:{defaultValue:null,description:"Внешний вид",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"red"'},{value:'"orange"'},{value:'"yellow"'},{value:'"green"'},{value:'"blue"'},{value:'"violet"'},{value:'"pink"'},{value:'"neutral"'},{value:'"primary"'},{value:'"invert-neutral"'}]}},text:{defaultValue:null,description:"Текст кнопки",name:"text",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"Иконка в кнопке",name:"icon",required:!1,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}},variant:{defaultValue:{value:"simple"},description:"Вариант отображения",name:"variant",required:!1,type:{name:"enum",value:[{value:'"simple"'},{value:'"tonal"'}]}},onClick:{defaultValue:null,description:"Колбек клика",name:"onClick",required:!1,type:{name:"((e: MouseEvent<HTMLButtonElement, MouseEvent>) => void)"}},dataTestId:{defaultValue:null,description:"Дата тест айди",name:"dataTestId",required:!1,type:{name:"string"}},loading:{defaultValue:{value:"false"},description:"Управление состоянием загрузки",name:"loading",required:!1,type:{name:"boolean"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'}]}}}}}catch{}function P(c,t){switch(c){case n.Success:return e.jsx(g,{size:t});case n.Error:return e.jsx(m,{size:t});case n.Warning:return e.jsx(b,{size:t});case n.Primary:case n.Neutral:default:return e.jsx(h,{size:t})}}const E="_wrapper_4wy6n_1",x={wrapper:E};export{F as A,n as a,_ as b,k as c,y as d,v as e,f,P as g,x as s};
