import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{d as K}from"./index-D3kvmOHM.js";import{r as i}from"./index-CJ_LmFaV.js";import{C as I}from"./index-BstMuGci.js";import{t as W}from"./helpers-Bb_FfY3_.js";import{c as U}from"./index-CXM-PPQz.js";import{m as Q}from"./index-B7wZyJkK.js";import{e as j}from"./componentPropsProcessors-UJEZy8aQ.js";import{D as Z}from"./DropList-DEhmQza7.js";import{f as M}from"./hooks-Cb7q2uDh.js";import{P as X}from"./index-DW7JD-Lj.js";import{B as Y}from"./ButtonFunction-CtElqV7K.js";import{S as ee}from"./Scroll-p7EvfiBx.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./Typography-B_4XbOMz.js";import"./ButtonFilled-DZiul5Ky.js";import"./utils-d0rn_W0T.js";import"./Counter-C_DywCEs.js";import"./Sun-DVH5ADpI.js";import"./constants-BAH7I9kc.js";import"./ButtonTonal-CmQYw77c.js";import"./PromoTag-1aL6Dxvi.js";import"./index-Df-dmYFR.js";import"./IconPredefined-DvZvK1aQ.js";import"./TruncateString-DMHAWZlY.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DaeWZEms.js";import"./PopoverPrivate-BQgi56s-.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-JZGyZbA2.js";import"./index-B6hh_CYl.js";import"./Tag-CA014ENK.js";import"./constants-BaREPXw5.js";import"./index-C3gycbXm.js";import"./index-Chjiymov.js";import"./index-Cxdp8tlc.js";import"./ProgressBar-G0ToIzOu.js";import"./index-BPI37A09.js";import"./index-S9IyB2Vz.js";import"./index-BDKfaAX1.js";import"./Link-cLNEphnk.js";import"./LocaleProvider-XVitSj_D.js";import"./useValueControl-CNLw7ht-.js";import"./Dropdown-CJIpH82E.js";import"./Checkbox-BrjwspCG.js";import"./constants-BObEONKm.js";import"./TogglePrivate-D_Ey2AsU.js";import"./index-CP5aoo4S.js";import"./Switch-CnO5GMY9.js";import"./index-00FjgX9j.js";import"./index-CsyvGLEa.js";import"./index-DCrMFnLF.js";import"./Divider-CUoM6iCM.js";import"./Spinner-BJeEd4V6.js";import"./useButtonNavigation-EjhHKyx9.js";import"./useClearButton-C6OboUMx.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-uCEkO2Kz.js";const ne=`# Change Log
...
- Initial version
`,te="@snack-uikit/search",ue="0.12.29",T={name:te,version:ue},ae=`# Search
...
`,C={S:"s"},F={decorator:"search__decorator",droplist:"search__droplist",option:"search__option"},$={field:"search__field"},ie="_decorator_1m3gt_1",se={decorator:ie};function H({children:o,outline:c,size:e=C.S,focused:t,className:p,postfix:d,...r}){return n.jsxs("div",{className:U(se.decorator,p),"data-outline":c||void 0,"data-size":e,"data-focused":t||void 0,...j(r),children:[o,d]})}try{H.displayName="SearchDecorator",H.__docgenInfo={description:"",displayName:"SearchDecorator",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},focused:{defaultValue:null,description:"",name:"focused",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'},{value:'"l"'}]}},postfix:{defaultValue:null,description:"Произвольный постфикс для поля",name:"postfix",required:!1,type:{name:"ReactNode"}},outline:{defaultValue:null,description:"Внешний бордер",name:"outline",required:!1,type:{name:"boolean"}}}}}catch{}const ce="_wrap_1qkek_1",le="_triggerClassName_1qkek_8",V={wrap:ce,triggerClassName:le},S=i.forwardRef(function({size:c=C.S,value:e,onChange:t,placeholder:p,options:d=[],loading:r,outline:h,onSubmit:s,onFocus:k,className:m,tabIndex:b,postfix:g,...G},E){const O=i.useRef(null),u=i.useRef(null),[B,y]=i.useState(!1),D=i.useCallback(l=>{var a,N;if(l.key.length===1){l.stopPropagation(),(a=u.current)==null||a.focus(),(N=O.current)==null||N.scroll(0,0);return}["ArrowUp","ArrowDown"].includes(l.key)?l.preventDefault():l.stopPropagation()},[O]),z=l=>a=>{a.key===" "&&a.stopPropagation(),a.key.length===1&&y(!0),l==null||l(a)},J=i.useMemo(()=>d.map(({onClick:l,...a},N)=>({...a,onClick:f=>{var x;f.type==="keydown"&&(f==null?void 0:f.key)===" "||(l==null||l(f),a.id?(t==null||t(String(a.id)),s==null||s(String(a.id))):typeof a.content=="string"&&(t==null||t(a.content),s==null||s(a.content)),y(!1),(x=u.current)==null||x.focus())},onKeyDown:D,"data-test-id":`${F.option}__${a.id??N}`})),[D,t,s,d]);return n.jsx("div",{className:U(V.wrap,m),...G,children:n.jsx(Z,{open:B&&d.length>0,scroll:!0,size:c,onOpenChange:y,"data-test-id":F.droplist,triggerClassName:V.triggerClassName,scrollRef:O,triggerElemRef:u,items:J,loading:r,children:({onKeyDown:l})=>{var a;return n.jsx(H,{size:c,outline:h||void 0,focused:B&&!!((a=u.current)!=null&&a.value)||void 0,"data-test-id":F.decorator,postfix:g,children:n.jsx(M,{loading:r,value:e,onChange:t,onSubmit:s,placeholder:p,ref:Q(E,u),onKeyDown:z(l),onFocus:k,size:c,"data-test-id":$.field,tabIndex:b})})}})})});try{S.displayName="SearchAutocomplete",S.__docgenInfo={description:"",displayName:"SearchAutocomplete",props:{onFocus:{defaultValue:null,description:"Колбек обработки получения фокуса",name:"onFocus",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},onBlur:{defaultValue:null,description:"Колбек обработки потери фокуса",name:"onBlur",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"Значение input",name:"value",required:!1,type:{name:"string"}},onChange:{defaultValue:null,description:"Колбек смены значения",name:"onChange",required:!1,type:{name:"((value: string, e?: ChangeEvent<HTMLInputElement>) => void)"}},tabIndex:{defaultValue:null,description:"",name:"tabIndex",required:!1,type:{name:"number"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'},{value:'"l"'}]}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},placeholder:{defaultValue:null,description:"Значение плейсхолдера",name:"placeholder",required:!1,type:{name:"string"}},loading:{defaultValue:null,description:"Состояние загрузки",name:"loading",required:!1,type:{name:"boolean"}},onSubmit:{defaultValue:null,description:"Колбек на подтверждение поиска по строке",name:"onSubmit",required:!1,type:{name:"((value: string) => void)"}},outline:{defaultValue:null,description:"Внешний бордер",name:"outline",required:!1,type:{name:"boolean"}},postfix:{defaultValue:null,description:"Произвольный постфикс для поля",name:"postfix",required:!1,type:{name:"ReactNode"}},options:{defaultValue:{value:"[]"},description:`Элементы выпадающие в Droplist в режиме Autocomplete.

На нажатие 'Space', 'Enter' или клике по элементу будет вызываться onSubmit.`,name:"options",required:!1,type:{name:"BaseItem[]"}}}}}catch{}const _=i.forwardRef(function({value:c,onChange:e,onBlur:t,onFocus:p,size:d=C.S,outline:r,loading:h,placeholder:s,onSubmit:k,className:m,tabIndex:b,...g},G){return n.jsx(H,{outline:r,size:d,className:m,...g,children:n.jsx(M,{ref:G,size:d,value:c,onChange:e,onBlur:t,onFocus:p,onSubmit:k,placeholder:s,loading:h,"data-test-id":$.field,tabIndex:b})})});try{_.displayName="SearchFieldText",_.__docgenInfo={description:"",displayName:"SearchFieldText",props:{onFocus:{defaultValue:null,description:"Колбек обработки получения фокуса",name:"onFocus",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},onBlur:{defaultValue:null,description:"Колбек обработки потери фокуса",name:"onBlur",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"Значение input",name:"value",required:!1,type:{name:"string"}},onChange:{defaultValue:null,description:"Колбек смены значения",name:"onChange",required:!1,type:{name:"((value: string, e?: ChangeEvent<HTMLInputElement>) => void)"}},tabIndex:{defaultValue:null,description:"",name:"tabIndex",required:!1,type:{name:"number"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'},{value:'"l"'}]}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},placeholder:{defaultValue:null,description:"Значение плейсхолдера",name:"placeholder",required:!1,type:{name:"string"}},loading:{defaultValue:null,description:"Состояние загрузки",name:"loading",required:!1,type:{name:"boolean"}},onSubmit:{defaultValue:null,description:"Колбек на подтверждение поиска по строке",name:"onSubmit",required:!1,type:{name:"((value: string) => void)"}},outline:{defaultValue:null,description:"Внешний бордер",name:"outline",required:!1,type:{name:"boolean"}},postfix:{defaultValue:null,description:"Произвольный постфикс для поля",name:"postfix",required:!1,type:{name:"ReactNode"}}}}}catch{}const A=i.forwardRef(function(c,e){const{value:t,onChange:p,onBlur:d,onFocus:r,outline:h,loading:s,placeholder:k,onSubmit:m,className:b,tabIndex:g,postfix:G,size:E=C.S,...O}=c,u=j(O);return c.autocomplete?n.jsx(S,{value:t,onChange:p,options:c.options,onBlur:d,onFocus:r,onSubmit:m,size:E,outline:h,loading:s,placeholder:k,className:b,ref:e,tabIndex:g,postfix:G,...u}):n.jsx(_,{value:t,onChange:p,onBlur:d,onFocus:r,onSubmit:m,size:E,outline:h,loading:s,placeholder:k,className:b,ref:e,tabIndex:g,postfix:G,...u})});try{A.displayName="Search",A.__docgenInfo={description:"",displayName:"Search",props:{onFocus:{defaultValue:null,description:"Колбек обработки получения фокуса",name:"onFocus",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},onBlur:{defaultValue:null,description:"Колбек обработки потери фокуса",name:"onBlur",required:!1,type:{name:"FocusEventHandler<HTMLInputElement>"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"Значение input",name:"value",required:!1,type:{name:"string"}},onChange:{defaultValue:null,description:"Колбек смены значения",name:"onChange",required:!1,type:{name:"((value: string, e?: ChangeEvent<HTMLInputElement>) => void)"}},tabIndex:{defaultValue:null,description:"",name:"tabIndex",required:!1,type:{name:"number"}},size:{defaultValue:null,description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'},{value:'"l"'}]}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},placeholder:{defaultValue:null,description:"Значение плейсхолдера",name:"placeholder",required:!1,type:{name:"string"}},loading:{defaultValue:null,description:"Состояние загрузки",name:"loading",required:!1,type:{name:"boolean"}},onSubmit:{defaultValue:null,description:"Колбек на подтверждение поиска по строке",name:"onSubmit",required:!1,type:{name:"((value: string) => void)"}},outline:{defaultValue:null,description:"Внешний бордер",name:"outline",required:!1,type:{name:"boolean"}},postfix:{defaultValue:null,description:"Произвольный постфикс для поля",name:"postfix",required:!1,type:{name:"ReactNode"}},options:{defaultValue:null,description:`Элементы выпадающие в Droplist в режиме Autocomplete.

На нажатие 'Space', 'Enter' или клике по элементу будет вызываться onSubmit.
В режиме FieldText options отсутствуют`,name:"options",required:!1,type:{name:"BaseItem[]"}},autocomplete:{defaultValue:null,description:`Работа в режиме Autocomplete в значении true

Работа в режиме FieldText в значении false | undefined`,name:"autocomplete",required:!1,type:{name:"boolean"}}}}}catch{}const oe="submit-toaster";function P(o){return Array.from({length:o.length}).map((c,e)=>({id:o+e,content:{option:o+e,description:"some description"}}))}const de="_wrapper_19t1e_1",re="_scrollWrapper_19t1e_15",pe="_scroll_19t1e_15",he="_container_19t1e_23",ke="_card_19t1e_29",v={wrapper:de,scrollWrapper:re,scroll:pe,container:he,card:ke},Cn={title:"Components/Search",component:A},me=({autocomplete:o,showPostfix:c,...e})=>{const[t,p]=i.useState(e.value||""),[d,r]=i.useState(!1),[h,s]=i.useState([]),[k,m]=i.useState(t),b=i.useCallback(async u=>{k!==u&&(m(u),s(P(u)),r(!1))},[k]),g=i.useMemo(()=>K(b,300),[b]),G=u=>{p(u),g(u),r(!0)},E=()=>{W.userAction.success({label:"Submit action","data-test-id":oe})};i.useEffect(()=>g.cancel,[]),i.useEffect(()=>{e.value&&(p(e.value),m(e.value),s(P(e.value)))},[e.value]);const O=i.useMemo(()=>{if(c)return n.jsx(Y,{icon:n.jsx(X,{})})},[c]);return o?n.jsx("div",{className:v.wrapper,"data-outline":e.outline||void 0,children:n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,options:h,onSubmit:E,autocomplete:!0,postfix:O})}):n.jsxs("div",{className:v.wrapper,"data-outline":e.outline||void 0,children:[n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,autocomplete:void 0,options:void 0,onSubmit:E,postfix:O}),h.length>0&&n.jsx("div",{className:v.scrollWrapper,children:n.jsx(ee,{className:v.scroll,children:n.jsx("div",{className:v.container,children:h.map(u=>n.jsx(I,{className:v.card,header:n.jsx(I.Header,{title:u.content.option,description:u.content.description})},u.id))})})})]})},L={render:me,args:{size:C.S,placeholder:"Placeholder",autocomplete:!0,outline:!0,showPostfix:!0,"data-test-id":""},argTypes:{options:{name:"options",defaultValue:[],if:{arg:"autocomplete",eq:!0}},showPostfix:{name:"[Stories]: Show postfix slot"}},parameters:{readme:{sidebar:[`Latest version: ${T.version}`,ae,ne]},packageName:T.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A143287&mode=design"}}};var q,R,w;L.parameters={...L.parameters,docs:{...(q=L.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: Template,
  args: {
    size: SIZE.S,
...
}`,...(w=(R=L.parameters)==null?void 0:R.docs)==null?void 0:w.source}}};export{Cn as default,L as search};
