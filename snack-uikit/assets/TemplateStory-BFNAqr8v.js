import{r}from"./index-CJ_LmFaV.js";import{j as u}from"./jsx-runtime-BTJTZTIL.js";import{D as P}from"./index-h0kOFyIh.js";import{U as j}from"./index-DbF-M2Rm.js";import{T as U}from"./index-CGSydWJd.js";import{B as L}from"./ButtonFunction-C2wuI7Dc.js";import{c as I}from"./index-DUmpqB7p.js";import{T as M}from"./TruncateString-CGm6SssY.js";import{e as V}from"./componentPropsProcessors-UJEZy8aQ.js";import{t as C}from"./helpers-CRqi-QNk.js";import{g as K}from"./_commonjsHelpers-D6-XlEtG.js";import{D as z}from"./DropZone-H1GkPgsY.js";const q=r.createContext({});function v(){return r.useContext(q)}const X=r.createContext({focused:!1,setFocused:()=>{}});function J(){return r.useContext(X)}function Dn(n){if(!n)return n;const t=n.split(".");return t.pop(),t.length===1&&t[0]===""?n:t.join(".")}function Z(n){var t;return(t=n==null?void 0:n.split(".").pop())==null?void 0:t.toLocaleUpperCase()}function Y(n){return n.type.match(/image\/(png|jpg|jpeg|gif|webp|bmp|svg)/i)}function _n(n){const[t,o]=r.useState(void 0),[e,d]=r.useState(!1);return r.useEffect(()=>{if(n&&Y(n)){const i=new FileReader;i.onloadstart=()=>{d(!0)},i.onloadend=()=>{d(!1);const{result:c}=i;c&&o(c.toString())},i.readAsDataURL(n)}else o(void 0)},[n]),{imageData:t,loading:e}}const k="attachment",h={icon:`${k}__icon`,image:`${k}__image`,loading:`${k}__loading`,retryAction:`${k}__retry-action`,deleteAction:`${k}__delete-action`,downloadAction:`${k}__download-action`,title:`${k}__title`,description:`${k}__description`,error:`${k}__error`},$="_actions_1aog0_1",W="_retryAction_1aog0_6",w={actions:$,retryAction:W},nn=()=>{};function D({hideDelete:n,hideDownload:t,hideRetry:o}){const{onDelete:e,onDownload:d,file:i,disabled:c,onRetry:s}=v(),{setFocused:g=nn}=J(),A=d&&!t,G=e&&!n,E=s&&!o,b=()=>{g(!0)},l=()=>{g(!1)},N=a=>{s==null||s(),a.stopPropagation()},O=a=>{d==null||d(i),a.stopPropagation()},H=a=>{e==null||e(i),a.stopPropagation()};return!A&&!G?null:u.jsxs("div",{className:w.actions,children:[A&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(P,{}),onClick:O,onFocus:b,onBlur:l,"data-test-id":h.downloadAction}),E&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(j,{}),onClick:N,onFocus:b,onBlur:l,className:w.retryAction,"data-test-id":h.retryAction}),G&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(U,{}),onClick:H,onFocus:b,onBlur:l,"data-test-id":h.deleteAction})]})}try{D.displayName="Actions",D.__docgenInfo={description:"",displayName:"Actions",props:{hideDownload:{defaultValue:null,description:"",name:"hideDownload",required:!1,type:{name:"boolean"}},hideDelete:{defaultValue:null,description:"",name:"hideDelete",required:!1,type:{name:"boolean"}},hideRetry:{defaultValue:null,description:"",name:"hideRetry",required:!1,type:{name:"boolean"}}}}}catch{}function p({text:n,className:t,maxLines:o=1,...e}){const{truncateVariant:d}=v();return n?u.jsx("div",{className:t,children:u.jsx(M,{text:n,maxLines:o,variant:d,...V(e)})}):null}try{p.displayName="Text",p.__docgenInfo={description:"",displayName:"Text",props:{text:{defaultValue:null,description:"",name:"text",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!0,type:{name:"string"}},maxLines:{defaultValue:{value:"1"},description:"",name:"maxLines",required:!1,type:{name:"number"}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}}}}}catch{}const tn="_content_1nvre_1",en="_title_1nvre_16",cn="_description_1nvre_24",an="_error_1nvre_25",f={content:tn,title:en,description:cn,error:an};function _({title:n,description:t,error:o,className:e,align:d="left"}){const{size:i,truncate:c={}}=v();return u.jsxs("div",{className:I(f.content,e),"data-size":i,"data-align":d,children:[u.jsx(p,{className:f.title,text:n,"data-test-id":h.title,maxLines:c==null?void 0:c.title}),u.jsx(p,{className:f.description,text:t,"data-test-id":h.description,maxLines:c==null?void 0:c.description}),u.jsx(p,{className:f.error,text:o,"data-test-id":h.error,maxLines:c==null?void 0:c.error})]})}try{_.displayName="TextBlock",_.__docgenInfo={description:"",displayName:"TextBlock",props:{className:{defaultValue:null,description:"CSS-класс для элемента с контентом",name:"className",required:!1,type:{name:"string"}},title:{defaultValue:{value:"fileName"},description:"Заголовок",name:"title",required:!1,type:{name:"string"}},description:{defaultValue:{value:"fileExtension"},description:"Описание",name:"description",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Сообщение об ошибке",name:"error",required:!1,type:{name:"string"}},align:{defaultValue:{value:"left"},description:"",name:"align",required:!1,type:{name:"enum",value:[{value:'"center"'},{value:'"left"'}]}}}}}catch{}const sn=`# Change Log
