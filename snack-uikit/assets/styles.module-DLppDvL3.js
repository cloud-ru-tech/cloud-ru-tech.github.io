import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as V}from"./index-DUmpqB7p.js";import{r as p}from"./index-CJ_LmFaV.js";import{I as M,A as j,a as w,C as R}from"./index-CAfvFIBF.js";import{K as q}from"./index-B80hK4m0.js";import{D as Y}from"./DropList-o7olARL3.js";import{B as z}from"./ButtonFunction-CawjluWV.js";import{T as K}from"./Tag-BEBGOq3Q.js";import{e as W}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as m}from"./Typography-DmSN6cv6.js";import{T as H}from"./TruncateString-D54BiV_x.js";import{B as U}from"./ButtonSimple-iluLro46.js";import{B as J}from"./ButtonTonal-BAM_PsxW.js";import{L as Q}from"./Link-D99a5Mz9.js";import{t as $}from"./helpers-DYmLWXgH.js";const xt=`# Change Log
...
- Initial version
`,X="@snack-uikit/notification",Z="0.13.24",Pt={name:X,version:Z},Tt=`# Notification
...
`,u={Neutral:"neutral",Error:"error",ErrorCritical:"errorCritical",Warning:"warning",Success:"success"},i={label:"notification-card__label",title:"notification-card__title",content:"notification-card__content",link:"notification-card__link",date:"notification-card__date",actions:{wrapper:"notification-card__actions",droplist:"notification-card__droplist",droplistTrigger:"notification-card__droplist-trigger",droplistAction:"notification-card__droplist-action"},primaryButton:"notification-card__primary-button",secondaryButton:"notification-card__secondary-button"},tt="_notificationCardFunction_138gs_1",nt="_notificationCardTitleText_138gs_12",ct="_notificationCardTitleIcon_138gs_17",it="_notificationCard_138gs_1",st="_notificationCardLabel_138gs_107",at="_notificationCardTitle_138gs_12",et="_notificationCardContent_138gs_120",ut="_notificationCardFooter_138gs_126",kt="_notificationCardDate_138gs_133",ot="_notificationCardButtons_138gs_140",a={notificationCardFunction:tt,notificationCardTitleText:nt,notificationCardTitleIcon:ct,notificationCard:it,notificationCardLabel:st,notificationCardTitle:at,notificationCardContent:et,notificationCardFooter:ut,notificationCardDate:kt,notificationCardButtons:ot};function N({actions:n,open:s,setDroplistOpen:e}){return t.jsx("div",{className:a.notificationCardFunction,"data-test-id":i.actions.wrapper,children:t.jsx(Y,{trigger:"clickAndFocusVisible",open:s,onOpenChange:e,placement:"bottom-end",scroll:!0,"data-test-id":i.actions.droplist,items:n.map(({onClick:k,disabled:g,content:l,tagLabel:c,icon:o})=>({onClick:r=>{e(!1),k==null||k(r)},disabled:g,content:l,beforeContent:o,afterContent:c?t.jsx(K,{label:c}):void 0,"data-test-id":i.actions.droplistAction})),children:t.jsx(z,{size:"s",icon:t.jsx(q,{}),"data-test-id":i.actions.droplistTrigger})})})}try{N.displayName="NotificationCardFunction",N.__docgenInfo={description:"",displayName:"NotificationCardFunction",props:{actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},setDroplistOpen:{defaultValue:null,description:"",name:"setDroplistOpen",required:!0,type:{name:"Dispatch<SetStateAction<boolean>>"}}}}}catch{}function E(n){switch(n){case u.Success:return t.jsx(R,{size:16});case u.Error:case u.ErrorCritical:return t.jsx(w,{size:16});case u.Warning:return t.jsx(j,{size:16});case u.Neutral:return t.jsx(M,{size:16});default:return null}}try{E.displayName="getIcon",E.__docgenInfo={description:"",displayName:"getIcon",props:{}}}catch{}function f({id:n,appearance:s=u.Neutral,label:e,unread:k,title:g,content:l,link:c,date:o,onClick:r,primaryButton:G,secondaryButton:O,actions:b,onVisible:C,className:_,...B}){const S=p.useMemo(()=>E(s),[s]),[A,D]=p.useState(!1),L=p.useRef(null);p.useEffect(()=>{if(!k||!C)return;const d=T=>{const[I]=T;I.isIntersecting&&C(n)},h=new IntersectionObserver(d,{root:null,threshold:.8,rootMargin:"0px"});return h.observe(L.current),()=>{h.disconnect()}},[n,C,k]);const x=!!(c||o),P=d=>{var h;d.stopPropagation(),(h=c==null?void 0:c.onClick)==null||h.call(c,d)};return t.jsxs("div",{ref:L,role:"button",onClick:r,tabIndex:0,...W(B),"data-appearance":s,"data-unread":k||void 0,"data-clickable":!!r||void 0,"data-droplist-open":A||void 0,className:V(a.notificationCard,_),children:[(b==null?void 0:b.length)&&t.jsx(N,{actions:b,open:A,setDroplistOpen:D}),e&&t.jsx(m.LightLabelS,{tag:"div",className:a.notificationCardLabel,children:t.jsx(H,{maxLines:1,text:e,"data-test-id":i.label})}),t.jsxs("div",{className:a.notificationCardTitle,children:[t.jsx("div",{className:a.notificationCardTitleIcon,children:S}),t.jsx(m.SansTitleS,{tag:"div",className:a.notificationCardTitleText,children:t.jsx(H,{maxLines:2,text:g,"data-test-id":i.title})})]}),l&&t.jsx(m.SansBodyS,{tag:"div",className:a.notificationCardContent,"data-test-id":i.content,children:l}),(G||O)&&t.jsxs("div",{className:a.notificationCardButtons,children:[O&&t.jsx(U,{...O,appearance:"neutral",size:"s","data-test-id":i.primaryButton}),G&&t.jsx(J,{...G,appearance:"neutral",size:"s","data-test-id":i.secondaryButton})]}),x&&t.jsxs("div",{className:a.notificationCardFooter,children:[c&&t.jsx(Q,{...c,onClick:P,appearance:"primary",textMode:"accent",size:"s","data-test-id":i.link}),o&&t.jsx(m.LightLabelS,{className:a.notificationCardDate,"data-test-id":i.date,children:o})]})]})}try{f.displayName="NotificationCard",f.__docgenInfo={description:"Компонент карточки уведомления",displayName:"NotificationCard",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"Идентификатор уведомления",name:"id",required:!0,type:{name:"string"}},appearance:{defaultValue:{value:"neutral"},description:"Тип уведомления",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"neutral"'},{value:'"warning"'},{value:'"success"'},{value:'"errorCritical"'}]}},label:{defaultValue:null,description:"Лейбл перед заголовком",name:"label",required:!1,type:{name:"string"}},unread:{defaultValue:null,description:"Управление состоянием прочитано/не прочитано",name:"unread",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"Заголовок уведомления",name:"title",required:!0,type:{name:"string"}},content:{defaultValue:null,description:"Контент уведомления",name:"content",required:!0,type:{name:"ReactNode"}},link:{defaultValue:null,description:"Ссылка",name:"link",required:!1,type:{name:'PickLinkProps<LinkElement, "text" | "truncateVariant" | "insideText">'}},date:{defaultValue:null,description:"Дата уведомления",name:"date",required:!0,type:{name:"string"}},onClick:{defaultValue:null,description:"Колбэк клика по карточке",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onVisible:{defaultValue:null,description:"Колбэк при попадании карточки в область видимости на 80%",name:"onVisible",required:!1,type:{name:"((cardId: string) => void)"}},primaryButton:{defaultValue:null,description:"Кнопка главного действия у карточки",name:"primaryButton",required:!1,type:{name:'Omit<ButtonTonalProps, "data-test-id" | "size" | "appearance">'}},secondaryButton:{defaultValue:null,description:"Кнопка второстепенного действия у карточки",name:"secondaryButton",required:!1,type:{name:'Omit<ButtonSimpleProps, "data-test-id" | "size" | "appearance">'}},actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}}}}}catch{}const ht={card:"notification-card",toaster:"toaster",blank:"panel-blank"},lt={id:"cardId",label:["Category","Subcategory"].join("・"),appearance:u.Neutral,title:"Title truncate two line",content:`Demo content.

For replacement, use Property: ◆ProdContent. Replace this element with your local component with the original content.`,link:{text:"Link to detailed information",href:"#"},date:"DD.MM.YYYY HH:MM",actions:[{content:{option:"action 1"}},{content:{option:"action 2"}}]},It={amount:10,title:"Notifications",readAllButton:{label:"Mark all as read",tooltip:{tip:"Your tip could be here"}},footerButton:{label:"All events"}},v=n=>{$.userAction.success({label:n.currentTarget.textContent||"","data-test-id":ht.toaster})};function y(n,s){return Math.floor(Math.random()*(s-n+1)+n)}const F=Object.values(u);function Vt(n){const s=[];for(let e=0;e<n;++e)s.push({...lt,id:String(e),unread:!!y(0,1),appearance:F[y(0,F.length-1)],primaryButton:{label:"Primary button",onClick:v},secondaryButton:{label:"Secondary button",onClick:v}});return s}const rt="_pageWrapper_7p5lo_1",bt="_controlledWrapper_7p5lo_13",dt="_controlledCard_7p5lo_28",pt="_table_7p5lo_32",mt="_cell_7p5lo_40",gt="_headerCell_7p5lo_48",Gt="_card_7p5lo_53",Mt={pageWrapper:rt,controlledWrapper:bt,controlledCard:dt,table:pt,cell:mt,headerCell:gt,card:Gt};export{u as A,f as N,ht as S,Tt as a,xt as b,Pt as c,lt as d,a as e,It as f,Vt as g,v as h,Mt as s};
