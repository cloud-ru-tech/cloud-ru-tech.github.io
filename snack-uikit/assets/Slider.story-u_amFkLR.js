...
- Initial version
`,E="@snack-uikit/slider",C="0.3.32",u={name:E,version:C},y=`# Slider
...
`,N="_wrapper_1r7by_1",A={wrapper:N},$={title:"Components/Slider",component:b},l={1:"512mb",4:"2gb",8:"4gb",16:"8gb"},f={1:"1",4:"4",8:"8",12:"12",16:"16"},r={none:"none",linear:"linear","not-linear":"not-linear"},d=[4,8],L=({storyMarks:n,moveByMarks:h,step:g,...t})=>{const[c,o]=a.useState(d);a.useEffect(()=>{o(d)},[t.range]);const O=a.useMemo(()=>{switch(n){case"not-linear":return l;case"linear":return f;case"none":default:return}},[n]),G=a.useCallback(e=>{switch(n){case"not-linear":return l[Number(e)];case"linear":case"none":default:return e}},[n]);return s.jsx("div",{className:A.wrapper,children:s.jsx(b,{...t,value:t.range?c:c[0],onChange:e=>{t.range?o(e):o([e])},step:h&&n!=="none"?null:g,marks:O,tipFormatter:G})})},i={render:L,args:{className:"osThemeSnack",min:1,max:16,storyMarks:"not-linear",step:1,moveByMarks:!0,handleTip:!0,range:!1,reverse:!1},argTypes:{storyMarks:{name:"[Story]: example marks",options:Object.keys(r),mapping:r,control:{type:"radio"}},moveByMarks:{name:"[Story]: change value only by marks",type:"boolean"},step:{if:{arg:"moveByMarks",eq:!1}}},parameters:{readme:{sidebar:[`Latest version: ${u.version}`,y,v]},packageName:u.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-5.0.0?node-id=1755-108937&m=dev"}}};var m,p,k;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: Template,
  args: {
...
}`,...(k=(p=i.parameters)==null?void 0:p.docs)==null?void 0:k.source}}};export{$ as default,i as slider};
