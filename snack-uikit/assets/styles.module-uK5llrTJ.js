import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as R}from"./index-CXM-PPQz.js";import{r as G}from"./index-CJ_LmFaV.js";import{I as J,A as $,a as M,C as V}from"./index-CAfvFIBF.js";import{D as j}from"./DropList-BBWyT9IX.js";import{B as w}from"./ButtonFunction-ctF4tyrm.js";import{T as Y}from"./Tag-B6mtpPJU.js";import{K as q}from"./index-B80hK4m0.js";import{T as C}from"./Typography-B-8nXnBH.js";import{T as f}from"./TruncateString-BO9DNutf.js";import{B as z}from"./ButtonSimple-DhblX_Cq.js";import{B as K}from"./ButtonTonal-CMekq5wC.js";import{L as W}from"./Link-DHkA6i0J.js";import{S as Q}from"./StatusIndicator-Bd2AgtNl.js";import{e as X}from"./componentPropsProcessors-UJEZy8aQ.js";import{t as Z}from"./helpers-CMZz49tI.js";const $t=`# Change Log
...
- Initial version
`,tt="@snack-uikit/notification",nt="0.14.8",Mt={name:tt,version:nt},Vt=`# Notification
...
`,o={Neutral:"neutral",Error:"error",ErrorCritical:"errorCritical",Warning:"warning",Success:"success"},s={label:"notification-card__label",title:"notification-card__title",content:"notification-card__content",link:"notification-card__link",date:"notification-card__date",actions:{wrapper:"notification-card__actions",droplist:"notification-card__droplist",droplistTrigger:"notification-card__droplist-trigger",droplistAction:"notification-card__droplist-action"},primaryButton:"notification-card__primary-button",secondaryButton:"notification-card__secondary-button"};function L(n){switch(n){case o.Success:return t.jsx(V,{size:16});case o.Error:case o.ErrorCritical:return t.jsx(M,{size:16});case o.Warning:return t.jsx($,{size:16});case o.Neutral:return t.jsx(J,{size:16});default:return null}}function O(n){n.stopPropagation()}try{L.displayName="getIcon",L.__docgenInfo={description:"",displayName:"getIcon",props:{}}}catch{}try{O.displayName="stopPropagationClick",O.__docgenInfo={description:"",displayName:"stopPropagationClick",props:{}}}catch{}const ct="_container_11i26_1",it={container:ct};function N({actions:n,open:a,setDroplistOpen:i,size:u,icon:l,className:k}){return t.jsx("div",{className:R(it.container,k),"data-test-id":s.actions.wrapper,onClick:O,children:t.jsx(j,{trigger:"clickAndFocusVisible",open:a,onOpenChange:i,placement:"bottom-end",scroll:!0,"data-test-id":s.actions.droplist,items:n.map(({onClick:c,disabled:b,content:m,tagLabel:h,icon:d})=>({onClick:r=>{i(!1),c==null||c(r)},disabled:b,content:m,beforeContent:d,afterContent:h?t.jsx(Y,{label:h}):void 0,"data-test-id":s.actions.droplistAction})),children:t.jsx(w,{size:u,icon:l,"data-test-id":s.actions.droplistTrigger})})})}try{N.displayName="ActionsButton",N.__docgenInfo={description:"",displayName:"ActionsButton",props:{actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},setDroplistOpen:{defaultValue:null,description:"",name:"setDroplistOpen",required:!0,type:{name:"Dispatch<SetStateAction<boolean>>"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},icon:{defaultValue:null,description:"",name:"icon",required:!0,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const at="_notificationCardFunction_1k92d_1",et="_notificationCardTitleText_1k92d_12",st="_notificationCardTitleIcon_1k92d_17",ut="_statusIndicator_1k92d_26",kt="_notificationCard_1k92d_1",ot="_notificationCardLabel_1k92d_114",lt="_notificationCardTitle_1k92d_12",ht="_notificationCardContent_1k92d_127",rt="_notificationCardFooter_1k92d_133",bt="_notificationCardDate_1k92d_140",dt="_notificationCardButtons_1k92d_147",e={notificationCardFunction:at,notificationCardTitleText:et,notificationCardTitleIcon:st,statusIndicator:ut,notificationCard:kt,notificationCardLabel:ot,notificationCardTitle:lt,notificationCardContent:ht,notificationCardFooter:rt,notificationCardDate:bt,notificationCardButtons:dt};function v({id:n,appearance:a=o.Neutral,label:i,unread:u,title:l,content:k,link:c,date:b,onClick:m,primaryButton:h,secondaryButton:d,actions:r,onVisible:E,className:B,...U}){const T=G.useMemo(()=>L(a),[a]),[A,F]=G.useState(!1),H=G.useRef(null);G.useEffect(()=>{if(!u||!E)return;const g=D=>{const[x]=D;x.isIntersecting&&E(n)},p=new IntersectionObserver(g,{root:null,threshold:.8,rootMargin:"0px"});return p.observe(H.current),()=>{p.disconnect()}},[n,E,u]);const I=!!(c||b),S=g=>{var p;g.stopPropagation(),(p=c==null?void 0:c.onClick)==null||p.call(c,g)};return t.jsxs("div",{ref:H,role:"button",onClick:m,tabIndex:0,...X(U),"data-appearance":a,"data-unread":u||void 0,"data-clickable":!!m||void 0,"data-droplist-open":A||void 0,className:R(e.notificationCard,B),children:[(r==null?void 0:r.length)&&t.jsx(N,{className:e.notificationCardFunction,actions:r,open:A,setDroplistOpen:F,size:"s",icon:t.jsx(q,{})}),i&&t.jsx(C.LightLabelS,{tag:"div",className:e.notificationCardLabel,children:t.jsx(f,{maxLines:1,text:i,"data-test-id":s.label})}),t.jsxs("div",{className:e.notificationCardTitle,children:[t.jsx("div",{className:e.notificationCardTitleIcon,children:T}),t.jsx(C.SansTitleS,{tag:"div",className:e.notificationCardTitleText,children:t.jsx(f,{maxLines:2,text:l,"data-test-id":s.title})})]}),k&&t.jsx(C.SansBodyS,{tag:"div",className:e.notificationCardContent,"data-test-id":s.content,children:k}),(h||d)&&t.jsxs("div",{className:e.notificationCardButtons,onClick:O,children:[d&&t.jsx(z,{...d,appearance:"neutral",size:"s","data-test-id":s.primaryButton}),h&&t.jsx(K,{...h,appearance:"neutral",size:"s","data-test-id":s.secondaryButton})]}),I&&t.jsxs("div",{className:e.notificationCardFooter,children:[c&&t.jsx(W,{...c,onClick:S,appearance:"primary",textMode:"accent",size:"s","data-test-id":s.link}),b&&t.jsx(C.LightLabelS,{className:e.notificationCardDate,"data-test-id":s.date,children:b})]}),u&&t.jsx(Q,{className:e.statusIndicator,size:"xs",appearance:"primary"})]})}try{v.displayName="NotificationCard",v.__docgenInfo={description:"Компонент карточки уведомления",displayName:"NotificationCard",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"Идентификатор уведомления",name:"id",required:!0,type:{name:"string"}},appearance:{defaultValue:{value:"neutral"},description:"Тип уведомления",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"error"'},{value:'"warning"'},{value:'"success"'},{value:'"errorCritical"'}]}},label:{defaultValue:null,description:"Лейбл перед заголовком",name:"label",required:!1,type:{name:"string"}},unread:{defaultValue:null,description:"Управление состоянием прочитано/не прочитано",name:"unread",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"Заголовок уведомления",name:"title",required:!0,type:{name:"string"}},content:{defaultValue:null,description:"Контент уведомления",name:"content",required:!0,type:{name:"ReactNode"}},link:{defaultValue:null,description:"Ссылка",name:"link",required:!1,type:{name:`(Pick<{ 'data-test-id'?: string; } & AriaAttributes & { text?: string; size?: Size | undefined; purpose?: Purpose | undefined; appearance?: Appearance | undefined; textMode?: TextMode | undefined; insideText?: boolean | undefined; } & TruncateEndProps & { ...; } & Omit<...>, "truncateVariant"...`}},date:{defaultValue:null,description:"Дата уведомления",name:"date",required:!0,type:{name:"string"}},onClick:{defaultValue:null,description:"Колбэк клика по карточке",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onVisible:{defaultValue:null,description:"Колбэк при попадании карточки в область видимости на 80%",name:"onVisible",required:!1,type:{name:"((cardId: string) => void)"}},primaryButton:{defaultValue:null,description:"Кнопка главного действия у карточки",name:"primaryButton",required:!1,type:{name:'Omit<ButtonTonalProps, "data-test-id" | "size" | "appearance">'}},secondaryButton:{defaultValue:null,description:"Кнопка второстепенного действия у карточки",name:"secondaryButton",required:!1,type:{name:'Omit<ButtonSimpleProps, "data-test-id" | "size" | "appearance">'}},actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}}}}}catch{}const pt={card:"notification-card",toaster:"toaster",blank:"panel-blank"},mt={id:"cardId",label:["Category","Subcategory"].join("・"),appearance:o.Neutral,title:"Title truncate two line",content:`Demo content.

For replacement, use Property: ◆ProdContent. Replace this element with your local component with the original content.`,link:{text:"Link to detailed information",href:"#"},date:"DD.MM.YYYY HH:MM",actions:[{content:{option:"action 1"}},{content:{option:"action 2"}}]},jt={amount:20,groupSize:2,stackSize:3,title:"Notifications",readAllButton:{label:"Mark all as read",tooltip:{tip:"Your tip could be here"}},footerButton:{label:"All events"}},y=n=>{Z.userAction.success({label:n.currentTarget.textContent||"","data-test-id":pt.toaster})};function _(n,a){return Math.floor(Math.random()*(a-n+1)+n)}const P=Object.values(o);function wt(n){const a=[];for(let i=0;i<n;++i)a.push({...mt,id:String(i),unread:!!_(0,1),appearance:P[_(0,P.length-1)],primaryButton:{label:"Primary button",onClick:y},secondaryButton:{label:"Secondary button",onClick:y}});return a}function Yt({bunchSize:n,renderBunch:a,items:i}){const u=Array.isArray(i)?i:[i];if(n<=0)return u;const l=[];for(let k=0;k<u.length;k+=n){const c=k/n;l.push(a(u.slice(k,k+n),c))}return l}const gt="_pageWrapper_1foau_1",Gt="_controlledWrapper_1foau_13",Ct="_controlledCard_1foau_28",Ot="_table_1foau_32",Et="_cell_1foau_40",Lt="_headerCell_1foau_48",Nt="_card_1foau_53",At="_backdrop_1foau_57",qt={pageWrapper:gt,controlledWrapper:Gt,controlledCard:Ct,table:Ot,cell:Et,headerCell:Lt,card:Nt,backdrop:At};export{o as A,v as N,pt as S,Vt as a,$t as b,Mt as c,mt as d,jt as e,Yt as f,wt as g,y as h,e as i,N as j,qt as s};
