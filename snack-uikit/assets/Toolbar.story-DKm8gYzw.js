import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{r as k}from"./index-CJ_LmFaV.js";import{t as n}from"./helpers-Bb_FfY3_.js";import{T as i,a as R}from"./Toolbar-Bo-r2GHN.js";import{P as s}from"./index-DW7JD-Lj.js";import{C as Q}from"./index-Df-dmYFR.js";import{C as z}from"./index-C3gycbXm.js";import{T as W}from"./index-OG_QCddz.js";import{e as Y}from"./componentPropsProcessors-UJEZy8aQ.js";import{B as N}from"./ButtonFunction-CtElqV7K.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-D8ciwPN-.js";import"./index-BRq5TIsn.js";import"./index-CXM-PPQz.js";import"./index-Chjiymov.js";import"./index-Cxdp8tlc.js";import"./ProgressBar-G0ToIzOu.js";import"./index-BPI37A09.js";import"./index-S9IyB2Vz.js";import"./index-BDKfaAX1.js";import"./TruncateString-DMHAWZlY.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DaeWZEms.js";import"./PopoverPrivate-BQgi56s-.js";import"./index-JZGyZbA2.js";import"./Link-cLNEphnk.js";import"./LocaleProvider-XVitSj_D.js";import"./Scroll-p7EvfiBx.js";import"./Sun-DVH5ADpI.js";import"./constants-BAH7I9kc.js";import"./ChipChoiceRow-CcE-KqBs.js";import"./constants-BIigMBdG.js";import"./index-BiMXMqy2.js";import"./FuzzySearch-C8qpdhmO.js";import"./ButtonFilled-DZiul5Ky.js";import"./utils-d0rn_W0T.js";import"./Counter-C_DywCEs.js";import"./index-B7wZyJkK.js";import"./useValueControl-CNLw7ht-.js";import"./Dropdown-CJIpH82E.js";import"./hooks-Cb7q2uDh.js";import"./Checkbox-BrjwspCG.js";import"./constants-BObEONKm.js";import"./TogglePrivate-D_Ey2AsU.js";import"./index-CP5aoo4S.js";import"./Switch-CnO5GMY9.js";import"./index-00FjgX9j.js";import"./index-CsyvGLEa.js";import"./index-DCrMFnLF.js";import"./IconPredefined-DvZvK1aQ.js";import"./Typography-B_4XbOMz.js";import"./ButtonTonal-CmQYw77c.js";import"./Divider-CUoM6iCM.js";import"./Spinner-BJeEd4V6.js";import"./useButtonNavigation-EjhHKyx9.js";import"./useClearButton-C6OboUMx.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-uCEkO2Kz.js";import"./DropList-DEhmQza7.js";import"./Calendar-D0YVXJqx.js";import"./TimePickerBase-4GF_QIc_.js";import"./List-SKxEdaQm.js";import"./TimePicker-C_3Glmvs.js";import"./index-BURG081a.js";import"./index-C11pXQBT.js";import"./Tag-CA014ENK.js";import"./constants-BaREPXw5.js";const Z=`# Change Log
...
- Initial version
`,X="@snack-uikit/toolbar",tt="0.14.25",H={name:X,version:tt},nt=`# Toolbar
...
`,e={submit:"submit-toaster",delete:"delete-toaster",deactivate:"deactivate-toaster",disabled:"disabled-toaster",confirm:"confirm-toaster",reject:"reject-toaster",refresh:"refresh-toaster",option:"option-toaster"},l={pinnedSingleFilter:"pinned-single-filter",pinnedMultiFilter:"pinned-multi-filter",singleFilter:"single-filter",dateFilter:"date-filter"};function m(c){return Array.from({length:Number(c)||3}).map((a,u)=>({content:{option:`Option ${u+1}`},onClick:()=>n.userAction.neutral({label:`Option ${u+1} clicked`,"data-test-id":e.option}),icon:t.jsx(s,{})}))}function f({outline:c,selectionMode:a}){return{outline:c,selectionMode:a}}try{m.displayName="generateOptions",m.__docgenInfo={description:"",displayName:"generateOptions",props:{}}}catch{}try{f.displayName="extractToolbarArgs",f.__docgenInfo={description:"",displayName:"extractToolbarArgs",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},search:{defaultValue:null,description:`Параметры отвечают за строку поиска <br>
...
Поле id должно быть уникальным для каждого инстанса компонента. <br>`,name:"persist",required:!1,type:{name:"ToolbarPersistConfig<TState>"}}}}}catch{}const et=3,S=m(et),ct=[{label:"Confirm",icon:Q,onClick:()=>n.userAction.warning({label:"Confirm","data-test-id":e.confirm}),"data-test-id":i.confirmAction},{label:"Remove confirmation",icon:z,onClick:()=>n.userAction.warning({label:"Reject","data-test-id":e.reject}),"data-test-id":i.rejectAction},{label:"Delete",icon:W,onClick:()=>n.userAction.warning({label:"Delete","data-test-id":e.delete}),disabled:!0,tooltip:"One of the selected objects cannot be deleted in bulk","data-test-id":i.deleteAction},{label:"Deactivate",icon:s,onClick:()=>n.userAction.warning({label:"Deactivate","data-test-id":e.deactivate}),"data-test-id":i.deactivateAction},{label:"Disabled Action",icon:s,onClick:()=>n.userAction.warning({label:"Disabled","data-test-id":e.disabled}),disabled:!0,tooltip:"Example of disabled action in the list","data-test-id":i.disabledAction}],it={showAddButton:!0,showClearButton:!0,filters:[{id:"multi1",label:"Multi",type:"multiple",pinned:!0,options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],"data-test-id":l.pinnedMultiFilter},{id:"multi2",label:"Multi with apply button",type:"multiple",options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],autoApply:!1},{id:"single3",label:"Single",type:"single",pinned:!0,options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],"data-test-id":l.pinnedSingleFilter},{id:"single4",label:"Single with apply button",type:"single",options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],autoApply:!1,"data-test-id":l.singleFilter},{id:"date5",label:"Date",type:"date","data-test-id":l.dateFilter},{id:"time6",label:"Time",type:"time"}]},st="_wrapper_1bq79_1",at={wrapper:st},{useArgs:ut}=__STORYBOOK_MODULE_PREVIEW_API__,Hn={title:"Components/Toolbar",component:R},ot=({showOnRefresh:c,showBulkActions:a,showManyBulkActions:u,showFilters:_,filterRowOpened:P,showAfterActions:B,showSearch:T,showMoreActions:w,outline:U,selectionMode:p,filterRow:g,enablePersist:D,...d})=>{var A;const I=u?d.bulkActions:(A=d.bulkActions)==null?void 0:A.slice(0,3),[{checked:o,indeterminate:x},r]=ut(),[V,G]=k.useState({}),[q,O]=k.useState([]),[$,C]=k.useState(""),J=()=>{r({checked:!o})};k.useEffect(()=>{o&&(b=>{r({indeterminate:b})})(!1)},[o,r]);const M=()=>n.userAction.neutral({label:"Refresh","data-test-id":e.refresh}),j=()=>n.userAction.success({label:"Submit","data-test-id":e.submit}),K=t.jsxs(t.Fragment,{children:[t.jsx(N,{icon:t.jsx(s,{}),size:"m"}),t.jsx(N,{icon:t.jsx(s,{}),size:"m"})]});return t.jsx("div",{className:at.wrapper,children:t.jsx(R,{...Y(d),outline:U,selectionMode:p,...p==="multiple"?{checked:o,onCheck:J,bulkActions:a?I:void 0,indeterminate:x}:{},search:T?{value:$,onChange:C,onSubmit:j}:void 0,onRefresh:c?M:void 0,after:B?K:void 0,moreActions:w?S:void 0,filterRow:_&&g?{...g,open:P,value:V,onChange:G,visibleFilters:q,onVisibleFiltersChange:O}:void 0,persist:D?{id:"toolbar_filters_story",filterQueryKey:"filters",onLoad:({filter:E,search:b})=>{const L=E||{};G(L),O(Object.keys(L)),C(b||"")}}:void 0})})},h={render:ot,args:{outline:!1,selectionMode:"multiple",checked:!1,indeterminate:!1,showBulkActions:!0,showManyBulkActions:!0,bulkActions:ct,showSearch:!0,search:{value:"",placeholder:"Search",loading:!1,onChange(){}},showFilters:!0,filterRow:it,filterRowOpened:void 0,showMoreActions:!0,moreActions:S,showOnRefresh:!0,showAfterActions:!0,"data-test-id":"toolbar"},argTypes:{checked:{if:{arg:"selectionMode",eq:"multiple"}},indeterminate:{if:{arg:"selectionMode",eq:"multiple"}},showBulkActions:{name:"[Story]: Show bulk actions",type:"boolean"},showManyBulkActions:{name:"[Story]: Show many bulk actions to display droplist",type:"boolean",if:{arg:"showBulkActions",eq:!0}},bulkActions:{if:{arg:"showBulkActions",eq:!0}},showFilters:{name:"[Story]: Show filters",type:"boolean"},filterRowOpened:{name:"[Story]: Filter row open",type:"boolean",if:{arg:"showFilters",eq:!0}},filterRow:{if:{arg:"showFilters",eq:!0}},showOnRefresh:{name:"[Story]: Apply onRefresh callback",type:"boolean"},showSearch:{name:"[Story]: Apply search props",type:"boolean"},search:{table:{disable:!0}},showAfterActions:{name:'[Story]: Show custom ReactNode "after" (on the right side)',type:"boolean"},showMoreActions:{name:"[Story]: Show moreActions",type:"boolean"},enablePersist:{name:"[Story]: Enable filters persist",type:"boolean"},moreActions:{if:{arg:"showMoreActions",eq:!0}},after:{table:{disable:!0}},onCheck:{table:{disable:!0}},onRefresh:{table:{disable:!0}}},parameters:{readme:{sidebar:[`Latest version: ${H.version}`,nt,Z]},packageName:H.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A224846&mode=design"}}};var v,y,F;h.parameters={...h.parameters,docs:{...(v=h.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: Template,
  args: {
    outline: false,
    selectionMode: 'multiple',
...
}`,...(F=(y=h.parameters)==null?void 0:y.docs)==null?void 0:F.source}}};export{Hn as default,h as toolbar};
