import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{c as d}from"./index-DUmpqB7p.js";import{r as p}from"./index-CJ_LmFaV.js";import{T as u,a as N,S as k,P as f,F as y}from"./Typography-ChgE300v.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";const E=`# Change Log
...
- Initial version
`,G="@snack-uikit/typography",T="0.8.7",m={name:G,version:T},S='# Typography\n\n## Installation\n`npm i @snack-uikit/typography`\n\n[Changelog](./CHANGELOG.md)\n\n## Example\n\n```typescript jsx\nimport { Typography } from "@snack-uikit/typography";\n\n<Typography \n  family=\'sans\'\n  purpose=\'display\'\n  size=\'s\'\n  tag=\'h1\'\n  className=\'some-element\'\n>\n  Some text\n</Typography>\n```\n\nТакже чтобы не указывать пропсы family, purpose и size, воспользуйтесь нужным предустановленным вариантом, например:\n```typescript jsx\n<Typography.SansDisplayS tag=\'h1\' className=\'some-element\'>\n  Some text\n</Typography.SansDisplayS>\n```\n\nВсе компоненты вида ```<Typography.{Family}{Purpose}{Size} /> ``` генерируются автоматически при выполнении команды `npm run build:packages`.\n\n## Как добавить новый компонент такого вида?\n1. Добавить новое свойство в один или несколько объектов FAMILY, PURPOSE, SIZE в файле `constants.ts`, который лежит в  `typography/src/components/constants.ts`\n2. Запустить скрипт compile в package.json пакета `@typography`\n    ```json\n    "npm run build:typography-components && npm run build:constants && npm run build:index"\n    ```\n3. Готово! Можете использовать `Typography` с новым свойством\n\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## Typography\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| size* | enum Size: `"s"`, `"l"`, `"m"` | - | Размер |\n| purpose* | enum Purpose: `"label"`, `"body"`, `"title"`, `"display"`, `"headline"` | - | Роль |\n| family* | enum Family: `"link"`, `"sans"`, `"light"`, `"mono"`, `"crossed-out"` | - | Шрифт |\n| tag | enum Tag: `"span"`, `"h1"`, `"h2"`, `"h3"`, `"h4"`, `"h5"`, `"h6"`, `"div"`, `"label"`, `"p"` | span | HTML-тег |\n| className | `string` | - | CSS-класс |\n| children | `ReactNode` | - | Контент |\n\n\n[//]: DOCUMENTATION_SECTION_END\n',x="_wrapper_5ab24_1",A="_table_5ab24_11",j="_cell_5ab24_20",L="_headerCell_5ab24_29",_="_firstCell_5ab24_33",n={wrapper:x,table:A,cell:j,headerCell:L,firstCell:_},M={title:"Components/Typography",component:u},w=({...F})=>{const l=Object.values(y),O=Object.values(k),v=Object.values(f),c=d(n.cell,n.headerCell),r=d(n.cell,n.headerCell,n.firstCell),C=d(n.cell,n.firstCell);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:n.wrapper,children:e.jsx(u,{...F})}),e.jsxs("div",{className:n.table,children:[e.jsxs(e.Fragment,{children:[e.jsx("div",{className:c,children:"Purpose"}),e.jsx("div",{className:c,children:"Size"}),l.map(t=>e.jsx("div",{className:c,children:t},t))]}),v.map(t=>e.jsx(p.Fragment,{children:O.map((s,i)=>e.jsxs(p.Fragment,{children:[e.jsx("div",{className:i===0?r:c,children:t}),e.jsx("div",{className:i===0?r:c,children:s}),l.map(o=>e.jsx("div",{className:i===0?C:n.cell,children:e.jsx(u,{family:o,purpose:t,size:s,children:o.replace("-"," ")})},o))]},`${t}_${s}`))},t))]})]})},a={render:w,args:{children:"Some text",family:y.Sans,purpose:f.Display,size:k.S,tag:N.span},argTypes:{family:{control:{type:"select"}},purpose:{control:{type:"select"}},size:{control:{type:"select"}},tag:{control:{type:"select"}}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,S,E]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/evs7EwrZF4NikYiHp4Fydr/On-boarding-Typography?node-id=35-1948&t=bBnwJl7MOre5YUHS-0"}}};var h,b,g;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: Template,
  args: {
    children: 'Some text',
    family: FAMILY.Sans,
...
}`,...(g=(b=a.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};export{M as default,a as typography};
