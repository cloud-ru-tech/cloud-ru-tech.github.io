import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as A}from"./index-DUmpqB7p.js";import{r as F}from"./index-CJ_LmFaV.js";import{L as u,A as G,P as N,S as f,T as O,a as L}from"./Link-CNFTiRqm.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./TruncateString-C-ApBzyA.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DMNQxdBh.js";import"./PopoverPrivate-TrV_4kB1.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-JZGyZbA2.js";const C=`# Change Log
...
- Initial version
`,v="@snack-uikit/link",y="0.17.1",m={name:v,version:y},H=`# Link
...
`,x="_wrapper_1m21y_1",T="_table_1m21y_104",_="_cell_1m21y_112",S="_headerCell_1m21y_210",a={wrapper:x,table:T,cell:_,headerCell:S},nn={title:"Components/Link",component:u},s="Link text",E=f.S,j=N.Body,r=O.Default,k=G.Primary,P=Object.values(G),w=Object.values(f),D=Object.values(O);function o({header:d,options:t}){const e=A(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:e}),n.jsx("div",{className:e,children:d}),t.map(c=>{var h,b;return n.jsxs(F.Fragment,{children:[n.jsx("div",{className:e,children:c.header}),n.jsx("div",{className:a.cell,"data-appearance":(h=c.props)==null?void 0:h.appearance,"data-text-mode":(b=c.props)==null?void 0:b.textMode,children:n.jsx(u,{...c.props})})]},c.header)})]})}const R=({insideText:d,...t})=>n.jsxs(n.Fragment,{children:[n.jsx("div",{className:a.wrapper,"data-appearance":t.appearance,"data-text-mode":t.textMode,children:d?n.jsxs("span",{children:["Some text some text ",n.jsx(u,{...t,insideText:!0})," some text some text"]}):n.jsx(u,{...t})}),n.jsxs("div",{children:[n.jsx(o,{header:"Appearance",options:P.map(e=>({header:e,props:{appearance:e,text:s,textMode:r,size:E}}))}),n.jsx(o,{header:"Text Mode",options:D.map(e=>({header:e,props:{appearance:k,text:s,textMode:e}}))}),n.jsx(o,{header:"Size",options:w.map(e=>({header:e,props:{appearance:k,text:s,size:e,textMode:r}}))})]})]}),i={render:R,args:{textMode:r,href:"#",text:s,size:E,purpose:j,target:"_blank",appearance:k,insideText:!1,truncateVariant:"end"},argTypes:{size:{control:{type:"radio"}},target:{control:{type:"select",options:Object.values(L)}},download:{type:"string"}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,H,C]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=2%3A9&mode=design"}}};var l,p,g;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: Template,
  args: {
