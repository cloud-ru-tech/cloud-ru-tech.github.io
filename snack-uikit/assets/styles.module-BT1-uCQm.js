import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as P}from"./index-DUmpqB7p.js";import{r as g}from"./index-CJ_LmFaV.js";import{I as V,A as w,a as j,C as z}from"./index-CAfvFIBF.js";import{D as U}from"./DropList-Be0cOCb8.js";import{B as Y}from"./ButtonFunction-IUEJSlMa.js";import{T as q}from"./Tag-BEBGOq3Q.js";import{K}from"./index-B80hK4m0.js";import{e as J}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as G}from"./Typography-DmSN6cv6.js";import{T as f}from"./TruncateString-D54BiV_x.js";import{B as $}from"./ButtonSimple-CpxdojdF.js";import{B as W}from"./ButtonTonal-GaaAXicP.js";import{L as Q}from"./Link-DMlnAGbL.js";import{t as X}from"./helpers-DYkURdBT.js";const Rt=`# Change Log
...
- Initial version
`,Z="@snack-uikit/notification",tt="0.13.27",Mt={name:Z,version:tt},Vt=`# Notification
...
`,u={Neutral:"neutral",Error:"error",ErrorCritical:"errorCritical",Warning:"warning",Success:"success"},i={label:"notification-card__label",title:"notification-card__title",content:"notification-card__content",link:"notification-card__link",date:"notification-card__date",actions:{wrapper:"notification-card__actions",droplist:"notification-card__droplist",droplistTrigger:"notification-card__droplist-trigger",droplistAction:"notification-card__droplist-action"},primaryButton:"notification-card__primary-button",secondaryButton:"notification-card__secondary-button"};function E(n){switch(n){case u.Success:return t.jsx(z,{size:16});case u.Error:case u.ErrorCritical:return t.jsx(j,{size:16});case u.Warning:return t.jsx(w,{size:16});case u.Neutral:return t.jsx(V,{size:16});default:return null}}function O(n){n.stopPropagation()}try{E.displayName="getIcon",E.__docgenInfo={description:"",displayName:"getIcon",props:{}}}catch{}try{O.displayName="stopPropagationClick",O.__docgenInfo={description:"",displayName:"stopPropagationClick",props:{}}}catch{}const nt="_container_11i26_1",ct={container:nt};function A({actions:n,open:a,setDroplistOpen:s,size:l,icon:C,className:d}){return t.jsx("div",{className:P(ct.container,d),"data-test-id":i.actions.wrapper,onClick:O,children:t.jsx(U,{trigger:"clickAndFocusVisible",open:a,onOpenChange:s,placement:"bottom-end",scroll:!0,"data-test-id":i.actions.droplist,items:n.map(({onClick:c,disabled:h,content:p,tagLabel:k,icon:r})=>({onClick:o=>{s(!1),c==null||c(o)},disabled:h,content:p,beforeContent:r,afterContent:k?t.jsx(q,{label:k}):void 0,"data-test-id":i.actions.droplistAction})),children:t.jsx(Y,{size:l,icon:C,"data-test-id":i.actions.droplistTrigger})})})}try{A.displayName="ActionsButton",A.__docgenInfo={description:"",displayName:"ActionsButton",props:{actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},setDroplistOpen:{defaultValue:null,description:"",name:"setDroplistOpen",required:!0,type:{name:"Dispatch<SetStateAction<boolean>>"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'}]}},icon:{defaultValue:null,description:"",name:"icon",required:!0,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const it="_notificationCardFunction_1etz8_1",at="_notificationCardTitleText_1etz8_12",et="_notificationCardTitleIcon_1etz8_17",st="_notificationCard_1etz8_1",ut="_notificationCardLabel_1etz8_108",kt="_notificationCardTitle_1etz8_12",ot="_notificationCardContent_1etz8_121",lt="_notificationCardFooter_1etz8_127",ht="_notificationCardDate_1etz8_134",rt="_notificationCardButtons_1etz8_141",e={notificationCardFunction:it,notificationCardTitleText:at,notificationCardTitleIcon:et,notificationCard:st,notificationCardLabel:ut,notificationCardTitle:kt,notificationCardContent:ot,notificationCardFooter:lt,notificationCardDate:ht,notificationCardButtons:rt};function v({id:n,appearance:a=u.Neutral,label:s,unread:l,title:C,content:d,link:c,date:h,onClick:p,primaryButton:k,secondaryButton:r,actions:o,onVisible:N,className:B,...S}){const D=g.useMemo(()=>E(a),[a]),[L,x]=g.useState(!1),H=g.useRef(null);g.useEffect(()=>{if(!l||!N)return;const m=R=>{const[M]=R;M.isIntersecting&&N(n)},b=new IntersectionObserver(m,{root:null,threshold:.8,rootMargin:"0px"});return b.observe(H.current),()=>{b.disconnect()}},[n,N,l]);const T=!!(c||h),I=m=>{var b;m.stopPropagation(),(b=c==null?void 0:c.onClick)==null||b.call(c,m)};return t.jsxs("div",{ref:H,role:"button",onClick:p,tabIndex:0,...J(S),"data-appearance":a,"data-unread":l||void 0,"data-clickable":!!p||void 0,"data-droplist-open":L||void 0,className:P(e.notificationCard,B),children:[(o==null?void 0:o.length)&&t.jsx(A,{className:e.notificationCardFunction,actions:o,open:L,setDroplistOpen:x,size:"s",icon:t.jsx(K,{})}),s&&t.jsx(G.LightLabelS,{tag:"div",className:e.notificationCardLabel,children:t.jsx(f,{maxLines:1,text:s,"data-test-id":i.label})}),t.jsxs("div",{className:e.notificationCardTitle,children:[t.jsx("div",{className:e.notificationCardTitleIcon,children:D}),t.jsx(G.SansTitleS,{tag:"div",className:e.notificationCardTitleText,children:t.jsx(f,{maxLines:2,text:C,"data-test-id":i.title})})]}),d&&t.jsx(G.SansBodyS,{tag:"div",className:e.notificationCardContent,"data-test-id":i.content,children:d}),(k||r)&&t.jsxs("div",{className:e.notificationCardButtons,onClick:O,children:[r&&t.jsx($,{...r,appearance:"neutral",size:"s","data-test-id":i.primaryButton}),k&&t.jsx(W,{...k,appearance:"neutral",size:"s","data-test-id":i.secondaryButton})]}),T&&t.jsxs("div",{className:e.notificationCardFooter,children:[c&&t.jsx(Q,{...c,onClick:I,appearance:"primary",textMode:"accent",size:"s","data-test-id":i.link}),h&&t.jsx(G.LightLabelS,{className:e.notificationCardDate,"data-test-id":i.date,children:h})]})]})}try{v.displayName="NotificationCard",v.__docgenInfo={description:"Компонент карточки уведомления",displayName:"NotificationCard",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"Идентификатор уведомления",name:"id",required:!0,type:{name:"string"}},appearance:{defaultValue:{value:"neutral"},description:"Тип уведомления",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"neutral"'},{value:'"warning"'},{value:'"success"'},{value:'"errorCritical"'}]}},label:{defaultValue:null,description:"Лейбл перед заголовком",name:"label",required:!1,type:{name:"string"}},unread:{defaultValue:null,description:"Управление состоянием прочитано/не прочитано",name:"unread",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"Заголовок уведомления",name:"title",required:!0,type:{name:"string"}},content:{defaultValue:null,description:"Контент уведомления",name:"content",required:!0,type:{name:"ReactNode"}},link:{defaultValue:null,description:"Ссылка",name:"link",required:!1,type:{name:'PickLinkProps<LinkElement, "truncateVariant" | "text" | "insideText">'}},date:{defaultValue:null,description:"Дата уведомления",name:"date",required:!0,type:{name:"string"}},onClick:{defaultValue:null,description:"Колбэк клика по карточке",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onVisible:{defaultValue:null,description:"Колбэк при попадании карточки в область видимости на 80%",name:"onVisible",required:!1,type:{name:"((cardId: string) => void)"}},primaryButton:{defaultValue:null,description:"Кнопка главного действия у карточки",name:"primaryButton",required:!1,type:{name:'Omit<ButtonTonalProps, "data-test-id" | "size" | "appearance">'}},secondaryButton:{defaultValue:null,description:"Кнопка второстепенного действия у карточки",name:"secondaryButton",required:!1,type:{name:'Omit<ButtonSimpleProps, "data-test-id" | "size" | "appearance">'}},actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}}}}}catch{}const bt={card:"notification-card",toaster:"toaster",blank:"panel-blank"},dt={id:"cardId",label:["Category","Subcategory"].join("・"),appearance:u.Neutral,title:"Title truncate two line",content:`Demo content.

For replacement, use Property: ◆ProdContent. Replace this element with your local component with the original content.`,link:{text:"Link to detailed information",href:"#"},date:"DD.MM.YYYY HH:MM",actions:[{content:{option:"action 1"}},{content:{option:"action 2"}}]},wt={amount:10,title:"Notifications",readAllButton:{label:"Mark all as read",tooltip:{tip:"Your tip could be here"}},footerButton:{label:"All events"}},y=n=>{X.userAction.success({label:n.currentTarget.textContent||"","data-test-id":bt.toaster})};function _(n,a){return Math.floor(Math.random()*(a-n+1)+n)}const F=Object.values(u);function jt(n){const a=[];for(let s=0;s<n;++s)a.push({...dt,id:String(s),unread:!!_(0,1),appearance:F[_(0,F.length-1)],primaryButton:{label:"Primary button",onClick:y},secondaryButton:{label:"Secondary button",onClick:y}});return a}const pt="_pageWrapper_1foau_1",mt="_controlledWrapper_1foau_13",gt="_controlledCard_1foau_28",Gt="_table_1foau_32",Ot="_cell_1foau_40",Ct="_headerCell_1foau_48",Nt="_card_1foau_53",Et="_backdrop_1foau_57",zt={pageWrapper:pt,controlledWrapper:mt,controlledCard:gt,table:Gt,cell:Ot,headerCell:Ct,card:Nt,backdrop:Et};export{u as A,v as N,bt as S,Vt as a,Rt as b,Mt as c,dt as d,wt as e,e as f,jt as g,y as h,A as i,zt as s};
