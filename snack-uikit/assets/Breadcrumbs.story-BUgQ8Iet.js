import{j as l}from"./jsx-runtime-BTJTZTIL.js";import{a as oe}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import{r as h}from"./index-CJ_LmFaV.js";import{d as de}from"./index-D3kvmOHM.js";import{i as re}from"./isBrowser-C2N6XvuH.js";import{c as se}from"./index-DUmpqB7p.js";import{e as ae}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as he}from"./Typography-DmSN6cv6.js";import{D as pe}from"./DropList-B0JJwNMY.js";import{H as me}from"./index-BcKv4fI4.js";import"./index-ChsGqxH_.js";import"./v4-CtRu48qb.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-B7wZyJkK.js";import"./hooks-68YSeHc4.js";import"./useValueControl-C51frgGe.js";import"./index-JZGyZbA2.js";import"./Checkbox-BUwce3wU.js";import"./constants-BObEONKm.js";import"./TogglePrivate-BTSew7b5.js";import"./index-3XDw48l5.js";import"./index-DtRrUciF.js";import"./TruncateString-P8oWpQXG.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./Tooltip-BF_Vu_8t.js";import"./PopoverPrivate-BRtB5jhm.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./Switch-DSwFYifT.js";import"./index-BQAaeyfQ.js";import"./index-C7IVzcIX.js";import"./index-BLj3vrxU.js";import"./Dropdown-DnGqb98r.js";import"./index-DLGJiw2b.js";import"./index-Baw9oej9.js";import"./LocaleProvider-CyhbxqE1.js";import"./index-DTmowtnF.js";import"./IconPredefined-yX8Rdo-2.js";import"./ButtonTonal-CuYKbiS_.js";import"./utils-Bz59hGap.js";import"./Counter-dO15w468.js";import"./Sun-Bft0ZijA.js";import"./constants-BAH7I9kc.js";import"./ButtonFilled-BS9AKezQ.js";import"./Divider-G_YGM_Hz.js";import"./Spinner-BoRMrYYR.js";import"./Scroll-DbfXyGNV.js";import"./ButtonFunction-CBZoLIZd.js";import"./useButtonNavigation-CnLiqaIQ.js";import"./useEventHandler-C8nLb_YB.js";import"./useClearButton-CfofiGle.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-C2dxrcl-.js";const be=`# Change Log
...
- Initial version
`,ke="@snack-uikit/breadcrumbs",ge="0.11.9",Z={name:ke,version:ge},ye=`# Breadcrumbs
...
\`\`\`
Компоненты Breadcrumbs мемоизирован, старайтесь передавать \`items\` одной и той же ссылкой.`,ie="›",o={Full:"full",ShortLabel:"shortLabel",Ellipsis:"ellipsis",Collapsed:"collapsed"},k={Separator:"separator",Collapse:"collapse",Item:"item"},O={Xs:"xs",S:"s"},fe={[o.Full]:0,[o.ShortLabel]:1,[o.Ellipsis]:100,[o.Collapsed]:1e4},Ee=[o.Full,o.ShortLabel,o.Ellipsis],x=e=>(n,u)=>[{...n,renderMode:e},...u],R=x(o.Full),V=x(o.ShortLabel),T=x(o.Ellipsis),q=x(o.Collapsed);function F([e,...n],{useCollapse:u=!0,useEllipse:t=!0}){const a=[];return e?n.length?(F(n,{useCollapse:!1,useEllipse:!1}).forEach(s=>{a.push(R(e,s)),e.shortLabel&&a.push(V(e,s))}),t&&F(n,{useCollapse:!1,useEllipse:!0}).forEach(s=>{a.push(T(e,s))}),u&&F(n,{useCollapse:!0,useEllipse:!1}).forEach(s=>{a.push(q(e,s))}),a):(a.push(R(e,[])),e.shortLabel&&a.push(V(e,[])),a):a}const L=(e,n)=>n.map((u,t,a)=>{const s=t===a.length-1;return{...u,renderMode:s?e:o.Collapsed}});function Ce(e,n,u){if(!e.length)return[];const t=[],[a,...s]=e.map(c=>({...c,renderMode:o.Full}));return F(s,{useCollapse:!0,useEllipse:!0}).forEach(c=>{t.push(R(a,c)),a.shortLabel&&t.push(V(a,c))}),t.push(T(a,L(o.Full,s))),t.push(T(a,L(o.Ellipsis,s))),t.push(q(a,L(o.Full,s))),t.push(q(a,L(o.Ellipsis,s))),t.map(c=>c.reduce((i,d,p,m)=>{const{renderMode:r}=d;p&&Ee.includes(r)&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),!i.hasCollapsed&&r===o.Collapsed&&(p&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i.hasCollapsed=!0,i.width+=n.collapse,i.chain.push({element:k.Collapse,width:n.collapse}));const g=n.items[d.id][r];return i.weight+=fe[d.renderMode],i.width+=g,i.chain.push({element:k.Item,item:d,width:g}),p===m.length-1&&u&&(i.width+=n.separator,i.chain.push({element:k.Separator,width:n.separator})),i},{chain:[],weight:0,width:0,hasCollapsed:!1}))}const Oe=()=>({[o.ShortLabel]:0,[o.Collapsed]:0,[o.Ellipsis]:0,[o.Full]:0}),j=e=>e.getBoundingClientRect().width;function Ge(e){if(!e)return;const n=e.children,[u,t,...a]=Array.from(n);return{separator:j(u),collapse:j(t),items:a.reduce((s,c)=>{const i=c.getAttribute("data-id"),d=c.getAttribute("data-render-mode");return s[i]=s[i]||Oe(),s[i][d]=j(c),s},{})}}const J=e=>{if(!e)return 0;if(re()){const n=document.createElement("div");n.style.width="10000px",e.append(n);const u=e.getBoundingClientRect().width;return e.removeChild(n),u}return 0},P=(e,n)=>n?`${e}-element-${n}`:"",Q=(e,n)=>{if(!n.length)return;let[u]=n;for(const t of n)t.width<=e?(u.width>e||u.weight>t.weight)&&(u=t):t.width<u.width&&(u=t);if(u)return{chain:u.chain,containerWidth:e,chainWidth:u.width}};function W(e){const[n,u]=h.useState(void 0),[t,a]=h.useState([]),s=h.useCallback(c=>Q(c,t),[t]);return h.useEffect(()=>{var i;const c=(i=e.current)==null?void 0:i.parentElement;c&&u(Q(J(c),t))},[t,e]),h.useEffect(()=>{var p;const c=(p=e.current)==null?void 0:p.parentElement;if(!c)return;const i=de(()=>{const m=J(c);u(r=>(r==null?void 0:r.containerWidth)===m?r:s(m)||r&&{...r,containerWidth:m})},100),d=new ResizeObserver(i);return d.observe(c),d.observe(document.body),()=>d.disconnect()},[e,s]),{setConfigs:a,currentConfig:n}}try{W.displayName="useBreadcrumbsLayout",W.__docgenInfo={description:`Расчет способа отображения breadcrumbs работает следующим образом:
Каждый item может быть отображен в одном из режимов:
 ...
 Для того чтоб отобразить breadcrumbs, нужно подобрать конфиг, максимальный по ширине, влезающий в контейнер, но с минимальным весом (наименьшим количеством сокращений).`,displayName:"useBreadcrumbsLayout",props:{}}}catch{}const G=h.createContext({hidden:!1,size:O.S,separator:ie});function v({size:e,children:n,className:u}){return l.jsx(he,{className:u,size:e===O.S?"m":"s",tag:"div",family:"sans",purpose:"body",children:n})}try{v.displayName="CrumbsTypography",v.__docgenInfo={description:"",displayName:"CrumbsTypography",props:{size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const ve="_collapse_28pvy_1",Ne="_a_28pvy_20",Y={collapse:ve,a:Ne};function _({currentConfig:e,className:n}){const u=h.useContext(G),{hidden:t,size:a,testId:s}=u,c=h.useRef(null),i=e.filter(d=>d.element===k.Item&&d.item.renderMode===o.Collapsed).map(d=>({content:{option:d.item.label},...d.item.href?{itemWrapRender:p=>l.jsx("a",{href:d.item.href,onClick:d.item.onClick,className:Y.a,children:p})}:{onClick:d.item.onClick}}));return l.jsx("div",{className:n,"data-test-id":P("collapse",s),"data-element-type":k.Collapse,children:l.jsx(G.Provider,{value:{...u,testId:`${s}-collapsed`},children:l.jsx(pe,{trigger:"hoverAndFocusVisible",size:"s",scroll:!0,triggerElemRef:c,items:i,children:l.jsx("button",{type:"button",ref:c,className:Y.collapse,tabIndex:t?-1:0,children:l.jsx(v,{size:a,children:"..."})})})})})}try{_.displayName="Collapse",_.__docgenInfo={description:"",displayName:"Collapse",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},currentConfig:{defaultValue:null,description:"",name:"currentConfig",required:!0,type:{name:"BreadcrumbsConfigChain"}}}}}catch{}const Ae="_wrapper_1sszs_1",Le="_crumb_1sszs_9",He="_label_1sszs_43",Fe="_icon_1sszs_49",E={wrapper:Ae,crumb:Le,label:He,icon:Fe},_e=8,B=h.memo(function({minWidth:n=0,current:u=!1,renderMode:t,className:a,item:{label:s,shortLabel:c,icon:i,id:d,onClick:p,href:m},useIconOnly:r,...g}){const{hidden:b,size:y,testId:w}=h.useContext(G),f=b&&s.length>_e&&t===o.Ellipsis?`${s.substring(0,4)}...`:s,C=!!(i&&r),le=n&&t===o.Ellipsis?n:"auto",N={"data-render-mode":t,"data-current":u,"data-hidden":b,"data-size":y,"data-id":d},S=l.jsxs(l.Fragment,{children:[i&&l.jsx("div",{className:E.icon,children:l.jsx(i,{size:16})}),!C&&l.jsx(v,{size:y,className:E.label,children:t===o.ShortLabel?c:f})]}),U=b?{tabIndex:-1}:{},K=t===o.Ellipsis?f:"";let A=null;return m?A=l.jsx("a",{className:E.crumb,onClick:p,href:m,"aria-label":C?f:void 0,"data-clickable":!0,...N,...U,children:S}):p?A=l.jsx("button",{type:"button",title:K,onClick:p,className:E.crumb,"aria-label":C?f:void 0,"data-clickable":!0,...N,...U,children:S}):A=l.jsx("div",{className:E.crumb,...N,children:S}),l.jsx("li",{...ae(g),...N,"data-test-id":P("crumb",w),className:se(E.wrapper,a),"data-element-type":k.Item,style:{minWidth:le},title:K,children:A})});try{B.displayName="Crumb",B.__docgenInfo={description:"",displayName:"Crumb",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},renderMode:{defaultValue:null,description:"",name:"renderMode",required:!0,type:{name:"enum",value:[{value:'"full"'},{value:'"collapsed"'},{value:'"shortLabel"'},{value:'"ellipsis"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},minWidth:{defaultValue:null,description:"",name:"minWidth",required:!1,type:{name:"number"}},current:{defaultValue:null,description:"",name:"current",required:!1,type:{name:"boolean"}},item:{defaultValue:null,description:"",name:"item",required:!0,type:{name:"Item"}},useIconOnly:{defaultValue:null,description:"",name:"useIconOnly",required:!1,type:{name:"boolean"}}}}}catch{}const Be="_separator_sbabc_1",Ie={separator:Be};function ce(){const{size:e,separator:n,testId:u}=h.useContext(G);return l.jsx("div",{"aria-hidden":!0,"data-size":e,className:Ie.separator,"data-test-id":P("separator",u),"data-element-type":k.Separator,children:l.jsx(v,{size:e,children:n})})}const De="_wrapper_1v8x9_1",xe="_row_1v8x9_12",X={wrapper:De,row:xe},I=h.forwardRef(function({children:n,className:u,size:t,hidden:a,separator:s,"data-test-id":c,...i},d){return l.jsx("nav",{...ae(i),className:se(X.wrapper,u),"data-test-id":c,"data-hidden":a,"aria-hidden":a,children:l.jsx(G.Provider,{value:{hidden:a,size:t,separator:s,testId:c},children:l.jsx("ul",{className:X.row,ref:d,"data-hidden":a,"data-size":t,children:n})})})});try{I.displayName="Wrapper",I.__docgenInfo={description:"",displayName:"Wrapper",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},hidden:{defaultValue:null,description:"",name:"hidden",required:!0,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'}]}},separator:{defaultValue:null,description:"",name:"separator",required:!0,type:{name:"string"}}}}}catch{}const we=[[o.ShortLabel,"shortLabel"],[o.Ellipsis,"label"],[o.Full,"label"]],Se=[[o.Full,"label"]],je=e=>(n,u)=>{const t=!u&&e;return(t?Se:we).map(([s,c])=>!n[c]&&s!==o.Full?null:l.jsx(B,{useIconOnly:t,renderMode:s,item:n},n.id+s))},z=({firstItemIconOnly:e})=>h.useMemo(()=>je(e),[e]);try{z.displayName="useItemModesRender",z.__docgenInfo={description:"",displayName:"useItemModesRender",props:{firstItemIconOnly:{defaultValue:null,description:"",name:"firstItemIconOnly",required:!0,type:{name:"boolean"}}}}}catch{}const M=h.memo(function({size:n,separator:u,items:t,onConfigsBuilt:a,firstItemIconOnly:s=!1,lastEmpty:c=!1}){const i=h.useRef(null),d=h.useRef(t);d.current=t,h.useEffect(()=>{const m=i.current;if(m){const r=new ResizeObserver(([{target:g}])=>{const b=Ge(g);b&&a(Ce(d.current,b,c))});return r.observe(m),()=>{r.disconnect()}}},[t,c,a]);const p=z({firstItemIconOnly:s});return l.jsxs(I,{size:n,hidden:!0,ref:i,separator:u,"data-test-id":"hidden-wrapper",children:[l.jsx(ce,{}),l.jsx(_,{currentConfig:[]}),t.map(p)]})});try{M.displayName="HiddenChain",M.__docgenInfo={description:"",displayName:"HiddenChain",props:{separator:{defaultValue:null,description:"",name:"separator",required:!0,type:{name:"string"}},items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"Item[]"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'}]}},onConfigsBuilt:{defaultValue:null,description:"",name:"onConfigsBuilt",required:!0,type:{name:"(config: BreadcrumbsConfig[]) => void"}},firstItemIconOnly:{defaultValue:null,description:"",name:"firstItemIconOnly",required:!1,type:{name:"boolean"}},lastEmpty:{defaultValue:null,description:"",name:"lastEmpty",required:!1,type:{name:"boolean"}}}}}catch{}const D=h.memo(function({items:n,size:u=O.S,separator:t=ie,className:a,firstItemIconOnly:s=!1,inactiveLastItem:c=!1,lastEmpty:i=!1,...d}){const p=h.useRef(null),{setConfigs:m,currentConfig:r}=W(p),g=h.useMemo(()=>c?n.map((b,y)=>y===n.length-1?{...b,onClick:void 0,href:void 0}:b):n,[c,n]);return l.jsxs(l.Fragment,{children:[l.jsx(M,{items:g,size:u,separator:t,onConfigsBuilt:m,firstItemIconOnly:s,lastEmpty:i}),l.jsx(I,{...d,ref:p,hidden:!1,size:u,separator:t,className:a,children:r==null?void 0:r.chain.map((b,y,w)=>{const $=y===w.length-1;switch(b.element){case k.Separator:return l.jsx(ce,{},y);case k.Collapse:return l.jsx(_,{currentConfig:r.chain},y);case k.Item:{const{renderMode:f,id:C}=b.item;if(f!==o.Collapsed)return l.jsx(B,{useIconOnly:!y&&s,current:$,renderMode:f,minWidth:b.width,item:b.item},C);break}default:return null}})})]})});try{D.displayName="Breadcrumbs",D.__docgenInfo={description:"Компонент хлебных крошек",displayName:"Breadcrumbs",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},items:{defaultValue:null,description:"Массив айтемов",name:"items",required:!0,type:{name:"Item[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}},separator:{defaultValue:{value:'"›"'},description:"Разделитель",name:"separator",required:!1,type:{name:"string"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'}]}},firstItemIconOnly:{defaultValue:{value:"false"},description:"Использовать иконку без лейбла в первом айтеме",name:"firstItemIconOnly",required:!1,type:{name:"boolean"}},inactiveLastItem:{defaultValue:{value:"false"},description:"Делает некликабельным последний элемент, даже если для него переданы `href` или `onClick`",name:"inactiveLastItem",required:!1,type:{name:"boolean"}},lastEmpty:{defaultValue:null,description:"",name:"lastEmpty",required:!1,type:{name:"boolean"}}}}}catch{}const Re="_container_15w2x_1",Ve="_crumbClickHolder_15w2x_13",ee={container:Re,crumbClickHolder:Ve},qn={title:"Components/Breadcrumbs",component:D},Te=({storyIcon:e,storyBreadcrumbs:n,storyUrl:u,storyOnClick:t,storyContainerWidth:a,...s})=>{const c=oe("onClick"),[i,d]=h.useState(""),p=n.map((m,r)=>({...m,id:`id${r}`,href:u?`https://yandex.ru/search?text=${encodeURIComponent(m.label)}`:void 0,onClick:t?(...g)=>{d(m.label),c(...g)}:void 0}));return e&&(p[0].icon=me),l.jsxs("div",{children:[l.jsx("div",{className:ee.container,style:{width:a},children:l.jsx(D,{...s,items:p})}),l.jsx("div",{className:ee.crumbClickHolder,"data-test-id":"last-clicked-crumb",children:i})]})},H={render:Te,args:{storyBreadcrumbs:[{label:"Литература"},{label:"Стихи"},{label:"Золотой век русской поэзии",shortLabel:"Золотой век"},{label:"Михаил Лермонтов",shortLabel:"Лермонтов"},{label:'Тема "Одиночество"',shortLabel:"Одиночество"},{label:"Парус"}],storyUrl:!1,storyIcon:!1,storyOnClick:!1,lastEmpty:!1,storyContainerWidth:"100%",size:O.S},argTypes:{items:{table:{disable:!0}},storyBreadcrumbs:{name:"[story] Items"},storyUrl:{name:"[story] url",description:"Передать урлы для айтемов"},storyOnClick:{name:"[story] onClick",description:"Передать обработчики кликов для айтемов"},storyIcon:{name:"[story] icon",description:"Передать иконку в первый айтем"},storyContainerWidth:{name:"[story] container width"},size:{options:Object.values(O),control:{type:"radio"}}},parameters:{readme:{sidebar:[`Latest version: ${Z.version}`,ye,be]},packageName:Z.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A30976&mode=design"}}};var ne,te,ue;H.parameters={...H.parameters,docs:{...(ne=H.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: Template,
  args: {
    storyBreadcrumbs: [{
      label: 'Литература'
      ...
      label: 'Золотой век русской поэзии',
      shortLabel: 'Золотой век'
    }, {
      label: 'Михаил Лермонтов',
      shortLabel: 'Лермонтов'
    }, {
      label: 'Тема "Одиночество"',
      shortLabel: 'Одиночество'
    }, {
      label: 'Парус'
    }],
    storyUrl: false,
...
}`,...(ue=(te=H.parameters)==null?void 0:te.docs)==null?void 0:ue.source}}};export{H as breadcrumbs,qn as default};
