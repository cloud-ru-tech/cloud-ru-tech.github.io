import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{d as W}from"./index-D3kvmOHM.js";import{r as i}from"./index-CJ_LmFaV.js";import{t as J}from"./helpers-BM83PUJX.js";import{c as j}from"./index-DUmpqB7p.js";import{m as Q}from"./index-B7wZyJkK.js";import{e as M}from"./componentPropsProcessors-UJEZy8aQ.js";import{D as Z}from"./DropList-G23C-I-U.js";import{f as z}from"./hooks-BUT8uqom.js";import{P as X}from"./index-C9_U387z.js";import{B as Y}from"./ButtonFunction-BElZbry1.js";import{S as ee}from"./Scroll-B3e6J9cA.js";import{C as I}from"./index-BSaiJUvD.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-Chjiymov.js";import"./LocaleProvider-CyhbxqE1.js";import"./index-C7IVzcIX.js";import"./index-BLj3vrxU.js";import"./index-BQAaeyfQ.js";import"./ProgressBar-DoG3l5ps.js";import"./index-6PN_JoHT.js";import"./index-C-NxZ9RO.js";import"./index-zbp_5bxn.js";import"./TruncateString-D12I7bk8.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-BNp3usZT.js";import"./PopoverPrivate-CnKgsFAm.js";import"./index-JZGyZbA2.js";import"./Link-DxTCR0Rb.js";import"./Sun-CjKF0Bsh.js";import"./constants-BAH7I9kc.js";import"./useValueControl-C51frgGe.js";import"./Dropdown-uG1Hplv7.js";import"./Checkbox-BJ1fNH24.js";import"./constants-BObEONKm.js";import"./TogglePrivate-BTSew7b5.js";import"./index-3XDw48l5.js";import"./index-DtRrUciF.js";import"./Switch-DmwOlfxh.js";import"./index-DLGJiw2b.js";import"./index-Baw9oej9.js";import"./index-BN98criP.js";import"./IconPredefined-yX8Rdo-2.js";import"./Typography-DmSN6cv6.js";import"./ButtonTonal-D0vhccb5.js";import"./utils-BM2s5Pk-.js";import"./Counter-dO15w468.js";import"./ButtonFilled-CM3N-4F4.js";import"./Divider-C1X9zrkx.js";import"./Spinner-PYn9r2mo.js";import"./useButtonNavigation-CVCsehRW.js";import"./useClearButton-DMWmUR1d.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-D3npAkF4.js";import"./PromoTag-okkeJ18g.js";import"./index-CIcT2jya.js";import"./Tag-CalHVeMA.js";import"./constants-BaREPXw5.js";const ne=`# Change Log
...
- Initial version
`,te="@snack-uikit/search",ue="0.12.10",V={name:te,version:ue},ae=`# Search
...
Работа в режиме FieldText в значении false | undefined`,name:"autocomplete",required:!1,type:{name:"boolean"}}}}}catch{}const le="submit-toaster";function T(l){return Array.from({length:l.length}).map((s,e)=>({id:l+e,content:{option:l+e,description:"some description"}}))}const de="_wrapper_7ufd9_1",re="_scrollWrapper_7ufd9_15",pe="_scroll_7ufd9_15",he="_container_7ufd9_23",ke="_card_7ufd9_29",f={wrapper:de,scrollWrapper:re,scroll:pe,container:he,card:ke},Cn={title:"Components/Search",component:A},me=({autocomplete:l,showPostfix:s,...e})=>{const[t,p]=i.useState(e.value||""),[d,r]=i.useState(!1),[h,c]=i.useState([]),[k,m]=i.useState(t),b=i.useCallback(async u=>{k!==u&&(m(u),c(T(u)),r(!1))},[k]),g=i.useMemo(()=>W(b,300),[b]),G=u=>{p(u),g(u),r(!0)},E=()=>{J.userAction.success({label:"Submit action","data-test-id":le})};i.useEffect(()=>g.cancel,[]),i.useEffect(()=>{e.value&&(p(e.value),m(e.value),c(T(e.value)))},[e.value]);const O=i.useMemo(()=>{if(s)return n.jsx(Y,{icon:n.jsx(X,{})})},[s]);return l?n.jsx("div",{className:f.wrapper,"data-outline":e.outline||void 0,children:n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,options:h,onSubmit:E,autocomplete:!0,postfix:O})}):n.jsxs("div",{className:f.wrapper,"data-outline":e.outline||void 0,children:[n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,autocomplete:void 0,options:void 0,onSubmit:E,postfix:O}),h.length>0&&n.jsx("div",{className:f.scrollWrapper,children:n.jsx(ee,{className:f.scroll,children:n.jsx("div",{className:f.container,children:h.map(u=>n.jsx(I,{className:f.card,header:n.jsx(I.Header,{title:u.content.option,description:u.content.description})},u.id))})})})]})},y={render:me,args:{size:N.S,placeholder:"Placeholder",autocomplete:!0,outline:!0,showPostfix:!0,"data-test-id":""},argTypes:{options:{name:"options",defaultValue:[],if:{arg:"autocomplete",eq:!0}},showPostfix:{name:"[Stories]: Show postfix slot"}},parameters:{readme:{sidebar:[`Latest version: ${V.version}`,ae,ne]},packageName:V.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A143287&mode=design"}}};var w,P,R;y.parameters={...y.parameters,docs:{...(w=y.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: Template,
  args: {
    size: SIZE.S,
