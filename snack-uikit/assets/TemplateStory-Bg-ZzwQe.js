import{r}from"./index-CJ_LmFaV.js";import{j as u}from"./jsx-runtime-BTJTZTIL.js";import{D as P}from"./index-BBF-mQaP.js";import{U as j}from"./index-CbwBVTm2.js";import{T as U}from"./index-BSWI5MkI.js";import{B as L}from"./ButtonFunction-DtKTUXuJ.js";import{c as I}from"./index-DUmpqB7p.js";import{T as M}from"./TruncateString-C-ApBzyA.js";import{e as V}from"./componentPropsProcessors-UJEZy8aQ.js";import{t as C}from"./helpers-Cn_LzGP8.js";import{g as K}from"./_commonjsHelpers-D6-XlEtG.js";import{D as z}from"./DropZone-BkVZYGAP.js";const q=r.createContext({});function v(){return r.useContext(q)}const X=r.createContext({focused:!1,setFocused:()=>{}});function J(){return r.useContext(X)}function Dn(n){if(!n)return n;const e=n.split(".");return e.pop(),e.length===1&&e[0]===""?n:e.join(".")}function Z(n){var e;return(e=n==null?void 0:n.split(".").pop())==null?void 0:e.toLocaleUpperCase()}function Y(n){return n.type.match(/image\/(png|jpg|jpeg|gif|webp|bmp|svg)/i)}function _n(n){const[e,o]=r.useState(void 0),[t,d]=r.useState(!1);return r.useEffect(()=>{if(n&&Y(n)){const i=new FileReader;i.onloadstart=()=>{d(!0)},i.onloadend=()=>{d(!1);const{result:c}=i;c&&o(c.toString())},i.readAsDataURL(n)}else o(void 0)},[n]),{imageData:e,loading:t}}const k="attachment",h={icon:`${k}__icon`,image:`${k}__image`,loading:`${k}__loading`,retryAction:`${k}__retry-action`,deleteAction:`${k}__delete-action`,downloadAction:`${k}__download-action`,title:`${k}__title`,description:`${k}__description`,error:`${k}__error`},$="_actions_1aog0_1",W="_retryAction_1aog0_6",w={actions:$,retryAction:W},nn=()=>{};function D({hideDelete:n,hideDownload:e,hideRetry:o}){const{onDelete:t,onDownload:d,file:i,disabled:c,onRetry:s}=v(),{setFocused:g=nn}=J(),A=d&&!e,G=t&&!n,E=s&&!o,m=()=>{g(!0)},l=()=>{g(!1)},N=a=>{s==null||s(),a.stopPropagation()},O=a=>{d==null||d(i),a.stopPropagation()},H=a=>{t==null||t(i),a.stopPropagation()};return!A&&!G?null:u.jsxs("div",{className:w.actions,children:[A&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(P,{}),onClick:O,onFocus:m,onBlur:l,"data-test-id":h.downloadAction}),E&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(j,{}),onClick:N,onFocus:m,onBlur:l,className:w.retryAction,"data-test-id":h.retryAction}),G&&u.jsx(L,{disabled:c,size:"xs",icon:u.jsx(U,{}),onClick:H,onFocus:m,onBlur:l,"data-test-id":h.deleteAction})]})}try{D.displayName="Actions",D.__docgenInfo={description:"",displayName:"Actions",props:{hideDownload:{defaultValue:null,description:"",name:"hideDownload",required:!1,type:{name:"boolean"}},hideDelete:{defaultValue:null,description:"",name:"hideDelete",required:!1,type:{name:"boolean"}},hideRetry:{defaultValue:null,description:"",name:"hideRetry",required:!1,type:{name:"boolean"}}}}}catch{}function p({text:n,className:e,maxLines:o=1,...t}){const{truncateVariant:d}=v();return n?u.jsx("div",{className:e,children:u.jsx(M,{text:n,maxLines:o,variant:d,...V(t)})}):null}try{p.displayName="Text",p.__docgenInfo={description:"",displayName:"Text",props:{text:{defaultValue:null,description:"",name:"text",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!0,type:{name:"string"}},maxLines:{defaultValue:{value:"1"},description:"",name:"maxLines",required:!1,type:{name:"number"}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}}}}}catch{}const en="_content_1nvre_1",tn="_title_1nvre_16",cn="_description_1nvre_24",an="_error_1nvre_25",f={content:en,title:tn,description:cn,error:an};function _({title:n,description:e,error:o,className:t,align:d="left"}){const{size:i,truncate:c={}}=v();return u.jsxs("div",{className:I(f.content,t),"data-size":i,"data-align":d,children:[u.jsx(p,{className:f.title,text:n,"data-test-id":h.title,maxLines:c==null?void 0:c.title}),u.jsx(p,{className:f.description,text:e,"data-test-id":h.description,maxLines:c==null?void 0:c.description}),u.jsx(p,{className:f.error,text:o,"data-test-id":h.error,maxLines:c==null?void 0:c.error})]})}try{_.displayName="TextBlock",_.__docgenInfo={description:"",displayName:"TextBlock",props:{title:{defaultValue:{value:"fileName"},description:"Заголовок",name:"title",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"CSS-класс для элемента с контентом",name:"className",required:!1,type:{name:"string"}},description:{defaultValue:{value:"fileExtension"},description:"Описание",name:"description",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Сообщение об ошибке",name:"error",required:!1,type:{name:"string"}},align:{defaultValue:{value:"left"},description:"",name:"align",required:!1,type:{name:"enum",value:[{value:'"center"'},{value:'"left"'}]}}}}}catch{}const sn=`# Change Log
