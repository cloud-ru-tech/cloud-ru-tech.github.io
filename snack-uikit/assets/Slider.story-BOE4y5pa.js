import{j as s}from"./jsx-runtime-BTJTZTIL.js";import{r as a}from"./index-CJ_LmFaV.js";import{S as k}from"./Slider-3oBqh_UR.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-DUmpqB7p.js";import"./KeyCode-CHzoJbuw.js";import"./objectWithoutProperties-3ReGGzEA.js";import"./objectWithoutPropertiesLoose-Dsqj8S3w.js";import"./extends-CF3RwP-h.js";import"./useSwipeable-DMbEt_5P.js";import"./Tooltip-DMNQxdBh.js";import"./PopoverPrivate-TrV_4kB1.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-JZGyZbA2.js";import"./isBrowser-C2N6XvuH.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./componentPropsProcessors-UJEZy8aQ.js";const G=`# Change Log
...
- Initial version
`,y="@snack-uikit/slider",f="0.3.19",u={name:y,version:f},E="# Slider\n\n## Installation\n`npm i @snack-uikit/slider`\n\n[Changelog](./CHANGELOG.md)\n\n\n\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## Slider\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| className | `string` | - | CSS-класс |\n| disabled | `boolean` | - |  |\n| keyboard | `boolean` | - |  |\n| autoFocus | `boolean` | - |  |\n| onFocus | `(e: FocusEvent<HTMLDivElement, Element>) => void` | - |  |\n| onBlur | `(e: FocusEvent<HTMLDivElement, Element>) => void` | - |  |\n| range | `boolean` | - |  |\n| count | `number` | - |  |\n| min | `number` | - |  |\n| max | `number` | - |  |\n| step | `number` | - |  |\n| value | `number \\| number[]` | - |  |\n| defaultValue | `number \\| number[]` | - |  |\n| onChange | `(value: number \\| number[]) => void` | - |  |\n| onBeforeChange | `(value: number \\| number[]) => void` | - | @deprecated It's always better to use `onChange` instead |\n| onAfterChange | `(value: number \\| number[]) => void` | - | @deprecated Use `onChangeComplete` instead |\n| onChangeComplete | `(value: number \\| number[]) => void` | - |  |\n| allowCross | `boolean` | - |  |\n| pushable | `number \\| boolean` | - |  |\n| draggableTrack | `boolean` | - | range only |\n| reverse | `boolean` | - |  |\n| included | `boolean` | - |  |\n| startPoint | `number` | - |  |\n| marks | `Record<string \\| number, ReactNode \\| MarkObj>` | - |  |\n| dots | `boolean` | - |  |\n| tabIndex | `number \\| number[]` | - |  |\n| ariaLabelForHandle | `string \\| string[]` | - |  |\n| ariaLabelledByForHandle | `string \\| string[]` | - |  |\n| ariaValueTextFormatterForHandle | `AriaValueFormat \\| AriaValueFormat[]` | - |  |\n| handleTip | `boolean` | - |  |\n| tipFormatter | `(value: string \\| number) => ReactNode` | - |  |\n\n\n[//]: DOCUMENTATION_SECTION_END\n",C="_wrapper_1r7by_1",N={wrapper:C},J={title:"Components/Slider",component:k},r={1:"512mb",4:"2gb",8:"4gb",16:"8gb"},A={1:"1",4:"4",8:"8",12:"12",16:"16"},l={none:"none",linear:"linear","not-linear":"not-linear"},d=[4,8],L=({storyMarks:n,moveByMarks:h,step:g,...t})=>{const[c,o]=a.useState(d);a.useEffect(()=>{o(d)},[t.range]);const O=a.useMemo(()=>{switch(n){case"not-linear":return r;case"linear":return A;case"none":default:return}},[n]),v=a.useCallback(e=>{switch(n){case"not-linear":return r[Number(e)];case"linear":case"none":default:return e}},[n]);return s.jsx("div",{className:N.wrapper,children:s.jsx(k,{...t,value:t.range?c:c[0],onChange:e=>{t.range?o(e):o([e])},step:h&&n!=="none"?null:g,marks:O,tipFormatter:v})})},i={render:L,args:{className:"osThemeSnack",min:1,max:16,storyMarks:"not-linear",step:1,moveByMarks:!0,handleTip:!0,range:!1,reverse:!1},argTypes:{storyMarks:{name:"[Story]: example marks",options:Object.keys(l),mapping:l,control:{type:"radio"}},moveByMarks:{name:"[Story]: change value only by marks",type:"boolean"},step:{if:{arg:"moveByMarks",eq:!1}}},parameters:{readme:{sidebar:[`Latest version: ${u.version}`,E,G]},packageName:u.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-5.0.0?node-id=1755-108937&m=dev"}}};var m,p,b;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: Template,
  args: {
