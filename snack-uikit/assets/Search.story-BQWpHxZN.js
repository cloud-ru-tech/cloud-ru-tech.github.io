import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{d as W}from"./index-D3kvmOHM.js";import{r as i}from"./index-CJ_LmFaV.js";import{t as J}from"./helpers-CJ4g4fQI.js";import{c as j}from"./index-DUmpqB7p.js";import{m as Q}from"./index-B7wZyJkK.js";import{e as M}from"./componentPropsProcessors-UJEZy8aQ.js";import{D as Z}from"./DropList-Dbd7BgQk.js";import{f as z}from"./hooks-DMD2NFet.js";import{P as X}from"./index-C9_U387z.js";import{B as Y}from"./ButtonFunction-C3V72H94.js";import{S as ee}from"./Scroll-CyeY1SIb.js";import{C as I}from"./index-D4oO2jGU.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-Chjiymov.js";import"./index-Bx6tewuM.js";import"./index-BQAaeyfQ.js";import"./ProgressBar-TiBN-Oau.js";import"./index-6PN_JoHT.js";import"./index-C-NxZ9RO.js";import"./index-zbp_5bxn.js";import"./TruncateString-D54BiV_x.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./Tooltip-DzAF_V2U.js";import"./PopoverPrivate-CnKgsFAm.js";import"./index-JZGyZbA2.js";import"./Link-C3VI6992.js";import"./LocaleProvider-DhC1J63f.js";import"./Sun-CLMO8Tpr.js";import"./constants-BAH7I9kc.js";import"./useValueControl-CNLw7ht-.js";import"./Dropdown-4YXb2YvP.js";import"./Checkbox-DNWBK0nb.js";import"./constants-BObEONKm.js";import"./TogglePrivate-BTSew7b5.js";import"./index-3XDw48l5.js";import"./index-DtRrUciF.js";import"./Switch-C2kF5vvg.js";import"./index-DLGJiw2b.js";import"./index-Baw9oej9.js";import"./index-C-1kvXrI.js";import"./IconPredefined-DVxQYij_.js";import"./Typography-MfFPC1vi.js";import"./ButtonTonal-DfdaJ3pw.js";import"./utils-Co0TT2aK.js";import"./Counter-DXWSEFY6.js";import"./ButtonFilled-GPG4KXwt.js";import"./Divider-C1X9zrkx.js";import"./Spinner-DZPrD8kc.js";import"./useButtonNavigation-CVCsehRW.js";import"./useClearButton-CBEN1tav.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-DtBLtd2v.js";import"./PromoTag-njwyApDn.js";import"./index-CIcT2jya.js";import"./Tag-SYaj7e1D.js";import"./constants-BaREPXw5.js";const ne=`# Change Log
...
- Initial version
`,te="@snack-uikit/search",ue="0.12.18",V={name:te,version:ue},ae=`# Search
...
Работа в режиме FieldText в значении false | undefined`,name:"autocomplete",required:!1,type:{name:"boolean"}}}}}catch{}const le="submit-toaster";function T(l){return Array.from({length:l.length}).map((s,e)=>({id:l+e,content:{option:l+e,description:"some description"}}))}const de="_wrapper_19t1e_1",re="_scrollWrapper_19t1e_15",pe="_scroll_19t1e_15",he="_container_19t1e_23",ke="_card_19t1e_29",v={wrapper:de,scrollWrapper:re,scroll:pe,container:he,card:ke},Nn={title:"Components/Search",component:A},me=({autocomplete:l,showPostfix:s,...e})=>{const[t,p]=i.useState(e.value||""),[d,r]=i.useState(!1),[h,c]=i.useState([]),[k,m]=i.useState(t),b=i.useCallback(async u=>{k!==u&&(m(u),c(T(u)),r(!1))},[k]),g=i.useMemo(()=>W(b,300),[b]),G=u=>{p(u),g(u),r(!0)},E=()=>{J.userAction.success({label:"Submit action","data-test-id":le})};i.useEffect(()=>g.cancel,[]),i.useEffect(()=>{e.value&&(p(e.value),m(e.value),c(T(e.value)))},[e.value]);const O=i.useMemo(()=>{if(s)return n.jsx(Y,{icon:n.jsx(X,{})})},[s]);return l?n.jsx("div",{className:v.wrapper,"data-outline":e.outline||void 0,children:n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,options:h,onSubmit:E,autocomplete:!0,postfix:O})}):n.jsxs("div",{className:v.wrapper,"data-outline":e.outline||void 0,children:[n.jsx(A,{...e,value:t,onChange:G,loading:d||e.loading,autocomplete:void 0,options:void 0,onSubmit:E,postfix:O}),h.length>0&&n.jsx("div",{className:v.scrollWrapper,children:n.jsx(ee,{className:v.scroll,children:n.jsx("div",{className:v.container,children:h.map(u=>n.jsx(I,{className:v.card,header:n.jsx(I.Header,{title:u.content.option,description:u.content.description})},u.id))})})})]})},H={render:me,args:{size:N.S,placeholder:"Placeholder",autocomplete:!0,outline:!0,showPostfix:!0,"data-test-id":""},argTypes:{options:{name:"options",defaultValue:[],if:{arg:"autocomplete",eq:!0}},showPostfix:{name:"[Stories]: Show postfix slot"}},parameters:{readme:{sidebar:[`Latest version: ${V.version}`,ae,ne]},packageName:V.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A143287&mode=design"}}};var w,P,R;H.parameters={...H.parameters,docs:{...(w=H.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: Template,
  args: {
    size: SIZE.S,
...
}`,...(R=(P=H.parameters)==null?void 0:P.docs)==null?void 0:R.source}}};export{Nn as default,H as search};
