...
- Initial version
`,o="@snack-uikit/divider",m="3.2.9",t={name:o,version:m},h=`# Divider
...
`,l="_container_1qa84_1",b={container:l},G={title:"Components/Divider",component:s},r=({...u})=>e.jsx("div",{className:b.container,children:e.jsx(s,{...u})}),n={render:r,args:{},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${t.version}`,h,d]},packageName:t.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=11%3A7167&mode=design"}}};var c,i,a;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: Template,
  args: {},
  argTypes: {},
  parameters: {
...
}`,...(a=(i=n.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};export{G as default,n as divider};
