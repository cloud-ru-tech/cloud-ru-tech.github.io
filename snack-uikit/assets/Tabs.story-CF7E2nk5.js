import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{T as e,a as c,C as o,A as b,M as d,O as k}from"./Tabs-DRWlrP6g.js";import{B as L}from"./ButtonFilled-CqpH2yJb.js";import"./index-ChsGqxH_.js";import"./index-JZGyZbA2.js";import"./index-CJ_LmFaV.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-DUmpqB7p.js";import"./Typography-DmSN6cv6.js";import"./componentPropsProcessors-UJEZy8aQ.js";import"./Counter-CRGhF3Kb.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./index-DrT0s6v0.js";import"./index-CGBRtoFy.js";import"./index-C3mvkShn.js";import"./index-Ca89sW9R.js";import"./ButtonElevated-BdSG9FP0.js";import"./utils-Cl9LJVwK.js";import"./Sun-CLMO8Tpr.js";import"./constants-BAH7I9kc.js";import"./Divider-C1X9zrkx.js";const H=`# Change Log
...
- Initial version
`,T="@snack-uikit/tabs",F="0.10.11",m={name:T,version:F},P=`# TabBar
...
`,S="_tab_1a95q_1",I="_story_1a95q_11",r={tab:S,story:I},an={title:"Components/Tabs",component:e},s=[{value:"tab1",label:"Tab one",disabled:!1},{value:"tab2",label:"Second",disabled:!1},{value:"tab3",label:"Disabled",disabled:!0},{value:"tab4",label:"Very very long name of tab",disabled:!1},{value:"tab5",label:"tab",disabled:!1},{value:"tab6",label:"s",disabled:!1},{value:"tab7",label:"some tab",disabled:!1},{value:"tab8",label:"Еще",disabled:!1},{value:"tab9",label:"Последний",disabled:!1},{value:"tab10",label:"Tab 10"},{value:"tab11",label:"Tab 11"},{value:"tab12",label:"Tab 12"},{value:"tab13",label:"Tab 13"},{value:"tab14",label:"Tab 14"},{value:"tab15",label:"Tab 15"},{value:"tab16",label:"Tab 16"}],p=Object.values(s).map(({value:a})=>a),x=function({type:a,orientation:h,defaultValue:y,disableDivider:A,showAfter:f,markerPosition:u,counterLabel:C,counterAppearance:E,counterColor:N,...l}){return t.jsx("div",{className:r.story,"data-orientation":h,children:t.jsxs(e,{...l,defaultValue:y,children:[u==="before"&&s.map(({value:n})=>t.jsxs(e.TabContent,{className:r.tab,value:n,children:["Content of ",n]},n)),t.jsx(e.TabBar,{...a===c.Secondary?{disableDivider:A,type:a}:{type:a},after:f&&t.jsx(L,{label:"custom btn"}),orientation:h,markerPosition:u,...l,children:s.map((n,v)=>t.jsx(e.Tab,{counter:v===0?{label:C,appearance:E,color:N}:void 0,...n},n.value))}),u==="after"&&s.map(({value:n})=>t.jsxs(e.TabContent,{className:r.tab,value:n,children:["Content of ",n]},n))]})})},i={render:x,args:{type:c.Primary,orientation:k.Horizontal,markerPosition:d.After,defaultValue:p[0],disableDivider:!1,showAfter:!1,counterLabel:1,counterAppearance:b.Primary,counterColor:o.Accent},argTypes:{type:{name:"type",options:Object.values(c),defaultValue:c.Primary,control:{type:"radio"}},orientation:{name:"orientation",options:Object.values(k),defaultValue:k.Horizontal,control:{type:"radio"}},markerPosition:{name:"markerPosition",options:Object.values(d),defaultValue:d.After,control:{type:"radio"}},counterLabel:{name:"counter.label",defaultValue:1,control:{type:"number"}},counterAppearance:{name:"counter.appearance",options:Object.values(b),defaultValue:b.Primary,control:{type:"select"}},counterColor:{name:"counter.color",options:Object.values(o),defaultValue:o.Accent,control:{type:"select"}},"data-test-id":{name:"data-test-id",control:{type:"text"}},defaultValue:{name:"defaultValue",options:p,control:{type:"select"}},disableDivider:{if:{arg:"type",eq:c.Secondary}},showAfter:{name:"[Stories]: show custom content after tabs bar"}},parameters:{readme:{sidebar:[`Latest version: ${m.version}`,P,H]},packageName:m.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A19393&mode=design"}}};var g,G,O;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: Template,
  args: {
    type: TYPE.Primary,
...
}`,...(O=(G=i.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};export{an as default,i as tabs};
