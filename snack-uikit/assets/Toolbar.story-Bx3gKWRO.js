import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{r as P}from"./index-CJ_LmFaV.js";import{t as e}from"./helpers-ChD1sjCF.js";import{T as i,a as H}from"./Toolbar-BtZZ9I8d.js";import{P as s}from"./index-C9_U387z.js";import{C as j}from"./index-DtRrUciF.js";import{C as V}from"./index-BQAaeyfQ.js";import{T as K}from"./index-Drk0xmYR.js";import{e as U}from"./componentPropsProcessors-UJEZy8aQ.js";import{B as O}from"./ButtonFunction-BElZbry1.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-Bxu_udwM.js";import"./index-DdXvKv-Q.js";import"./index-DUmpqB7p.js";import"./index-Chjiymov.js";import"./LocaleProvider-CyhbxqE1.js";import"./index-C7IVzcIX.js";import"./index-BLj3vrxU.js";import"./Scroll-B3e6J9cA.js";import"./useIsomorphicLayoutEffect-BAXQmlEq.js";import"./isBrowser-C2N6XvuH.js";import"./ProgressBar-DoG3l5ps.js";import"./index-6PN_JoHT.js";import"./index-C-NxZ9RO.js";import"./index-zbp_5bxn.js";import"./TruncateString-C-ApBzyA.js";import"./Tooltip-DMNQxdBh.js";import"./PopoverPrivate-TrV_4kB1.js";import"./index-JZGyZbA2.js";import"./Link-CNFTiRqm.js";import"./Sun-CjKF0Bsh.js";import"./constants-BAH7I9kc.js";import"./ChipChoiceRow-Db3mGHjA.js";import"./constants-BIigMBdG.js";import"./index-BqnWYpCO.js";import"./FuzzySearch-C8qpdhmO.js";import"./ButtonFilled-CM3N-4F4.js";import"./utils-BM2s5Pk-.js";import"./Counter-dO15w468.js";import"./index-B7wZyJkK.js";import"./useValueControl-C51frgGe.js";import"./Dropdown-CY0dSXGI.js";import"./hooks-r2IyjRbb.js";import"./Checkbox-BJ1fNH24.js";import"./constants-BObEONKm.js";import"./TogglePrivate-BTSew7b5.js";import"./index-3XDw48l5.js";import"./Switch-DmwOlfxh.js";import"./index-DLGJiw2b.js";import"./index-Baw9oej9.js";import"./index-BH-1anz1.js";import"./IconPredefined-yX8Rdo-2.js";import"./Typography-DmSN6cv6.js";import"./ButtonTonal-D0vhccb5.js";import"./Divider-G_YGM_Hz.js";import"./Spinner-PYn9r2mo.js";import"./useButtonNavigation-CnLiqaIQ.js";import"./useEventHandler-C8nLb_YB.js";import"./useClearButton-CfofiGle.js";import"./constants-9uwKbtvo.js";import"./InputPrivate-CZBaZYOR.js";import"./DropList-BvJgBJ2Q.js";import"./Calendar-Ci71hG2R.js";import"./TimePickerBase-B962l51l.js";import"./List-U9uq8GTr.js";import"./TimePicker-CxGok2TV.js";import"./index-CwHIobxP.js";import"./index-NU8U5csw.js";import"./Tag-Bj9vPXKZ.js";import"./constants-BaREPXw5.js";const $=`# Change Log
...
- Initial version
`,W="@snack-uikit/toolbar",z="0.13.8",A={name:W,version:z},J=`# Toolbar
...
`,n={submit:"submit-toaster",delete:"delete-toaster",deactivate:"deactivate-toaster",disabled:"disabled-toaster",confirm:"confirm-toaster",reject:"reject-toaster",refresh:"refresh-toaster",option:"option-toaster"},r={pinnedSingleFilter:"pinned-single-filter",singleFilter:"single-filter",dateFilter:"date-filter"};function b(c){return Array.from({length:Number(c)||3}).map((a,u)=>({content:{option:`Option ${u+1}`},onClick:()=>e.userAction.neutral({label:`Option ${u+1} clicked`,"data-test-id":n.option}),icon:t.jsx(s,{})}))}function E({outline:c,selectionMode:a}){return{outline:c,selectionMode:a}}try{b.displayName="generateOptions",b.__docgenInfo={description:"",displayName:"generateOptions",props:{}}}catch{}try{E.displayName="extractToolbarArgs",E.__docgenInfo={description:"",displayName:"extractToolbarArgs",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},search:{defaultValue:null,description:`Параметры отвечают за строку поиска <br>
...
<strong>loading</strong>: Состояние загрузки <br>`,name:"search",required:!1,type:{name:"{ value: string; onChange(value: string): void; onSubmit?(value: string): void; placeholder?: string; loading?: boolean; } | undefined"}},className:{defaultValue:null,description:"Класснейм",name:"className",required:!1,type:{name:"string"}},outline:{defaultValue:null,description:"Внешний бордер",name:"outline",required:!1,type:{name:"boolean"}},selectionMode:{defaultValue:{value:"'multiple'"},description:"Режим выбора",name:"selectionMode",required:!1,type:{name:"enum",value:[{value:'"single"'},{value:'"multiple"'}]}},checked:{defaultValue:null,description:"Значение чекбокса",name:"checked",required:!1,type:{name:"boolean"}},indeterminate:{defaultValue:null,description:"Состояние частичного выбора",name:"indeterminate",required:!1,type:{name:"boolean"}},onCheck:{defaultValue:null,description:"Колбек смены значения чекбокса",name:"onCheck",required:!1,type:{name:"(() => void)"}},bulkActions:{defaultValue:null,description:"Список массовых действий",name:"bulkActions",required:!1,type:{name:"BulkAction[]"}},after:{defaultValue:null,description:"Дополнительный слот в конце тулбара",name:"after",required:!1,type:{name:"ReactNode"}},onRefresh:{defaultValue:null,description:"Колбек обновления",name:"onRefresh",required:!1,type:{name:"(() => void)"}},moreActions:{defaultValue:null,description:"Элементы выпадающего списка кнопки с действиями",name:"moreActions",required:!1,type:{name:"Action[]"}},filterRow:{defaultValue:null,description:"",name:"filterRow",required:!1,type:{name:"FilterRow<TState>"}}}}}catch{}const Q=3,v=b(Q),Y=[{label:"Confirm",icon:j,onClick:()=>e.userAction.warning({label:"Confirm","data-test-id":n.confirm}),"data-test-id":i.confirmAction},{label:"Remove confirmation",icon:V,onClick:()=>e.userAction.warning({label:"Reject","data-test-id":n.reject}),"data-test-id":i.rejectAction},{label:"Delete",icon:K,onClick:()=>e.userAction.warning({label:"Delete","data-test-id":n.delete}),disabled:!0,tooltip:"One of the selected objects cannot be deleted in bulk","data-test-id":i.deleteAction},{label:"Deactivate",icon:s,onClick:()=>e.userAction.warning({label:"Deactivate","data-test-id":n.deactivate}),"data-test-id":i.deactivateAction},{label:"Disabled Action",icon:s,onClick:()=>e.userAction.warning({label:"Disabled","data-test-id":n.disabled}),disabled:!0,tooltip:"Example of disabled action in the list","data-test-id":i.disabledAction}],X={showAddButton:!0,showClearButton:!0,filters:[{id:"multi1",label:"Multi",type:"multiple",pinned:!0,options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}]},{id:"multi2",label:"Multi with apply button",type:"multiple",options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],autoApply:!1},{id:"single3",label:"Single",type:"single",pinned:!0,options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],"data-test-id":r.pinnedSingleFilter},{id:"single4",label:"Single with apply button",type:"single",options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}],autoApply:!1,"data-test-id":r.singleFilter},{id:"date5",label:"Date",type:"date","data-test-id":r.dateFilter},{id:"time6",label:"Time",type:"time"}]},Z="_wrapper_1bq79_1",tt={wrapper:Z},{useArgs:et}=__STORYBOOK_MODULE_PREVIEW_API__,Ae={title:"Components/Toolbar",component:H},nt=({showOnRefresh:c,showBulkActions:a,showManyBulkActions:u,showFilters:f,filterRowOpened:y,showAfterActions:F,showSearch:w,showMoreActions:S,outline:B,selectionMode:m,filterRow:p,...d})=>{var g;const D=u?d.bulkActions:(g=d.bulkActions)==null?void 0:g.slice(0,3),[{search:o,checked:k,indeterminate:T},l]=et(),R=G=>{l({search:{...o,value:G,onChange(){}}})},_=()=>{l({checked:!k})};P.useEffect(()=>{k&&(M=>{l({indeterminate:M})})(!1)},[k,l]);const I=()=>e.userAction.neutral({label:"Refresh","data-test-id":n.refresh}),q=()=>e.userAction.success({label:"Submit","data-test-id":n.submit}),x=t.jsxs(t.Fragment,{children:[t.jsx(O,{icon:t.jsx(s,{}),size:"m"}),t.jsx(O,{icon:t.jsx(s,{}),size:"m"})]});return t.jsx("div",{className:tt.wrapper,children:t.jsx(H,{...U(d),outline:B,selectionMode:m,...m==="multiple"?{checked:k,onCheck:_,bulkActions:a?D:void 0,indeterminate:T}:{},search:w&&o?{...o,value:o.value,onChange:R,onSubmit:q}:void 0,onRefresh:c?I:void 0,after:F?x:void 0,moreActions:S?v:void 0,filterRow:f&&p?{...p,open:y}:void 0})})},h={render:nt,args:{outline:!1,selectionMode:"multiple",checked:!1,indeterminate:!1,showBulkActions:!0,showManyBulkActions:!0,bulkActions:Y,showSearch:!0,search:{value:"",placeholder:"Search",loading:!1,onChange(){}},showFilters:!0,filterRow:X,filterRowOpened:void 0,showMoreActions:!0,moreActions:v,showOnRefresh:!0,showAfterActions:!0,"data-test-id":"toolbar"},argTypes:{checked:{if:{arg:"selectionMode",eq:"multiple"}},indeterminate:{if:{arg:"selectionMode",eq:"multiple"}},showBulkActions:{name:"[Story]: Show bulk actions",type:"boolean"},showManyBulkActions:{name:"[Story]: Show many bulk actions to display droplist",type:"boolean",if:{arg:"showBulkActions",eq:!0}},bulkActions:{if:{arg:"showBulkActions",eq:!0}},showFilters:{name:"[Story]: Show filters",type:"boolean"},filterRowOpened:{name:"[Story]: Filter row open",type:"boolean",if:{arg:"showFilters",eq:!0}},filterRow:{if:{arg:"showFilters",eq:!0}},showOnRefresh:{name:"[Story]: Apply onRefresh callback",type:"boolean"},showSearch:{name:"[Story]: Apply search props",type:"boolean"},search:{if:{arg:"showSearch",eq:!0}},showAfterActions:{name:'[Story]: Show custom ReactNode "after" (on the right side)',type:"boolean"},showMoreActions:{name:"[Story]: Show moreActions",type:"boolean"},moreActions:{if:{arg:"showMoreActions",eq:!0}},after:{table:{disable:!0}},onCheck:{table:{disable:!0}},onRefresh:{table:{disable:!0}}},parameters:{readme:{sidebar:[`Latest version: ${A.version}`,J,$]},packageName:A.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A224846&mode=design"}}};var C,N,L;h.parameters={...h.parameters,docs:{...(C=h.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: Template,
  args: {
    outline: false,
...
}`,...(L=(N=h.parameters)==null?void 0:N.docs)==null?void 0:L.source}}};export{Ae as default,h as toolbar};
