import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{c as j}from"./index-DUmpqB7p.js";import{r as p}from"./index-CJ_LmFaV.js";import{I as R,A as M,a as w,C as q}from"./index-CAfvFIBF.js";import{K as z}from"./index-B80hK4m0.js";import{D as K}from"./DropList-DDd8rCqD.js";import{B as Y}from"./ButtonFunction-kMVPL1in.js";import{T as W}from"./Tag-CtZ8TAQt.js";import{e as U}from"./componentPropsProcessors-UJEZy8aQ.js";import{T as m}from"./Typography-MfFPC1vi.js";import{T as f}from"./TruncateString-D12I7bk8.js";import{B as $}from"./ButtonSimple-CoS53OZZ.js";import{B as J}from"./ButtonTonal-Bf6KFNBv.js";import{L as Q}from"./Link-C-pYE027.js";import{t as X}from"./helpers-hLhTYNK-.js";const xt=`# Change Log
...
- Initial version
`,Z="@snack-uikit/notification",tt="0.13.8",Pt={name:Z,version:tt},It=`# Notification
...
`,e={Neutral:"neutral",Error:"error",ErrorCritical:"errorCritical",Warning:"warning",Success:"success"},s={label:"notification-card__label",title:"notification-card__title",content:"notification-card__content",link:"notification-card__link",date:"notification-card__date",actions:{wrapper:"notification-card__actions",droplist:"notification-card__droplist",droplistTrigger:"notification-card__droplist-trigger",droplistAction:"notification-card__droplist-action"},primaryButton:"notification-card__primary-button",secondaryButton:"notification-card__secondary-button"},ct="_notificationCardFunction_1eneb_1",nt="_notificationCardTitleText_1eneb_12",it="_notificationCardTitleIcon_1eneb_17",st="_notificationCard_1eneb_1",at="_notificationCardLabel_1eneb_98",et="_notificationCardTitle_1eneb_12",ut="_notificationCardContent_1eneb_111",kt="_notificationCardFooter_1eneb_117",ot="_notificationCardDate_1eneb_124",ht="_notificationCardButtons_1eneb_131",a={notificationCardFunction:ct,notificationCardTitleText:nt,notificationCardTitleIcon:it,notificationCard:st,notificationCardLabel:at,notificationCardTitle:et,notificationCardContent:ut,notificationCardFooter:kt,notificationCardDate:ot,notificationCardButtons:ht};function E({actions:c,open:n,setDroplistOpen:u}){return t.jsx("div",{className:a.notificationCardFunction,"data-test-id":s.actions.wrapper,children:t.jsx(K,{trigger:"clickAndFocusVisible",open:n,onOpenChange:u,placement:"bottom-end",scroll:!0,"data-test-id":s.actions.droplist,items:c.map(({onClick:k,disabled:g,content:l,tagLabel:i,icon:o})=>({onClick:b=>{u(!1),k==null||k(b)},disabled:g,content:l,beforeContent:o,afterContent:i?t.jsx(W,{label:i}):void 0,"data-test-id":s.actions.droplistAction})),children:t.jsx(Y,{size:"s",icon:t.jsx(z,{}),"data-test-id":s.actions.droplistTrigger})})})}try{E.displayName="NotificationCardFunction",E.__docgenInfo={description:"",displayName:"NotificationCardFunction",props:{actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},setDroplistOpen:{defaultValue:null,description:"",name:"setDroplistOpen",required:!0,type:{name:"Dispatch<SetStateAction<boolean>>"}}}}}catch{}function N(c){switch(c){case e.Success:return t.jsx(q,{size:16});case e.Error:case e.ErrorCritical:return t.jsx(w,{size:16});case e.Warning:return t.jsx(M,{size:16});case e.Neutral:return t.jsx(R,{size:16});default:return null}}try{N.displayName="getIcon",N.__docgenInfo={description:"",displayName:"getIcon",props:{}}}catch{}function v({id:c,appearance:n=e.Neutral,label:u,unread:k,title:g,content:l,link:i,date:o,onClick:b,primaryButton:G,secondaryButton:O,actions:r,onVisible:C,className:_,...B}){const{icon:D,linkOnColor:T,buttonAppearance:A}=p.useMemo(()=>({icon:N(n),linkOnColor:n===e.ErrorCritical?"red":void 0,buttonAppearance:n===e.ErrorCritical?"destructive":"primary"}),[n]),[L,S]=p.useState(!1),H=p.useRef(null);p.useEffect(()=>{if(!k||!C)return;const d=I=>{const[V]=I;V.isIntersecting&&C(c)},h=new IntersectionObserver(d,{root:null,threshold:.8,rootMargin:"0px"});return h.observe(H.current),()=>{h.disconnect()}},[c,C,k]);const x=!!(i||o),P=d=>{var h;d.stopPropagation(),(h=i==null?void 0:i.onClick)==null||h.call(i,d)};return t.jsxs("div",{ref:H,role:"button",onClick:b,tabIndex:0,...U(B),"data-appearance":n,"data-unread":k||void 0,"data-clickable":!!b||void 0,"data-droplist-open":L||void 0,className:j(a.notificationCard,_),children:[(r==null?void 0:r.length)&&t.jsx(E,{actions:r,open:L,setDroplistOpen:S}),u&&t.jsx(m.LightLabelS,{tag:"div",className:a.notificationCardLabel,children:t.jsx(f,{maxLines:1,text:u,"data-test-id":s.label})}),t.jsxs("div",{className:a.notificationCardTitle,children:[t.jsx("div",{className:a.notificationCardTitleIcon,children:D}),t.jsx(m.SansTitleS,{tag:"div",className:a.notificationCardTitleText,children:t.jsx(f,{maxLines:2,text:g,"data-test-id":s.title})})]}),l&&t.jsx(m.SansBodyS,{tag:"div",className:a.notificationCardContent,"data-test-id":s.content,children:l}),(G||O)&&t.jsxs("div",{className:a.notificationCardButtons,children:[O&&t.jsx($,{...O,appearance:A,size:"s","data-test-id":s.primaryButton}),G&&t.jsx(J,{...G,appearance:A,size:"s","data-test-id":s.secondaryButton})]}),x&&t.jsxs("div",{className:a.notificationCardFooter,children:[i&&t.jsx(Q,{...i,onClick:P,appearance:T,textMode:"default",size:"s","data-test-id":s.link}),o&&t.jsx(m.LightLabelS,{className:a.notificationCardDate,"data-test-id":s.date,children:o})]})]})}try{v.displayName="NotificationCard",v.__docgenInfo={description:"Компонент карточки уведомления",displayName:"NotificationCard",props:{"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"Идентификатор уведомления",name:"id",required:!0,type:{name:"string"}},appearance:{defaultValue:{value:"neutral"},description:"Тип уведомления",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"error"'},{value:'"warning"'},{value:'"success"'},{value:'"errorCritical"'}]}},label:{defaultValue:null,description:"Лейбл перед заголовком",name:"label",required:!1,type:{name:"string"}},unread:{defaultValue:null,description:"Управление состоянием прочитано/не прочитано",name:"unread",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"Заголовок уведомления",name:"title",required:!0,type:{name:"string"}},content:{defaultValue:null,description:"Контент уведомления",name:"content",required:!0,type:{name:"ReactNode"}},link:{defaultValue:null,description:"Ссылка",name:"link",required:!1,type:{name:'PickLinkProps<LinkElement, "text" | "insideText" | "truncateVariant">'}},date:{defaultValue:null,description:"Дата уведомления",name:"date",required:!0,type:{name:"string"}},onClick:{defaultValue:null,description:"Колбэк клика по карточке",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onVisible:{defaultValue:null,description:"Колбэк при попадании карточки в область видимости на 80%",name:"onVisible",required:!1,type:{name:"((cardId: string) => void)"}},primaryButton:{defaultValue:null,description:"Кнопка главного действия у карточки",name:"primaryButton",required:!1,type:{name:'Omit<ButtonTonalProps, "data-test-id" | "appearance" | "size">'}},secondaryButton:{defaultValue:null,description:"Кнопка второстепенного действия у карточки",name:"secondaryButton",required:!1,type:{name:'Omit<ButtonSimpleProps, "data-test-id" | "appearance" | "size">'}},actions:{defaultValue:null,description:"Дополнительные действия у карточки",name:"actions",required:!1,type:{name:"Action[]"}},className:{defaultValue:null,description:"CSS-класс",name:"className",required:!1,type:{name:"string"}}}}}catch{}const lt={card:"notification-card",toaster:"toaster",blank:"panel-blank"},bt={id:"cardId",label:["Category","Subcategory"].join("・"),appearance:e.Neutral,title:"Title truncate two line",content:`Demo content.

For replacement, use Property: ◆ProdContent. Replace this element with your local component with the original content.`,link:{text:"Link to detailed information",href:"#"},date:"DD.MM.YYYY HH:MM",actions:[{content:{option:"action 1"}},{content:{option:"action 2"}}]},Vt={amount:10,title:"Notifications",readAllButton:{label:"Mark all as read"},footerButton:{label:"All events"}},jt=c=>{X.userAction.success({label:c.currentTarget.textContent||"","data-test-id":lt.toaster})};function y(c,n){return Math.floor(Math.random()*(n-c+1)+c)}const F=Object.values(e);function Rt(c){const n=[];for(let u=0;u<c;++u)n.push({...bt,id:String(u),unread:!!y(0,1),appearance:F[y(0,F.length-1)]});return n}const rt="_pageWrapper_7p5lo_1",dt="_controlledWrapper_7p5lo_13",pt="_controlledCard_7p5lo_28",mt="_table_7p5lo_32",gt="_cell_7p5lo_40",Gt="_headerCell_7p5lo_48",Ot="_card_7p5lo_53",Mt={pageWrapper:rt,controlledWrapper:dt,controlledCard:pt,table:mt,cell:gt,headerCell:Gt,card:Ot};export{e as A,v as N,lt as S,It as a,xt as b,Pt as c,bt as d,a as e,Vt as f,Rt as g,jt as h,Mt as s};
