import{j as n}from"./jsx-runtime-BTJTZTIL.js";import{c as L}from"./index-CXM-PPQz.js";import{r as F}from"./index-CJ_LmFaV.js";import{A as y}from"./StatusIndicator-Bd2AgtNl.js";import{S as u,a as e,b as m,A as l}from"./Avatar-WvV69klA.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./componentPropsProcessors-UJEZy8aQ.js";const I=`# Change Log
...
- Initial version
`,w="@snack-uikit/avatar",H="0.8.25",h={name:w,version:H},U=`# Avatar
...
`,j=""+new URL("ImageCorp01-CgvwRRCD.jpg",import.meta.url).href,_=""+new URL("ImageCorp02-B-I_owas.jpg",import.meta.url).href,x=""+new URL("ImageCorp03-nTQ3Xaon.jpg",import.meta.url).href,R=""+new URL("ImageCorp04-DfsBLJwB.jpg",import.meta.url).href,S=""+new URL("ImageCorp05-DRRx2G3P.jpg",import.meta.url).href,T=""+new URL("ImageCorp06-BIiaLpUM.jpg",import.meta.url).href,P=""+new URL("ImageCorp07-pUPh_07Z.jpg",import.meta.url).href,D=""+new URL("ImageCorp08-B0QpUwph.jpg",import.meta.url).href,B=""+new URL("ImageUser01-Clej7SsF.jpg",import.meta.url).href,z=""+new URL("ImageUser02-CxtugQ_j.jpg",import.meta.url).href,J=""+new URL("ImageUser03-Da4kh21e.jpg",import.meta.url).href,M=""+new URL("ImageUser04-Bp9pxQow.jpg",import.meta.url).href,V=""+new URL("ImageUser05-CJOeERMP.jpg",import.meta.url).href,K=""+new URL("ImageUser06-DUAyf60s.jpg",import.meta.url).href,Q=""+new URL("ImageUser07-B4cxRweM.jpg",import.meta.url).href,$=""+new URL("ImageUser08-q1bAz7dA.jpg",import.meta.url).href,p={[u.Round]:{[e.Red]:B,[e.Orange]:z,[e.Yellow]:J,[e.Green]:M,[e.Blue]:V,[e.Violet]:K,[e.Pink]:Q,[e.Neutral]:$},[u.Square]:{[e.Red]:j,[e.Orange]:_,[e.Yellow]:x,[e.Green]:R,[e.Blue]:S,[e.Violet]:T,[e.Pink]:P,[e.Neutral]:D}},W="_pageWrapper_1ey0r_1",Z="_wrapper_1ey0r_7",q="_tableHorizontalGroup_1ey0r_20",Y="_tableVerticalGroup_1ey0r_26",X="_table_1ey0r_20",ee="_cell_1ey0r_40",ne="_headerCell_1ey0r_48",a={pageWrapper:W,wrapper:Z,tableHorizontalGroup:q,tableVerticalGroup:Y,table:X,cell:ee,headerCell:ne},le={title:"Components/Avatar",component:l},f="Will Willow",te=m.S,G=u.Round,O=e.Red;function i({header:r,options:d}){const s=L(a.cell,a.headerCell);return n.jsxs("div",{className:a.table,children:[n.jsx("div",{className:s}),n.jsx("div",{className:s,children:r}),d.map(c=>n.jsxs(F.Fragment,{children:[n.jsx("div",{className:s,children:c.header}),n.jsx("div",{className:a.cell,children:n.jsx(l,{name:f,...c.props})})]},c.header))]})}const ae=({showImage:r,customSrc:d,shape:s=G,appearance:c=O,...A})=>{const C=Object.values(u),E=Object.values(m),N=Object.values(e),v=Object.values(y);return n.jsxs("div",{className:a.pageWrapper,children:[n.jsxs("div",{className:a.wrapper,children:["Controlled:",n.jsx(l,{...A,shape:s,appearance:c,src:r?d||p[s][c]:void 0})]}),n.jsxs("div",{className:a.tableHorizontalGroup,children:[n.jsxs("div",{className:a.tableVerticalGroup,children:[n.jsx(i,{header:"Image",options:[{header:"Yes",props:{src:p[u.Round][e.Red]}},{header:"No"}]}),n.jsx(i,{header:"Shape",options:C.map(t=>({header:t,props:{shape:t}}))}),n.jsx(i,{header:"Symbols",options:[{header:"One",props:{showTwoSymbols:!1}},{header:"Two",props:{showTwoSymbols:!0}}]})]}),n.jsx(i,{header:"Appearance",options:N.map(t=>({header:t,props:{appearance:t}}))}),n.jsx(i,{header:"Indicator",options:[{header:"None"},...v.map(t=>({header:t,props:{indicator:t}}))]}),n.jsx(i,{header:"Size",options:E.map(t=>({header:t,props:{size:t}}))})]})]})},o={render:ae,args:{showImage:!1,customSrc:"",name:f,size:te,appearance:O,shape:G,indicator:void 0,showTwoSymbols:!1},argTypes:{showImage:{type:"boolean"},customSrc:{type:"string",if:{arg:"showImage"}},src:{table:{disable:!0}},size:{options:Object.values(m),control:{type:"select"}}},parameters:{readme:{sidebar:[`Latest version: ${h.version}`,U,I]},packageName:h.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A21136&mode=design"}}};var b,k,g;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: Template,
  args: {
    showImage: false,
    customSrc: '',
