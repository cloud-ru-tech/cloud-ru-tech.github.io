import{r}from"./index-CJ_LmFaV.js";import{j as u}from"./jsx-runtime-BTJTZTIL.js";import{D as T}from"./index-CNC7znSK.js";import{U as S}from"./index-BDKfaAX1.js";import{T as I}from"./index-OG_QCddz.js";import{B as f}from"./ButtonFunction-CtElqV7K.js";import{c as j}from"./index-CXM-PPQz.js";import{T as M}from"./TruncateString-DMHAWZlY.js";import{e as J}from"./componentPropsProcessors-UJEZy8aQ.js";import{t as C}from"./helpers-Bb_FfY3_.js";import{g as V}from"./_commonjsHelpers-D6-XlEtG.js";import{D as z}from"./DropZone-BrA8oo8c.js";const K=r.createContext({});function v(){return r.useContext(K)}const $=r.createContext({focused:!1,setFocused:()=>{}});function q(){return r.useContext($)}function wn(n){if(!n)return n;const t=n.split(".");return t.pop(),t.length===1&&t[0]===""?n:t.join(".")}function X(n){var t;return(t=n==null?void 0:n.split(".").pop())==null?void 0:t.toLocaleUpperCase()}function Z(n){return n.type.match(/image\/(png|jpg|jpeg|gif|webp|bmp|svg)/i)}function Dn(n){const[t,d]=r.useState(void 0),[e,o]=r.useState(!1);return r.useEffect(()=>{if(n&&Z(n)){const i=new FileReader;i.onloadstart=()=>{o(!0)},i.onloadend=()=>{o(!1);const{result:c}=i;c&&d(c.toString())},i.readAsDataURL(n)}else d(void 0)},[n]),{imageData:t,loading:e}}const k="attachment",h={icon:`${k}__icon`,image:`${k}__image`,loading:`${k}__loading`,retryAction:`${k}__retry-action`,deleteAction:`${k}__delete-action`,downloadAction:`${k}__download-action`,title:`${k}__title`,description:`${k}__description`,error:`${k}__error`},Y="_actions_1aog0_1",W="_retryAction_1aog0_6",_={actions:Y,retryAction:W},nn=()=>{};function w({hideDelete:n,hideDownload:t,hideRetry:d}){const{onDelete:e,onDownload:o,file:i,disabled:c,onRetry:s}=v(),{setFocused:p=nn}=q(),A=o&&!t,G=e&&!n,O=s&&!d,m=()=>{p(!0)},l=()=>{p(!1)},N=a=>{s==null||s(),a.stopPropagation()},E=a=>{o==null||o(i),a.stopPropagation()},H=a=>{e==null||e(i),a.stopPropagation()};return!A&&!G?null:u.jsxs("div",{className:_.actions,children:[A&&u.jsx(f,{disabled:c,size:"xs",icon:u.jsx(T,{}),onClick:E,onFocus:m,onBlur:l,"data-test-id":h.downloadAction}),O&&u.jsx(f,{disabled:c,size:"xs",icon:u.jsx(S,{}),onClick:N,onFocus:m,onBlur:l,className:_.retryAction,"data-test-id":h.retryAction}),G&&u.jsx(f,{disabled:c,size:"xs",icon:u.jsx(I,{}),onClick:H,onFocus:m,onBlur:l,"data-test-id":h.deleteAction})]})}try{w.displayName="Actions",w.__docgenInfo={description:"",displayName:"Actions",props:{hideDownload:{defaultValue:null,description:"",name:"hideDownload",required:!1,type:{name:"boolean"}},hideDelete:{defaultValue:null,description:"",name:"hideDelete",required:!1,type:{name:"boolean"}},hideRetry:{defaultValue:null,description:"",name:"hideRetry",required:!1,type:{name:"boolean"}}}}}catch{}function g({text:n,className:t,maxLines:d=1,...e}){const{truncateVariant:o}=v();return n?u.jsx("div",{className:t,children:u.jsx(M,{text:n,maxLines:d,variant:o,...J(e)})}):null}try{g.displayName="Text",g.__docgenInfo={description:"",displayName:"Text",props:{text:{defaultValue:null,description:"",name:"text",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!0,type:{name:"string"}},maxLines:{defaultValue:{value:"1"},description:"",name:"maxLines",required:!1,type:{name:"number"}},"data-test-id":{defaultValue:null,description:"",name:"data-test-id",required:!1,type:{name:"string"}}}}}catch{}const tn="_content_1nvre_1",en="_title_1nvre_16",cn="_description_1nvre_24",an="_error_1nvre_25",L={content:tn,title:en,description:cn,error:an};function D({title:n,description:t,error:d,className:e,align:o="left"}){const{size:i,truncate:c={}}=v();return u.jsxs("div",{className:j(L.content,e),"data-size":i,"data-align":o,children:[u.jsx(g,{className:L.title,text:n,"data-test-id":h.title,maxLines:c==null?void 0:c.title}),u.jsx(g,{className:L.description,text:t,"data-test-id":h.description,maxLines:c==null?void 0:c.description}),u.jsx(g,{className:L.error,text:d,"data-test-id":h.error,maxLines:c==null?void 0:c.error})]})}try{D.displayName="TextBlock",D.__docgenInfo={description:"",displayName:"TextBlock",props:{className:{defaultValue:null,description:"CSS-класс для элемента с контентом",name:"className",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Сообщение об ошибке",name:"error",required:!1,type:{name:"string"}},title:{defaultValue:{value:"fileName"},description:"Заголовок",name:"title",required:!1,type:{name:"string"}},description:{defaultValue:{value:"fileExtension"},description:"Описание",name:"description",required:!1,type:{name:"string"}},align:{defaultValue:{value:"left"},description:"",name:"align",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"center"'}]}}}}}catch{}const sn=`# Change Log
...
- Initial version
`,un="@snack-uikit/attachment",dn="0.4.42",F={name:un,version:dn},on=`# Attachment
...
`,b={Attachment:"attachment",ClickAction:"onClick",DeleteAction:"onDelete",DownloadAction:"onDownload",RetryAction:"onRetry"},rn={exampleFile:"pdf",showDelete:!0,showDownload:!0,showRetry:!0,title:"Title",description:"Description",error:"",showClick:!0,size:"s",loading:!1,checked:!1,disabled:!1,truncateVariant:"end","data-test-id":b.Attachment},kn="data:image/jpeg;base64,",ln="_wrapper_728ka_1",hn="_filesContainer_728ka_12",x={wrapper:ln,filesContainer:hn};var y,R;function mn(){return R||(R=1,y=function(n,t,d,e){var o=typeof e<"u"?[e,n]:[n],i=new Blob(o,{type:d||"application/octet-stream"});if(typeof window.navigator.msSaveBlob<"u")window.navigator.msSaveBlob(i,t);else{var c=window.URL&&window.URL.createObjectURL?window.URL.createObjectURL(i):window.webkitURL.createObjectURL(i),s=document.createElement("a");s.style.display="none",s.href=c,s.setAttribute("download",t),typeof s.download>"u"&&s.setAttribute("target","_blank"),document.body.appendChild(s),s.click(),setTimeout(function(){document.body.removeChild(s),window.URL.revokeObjectURL(c)},200)}}),y}var bn=mn();const gn=V(bn);function pn({content:n,path:t,fileName:d}){if(n&&gn(n,d),t){const e=Object.assign(document.createElement("a"),{target:"_blank",href:t,download:d});e.click(),e.remove()}}function An(n){const t=["B","KB","MB","GB","TB","PB","EB","ZB","YB"];if(n===0)return`0 ${t[0]}`;const d=2,e=1024,o=d,i=Math.floor(Math.log(n)/Math.log(e));return`${parseFloat((n/e**i).toFixed(o))} ${t[i]}`}function P(n){return function({exampleFile:d,showDelete:e,showDownload:o,showClick:i,showRetry:c,...s}){const[p,A]=r.useState({}),[G,O]=r.useState([]),[m,l]=r.useState(!1),[N,E]=r.useState(!1);r.useEffect(()=>{E(s.checked??!1)},[s.checked]);const H=()=>{l(!0),fetch(kn).then(a=>a.blob()).then(a=>A({img:new File([a],"Picture.jpg",{type:"image/jpg"}),pdf:new File([a],"File.pdf",{type:"application/pdf"})})).finally(()=>{l(!1)})};return r.useEffect(()=>{H()},[]),u.jsxs("div",{className:x.wrapper,children:[u.jsx(n,{...s,loading:m||s.loading,file:p[d],checked:N,onClick:i?()=>{C.userAction.neutral({label:"onClick","data-test-id":b.ClickAction}),E(a=>!a)}:void 0,onDelete:e?()=>{C.userAction.neutral({label:"onDelete","data-test-id":b.DeleteAction})}:void 0,onDownload:o?()=>{C.userAction.neutral({label:"onDownload","data-test-id":b.DownloadAction})}:void 0,onRetry:c?()=>{C.userAction.neutral({label:"onRetry","data-test-id":b.RetryAction})}:void 0}),u.jsx(z,{title:"Drop files here",onFilesUpload:O}),u.jsx("div",{className:x.filesContainer,children:G.map(a=>{var B;return u.jsx(n,{file:a,onDownload:()=>{pn({content:a,fileName:a.name})},description:`${(B=X(a.name))==null?void 0:B.toUpperCase()}, ${An(a.size)}`,onDelete:()=>O(Q=>Q.filter(U=>U.name!==a.name))},a.name)})})]})}}const Fn=rn,xn={exampleFile:{name:"[Story]: Show example file",options:["img","pdf"],control:{type:"radio"}},onClick:{table:{disable:!0}},onDelete:{table:{disable:!0}},onDownload:{table:{disable:!0}},onRetry:{table:{disable:!0}},file:{table:{disable:!0}},icon:{table:{disable:!0}},truncate:{table:{disable:!0}}},Rn={readme:{sidebar:[`Latest version: ${F.version}`,on,sn]},packageName:F.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/jtGxAPvFJOMir7V0eQFukN/branch/OSnyUq4zigaHiTkL1egWTB/Snack-UI-Kit-3.0.0?m=auto&node-id=6075%3A208643&t=B12jkbmMhhHAG3cv-1"}};try{P.displayName="TemplateStory",P.__docgenInfo={description:"",displayName:"TemplateStory",props:{}}}catch{}export{K as A,Rn as D,h as T,Dn as a,X as b,D as c,w as d,xn as e,Fn as f,wn as g,P as h,$ as i,v as u};
