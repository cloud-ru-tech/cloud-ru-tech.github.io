"use strict";(()=>{(self.webpackChunkuikit_product=self.webpackChunkuikit_product||[]).push([[9133],{"./packages/site-media/CHANGELOG.md"(n){n.exports=`# Change Log
...
`},"./packages/site-media/package.json"(n){n.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-media","rE":"1.1.22"}')}}]);})();
