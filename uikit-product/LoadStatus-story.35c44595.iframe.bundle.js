...
]`},description:"",name:"appearanceByProgress",required:!1,type:{name:"ProgressLimitList"}},showErrorIcon:{defaultValue:null,description:"",name:"showErrorIcon",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:{value:"s"},description:"\u0420\u0430\u0437\u043C\u0435\u0440",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},progress:{defaultValue:null,description:"\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u043E\u0442 0 \u0434\u043E 100",name:"progress",required:!0,type:{name:"number"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["packages/load-status/src/components/LoadStatus.tsx#LoadStatus"]={docgenInfo:v.__docgenInfo,name:"LoadStatus",path:"packages/load-status/src/components/LoadStatus.tsx#LoadStatus"})}catch(i){}var M={title:"Console/Load Status",component:v};function U(i){return(0,n.jsx)(v,{...i})}const W={render:U,args:{label:"Label",value:"Value",valueType:"percent",progress:70,hint:"Hint text",showErrorIcon:!0},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${l.rE}`,o,p]},packageName:l.UU,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/nrnltwtMewvlg7Oeftg22c/PDS-980-(Load-status)?node-id=22352-131934&t=r9ui39ENLqx5ZpTB-4"}}}}),"./packages/utils/src/utils/extractSupportProps.ts":((b,r,e)=>{e.d(r,{z:()=>l});var n=e("./packages/utils/src/utils/private/constants.ts");function p(o,u){return Object.keys(o).reduce((m,k)=>(k.match(u)&&(m[k]=o[k]),m),{})}function l(o){return p(o,n.d)}}),"./packages/utils/src/utils/private/constants.ts":((b,r,e)=>{e.d(r,{d:()=>n});const n=/^(data|aria)-/})}]);})();
