"use strict";(()=>{(self.webpackChunkuikit_product=self.webpackChunkuikit_product||[]).push([[3060],{"./packages/mobile-alert/stories/AlertTop.story.tsx"(k,t,n){n.r(t),n.d(t,{alertTop:()=>g,default:()=>h});var c=n("./node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js"),a=n("./node_modules/.pnpm/@snack-uikit+icons@1.0.1/node_modules/@snack-uikit/icons/dist/esm/components/interface-icons/placeholder/index.js");const p=`# Change Log
...
- Initial version
`,u=JSON.parse('{"UU":"@cloud-ru/uikit-product-mobile-alert","rE":"2.0.0"}'),l=`# Mobile Alert
...
`;var i=n("./packages/mobile-alert/src/components/MobileAlertTop/MobileAlertTop.tsx"),b=n("./packages/mobile-alert/src/constants.ts"),h={title:"Mobile/Alert/AlertTop",component:i.i};const d={text:"Button Text",icon:(0,c.jsx)(a.A,{}),onClick:()=>{}},s={text:"Link text",href:"#",onClick:e=>{e.preventDefault()}},g={render:({link:e,action:o,showCloseButton:m,...r})=>(0,c.jsx)(i.i,{...r,action:o?{...d,text:o}:void 0,link:e?{...s,text:e}:void 0,onClose:m?r.onClose:void 0}),args:{appearance:b.xz.Success,title:"Title with long long long long long long long long long long content",description:"Description with long long long long long long long long long long long long long long long long content",link:s.text,action:d.text,showCloseButton:!0,onClose:()=>{}},argTypes:{showCloseButton:{name:"[Stories]: showCloseButton"},description:{type:"string"},link:{type:"string"},action:{type:"string"},onClose:{table:{disable:!0}},icon:{table:{disable:!0}},truncate:{table:{disable:!0}}},parameters:{readme:{sidebar:[`Latest version: ${u.rE}`,l,p]},packageName:u.UU,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A182904&mode=design"}}}}}]);})();
