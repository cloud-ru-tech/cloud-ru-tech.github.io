"use strict";(()=>{(self.webpackChunkuikit_product=self.webpackChunkuikit_product||[]).push([[787],{"./packages/utils/src/utils/extractSupportProps.ts"(t,c,e){e.d(c,{z:()=>s});var u=e("./packages/utils/src/utils/private/constants.ts");function r(n,o){return Object.keys(n).reduce((i,d)=>(d.match(o)&&(i[d]=n[d]),i),{})}function s(n){return r(n,u.d)}},"./packages/utils/src/utils/private/constants.ts"(t,c,e){e.d(c,{d:()=>u});const u=/^(data|aria)-/},"./packages/site-cards/CHANGELOG.md"(t){t.exports=`# Change Log
...
- Initial version
`},"./packages/site-cards/README.md"(t){t.exports=`# Site Cards
...
`},"./packages/site-cards/package.json"(t){t.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-cards","rE":"1.4.2"}')}}]);})();
