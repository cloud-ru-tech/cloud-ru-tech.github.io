"use strict";(()=>{(self.webpackChunkuikit_product=self.webpackChunkuikit_product||[]).push([[787],{"./packages/utils/src/utils/extractSupportProps.ts"(e,c,t){t.d(c,{z:()=>s});var u=t("./packages/utils/src/utils/private/constants.ts");function r(n,o){return Object.keys(n).reduce((i,d)=>(d.match(o)&&(i[d]=n[d]),i),{})}function s(n){return r(n,u.d)}},"./packages/utils/src/utils/private/constants.ts"(e,c,t){t.d(c,{d:()=>u});const u=/^(data|aria)-/},"./packages/site-cards/CHANGELOG.md"(e){e.exports=`# Change Log
...
- Initial version
`},"./packages/site-cards/README.md"(e){e.exports=`# Site Cards
...
`},"./packages/site-cards/package.json"(e){e.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-cards","rE":"1.4.10"}')}}]);})();
