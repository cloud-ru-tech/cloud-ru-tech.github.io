...
`}),"./packages/charts/package.json":(t=>{t.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-charts","rE":"1.1.6"}')}),"./packages/utils/src/utils/extractSupportProps.ts":((t,c,e)=>{e.d(c,{z:()=>o});var r=e("./packages/utils/src/utils/private/constants.ts");function n(u,a){return Object.keys(u).reduce((d,i)=>(i.match(a)&&(d[i]=u[i]),d),{})}function o(u){return n(u,r.d)}}),"./packages/utils/src/utils/private/constants.ts":((t,c,e)=>{e.d(c,{d:()=>r});const r=/^(data|aria)-/})}]);})();
