...
]`},description:"",name:"appearanceByProgress",required:!1,type:{name:"ProgressLimitList"}},showErrorIcon:{defaultValue:null,description:"",name:"showErrorIcon",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:{value:"s"},description:"\u0420\u0430\u0437\u043C\u0435\u0440",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"s"'}]}},progress:{defaultValue:null,description:"\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u043E\u0442 0 \u0434\u043E 100",name:"progress",required:!0,type:{name:"number"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["packages/load-status/src/components/LoadStatus.tsx#LoadStatus"]={docgenInfo:G.__docgenInfo,name:"LoadStatus",path:"packages/load-status/src/components/LoadStatus.tsx#LoadStatus"})}catch(o){}var X={title:"Console/Load Status",component:G};function Y(o){return(0,r.jsx)(G,{...o})}const $={render:Y,args:{label:"Label",value:"Value",valueType:"percent",progress:70,hint:"Hint text",showErrorIcon:!0},argTypes:{},parameters:{readme:{sidebar:[`Latest version: ${b.rE}`,h,m]},packageName:b.UU,design:{name:"Figma",type:"figma",url:"https://www.figma.com/design/nrnltwtMewvlg7Oeftg22c/PDS-980-(Load-status)?node-id=22352-131934&t=r9ui39ENLqx5ZpTB-4"}}}}),"./packages/utils/src/utils/extractSupportProps.ts":((_,l,n)=>{n.d(l,{z:()=>b});var r=n("./packages/utils/src/utils/private/constants.ts");function m(h,i){return Object.keys(h).reduce((g,v)=>(v.match(i)&&(g[v]=h[v]),g),{})}function b(h){return m(h,r.d)}}),"./packages/utils/src/utils/private/constants.ts":((_,l,n)=>{n.d(l,{d:()=>r});const r=/^(data|aria)-/})}]);})();
