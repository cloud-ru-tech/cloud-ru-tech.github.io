...
`}),"./packages/site-cards/package.json":(t=>{t.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-cards","rE":"1.1.10"}')}),"./packages/utils/src/utils/extractSupportProps.ts":((t,c,e)=>{e.d(c,{z:()=>s});var u=e("./packages/utils/src/utils/private/constants.ts");function r(n,o){return Object.keys(n).reduce((d,i)=>(i.match(o)&&(d[i]=n[i]),d),{})}function s(n){return r(n,u.d)}}),"./packages/utils/src/utils/private/constants.ts":((t,c,e)=>{e.d(c,{d:()=>u});const u=/^(data|aria)-/})}]);})();
