...
- Initial version
`,_=JSON.parse('{"UU":"@cloud-ru/uikit-product-mobile-table","rE":"2.3.1"}'),w=`# Mobile Table
...
- Initial version
`,c=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-table","rE":"1.1.5"}'),p=`# Site Table
