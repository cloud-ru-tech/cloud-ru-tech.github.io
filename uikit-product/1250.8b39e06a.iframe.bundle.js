...
`}),"./packages/mobile-chips/package.json":(u=>{u.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-mobile-chips","rE":"2.0.10"}')}),"./packages/mobile-chips/stories/constants.tsx":((u,l,a)=>{a.d(l,{BI:()=>r,LP:()=>t});var g=a("./node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js"),i=a("./packages/icons/src/index.ts"),c=a("./packages/mobile-chips/src/constants.ts");const o={none:void 0,...Object.fromEntries(Object.keys(i).filter(e=>e!=="Sprite").map(e=>{const d=i[e];return[e,(0,g.jsx)(d,{},e)]}))},r={size:{options:Object.values(c.SK),control:{type:"radio"}},icon:{name:"[Stories]: Show icon examples",options:Object.keys(o),mapping:o,control:{type:"select"}}},t={multiple2:["vm-1"],date:new Date("2025-01-01"),single2:"true",dateRange:[new Date("2025-01-01"),new Date("2025-01-31")],time:{hours:12,minutes:0}}})}]);})();
