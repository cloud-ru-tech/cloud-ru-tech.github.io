...
`}),"./packages/site-cards/package.json":(t=>{t.exports=JSON.parse('{"UU":"@cloud-ru/uikit-product-site-cards","rE":"1.1.6"}')}),"./packages/utils/src/utils/extractSupportProps.ts":((t,n,e)=>{e.d(n,{z:()=>s});var u=e("./packages/utils/src/utils/private/constants.ts");function r(c,o){return Object.keys(c).reduce((d,i)=>(i.match(o)&&(d[i]=c[i]),d),{})}function s(c){return r(c,u.d)}}),"./packages/utils/src/utils/private/constants.ts":((t,n,e)=>{e.d(n,{d:()=>u});const u=/^(data|aria)-/})}]);})();
